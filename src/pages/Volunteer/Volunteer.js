    ...
    <div>
      <div>
        ...
        <meta
          ...
          content="Explore the wide range of exciting volunteering opportunities at the Museum."
        />
        <meta
          property="og:image"
              ...
              <main id="main-content" className="js-main">
                <div>
                  <div
                    ...
                    role="article"
                    aria-labelledby="paragraph-3365-title"
                  >
                    ...
                    <div className="container">
                      <div className="hero__inner">
                        <div className="hero__content-container">
                          ...
                          {/* <h1 id="paragraph-3365-title" className="hero__title">
                            {" "}
                            Volunteer
                          </h1> */}
                        </div>
                        <div className="hero__controls">
                          <div className="hero__caption | js-hero-caption">
                            <button
                              ...
                              id="hero-image-caption-button-3365"
                              aria-expanded="false"
                              aria-controls="hero-image-caption-content-3365"
                            >
                            ...
                            <div
                              ...
                              id="hero-image-caption-content-3365"
                              aria-hidden="true"
                              aria-labelledby="hero-image-caption-button-3365"
                            >
                              <button
                                type="button"
                                className="hero__caption-content-close | js-hero-caption-btn"
                                id="hero-image-caption-close-button-3365"
                                aria-expanded="false"
                                aria-controls="hero-image-caption-content-3365"
                              >
                                <span className="visually-hidden">
                              ...
                              <p>
                                {" "}
                                Volunteer giving a China eye-opener tour.&nbsp;
                              </p>
                            </div>
                          </div>
                        </div>
                    ...
                    <div className="breadcrumb__inner">
                      <div id="block-breadcrumbs">
                        <nav aria-labelledby="system-breadcrumb">
                          ...
                          >
                            You are in the Support us section
                          </h2>
                      ...
                      <div className="section__inner">
                        <div className="section--intro__container">
                            ...
                            <div className="section--intro__info-slices">
                              <div className="paragraph paragraph--type--info-content paragraph--view-mode--default section--intro__info-content wysiwyg">
                                <p>
                                  ...
                                  <br />
                                  Email:&nbsp;
                                  <a href="/cdn-cgi/l/email-protection#d4a2bbb8a1baa0b1b1a6a794b6a6bda0bda7bcb9a1a7b1a1b9fabba6b3">
                                    <span
                                      className="__cf_email__"
                                      data-cfemail="295f46455c475d4c4c5b5a694b5b405d405a41445c5a4c5c4407465b4e"
                                    >
                                      [email&nbsp;protected]
                                    </span>
                                  </a>
                          ...
                          <div className="section--intro__content">
                            ...
                            {/* <p className="h3">
                              More than 500 volunteers support the Museum
                              throughout the year, in a variety of roles.
                            </p>
                            <div className="wysiwyg">
                              <p>
                                Volunteers share their knowledge and enthusiasm
                                by delivering daily eye-opener tours, they help
                                the public enjoy the collection in numerous
                                other ways and support behind-the-scenes
                                activities in almost every department. And
                                that's just the start.
                              </p>
                              <p>
                                Every volunteer offers invaluable support to the
                                Museum, and they get something back from it too.
                              </p>
                            </div> */}
                          </div>
                        </div>
                      ...
                      <div>
                        <div>
                          <section
                            ...
                            aria-labelledby="paragraph-3374-title"
                          >
                            <div className="container">
                              <a
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    ...
                                    <ul>
                                      ...
                                      <li>
                                        Become part of a supportive team and
                                        community
                                      </li>
                                      <li>
                                    ...
                                    <div
                                      ...
                                      data-entity-uuid="1014e7ba-219c-4827-b17a-252363d422e6"
                                      data-langcode="en"
                                      data-media-alt-decorative={0}
                          ...
                          <section
                            aria-labelledby="paragraph-3375-title"
                            className="paragraph paragraph--type--slice-quote paragraph--view-mode--default section section--slice-quote section--bg-white"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-3375-title"
                                  className="visually-hidden"
                                >
                                  Volunteer testimony
                                </h2>
                                <div className="section--slice-quote__container">
                                  <blockquote className="section--slice-quote__quote">
                                    <p>
                                      Volunteering helps make the Museum feel
                                      accessible and welcoming... it's an
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-5898-title"
                          >
                            <div className="container">
                              <a
                                className="js-jump-link-anchor"
                              ...
                              <div className="section__inner">
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    ...
                                    <p>
                                      From Spotlight&nbsp;to LGBTQ tours, there
                                      are many ways to become involved. Find out
                                      about the different roles and what a few
                                      of our volunteers had to say.
                                    </p>
                                  </div>
                                </div>
                                <aside className="section--slice-content__embed">
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-5905-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-5905-title"
                                  className="section__title section--slice-content__title"
                                >
                                  Hands on desks
                                </h2>
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      Volunteer-run Hands on desks allow
                                      visitors to handle real objects, and to
                                      find out more about the collection,
                                      through relaxed informal conversations.
                                    </p>
                                    <p>
                                      Volunteers facilitate the object handling,
                                      encourage discussion and answer visitors'
                                      questions.
                                    </p>
                                    <p>
                                      <em>
                                        'The most enjoyable aspect of
                                        volunteering on the Hands on desks is
                                        the interaction with the visitors. Every
                                        time, I get to talk to different people
                                        from all over the world. Through
                                        discussions with them, I learn more
                                        about the objects.
                                      </em>
                                    </p>
                                    <p>
                                      <em>
                                        'My favourite memory is when I met a
                                        visitor from Turkey and we discussed the
                                        Arabic coffee pot. She worked at a
                                        museum in Istanbul and was an absolute
                                        expert in the objects! So instead of me
                                        giving her an introduction, she
                                        explained to me the whole history of
                                        Turkish coffee. That really made my
                                        day!'
                                      </em>
                                    </p>
                                    <p>
                                      –&nbsp;Bihe, Islamic World Hands on
                                      desk&nbsp;
                                    </p>
                                  </div>
                                </div>
                                <aside className="section--slice-content__embed">
                                  <div className="paragraph paragraph--type--embedded-media paragraph--view-mode--default">
                                    <figure className="media media-embed media-image js-media">
                                      ...
                                      />
                                      <figcaption>
                                        Young visitor taking part in a Hands on
                                        desks session. © Benedict Johnson.
                                      </figcaption>
                                    </figure>
                                  </div>
                                </aside>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-right section--bg-white"
                            aria-labelledby="paragraph-5899-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-5899-title"
                                  className="visually-hidden section--slice-content__title"
                                >
                                  Behind the scenes
                                </h2>
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    ...
                                    <p>
                                      Volunteering opportunities behind the
                                      scenes vary according to the work of each
                                      department and their current needs.
                                    </p>
                                    <p>
                                      Departmental volunteers help with tasks
                                      such as cataloguing
                                      <strong>&nbsp;</strong>objects, evaluating
                                      exhibitions and delivering learning
                                      programmes.
                                    </p>
                                    <p>
                                      <em>
                                        'I really enjoy volunteering with the
                                        Communities department. I get to see so
                                        many interesting things from all over
                                        the world. For example,&nbsp;the
                                        beautifully made padded jacket from
                                        Western China is so practical and warm,
                                        and is decorated with wonderful colours.
                                        I also love being part of a team and
                                        discovering the variety of work that's
                                        conducted within the museum.'
                                      </em>
                                    </p>
                                    <p>– Jane, Communities team</p>
                                  </div>
                                </div>
                                <aside className="section--slice-content__embed">
                                  <div className="paragraph paragraph--type--embedded-media paragraph--view-mode--default">
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-5900-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-5900-title"
                                  className="section__title section--slice-content__title"
                                >
                                  Eye-opener tours
                                </h2>
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      Eye-opener tours introduce visitors to the
                                      Museum's collection through a variety of
                                      guided talks that take place in different
                                      galleries across the Museum. There are 15
                                      tours that run every day on a range of
                                      topics.
                                    </p>
                                    <p>
                                      <em>
                                    ...
                                    <p>
                                      <em>
                                        'In the beginning, I wasn't sure that I
                                        could conduct the Eye-opener tour.
                                        However, with the support of the
                                        Volunteers'&nbsp;Office and my fellow
                                        volunteers, I was able to overcome my
                                        worries.'
                                      </em>
                                    </p>
                                    <p>– Mohamad, Eye-opener tours</p>
                                  </div>
                                </div>
                                <aside className="section--slice-content__embed">
                                  <div className="paragraph paragraph--type--embedded-media paragraph--view-mode--default">
                                    <figure className="media media-embed media-image js-media">
                                      ...
                                      <figcaption>
                                        ...
                                        in the Mexico gallery.&nbsp;© Benedict
                                        Johnson
                                      </figcaption>
                                    </figure>
                                  </div>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-right section--bg-white"
                            aria-labelledby="paragraph-5901-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-5901-title"
                                  className="visually-hidden section--slice-content__title"
                                >
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <h2>Friday night spotlight tours</h2>
                                    <p>
                                      The spotlight tours introduce visitors to
                                      key objects in the Museum's collection. We
                                      offer four tours every Friday evening,
                                      each lasting about 20 minutes.
                                    </p>
                                    <p>
                                      Volunteers take visitors on a short tour
                                      of the collection and answer questions.
                                    </p>
                                    <p>
                                      <em>
                                    ...
                                    <p>
                                      <em>
                                        'Learning about the objects on my tour
                                        is always fun. My favourite object to
                                        talk about is the Rosetta Stone.
                                        Visitors just love it and are genuinely
                                        keen to find out all they can.'
                                      </em>
                                    </p>
                                    <p>– Cecilia,&nbsp;Spotlight tours</p>
                                  </div>
                                </div>
                                <aside className="section--slice-content__embed">
                                  <div className="paragraph paragraph--type--embedded-media paragraph--view-mode--default">
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-5902-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-5902-title"
                                  className="section__title section--slice-content__title"
                                >
                                  LGBTQ tours
                                </h2>
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      ...
                                      integral part of human experience. The way
                                      they have been expressed culturally has
                                      varied widely around the globe and over
                                      time.
                                    </p>
                                    <p>
                                      <em>
                                    ...
                                    <p>
                                      <em>
                                        'I believe that our LGBTQ tours are a
                                        great way of highlighting same-sex
                                        desire and gender fluidity through the
                                        exceptional range of historical periods
                                        and cultures covered by the museum's
                                        collections. People joining the tour get
                                        an understanding of how widespread these
                                        themes are in the human experience.'
                                      </em>
                                    </p>
                                    <p>– Chris,&nbsp;LGBTQ tours</p>
                                  </div>
                                </div>
                                <aside className="section--slice-content__embed">
                                  <div className="paragraph paragraph--type--embedded-media paragraph--view-mode--default">
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-right section--bg-white"
                            aria-labelledby="paragraph-5903-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-5903-title"
                                  className="visually-hidden section--slice-content__title"
                                >
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <h2>Touch tour volunteers</h2>
                                    <p>
                                      A volunteer-facilitated Touch tour is
                                      available for blind and partially-sighted
                                      visitors in the Egyptian sculpture
                                      displays (Room 4). The tour features nine
                                      objects and lasts about an hour.
                                      Volunteers welcome the attendees, helping
                                      them navigate the physical space of the
                                      Museum and guide their exploration of the
                                      tour objects through touch and discussion.
                                    </p>
                                    <p>
                                      <em>
                                        'The touch tours are very intimate, as
                                        you only have one or two visitors and
                                        you can really tailor the experience to
                                        suit their interests. Helping visually
                                        impaired visitors access the collection
                                        is a privilege, and I love to make their
                                        visit extra special.
                                      </em>
                                    </p>
                                    <p>
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-5907-title"
                          >
                            <div className="container">
                              <a
                                className="js-jump-link-anchor"
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  <h3 className="teaser__title">
                                                    <a
                                                      href="/support-us/volunteer/marsh-awards"
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-6630-title"
                          >
                            <div className="container">
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-6623"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-6623"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                      ...
                                      <span>
                                        ...
                                        listed on the website. Can you keep my
                                        details on file?
                                      </span>
                                    </button>
                                  </h3>
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-6623"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-6623"
                                  >
                                    <p style={{ "margin-bottom": "13px" }}>
                                      Volunteer opportunities are advertised on
                                      our website. If there are none listed that
                                      means we are not currently taking on new
                                      volunteers. It is not our policy to keep
                                      applications on file because of the large
                                      numbers we receive, so please only apply
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-6624"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-6624"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                  ...
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-6624"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-6624"
                                  >
                                    <p style={{ "margin-bottom": "13px" }}>
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-6625"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-6625"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                  ...
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-6625"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-6625"
                                  >
                                    <p style={{ "margin-bottom": "13px" }}>
                                      We offer a range of volunteer
                                      opportunities, all with different levels
                                      of time commitment and flexibility.
                                    </p>
                                  </div>
                                </div>
                                <div
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-6626"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-6626"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                  ...
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-6626"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-6626"
                                  >
                                    <p style={{ "margin-bottom": "13px" }}>
                                      We have a range of volunteer opportunities
                                      with different time commitments. For most
                                      visitor-facing roles, you'll be asked to
                                      commit to volunteering for a minimum of
                                      six months.&nbsp;
                                    </p>
                                  </div>
                                </div>
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-6627"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-6627"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                      ...
                                      <span>
                                        {" "}
                                        Do you offer work experience for school
                                        students?
                                      </span>
                                    </button>
                                  </h3>
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-6627"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-6627"
                                  >
                                    <p style={{ "margin-bottom": "13px" }}>
                                      We don't run a work experience programme
                                      at present.
                                    </p>
                                  </div>
                                </div>
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-6628"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-6628"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                  ...
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-6628"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-6628"
                                  >
                                    <p style={{ "margin-bottom": "13px" }}>
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-6629"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-6629"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
