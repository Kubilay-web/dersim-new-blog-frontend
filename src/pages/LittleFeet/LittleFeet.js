  ...
  return (
    <div>
      <div>
        ...
        <meta
          name="description"
          content="Discover the awesome objects on display in the 'Silk Roads' exhibition while engaging in fun activities designed for under-5s."
        />
        <link
          rel="canonical"
          href="http://localhost:3000/events/little-feet-silk-roads-exhibition-explorer-17-Jan"
        />
        <link
          rel="image_src"
          href="http://localhost:3000/sites/default/files/styles/uncropped_large/public/2024-10/Little_Feet_exhibition_explorer_teaser.jpg?itok=CrAKRAF8"
        />
        <meta property="og:site_name" content="The British Museum" />
        <meta property="og:type" content="article" />
        <meta
          property="og:url"
          content="http://localhost:3000/events/little-feet-silk-roads-exhibition-explorer-17-Jan"
        />
        <meta property="og:title" content="Little Feet: exhibition explorer" />
        <meta
        ...
        <meta
          property="og:image"
          content="/images/LittleFeet/Little_Feet_exhibition_explorer_teaser.jpg"
        />
        ...
        <meta name="twitter:title" content="Little Feet: exhibition explorer" />
        <meta
          name="twitter:image"
          content="http://localhost:3000/sites/default/files/styles/uncropped_large/public/2024-10/Little_Feet_exhibition_explorer_teaser.jpg?itok=CrAKRAF8"
        />
        ...
        <title>Little Feet: exhibition explorer | British Museum</title>
        ...
        <link
          ...
          sizes="180x180"
          href="/images/LittleFeet/apple-touch-icon.png"
        />
        <link
          rel="icon"
          type="image/png"
          href="/images/LittleFeet/favicon-32x32.png"
          sizes="32x32"
        />
        <link
          rel="icon"
          type="image/png"
          href="/images/LittleFeet/favicon-16x16.png"
          sizes="16x16"
        />
        <link rel="manifest" href="/site.webmanifest" />
        <link
          rel="mask-icon"
          href="/images/LittleFeet/safari-pinned-tab.svg"
          color="#5bbad5"
        />
                  ...
                  <div>
                    <div>
                      <div
                        ...
                        role="article"
                        aria-labelledby="paragraph-41473-title"
                      >
                        <div className="hero__background">
                          <div className="media media-hero media-image js-media">
                            <picture>
                              ...
                              <source
                                srcSet="/images/LittleFeet/Little-Feet-exhibition-explorer-1920x1080_3.jpg 1x"
                              ...
                              />
                              <source
                                srcSet="/images/LittleFeet/Little-Feet-exhibition-explorer-1920x1080_2.jpg 1x"
                              ...
                              />
                              <source
                                srcSet="/images/LittleFeet/Little-Feet-exhibition-explorer-1920x1080_1.jpg 1x"
                              ...
                              <img
                                ...
                                src="/images/LittleFeet/Little-Feet-exhibition-explorer-1920x1080.jpg"
                        ...
                        <div className="container">
                          <div className="hero__inner">
                            <div className="hero__content-container hero__content-container--boxed ">
                              ...
                              <h1
                                id="paragraph-41473-title"
                                className="hero__title"
                              >
                                {" "}
                                <strong>Exhibition explorer</strong>
                              </h1>
                              <p className="hero__meta">
                                <span>Family activity</span>/ 17 January 2025
                              </p>
                              <p className="hero__meta">Under 5s</p>
                                    ...
                                    <div style={{ width: "40%" }}>
                                      <div className="media media-embed_no_caption media-image js-media">
                                        <img
                                          ...
                                          srcSet="/images/LittleFeet/Huo%20logo%20280px%20wide%20reversed%20out_1.png 282w"
                                          sizes="100vw"
                                          width={282}
                                          height={113}
                                          src="/images/LittleFeet/Huo%20logo%20280px%20wide%20reversed%20out.png"
                                    ...
                                    <div style={{ width: "40%" }}>
                                      <div className="media media-embed_no_caption media-image js-media">
                                        <img
                                          loading="eager"
                                          className="lazyload not-full-width"
                                          srcSet="/images/LittleFeet/UACF-logo%20white-EN-space3-280px_1.png 280w"
                                          sizes="100vw"
                                          width={280}
                                          height={170}
                                          src="/images/LittleFeet/UACF-logo%20white-EN-space3-280px.png"
                            ...
                            <div className="hero__controls">
                              <div className="hero__caption | js-hero-caption">
                                <button
                                  ...
                                  id="hero-image-caption-button-41473"
                                  aria-expanded="false"
                                  aria-controls="hero-image-caption-content-41473"
                                >
                                ...
                                <div
                                  ...
                                  id="hero-image-caption-content-41473"
                                  aria-hidden="true"
                                  aria-labelledby="hero-image-caption-button-41473"
                                >
                                  <button
                                    type="button"
                                    className="hero__caption-content-close | js-hero-caption-btn"
                                    id="hero-image-caption-close-button-41473"
                                    aria-expanded="false"
                                    aria-controls="hero-image-caption-content-41473"
                                  >
                                    <span className="visually-hidden">
                                  ...
                                  <p>
                                    {" "}
                                    Two Little Feet teddies crafting with gold
                                    foil and papyrus paper.
                                  </p>
                                </div>
                              </div>
                            </div>
                          ...
                          <ul className="breadcrumb__list">
                            ...
                            <li className="breadcrumb__item breadcrumb__item--current">
                              ...
                              <a
                                ...
                                aria-current="page"
                              >
                                Little Feet: exhibition explorer
                              </a>
                            </li>
                          </ul>
                        </nav>
                        ...
                        <ul className="social-share__list">
                          <li className="social-share__item">
                            <a
                              ...
                              href="http://www.facebook.com/share.php?u=http://localhost:3000/events/little-feet-silk-roads-exhibition-explorer-17-Jan"
                              target="_blank"
                          ...
                          <li className="social-share__item">
                            <a
                              className="social-share__link"
                              href="https://twitter.com/intent/tweet?text=Little%20Feet%3A%20exhibition%20explorer&url=http://localhost:3000/events/little-feet-silk-roads-exhibition-explorer-17-Jan"
                              target="_blank"
                              rel="nofollow noopener noreferrer"
                            >
                              <span className="visually-hidden">
                        ...
                        <div className="section--intro__container">
                          <div className="section--intro__info">
                            <div className="section--intro__info-slices">
                              ...
                              <div className="paragraph paragraph--type--info-content paragraph--view-mode--default section--intro__info-content">
                                ...
                                <p>The Sainsbury Exhibitions Gallery</p>
                              </div>
                              ...
                              <div className="intro-link--button paragraph paragraph--type--info-link paragraph--view-mode--default">
                                <a
                                  ...
                                  href="/support-us/donate-now"
                                >
                                  <span>Donate to the British Museum</span>
                                </a>
                              </div>
                              <div className="paragraph paragraph--type--info-content paragraph--view-mode--default section--intro__info-content wysiwyg">
                                <p>
                          ...
                          <div className="section--intro__content">
                            <div className="wysiwyg">
                              ...
                              <p>
                                The Little Feet teddies invite you to a free,
                                drop-in session in the{" "}
                                <a
                                ...
                                exhibition. Join the teddies as they explore the
                                awesome objects on display while engaging in
                                activities designed for under-fives and their
                                parents and carers.
                              </p>
                              <p>
                                You might want to visit the Middle East and spot
                                an Islamic coin – imagine taking it on a journey
                                along the Silk Roads, then maybe crafting it
                                into a pendant for a necklace and landing in
                                Sweden, where you can sell it to the Vikings.
                                Perhaps you'll see the bowl of fruit and explore
                                the pretend food market, practice your colour
                                words looking at the materials found across the
                                Silk Roads routes, or use your senses in the
                                travelling zone. Whatever you decide to do there
                              ...
                              <p>
                                This event is free to drop into at any time
                                between 10.30 and 12.00.
                              </p>
                              <p>
                                <span>You're advised to </span>
                                <a href="https://ticketing.britishmuseum.org/events?k=general%20admission">
                                  book a free timed ticket
                                </a>
                                <span>
                                  {" "}
                                  for Museum entry to receive key information
                                  and updates before your visit and priority
                                  entry during busy periods. Please note that
                                  you do not need to purchase a ticket for{" "}
                                </span>
                                <a
                                  href="/exhibitions/silk-roads"
                                  data-entity-type="node"
                                ...
                                <span> to attend this event.</span>
                              </p>
                              <p>
                                The Main entrance is on Great Russell Street.
                                Your timed ticket allows you to explore the
                                permanent collection as well. See the{" "}
                                <a
                                  href="/visit"
                                  data-entity-type="node"
                              ...
                              <p>
                                <span>
                                  Please note that Little Feet events can get
                                  busy, in which case a waiting area will be
                                  made available to ensure the best experience
                                  in the session.
                                </span>
                              </p>
                            </div>
