...
const National = () => {
  ...
  useEffect(() => {
    ...
    const category1 = `${categoryPrefix}-41`;
  ...
  useEffect(() => {
    ...
    // Kategoriler dil bazında dinamik olarak ayarlanıyor
    const category1 = `${contentPrefix}-content-36`;
  ...
  return (
    <div>
      <div>
        ...
        <meta
          property="og:image"
          content="/images/National/Hieroglyphs_at_Ferens_Art_Gallery_Hull_1.jpg"
        />
        ...
        <link
          ...
          sizes="180x180"
          href="/images/National/apple-touch-icon.png"
        />
        <link
          rel="icon"
          type="image/png"
          href="/images/National/favicon-32x32.png"
          sizes="32x32"
        />
        <link
          rel="icon"
          type="image/png"
          href="/images/National/favicon-16x16.png"
          sizes="16x16"
        />
        <link rel="manifest" href="/site.webmanifest" />
        <link
          rel="mask-icon"
          href="/images/National/safari-pinned-tab.svg"
          color="#5bbad5"
        />
              ...
              <main id="main-content" className="js-main">
                <div>
                  <div
                    ...
                    role="article"
                    aria-labelledby="paragraph-6721-title"
                  >
                    <div className="hero__background">
                      <div className="media media-hero media-image js-media">
                        <picture>
                          ...
                          <source
                            srcSet="/images/National/Hieroglyphs_at_Ferens_Art_Gallery_Hull_2.jpg 1x"
                          ...
                          />
                          <source
                            srcSet="/images/National/Hieroglyphs_at_Ferens_Art_Gallery_Hull_1.jpg 1x"
                          ...
                          />
                          <source
                            srcSet="/images/National/Hieroglyphs_at_Ferens_Art_Gallery_Hull_3.jpg 1x"
                          ...
                          <img
                            ...
                            src="/images/National/Hieroglyphs_at_Ferens_Art_Gallery_Hull.jpg"
                        ...
                        <div className="hero__controls">
                          <div className="hero__caption | js-hero-caption">
                            <button
                              ...
                              id="hero-image-caption-button-6721"
                              aria-expanded="false"
                              aria-controls="hero-image-caption-content-6721"
                            >
                            ...
                            <div
                              ...
                              id="hero-image-caption-content-6721"
                              aria-hidden="true"
                              aria-labelledby="hero-image-caption-button-6721"
                            >
                              <button
                                type="button"
                                className="hero__caption-content-close | js-hero-caption-btn"
                                id="hero-image-caption-close-button-6721"
                                aria-expanded="false"
                                aria-controls="hero-image-caption-content-6721"
                              >
                                <span className="visually-hidden">
                          ...
                          <div className="section--intro__info">
                            ...
                            <div className="section--intro__info-slices">
                              <div className="paragraph paragraph--type--info-content paragraph--view-mode--default section--intro__info-content wysiwyg">
                                <p>
                                  Email:&nbsp;
                                  <a href="/cdn-cgi/l/email-protection#f0859b809182849e95828398998083b0928299849983989d858395859dde9f8297">
                                    <span
                                      className="__cf_email__"
                                      data-cfemail="47322c37263533292235342f2e37340725352e332e342f2a323422322a69283520"
                                    >
                                      [email&nbsp;protected]
                                    </span>
                                  </a>
                      ...
                      <div>
                        <div>
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-6723-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-6723-title"
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      Our nationwide network of museums,
                                      galleries, libraries and heritage
                                      organisations delivers a wealth of
                                      activity through{" "}
                                      <a
                                        href="/our-work/national/uk-touring-exhibitions-and-loans/partnership-galleries"
                                        data-entity-type="node"
                                        data-entity-uuid="8df74952-073a-4f90-93b0-407a12327705"
                                        data-entity-substitution="canonical"
                                        title="Partnership Galleries"
                                      >
                                      ...
                                      , youth programmes, the creation of
                                    ...
                                    <p>
                                      Working together with our partners, we
                                      support local priorities by building
                                      relationships with not only museum
                                      colleagues, but with councillors and
                                      mayors to better understand local plans
                                      and the specific context of a region.
                                    </p>
                                    <p>
                                      <strong>
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-6728-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  <h3 className="teaser__title">
                                                    <a
                                                      href="/our-work/national/skills-sharing-and-expertise"
                                                      className="teaser__anchor"
                                                    >
                                                      <span>
                                                        <span>
                                  ...
                                  <div className="teaser__wrapper">
                                    ...
                                    <div className="teaser__content">
                                      <div className="teaser__content-push">
                                        ...
                                        <div className="teaser__summary">
                                          High-resolution images of the artist's
                                          pioneering 'paper mosaiks' of plants
                                          and flowers, displayed side by side
                                  ...
                                  <div className="teaser__wrapper">
                                    ...
                                    <div className="teaser__content">
                                      <div className="teaser__content-push">
                                        ...
                                        <div className="teaser__summary">
                                          Explore the fascinating Kushite
                                          Kingdom, which flourished in Sudan
                                          3,000 years ago and was a nexus for
                                  ...
                                  <div className="teaser__wrapper">
                                    ...
                                    <div className="teaser__content">
                                      <div className="teaser__content-push">
                                        ...
                                        <h3 className="teaser__title">
                                          <a
                                            href="/our-work/national/uk-touring-exhibitions-and-loans/current-tours/ice-age-art-now"
                                            className="teaser__anchor"
                                          >
                                            <span>
                                              <span>Ice Age Art Now</span>
                                            </span>
                                            {/* Add visually hidden defacer for screen-reader. Use full stops for reader punctuation. */}
                                            <span className="visually-hidden">
                                              . Coming June 2025 .
                                        ...
                                        <div className="teaser__summary">
                                          Discover how works by people who lived
                                          as long as 32,000 years ago reveal the
                                          deep roots of human artistic
                                          creativity.
                                        </div>
                                      </div>
                                      <span className="teaser__button | button button--chevron">
                                        Find out more{" "}
                                        <span className="visually-hidden">
                                          about <span>Ice Age Art Now</span>
                                        </span>
                                      </span>
                                    </div>
                                  </div>
