  ...
  return (
    <div>
      <div>
        ...
        <meta
          property="og:title"
          content="Admonitions of the instructress to the court ladies"
        />
        <meta
        ...
        <meta
          property="og:image"
          content="/images/Admonitions/The_Admonitions_Scroll_1000x500.jpg"
        />
        ...
        <title>
          Admonitions of the instructress to the court ladies | British Museum
        </title>
        ...
        <link
          ...
          sizes="180x180"
          href="/images/Admonitions/apple-touch-icon.png"
        />
        <link
          rel="icon"
          type="image/png"
          href="/images/Admonitions/favicon-32x32.png"
          sizes="32x32"
        />
        <link
          rel="icon"
          type="image/png"
          href="/images/Admonitions/favicon-16x16.png"
          sizes="16x16"
        />
        <link rel="manifest" href="/site.webmanifest" />
        <link
          rel="mask-icon"
          href="/images/Admonitions/safari-pinned-tab.svg"
          color="#5bbad5"
        />
              ...
              <main id="main-content" className="js-main">
                <div>
                  <div
                    ...
                    role="article"
                    aria-labelledby="paragraph-5713-title"
                  >
                    <div className="hero__background">
                      <div className="media media-hero media-image js-media">
                        <picture>
                          ...
                          <source
                            srcSet="/images/Admonitions/Admonitions%20of%20the%20Instructress%20to%20the%20Court%20Ladies%252C%20The%20Admonitions%20Scroll%252C%20British%20Museum_3.jpg 1x"
                          ...
                          />
                          <source
                            srcSet="/images/Admonitions/Admonitions%20of%20the%20Instructress%20to%20the%20Court%20Ladies%252C%20The%20Admonitions%20Scroll%252C%20British%20Museum_1.jpg 1x"
                          ...
                          />
                          <source
                            srcSet="/images/Admonitions/Admonitions%20of%20the%20Instructress%20to%20the%20Court%20Ladies%252C%20The%20Admonitions%20Scroll%252C%20British%20Museum_2.jpg 1x"
                          ...
                          <img
                            ...
                            src="/images/Admonitions/Admonitions%20of%20the%20Instructress%20to%20the%20Court%20Ladies%252C%20The%20Admonitions%20Scroll%252C%20British%20Museum.jpg"
                    ...
                    <div className="container">
                      <div className="hero__inner">
                        <div className="hero__content-container hero__content-container--boxed ">
                          <h1 id="paragraph-5713-title" className="hero__title">
                            {" "}
                        ...
                        <div className="hero__controls">
                          <div className="hero__caption | js-hero-caption">
                            <button
                              ...
                              id="hero-image-caption-button-5713"
                              aria-expanded="false"
                              aria-controls="hero-image-caption-content-5713"
                            >
                            ...
                            <div
                              ...
                              id="hero-image-caption-content-5713"
                              aria-hidden="true"
                              aria-labelledby="hero-image-caption-button-5713"
                            >
                              <button
                                type="button"
                                className="hero__caption-content-close | js-hero-caption-btn"
                                id="hero-image-caption-close-button-5713"
                                aria-expanded="false"
                                aria-controls="hero-image-caption-content-5713"
                              >
                                <span className="visually-hidden">
                              ...
                              <p>
                                {" "}
                                Traditionally attributed to Gu Kaizhi (AD
                                345–406), 'The Admonitions Scroll' ('Admonitions
                      ...
                      <div className="section__inner">
                        <div className="section--intro__container">
                            ...
                            <div className="section--intro__info-slices section--intro__info-slices-no-title">
                              ...
                              <div className="paragraph paragraph--type--info-content paragraph--view-mode--default section--intro__info-content wysiwyg">
                                <p>
                                  ...
                                  &nbsp;and be the first to hear about upcoming
                                  events.
                                </p>
                              </div>
                            </div>
                          ...
                          <div className="section--intro__content">
                            <p className="h3">
                              This masterpiece is considered a milestone in
                              Chinese painting history.
                            </p>
                            <div className="wysiwyg">
                              <p>
                                <span>
                                  Traditionally attributed to Gu Kaizhi (about
                                  AD 345–406), it probably dates to between AD
                                  400 and 700. Due to conservation precautions,
                                  it can only be displayed for six weeks a year.
                                </span>
                              </p>
                              <p>
                                The Admonitions Scroll depicts a poetic text
                                composed by an official Zhang Hua (about AD
                                232–300) aimed at correcting the behaviour of an
                                empress. The Scroll carries inscriptions by
                                later collectors including the Qianlong emperor
                                (r. 1736–1795). The British Museum purchased the
                                Scroll from Captain Clarence Johnson (1870–1937)
                                who was in Beijing in 1900 during the Boxer
                                Rebellion (1899–1901). Originally a handscroll,
                                the painting and later inscriptions were
                                separated and mounted onto panels in 1914.
                              </p>
                              <h3>Visiting information</h3>
                              <ul>
                                <li>
                                  <span>
                                    The Admonitions Scroll will be on display
                                    from Monday 14 July – Monday 25 August
                                  </span>{" "}
                                  2025
                                  <span>
                                    . Due to conservation precautions, it can
                                    only be displayed for six weeks
                                    each&nbsp;year.&nbsp;
                                  </span>
                                  &nbsp;
                                </li>
                                ...
                                <li>
                                  <span>
                                    Hand-held photography and video recording
                                    (without flash) is allowed in the gallery
                                    for private purposes only.
                                  </span>
                                </li>
                                <li>
                                  <span>
                                    If you want to see the Admonitions Scroll
                                    throughout the year,&nbsp;a digital screen
                                    of the scroll is available in{" "}
                                  </span>
                                  <a
                                  ...
                                  >
                                    <span>Room 33: China and South Asia</span>
                                  </a>
                                  <span>&nbsp;on the First Floor.</span>
                                </li>
                              </ul>
                            </div>
                          </div>
                      ...
                      <div>
                        <div>
                          <section
                            ...
                            aria-labelledby="paragraph-31823-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-31823-title"
                                            ...
                                            <div className="teaser__wrapper">
                                              <div className="teaser__content">
                                                <h3 className="teaser__title">
                                                  <a
                                                    href="https://www.britishmuseumshoponline.org/trade/the-admonitions-scroll.html"
                                                  ...
                                                  >
                                                    ...
                                                    <span className="visually-hidden">
                                                      https://www.britishmuseumshoponline.org/trade/the-admonitions-scroll.html
                                                    </span>
                                                  </a>
                                                </h3>
                                                £ 5
                                              ...
                                              <div className="teaser__image">
                                                <div className="media media-embed_no_caption media-image js-media">
                                                  <img
                                                    ...
                                                    srcSet="/images/Admonitions/The-Admonitions-Scroll-464x464_1.jpg 400w, /images/Admonitions/The-Admonitions-Scroll-464x464_2.jpg 464w"
                                                    sizes="100vw"
                                                    width={464}
                                                    height={464}
                                                    src="/images/Admonitions/The-Admonitions-Scroll-464x464.jpg"
                                                    alt="Book cover of The Admonitions Scroll showing section of scroll against white background"
                                                  />
                                                </div>
                                              </div>
                                            </div>
                                    ...
                                    <div className="teaser__image-container">
                                      <div className="media media-teaser_landscape media-image js-media">
                                        <img
                                          ...
                                          width={750}
                                          height={422}
                                          data-src="/sites/default/files/styles/16_9_media_small/public/2019-10/R33%2077_Hotung.jpg?h=73e3f11e&itok=hByu6lou"
                                          data-sizes="auto"
                                          data-srcset="/sites/default/files/styles/16_9_media_tiny/public/2019-10/R33%2077_Hotung.jpg?h=73e3f11e&itok=S0FPd45V 400w, /sites/default/files/styles/16_9_media_small/public/2019-10/R33%2077_Hotung.jpg?h=73e3f11e&itok=hByu6lou 750w, /sites/default/files/styles/16_9_media_medium/public/2019-10/R33%2077_Hotung.jpg?h=73e3f11e&itok=QPctzZLn 1000w, /sites/default/files/styles/16_9_media_large/public/2019-10/R33%2077_Hotung.jpg?h=73e3f11e&itok=wBHstPK1 1300w, /sites/default/files/styles/16_9_media_huge/public/2019-10/R33%2077_Hotung.jpg?h=73e3f11e&itok=ccWCS6L9 1600w"
                                          data-focal-position="center center"
                                          alt="A visitor looking at a statue in Room 33 Sir Joseph Hotung Gallery. Visitors walk around in the background"
                                        />
                                        <noscript>
                                          &lt;img loading="eager"
                                          srcset="/sites/default/files/styles/16_9_media_tiny/public/2019-10/R33%2077_Hotung.jpg?h=73e3f11e&amp;itok=S0FPd45V
                                          400w,
                                          /sites/default/files/styles/16_9_media_small/public/2019-10/R33%2077_Hotung.jpg?h=73e3f11e&amp;itok=hByu6lou
                                          750w,
                                          /sites/default/files/styles/16_9_media_medium/public/2019-10/R33%2077_Hotung.jpg?h=73e3f11e&amp;itok=QPctzZLn
                                          1000w,
                                          /sites/default/files/styles/16_9_media_large/public/2019-10/R33%2077_Hotung.jpg?h=73e3f11e&amp;itok=wBHstPK1
                                          1300w,
                                          /sites/default/files/styles/16_9_media_huge/public/2019-10/R33%2077_Hotung.jpg?h=73e3f11e&amp;itok=ccWCS6L9
                                          1600w" width="750" height="422"
                                          data-src="/sites/default/files/styles/16_9_media_small/public/2019-10/R33%2077_Hotung.jpg?h=73e3f11e&amp;itok=hByu6lou"
                                          data-sizes="auto" alt="A visitor
                                          looking at a statue in Room 33 Sir
                                          Joseph Hotung Gallery. Visitors walk
                                    ...
                                    <div className="teaser__content">
                                      <div className="teaser__content-push">
                                        <h3 className="teaser__title">
                                          ...
                                          >
                                            <span>
                                              <span>China and South Asia</span>
                                            </span>
                                            {/* Add visually hidden defacer for screen-reader. Use full stops for reader punctuation. */}
                                          </a>
                                        </h3>
                                        <div className="teaser__summary">
                                          This gallery explores the cultures of
                                          China and South Asia through a range
                                    ...
                                    <div className="teaser__image-container">
                                      <div className="media media-teaser_landscape media-image js-media">
                                        <img
                                          ...
                                          width={750}
                                          height={422}
                                          data-src="/sites/default/files/styles/16_9_media_small/public/2019-11/The%20David%20Vases%2C%20Yuan%20dynasty%2C%20British%20Museum%2C%20teaser_3.jpg?h=acacadf3&itok=lxPony0D"
                                          data-sizes="auto"
                                          data-srcset="/sites/default/files/styles/16_9_media_tiny/public/2019-11/The%20David%20Vases%2C%20Yuan%20dynasty%2C%20British%20Museum%2C%20teaser_3.jpg?h=acacadf3&itok=Wg74t1JQ 400w, /sites/default/files/styles/16_9_media_small/public/2019-11/The%20David%20Vases%2C%20Yuan%20dynasty%2C%20British%20Museum%2C%20teaser_3.jpg?h=acacadf3&itok=lxPony0D 750w, /sites/default/files/styles/16_9_media_medium/public/2019-11/The%20David%20Vases%2C%20Yuan%20dynasty%2C%20British%20Museum%2C%20teaser_3.jpg?h=acacadf3&itok=3kKgEeRc 1000w, /sites/default/files/styles/16_9_media_large/public/2019-11/The%20David%20Vases%2C%20Yuan%20dynasty%2C%20British%20Museum%2C%20teaser_3.jpg?h=acacadf3&itok=uCkO3p_1 1300w, /sites/default/files/styles/16_9_media_huge/public/2019-11/The%20David%20Vases%2C%20Yuan%20dynasty%2C%20British%20Museum%2C%20teaser_3.jpg?h=acacadf3&itok=FEXmT-pY 1600w"
                                          data-focal-position="bottom center"
                                          alt="The David Vases, two large porcelain temple-vases, Yuan dynasty, China. "
                                        />
                                        <noscript>
                                          &lt;img loading="eager"
                                          srcset="/sites/default/files/styles/16_9_media_tiny/public/2019-11/The%20David%20Vases%2C%20Yuan%20dynasty%2C%20British%20Museum%2C%20teaser_3.jpg?h=acacadf3&amp;itok=Wg74t1JQ
                                          400w,
                                          /sites/default/files/styles/16_9_media_small/public/2019-11/The%20David%20Vases%2C%20Yuan%20dynasty%2C%20British%20Museum%2C%20teaser_3.jpg?h=acacadf3&amp;itok=lxPony0D
                                          750w,
                                          /sites/default/files/styles/16_9_media_medium/public/2019-11/The%20David%20Vases%2C%20Yuan%20dynasty%2C%20British%20Museum%2C%20teaser_3.jpg?h=acacadf3&amp;itok=3kKgEeRc
                                          1000w,
                                          /sites/default/files/styles/16_9_media_large/public/2019-11/The%20David%20Vases%2C%20Yuan%20dynasty%2C%20British%20Museum%2C%20teaser_3.jpg?h=acacadf3&amp;itok=uCkO3p_1
                                          1300w,
                                          /sites/default/files/styles/16_9_media_huge/public/2019-11/The%20David%20Vases%2C%20Yuan%20dynasty%2C%20British%20Museum%2C%20teaser_3.jpg?h=acacadf3&amp;itok=FEXmT-pY
                                          1600w" width="750" height="422"
                                          data-src="/sites/default/files/styles/16_9_media_small/public/2019-11/The%20David%20Vases%2C%20Yuan%20dynasty%2C%20British%20Museum%2C%20teaser_3.jpg?h=acacadf3&amp;itok=lxPony0D"
                                          data-sizes="auto" alt="The David
                                          Vases, two large porcelain
                                          temple-vases, Yuan dynasty, China. "
                                          /&gt;
                                        </noscript>
                                      </div>
                                    </div>
                                    <div className="teaser__content">
                                      <div className="teaser__content-push">
                                        <h3 className="teaser__title">
                                          ...
                                          >
                                            <span>
                                              <span>Chinese ceramics</span>
                                            </span>
                                            {/* Add visually hidden defacer for screen-reader. Use full stops for reader punctuation. */}
                                          </a>
                                        </h3>
                                        <div className="teaser__summary">
                                          A gallery displaying some of the
                                          finest Chinese ceramics in the world,
                                          from the Sir Percival David
                                          Collection.
                                        </div>
                                      </div>
                                      <span className="teaser__button | button button--chevron">
