...
const CaseStudies = () => {
  ...
  useEffect(() => {
    ...
    const category1 = `${categoryPrefix}-54`;
  ...
  useEffect(() => {
    ...
    // Kategoriler dil bazında dinamik olarak ayarlanıyor
    const category1 = `${contentPrefix}-content-46`;
  ...
  return (
    <div>
      <div>
        ...
        <meta
          name="description"
          content="The corporate bodies and individuals who support the Museum are invaluable. Read case studies of our donors and partners who support the Museum, plus the history of some of our acquisitions."
        />
        <link
          rel="canonical"
        ...
        <meta
          ...
          content="Read our supporter case studies to discover just a few of the fantastic collaborations already happening with the Museum."
        />
        <meta
          property="og:image"
          content="/images/CaseStudies/Conservator-cleaning-Parthenon-Metope_1.jpg"
        />
        ...
        <link
          ...
          sizes="180x180"
          href="/images/CaseStudies/apple-touch-icon.png"
        />
        <link
          rel="icon"
          type="image/png"
          href="/images/CaseStudies/favicon-32x32.png"
          sizes="32x32"
        />
        <link
          rel="icon"
          type="image/png"
          href="/images/CaseStudies/favicon-16x16.png"
          sizes="16x16"
        />
        <link rel="manifest" href="/site.webmanifest" />
        <link
          rel="mask-icon"
          href="/images/CaseStudies/safari-pinned-tab.svg"
          color="#5bbad5"
        />
              ...
              <main id="main-content" className="js-main">
                <div>
                  <div
                    ...
                    role="article"
                    aria-labelledby="paragraph-3530-title"
                  >
                    <div className="hero__background">
                      <div className="media media-hero media-image js-media">
                        <picture>
                          ...
                          <source
                            srcSet="/images/CaseStudies/Conservator-cleaning-Parthenon-Metope_2.jpg 1x"
                          ...
                          />
                          <source
                            srcSet="/images/CaseStudies/Conservator-cleaning-Parthenon-Metope_1.jpg 1x"
                          ...
                          />
                          <source
                            srcSet="/images/CaseStudies/Conservator-cleaning-Parthenon-Metope_3.jpg 1x"
                          ...
                          <img
                            ...
                            src="/images/CaseStudies/Conservator-cleaning-Parthenon-Metope.jpg"
                            alt="Conservator cleaning Parthenon Metope"
                          />
                        </picture>
                      </div>
                    </div>
                        ...
                        <div className="hero__controls">
                          <div className="hero__caption | js-hero-caption">
                            <button
                              ...
                              id="hero-image-caption-button-3530"
                              aria-expanded="false"
                              aria-controls="hero-image-caption-content-3530"
                            >
                            ...
                            <div
                              ...
                              id="hero-image-caption-content-3530"
                              aria-hidden="true"
                              aria-labelledby="hero-image-caption-button-3530"
                            >
                              <button
                                type="button"
                                className="hero__caption-content-close | js-hero-caption-btn"
                                id="hero-image-caption-close-button-3530"
                                aria-expanded="false"
                                aria-controls="hero-image-caption-content-3530"
                              >
                                <span className="visually-hidden">
                              ...
                              <p>
                                {" "}
                                Conservator performing cleaning tests on the
                                Parthenon metope XXXI. Many of the Museum's
                          ...
                          <div className="section--intro__info">
                            ...
                            <div className="section--intro__info-slices">
                              <div className="paragraph paragraph--type--info-content paragraph--view-mode--default section--intro__info-content wysiwyg">
                                <p>
                                  Find out more about supporting the Museum:
                                  <br />
                                  Email:&nbsp;
                                  <a href="/cdn-cgi/l/email-protection#d9bdbcafbcb5b6a9b4bcb7ad99bbabb0adb0aab1b4acaabcacb4f7b6abbe">
                                    <span
                                      className="__cf_email__"
                                      data-cfemail="1470716271787b6479717a605476667d607d677c7961677161793a7b6673"
                                    >
                                      [email&nbsp;protected]
                                    </span>
                                  </a>
                          ...
                          <div className="section--intro__content">
                            ...
                            <div className="wysiwyg">
                              <p>
                                ...
                                organisations who have supported the Museum and
                                helped to shape its collections today.
                              </p>
                              <p>
                                If you're interested in joining the ranks of our
                      ...
                      <div>
                        <div>
                          <section
                            ...
                            aria-labelledby="paragraph-3543-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-3543-title"
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  <h3 className="teaser__title">
                                                    <a
                                                      href="/support-us/supporter-case-studies/acceptance-lieu-and-cultural-gifts-scheme"
                                                      className="teaser__anchor"
                                                    >
                                                      <span>
                                                        <span>
                                                          Acceptance in Lieu and
                                                  ...
                                                  <div className="teaser__summary">
                                                    The Acceptance in Lieu and
                                                    Cultural Gifts Scheme have
                                                    led to the acquisition of
                                                    significant works of art,
                                                    objects or manuscripts.
                                                  </div>
                                                </div>
                                              </div>
                                            </div>
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  <h3 className="teaser__title">
                                                    <a
                                                      href="/support-us/supporter-case-studies/bp"
                                                      className="teaser__anchor"
                                                    >
                                                      <span>
                                                        <span>BP</span>
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  <h3 className="teaser__title">
                                                    <a
                                                      href="/support-us/supporter-case-studies/bridget-riley-art-foundation"
                                                      className="teaser__anchor"
                                                    >
                                                      <span>
                                                        <span>
                          ...
                          {/* <section
                            className="paragraph paragraph--type--slice-teaser paragraph--view-mode--default section section--slice-teaser section--z-index-scope section--has-carousel section--bg-white"
                            aria-labelledby="paragraph-3544-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-3544-title"
                                    className="visually-hidden teaser-listing__title"
                                  >
                                    More supporter case studies
                                  </h2>
                                  <div className="carousel-container | js-carousel-container">
                                    <div
                                      className="teaser-listing carousel carousel--2-col swiper-container | js-carousel-2-col"
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  <h3 className="teaser__title">
                                                    <a
                                                      href="/support-us/supporter-case-studies/eisler"
                                                      className="teaser__anchor"
                                                    >
                                                      <span>
                                                        <span>Eisler</span>
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  <h3 className="teaser__title">
                                                    <a
                                                      href="/support-us/supporter-case-studies/dr-john-h-rassweiler"
                                                      className="teaser__anchor"
                                                    >
                                                      <span>
                                                        <span>
                                                  ...
                                                  <div className="teaser__summary">
                                                    Dr John H Rassweiler has
                                                    supported the care, research
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  <h3 className="teaser__title">
                                                    <a
                                                      href="/support-us/supporter-case-studies/kenneth-day"
                                                      className="teaser__anchor"
                                                    >
                                                      <span>
                                                        <span>Kenneth Day</span>
                                                      </span>
                                                    </a>
                                                  </h3>
                                                  <div className="teaser__summary">
                          ...
                          {/* <section
                            className="paragraph paragraph--type--slice-teaser paragraph--view-mode--default section section--slice-teaser section--z-index-scope section--has-carousel section--bg-white"
                            aria-labelledby="paragraph-12231-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-12231-title"
                                    className="visually-hidden teaser-listing__title"
                                  >
                                    More supporter case studies
                                  </h2>
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  <h3 className="teaser__title">
                                                    <a
                                                      href="/support-us/supporter-case-studies/lord-leonard-and-lady-estelle-wolfson-foundation"
                                                      className="teaser__anchor"
                                                    >
                                                      <span>
                                                        <span>
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  <h3 className="teaser__title">
                                                    <a
                                                      href="/support-us/supporter-case-studies/samsung"
                                                      className="teaser__anchor"
                                                    >
                                                      <span>
                                                        <span>Samsung</span>
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  <h3 className="teaser__title">
                                                    <a
                                                      href="/support-us/supporter-case-studies/world-conservation-and-exhibitions-centre"
                                                      className="teaser__anchor"
                                                    >
                                                      <span>
                                                        <span>
                                                  ...
                                                  <div className="teaser__summary">
                                                    The WCEC was unveiled in
                                                    2014, supported by a
                                                    significant legacy left to
                                                    the Museum by Florence
                                                    Cameron-Coles.
                                                  </div>
                                                </div>
                                              </div>
