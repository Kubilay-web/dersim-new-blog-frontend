...
const Communities = () => {
  ...
  useEffect(() => {
    const someContentId = "67b2f1c37ffef8be106d2815";
    ...
    <div>
      <div>
        ...
        <meta
          ...
          content="Find out more about our programme of activities, collaborative projects and learning opportunities with local communities."
        />
        <meta
          property="og:image"
              ...
              <main id="main-content" className="js-main">
                <div>
                  <div
                    ...
                    role="article"
                    aria-labelledby="paragraph-8706-title"
                  >
                    ...
                    <div className="container">
                      <div className="hero__inner">
                        <div className="hero__content-container">
                          ...
                          {/* <h1 id="paragraph-8706-title" className="hero__title">
                            {" "}
                            Communities
                          </h1> */}
                        </div>
                        <div className="hero__controls">
                          <div className="hero__caption | js-hero-caption">
                            <button
                              ...
                              id="hero-image-caption-button-8706"
                              aria-expanded="false"
                              aria-controls="hero-image-caption-content-8706"
                            >
                            ...
                            <div
                              ...
                              id="hero-image-caption-content-8706"
                              aria-hidden="true"
                              aria-labelledby="hero-image-caption-button-8706"
                            >
                              <button
                                type="button"
                                className="hero__caption-content-close | js-hero-caption-btn"
                                id="hero-image-caption-close-button-8706"
                                aria-expanded="false"
                                aria-controls="hero-image-caption-content-8706"
                              >
                                <span className="visually-hidden">
                              ...
                              <p>
                                {" "}
                                Discovering objects as part of an accompanied
                                visit to galleries.
                              </p>
                            </div>
                          </div>
                        ...
                        <nav aria-labelledby="system-breadcrumb">
                          ...
                          <ul className="breadcrumb__list">
                            ...
                            <li className="breadcrumb__item breadcrumb__item--link">
                              ...
                              <a href="/learn" className="breadcrumb__link">
                                <span>Learn</span>
                              </a>
                            </li>
                        ...
                        <div className="section--intro__container">
                          <div className="section--intro__info">
                            ...
                            <div className="section--intro__info-slices">
                              <div className="paragraph paragraph--type--info-content paragraph--view-mode--default section--intro__info-content wysiwyg">
                                ...
                                <p>
                                  Email:{" "}
                                  <a href="/cdn-cgi/l/email-protection#d9bab6b4b4acb7b0adb0bcaa99bbabb0adb0aab1b4acaabcacb4f7b6abbe">
                                    <span
                                      className="__cf_email__"
                                      data-cfemail="9dfef2f0f0e8f3f4e9f4f8eeddffeff4e9f4eef5f0e8eef8e8f0b3f2effa"
                                    >
                                      [email&nbsp;protected]
                                    </span>
                                  </a>
                              ...
                              <div className="intro-link--button paragraph paragraph--type--info-link paragraph--view-mode--default">
                                <a
                                  ...
                                  href="/learn/communities/projects"
                                >
                                  <span>Find out more about our projects</span>
                                </a>
                              </div>
                              <div className="intro-link--button paragraph paragraph--type--info-link paragraph--view-mode--default">
                                <a
                                  data-tracking="cta"
                                  className="button button--chevron"
                                  href="/learn/communities/programmes"
                                >
                                  <span>
                          ...
                          <div className="section--intro__content">
                            ...
                            <div className="wysiwyg">
                              <p>
                                We deliver an innovative, broad-ranging
                                programme of activities, collaborative projects
                                and learning opportunities with, and
                                for,&nbsp;local communities.
                              </p>
                              <p>
                                We aim to make the Museum a meeting place for
                                cross-cultural exchange and engagement and to
                                remove barriers to participation. We build
                                relationships with community partners that
                                deepens both collection and community knowledge,
                                celebrates the contribution of our communities
                                and affects positive societal change.
                              </p>
                            </div> */}
                          </div>
                        </div>
                      ...
                      <div>
                        <div>
                          <section
                            ...
                            aria-labelledby="paragraph-8709-title"
                          >
                            <div className="container">
                              <a
                              ...
                              <div className="section__inner">
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <h3>Programmes</h3>
                                    <p>
                                      Our&nbsp;programmes explore varied methods
                                      of engagement to facilitate
                                      greater&nbsp;understanding of our
                                      collection and to make connections with
                                      our&nbsp;communities.&nbsp;We tailor our
                                      offer to suit the needs and interests of
                                      our communities, enabling wider access.
                                    </p>
                                    <p>
                                      Our programmes seek to promote learning
                                      and participation, encourage discussion,
                                      increase confidence and&nbsp; contribute
                                      to wellbeing through inspiring and
                                      creative engagement with culture and
                                      heritage.
                                    </p>
                                    <p>
                                      <a
                                        ...
                                        data-entity-uuid="0c3c4262-1ead-40bd-8887-2eccc8b1bf82"
                                        href="/learn/communities/programmes"
                                        title="Programmes"
                                      >
                                        Find out more about our programmes
                                ...
                                <aside className="section--slice-content__embed">
                                  <div className="paragraph paragraph--type--embedded-media paragraph--view-mode--default">
                                    <figure className="media media-embed media-image js-media">
                                      ...
                                      />
                                      <figcaption>
                                        Two visitors enjoying the Manga
                                        exhibition at a Community Preview event.
                                      </figcaption>
                                    </figure>
                                  </div>
                                </aside>
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-8762-title"
                          >
                            <div className="container">
                              <a
                                className="js-jump-link-anchor"
                              ...
                              <div className="section__inner">
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <h3>Projects</h3>
                                    <p>
                                      We work with community organisations,
                                      charities, communities of interest and
                                      interested individuals to explore,
                                      research and respond to the Museum
                                      collections in mutually beneficial and
                                      productive ways through innovative
                                      projects. Past projects have included work
                                      with supplementary schools, young people,
                                      creative arts partnerships and
                                      LGBTQ.&nbsp;
                                    </p>
                                    <p>
                                      ...
                                      <br />
                                      <br />
                                      Our project work continually evolves to
                                      ensure we're best meeting the needs and
                                      interests of our audiences.&nbsp;
                                    </p>
                                    <p>
                                      Collaborations can take the form of
                                      community-led collections research
                                      initiatives, co-curation and
                                      co-interpretation of displays and
                                      exhibitions and co-designed programmes of
                                    ...
                                    <p>
                                      <a
                                        data-entity-substitution="canonical"
                                        data-entity-type="node"
                                        data-entity-uuid="92f48c4a-11a0-4a29-9c9f-af196694a5be"
                                        href="/learn/communities/projects"
                                        title="Projects"
                                      >
                                    ...
                                    <div className="teaser__content">
                                      <div className="teaser__content-push">
                                        ...
                                        <div className="teaser__summary">
                                          Our programmes promote learning and
                                          wellbeing through creative engagement
                                  ...
                                  <div className="teaser__wrapper">
                                    ...
                                    <div className="teaser__content">
                                      <div className="teaser__content-push">
                                        ...
                                        <div className="teaser__summary">
                                          We work with community organisations,
                                          charities and individuals to explore
                                          the collections in mutually beneficial
                                          ways.
                                        </div>
                                      </div>
                                    </div>
                                  ...
                                  <div className="teaser__wrapper">
                                    ...
                                    <div className="teaser__content">
                                      <div className="teaser__content-push">
                                        <h3 className="teaser__title">
                                          <a
                                            href="/our-work/national/uk-touring-exhibitions-and-loans"
                                            className="teaser__anchor"
                                          >
                                            <span>
                                              <span>
