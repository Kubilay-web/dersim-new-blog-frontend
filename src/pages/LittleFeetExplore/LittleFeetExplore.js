  ...
  return (
    <div>
      <div>
        ...
        <meta
          name="description"
          content="Set off on a grand exploration with the Little Feet teddies featuring multisensory activities for under-5s based on the current exhibition."
        />
        <link
          rel="canonical"
        ...
        <meta
          property="og:title"
          content="Little Feet: explore the Silk Roads"
        />
        <meta
        ...
        <meta
          property="og:image"
          content="/images/LittleFeetExplore/Little-Feet-Explore-Silk-Roads-1920x1080_2.jpg"
        />
        ...
        <title>Little Feet: explore the Silk Roads | British Museum</title>
        ...
        <link
          ...
          sizes="180x180"
          href="/images/LittleFeetExplore/apple-touch-icon.png"
        />
        <link
          rel="icon"
          type="image/png"
          href="/images/LittleFeetExplore/favicon-32x32.png"
          sizes="32x32"
        />
        <link
          rel="icon"
          type="image/png"
          href="/images/LittleFeetExplore/favicon-16x16.png"
          sizes="16x16"
        />
        <link rel="manifest" href="/site.webmanifest" />
        <link
          rel="mask-icon"
          href="/images/LittleFeetExplore/safari-pinned-tab.svg"
          color="#5bbad5"
        />
                  ...
                  <div>
                    <div>
                      <div
                        ...
                        role="article"
                        aria-labelledby="paragraph-41467-title"
                      >
                        <div className="hero__background">
                          <div className="media media-hero media-image js-media">
                            <picture>
                              ...
                              <source
                                srcSet="/images/LittleFeetExplore/Little-Feet-Explore-Silk-Roads-1920x1080_1.jpg 1x"
                              ...
                              />
                              <source
                                srcSet="/images/LittleFeetExplore/Little-Feet-Explore-Silk-Roads-1920x1080_2.jpg 1x"
                              ...
                              />
                              <source
                                srcSet="/images/LittleFeetExplore/Little-Feet-Explore-Silk-Roads-1920x1080_3.jpg 1x"
                              ...
                              <img
                                ...
                                src="/images/LittleFeetExplore/Little-Feet-Explore-Silk-Roads-1920x1080.jpg"
                        ...
                        <div className="container">
                          <div className="hero__inner">
                            <div className="hero__content-container hero__content-container--boxed ">
                              ...
                              <h1
                                id="paragraph-41467-title"
                                className="hero__title"
                              >
                                {" "}
                                <strong>Explore the Silk Roads</strong>
                              </h1>
                              <p className="hero__meta">
                                <span>Family activity</span>/ 10 February 2025
                              </p>
                                    ...
                                    <div style={{ width: "40%" }}>
                                      <div className="media media-embed_no_caption media-image js-media">
                                        <img
                                          ...
                                          srcSet="/images/LittleFeetExplore/Huo%20logo%20280px%20wide%20reversed%20out_1.png 282w"
                                          sizes="100vw"
                                          width={282}
                                          height={113}
                                          src="/images/LittleFeetExplore/Huo%20logo%20280px%20wide%20reversed%20out.png"
                                    ...
                                    <div style={{ width: "40%" }}>
                                      <div className="media media-embed_no_caption media-image js-media">
                                        <img
                                          loading="eager"
                                          className="lazyload not-full-width"
                                          srcSet="/images/LittleFeetExplore/UACF-logo%20white-EN-space3-280px_1.png 280w"
                                          sizes="100vw"
                                          width={280}
                                          height={170}
                                          src="/images/LittleFeetExplore/UACF-logo%20white-EN-space3-280px.png"
                            ...
                            <div className="hero__controls">
                              <div className="hero__caption | js-hero-caption">
                                <button
                                  ...
                                  id="hero-image-caption-button-41467"
                                  aria-expanded="false"
                                  aria-controls="hero-image-caption-content-41467"
                                >
                                ...
                                <div
                                  ...
                                  id="hero-image-caption-content-41467"
                                  aria-hidden="true"
                                  aria-labelledby="hero-image-caption-button-41467"
                                >
                                  <button
                                    type="button"
                                    className="hero__caption-content-close | js-hero-caption-btn"
                                    id="hero-image-caption-close-button-41467"
                                    aria-expanded="false"
                                    aria-controls="hero-image-caption-content-41467"
                                  >
                                    <span className="visually-hidden">
                                  ...
                                  <p>
                                    {" "}
                                    Little Feet teddies playing with crafting
                                    materials and a traveling chest.
                                  </p>
                                </div>
                              </div>
                            </div>
                          ...
                          <ul className="breadcrumb__list">
                            ...
                            <li className="breadcrumb__item breadcrumb__item--current">
                              ...
                              <a
                                ...
                                aria-current="page"
                              >
                                Little Feet: explore the Silk Roads
                              </a>
                            </li>
                          </ul>
                        </nav>
                        ...
                        <div className="section--intro__container">
                          ...
                          <div className="section--intro__content">
                            <div className="wysiwyg">
                              <h3>
                                The Little Feet teddies are off on a grand
                              ...
                              <p>
                                ...
                                exhibition, the teddies want to try their paws
                                at some of the activities that took place across
                                this vast landscape. They would like to craft
                                jewellery inspired by the metalwork from Sutton
                                Hoo and the colourful gemstones inlaid within it
                                which came from India, Czechia and Sri Lanka.
                                They also want to practice the art of exchanging
                                – swapping one set of goods or materials for
                                another – so join the exchange centre, use your
                                counting skills and get a good price. Can you
                                speak or understand any other languages? Perhaps
                                you can help the teddies with the different
                                languages along the way!
                              </p>
                              <p>
                                Pilgrims often brought back souvenirs, so why
                                not make one to bring home? All that exploration
                                will be hard work, so don't forget to visit the
                                pretend food market and find something that
                                tickles your taste-buds. There will be something
                                to interest all ages under five in our
                                multisensory Silk Roads session.
                              </p>
                              <p>
                                <span>
                              ...
                              <p>
                                <span>
                                  To get to the Clore Centre for Education in
                                  the lower levels, take the stairs going down
                                  on the east side of the Great Court. View the{" "}
                                </span>
                              ...
                              <p>
                                ...
                                Please note that your free timed ticket does not
                                include entry to{" "}
                                <a
                                  href="/exhibitions/silk-roads"
                                  data-entity-type="node"
...
export default LittleFeetExplore;
