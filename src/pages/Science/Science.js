...
const Science = () => {
  ...
  useEffect(() => {
    ...
    const category1 = `${contentPrefix}-content-44`;
  ...
  useEffect(() => {
    ...
    // Kategoriler dil bazında dinamik olarak ayarlanıyor
    const accordion1 = `${accordionPrefix}-accordion-5`;
              ...
              <main id="main-content" className="js-main">
                <div>
                  <div
                    ...
                    role="article"
                    aria-labelledby="paragraph-6933-title"
                  >
                        ...
                        <div className="hero__controls">
                          <div className="hero__caption | js-hero-caption">
                            <button
                              ...
                              id="hero-image-caption-button-6933"
                              aria-expanded="false"
                              aria-controls="hero-image-caption-content-6933"
                            >
                            ...
                            <div
                              ...
                              id="hero-image-caption-content-6933"
                              aria-hidden="true"
                              aria-labelledby="hero-image-caption-button-6933"
                            >
                              <button
                                type="button"
                                className="hero__caption-content-close | js-hero-caption-btn"
                                id="hero-image-caption-close-button-6933"
                                aria-expanded="false"
                                aria-controls="hero-image-caption-content-6933"
                              >
                                <span className="visually-hidden">
                      ...
                      <div className="section__inner">
                        <div className="section--intro__container">
                          ...
                          <div className="section--intro__content">
                            ...
                            {/* <p className="h3">
                              Find out how to apply to access collection
                              material for external scientific research.&nbsp;
                            </p>
                            <div className="wysiwyg">
                              <p>
                                The Museum makes its collection available for
                                scientific examination and analysis by external
                                researchers. Details of how to apply are
                                explained below.&nbsp;
                              </p>
                            </div> */}
                          </div>
                      ...
                      <div>
                        <div>
                          <section
                            ...
                            aria-labelledby="paragraph-26065-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-26058"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-26058"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                  ...
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-26058"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-26058"
                                  >
                                    <p>
                                      The Museum receives many requests to
                                      access collection material for external
                                      scientific research.
                                    </p>
                                    <p>
                                      To safeguard the collection, all requests
                                      are subject to a review process following
                                    ...
                                    <p>
                                      Occasionally, the review panel may invite
                                      the opinion of external experts to support
                                      their decisions. Vulnerable objects may
                                      also require conservation assessment.
                                    </p>
                                    <p>
                                      Requests involving human remains will need
                                      a detailed assessment to comply with the
                                      Human Tissue Act 2004.
                                    </p>
                                    <p>
                                      We need to ensure that such material is
                                      treated with appropriate respect, care and
                                      dignity.
                                    </p>
                                    <p>
                                      <a
                                    ...
                                    <p>
                                      ...
                                      <br />
                                      Requests for access to human remains in
                                      the collection that are the subject of a
                                      claim for transfer cannot be granted while
                                      the outcome of the claim is pending.
                                    </p>
                                  </div>
                                </div>
                                <div
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-26059"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-26059"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                      ...
                                      <span> Application criteria</span>
                                    </button>
                                  </h3>
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-26059"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-26059"
                                  >
                                    <p>
                                      All applications are assessed on the
                                      following criteria:
                                    </p>
                                    <ul>
                                      <li
                                      ...
                                      >
                                        ...
                                        scientific techniques/methods to answer
                                        the questions posed
                                      </li>
                                      <li
                                        data-gc-list-depth={1}
                                        data-gc-list-style="bullet"
                                      >
                                        Experience and expertise of the research
                                        team in applying these
                                        techniques/methods
                                      </li>
                                      <li
                                        data-gc-list-depth={1}
                                      ...
                                      <li
                                        ...
                                        data-gc-list-style="bullet"
                                      >
                                        Sample sizes required in relation to the
                                        size and rarity/uniqueness of the object
                                      </li>
                                      <li
                                        data-gc-list-depth={1}
                                        data-gc-list-style="bullet"
                                      >
                                        Other immediate or long-term impact on
                                        the object(s), including risks
                                        associated with exposure of object(s) to
                                      ...
                                      <li
                                        ...
                                        data-gc-list-style="bullet"
                                      >
                                        Experience of the research team in
                                        working with Museum material
                                      </li>
                                      <li
                                        data-gc-list-depth={1}
                                        data-gc-list-style="bullet"
                                    ...
                                    <p>
                                      Applicants are expected to indicate
                                      thorough knowledge of previous work
                                      undertaken (citing appropriate
                                      references).
                                    </p>
                                    <p>
                                      The potential of novel techniques should
                                      have been demonstrated on model material
                                      in advance of their application to Museum
                                      samples.
                                    </p>
                                    <p>
                                      Further information may be requested, and
                                      this will also be subject to review.
                                    </p>
                                    <p>
                                      Please submit your application as far in
                                      advance of the deadline as possible, as
                                      access at short notice can't be
                                      guaranteed.&nbsp;
                                    </p>
                                    <p>
                                      Applicants are encouraged to make an
                                      honest assessment of the likelihood of
                                      success/risk of failure of the project.
                                    </p>
                                    <p>
                                      Small-scale pilot studies on collection
                                      material prior to a full-scale study may
                                      be suggested in certain cases.
                                    </p>
                                    <p>
                                      We may ask applicants to collaborate on
                                      work when we receive two or more requests
                                      for the same area.
                                    </p>
                                    <p>
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-26060"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-26060"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                  ...
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-26060"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-26060"
                                  >
                                    <p>
                                      For requests relating to materials of
                                      human origin, applicants may wish to
                                      consult the following guidance documents
                                      from the{" "}
                                      <a href="https://apabe.archaeologyuk.org/">
                                        APABE (Advisory Panel on the Archaeology
                                        of Burials in England)
                                      </a>{" "}
                                      and DCMS (Department for Culture, Media
                                      &amp; Sport):
                                    </p>
                                    <p>
                                      <a
                                        href="https://apabe.archaeologyuk.org/pdf/Science_and_the_Dead.pdf"
                                        data-gc-link="http://www.archaeologyuk.org/apabe/pdf/Science_and_the_Dead.pdf"
                                        rel="noopener"
                                        target="_blank"
                                      >
                                        'Science and the Dead: A guideline for
                                        the destructive sampling of
                                        archaeological human remains for
                                        scientific analysis'&nbsp;(2013)
                                      </a>
                                    </p>
                                    <p>
                                      <a
                                        href="https://apabe.archaeologyuk.org/pdf/APABE_ToHREfCBG_FINAL_WEB.pdf"
                                        data-gc-link="http://www.archaeologyuk.org/apabe/pdf/APABE_ToHREfCBG_FINAL_WEB.pdf"
                                        rel="noopener"
                                        target="_blank"
                                      >
                                        'Guidance for Best Practice for the
                                        Treatment of Human Remains Excavated
                                        from Christian Burial Grounds in
                                        England'&nbsp;(2017)
                                      </a>
                                    </p>
                                    <p>
                                      <a
                                        href="/sites/default/files/2019-11/DCMS-Guide_0.pdf"
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-26061"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-26061"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                  ...
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-26061"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-26061"
                                  >
                                    <p>
                                    ...
                                    <p>
                                      Please email forms in Microsoft Word
                                      document format to&nbsp;
                                      <a
                                        href="/cdn-cgi/l/email-protection#f0839399959e9395b0928299849983989d858395859dde9f8297"
                                        data-gc-link="null"
                                      >
                                        <span
                                          className="__cf_email__"
                                          data-cfemail="daa9b9b3bfb4b9bf9ab8a8b3aeb3a9b2b7afa9bfafb7f4b5a8bd"
                                        >
                                          [email&nbsp;protected]
                                        </span>
                                      </a>
                                    ...
                                    <p>
                                      We recommend you discuss your request with
                                      the relevant curator before submitting an
                                      application.
                                    </p>
                                    <p>
                                      The review panel meets to assess requests
                                      four times a year and applications should
                                      be submitted by the deadlines indicated.
                                    </p>
                                    <p>
                                      Applicants will be notified of a decision
                                      within one month of the review panel
                                      meeting.
                                    </p>
                                  </div>
                                </div>
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-26062"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-26062"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                  ...
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-26062"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-26062"
                                  >
                                    <p>
                                      6 October 2024 (for Review Panel Meeting
                                      on 6 November 2024)
                                    </p>
                                    <p>
                                      12 January 2025 (for Review Panel Meeting
                                      on 12 February 2025)
                                    </p>
                                    <p>
                                      7 April 2025 (for Review Panel Meeting on
                                      7 May 2025)
                                    </p>
                                    <p>
                                      6 July 2025 (for Review Panel Meeting on 6
                                      August 2025)
                                    </p>
                                    <p>
                                      5 October 2025 (for Review Panel Meeting
                                      on 5 November 2025)
                                    </p>
                                  </div>
                                </div>
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-26063"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-26063"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                  ...
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-26063"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-26063"
                                  >
                                    <p>
                                    ...
                                    <ul>
                                      ...
                                      <li
                                        ...
                                        data-gc-list-style="bullet"
                                      >
                                        The Museum shall be allowed to make
                                        these data publicly available five years
                                        after they're received, whether or not
                                        they've been published elsewhere.
                                      </li>
                                      <li
                                        data-gc-list-depth={1}
                                        data-gc-list-style="bullet"
                                      ...
                                      >
                                        ...
                                        (any other purpose must be the subject
                                      ...
                                      <li
                                        ...
                                        data-gc-list-style="bullet"
                                      >
                                        Two copies of any publications arising
                                        from the work must be provided.
                                      </li>
                                      <li
                                        data-gc-list-depth={1}
                                        data-gc-list-style="bullet"
                                      ...
                                      <li
                                        ...
                                        data-gc-list-style="bullet"
                                      >
                                        Previous conduct in respect of these
                                        conditions will be taken into account
                                        when reviewing subsequent applications.
                                      </li>
                                      <li
                                        data-gc-list-depth={1}
                                        data-gc-list-style="bullet"
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-26064"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-26064"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                      ...
                                      <span>
                                        {" "}
                                        Moving the collection from Blythe House
                                      </span>
                                    </button>
                                  </h3>
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-26064"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-26064"
                                  >
                                    <p>
                                      We are currently undertaking a major
                                      object move project to vacate our
                                      collection store at Blythe House, Olympia,
                                      which is scheduled to be completed by
                                      summer 2024. From January 2020 to the end
                                      of the project, we will not be able to
                                      lend collection material located at Blythe
                                      House. If you have any queries about this
                                      or wish to know whether the objects you
                                      wish to request are affected, please
                                      email&nbsp;
                                      <a href="/cdn-cgi/l/email-protection#afc3c0cec1dcefcdddc6dbc6dcc7c2dadccadac281c0ddc8">
                                        <span
                                          className="__cf_email__"
                                          data-cfemail="375b585659447755455e435e445f5a424452425a19584550"
                                        >
                                          [email&nbsp;protected]
                                        </span>
                                      </a>
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-11886-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-11886-title"
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  <h3 className="teaser__title">
                                                    <a
                                                      href="/our-work/departments/scientific-research"
                                                  ...
                                                  <div className="teaser__summary">
                                                    ...
                                                    scientific techniques, this
                                                    department conducts
                                                    scientific research to learn
                                                    about and preserve the
                                                    collection.
                                                  </div>
                                                </div>
                                              </div>
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  ...
                                                  <div className="teaser__summary">
                                                    Learn how the Museum studies
                                                    and cares for ancient human
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  <h3 className="teaser__title">
                                                    <a
                                                      href="/our-work/departments/collection-care"
                                                      className="teaser__anchor"
                                                    >
                                                      <span>
                                                        <span>
