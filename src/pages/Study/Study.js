...
const Study = () => {
  ...
  useEffect(() => {
    ...
    const category1 = `${contentPrefix}-content-45`;
  ...
  useEffect(() => {
    ...
    // Kategoriler dil bazında dinamik olarak ayarlanıyor
    const accordion1 = `${accordionPrefix}-accordion-23`;
    ...
    <div>
      <div>
        ...
        <meta
          ...
          content="Read about the Museum's study rooms and how you can access them."
        />
        <meta
          property="og:image"
          content="/images/Study/P%2526D%20study%20room%202000%20x%201500_1.jpg"
        />
        ...
        <link
          ...
          sizes="180x180"
          href="/images/Study/apple-touch-icon.png"
        />
        <link
          rel="icon"
          type="image/png"
          href="/images/Study/favicon-32x32.png"
          sizes="32x32"
        />
        <link
          rel="icon"
          type="image/png"
          href="/images/Study/favicon-16x16.png"
          sizes="16x16"
        />
        <link rel="manifest" href="/site.webmanifest" />
        <link
          rel="mask-icon"
          href="/images/Study/safari-pinned-tab.svg"
          color="#5bbad5"
        />
              ...
              <main id="main-content" className="js-main">
                <div>
                  <div
                    ...
                    role="article"
                    aria-labelledby="paragraph-8091-title"
                  >
                    <div className="hero__background">
                      <div className="media media-hero media-image js-media">
                        <picture>
                          ...
                          <source
                            srcSet="/images/Study/P%2526D%20study%20room%202000%20x%201500_2.jpg 1x"
                          ...
                          />
                          <source
                            srcSet="/images/Study/P%2526D%20study%20room%202000%20x%201500_1.jpg 1x"
                          ...
                          />
                          <source
                            srcSet="/images/Study/P%2526D%20study%20room%202000%20x%201500_3.jpg 1x"
                    ...
                    <div className="container">
                      <div className="hero__inner">
                        <div className="hero__content-container">
                          ...
                          {/* <h1 id="paragraph-8091-title" className="hero__title">
                            {" "}
                            Study rooms
                          </h1> */}
                        </div>
                        <div className="hero__controls">
                          <div className="hero__caption | js-hero-caption">
                            <button
                              ...
                              id="hero-image-caption-button-8091"
                              aria-expanded="false"
                              aria-controls="hero-image-caption-content-8091"
                            >
                            ...
                            <div
                              ...
                              id="hero-image-caption-content-8091"
                              aria-hidden="true"
                              aria-labelledby="hero-image-caption-button-8091"
                            >
                              <button
                                type="button"
                                className="hero__caption-content-close | js-hero-caption-btn"
                                id="hero-image-caption-close-button-8091"
                                aria-expanded="false"
                                aria-controls="hero-image-caption-content-8091"
                              >
                                <span className="visually-hidden">
                    ...
                    <div className="breadcrumb__inner">
                      <div id="block-breadcrumbs">
                        <nav aria-labelledby="system-breadcrumb">
                          ...
                          >
                            You are in the Resources section
                          </h2>
                          <ul className="breadcrumb__list">
                            ...
                            <li className="breadcrumb__item breadcrumb__item--link">
                              ...
                              <a href="/resources" className="breadcrumb__link">
                                <span>Resources</span>
                              </a>
                            </li>
                            ...
                            >
                              <ul className="jump-links__list" role="list">
                                <li className="jump-links__item">
                                  <a
                                    href="#study-room-information"
                                    className="jump-links__link"
                                  >
                                    <span>Study room information</span>
                                  </a>
                                </li>
                                <li className="jump-links__item">
                                  <a
                                    href="#object-identification-service"
                                    className="jump-links__link"
                                  >
                                    <span>Object identification service </span>
                                  </a>
                                </li>
                              </ul>
                            </div>
                      ...
                      <div className="section__inner">
                        <div className="section--intro__container">
                          ...
                          <div className="section--intro__content">
                            ...
                            {/* <p className="h3">
                              Each curatorial department has a study room that's
                              open to the public – by appointment only.
                            </p>
                            <div className="wysiwyg">
                              <p>
                                <span lang="EN-GB" dir="ltr">
                                  Please note, all study rooms are accessible
                                ...
                                <span lang="EN-GB" dir="ltr">
                                  {" "}
                                  after reading the information on this page.
                                </span>
                                <br />
                                <br />
                                While we'll do our best to keep the study rooms
                                open, they may close at very short notice
                                following staff&nbsp;illness or isolation
                                requirements.&nbsp;We apologise in advance
                                should this occur.
                              </p>
                              <p>
                                <strong>
                              ...
                              <p>
                                ...
                                <a href="#study-room-information">
                                  opening times of the study rooms
                                </a>
                                , as well as details about the Museum's object
                      ...
                      <div>
                        <div>
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-21345-title"
                          >
                            <div className="container">
                              <a
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-21341"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-21341"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                  ...
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-21341"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-21341"
                                  >
                                    <ul>
                                      <li>
                                        You can find information about more than
                                        four million items in the Museum's
                                        collection on{" "}
                                        <a
                                          href="/collection"
                                      ...
                                      <li>
                                        Please use this resource to identify
                                        which items you wish to view on a study
                                        room visit.&nbsp;
                                      </li>
                                      <li>
                                        View the{" "}
                                        ...
                                        requested' section of your study room
                                        application form.
                                      </li>
                                      <li>
                                        View a{" "}
                                      ...
                                      <li>
                                        ...
                                        member of staff will contact you to
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-21361"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-21361"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                      ...
                                      <span>
                                        {" "}
                                        Opening times and email information
                                      </span>
                                    </button>
                                  </h3>
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-21361"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-21361"
                                  >
                                    <h4>
                                      <strong>
                                    ...
                                    <p>
                                      <span lang="EN-GB" dir="ltr">
                                        While we'll do our best to keep the
                                        study rooms open, we may have to close
                                        them at very short notice due
                                        to&nbsp;staff&nbsp;illness or isolation
                                        requirements.&nbsp;We&nbsp;apologise in
                                        advance should this be necessary.
                                      </span>
                                    </p>
                                    <p>
                                      <strong>
                                    ...
                                    <ul>
                                      <li>
                                        Via ALRC Anthropology Library and
                                        Research Centre – by appointment.&nbsp;
                                      </li>
                                      <li>
                                        Email:&nbsp;
                                        <a href="/cdn-cgi/l/email-protection#43020c02303736273a312c2c2e0321312a372a302b2e363026362e6d2c3124">
                                          <span
                                            className="__cf_email__"
                                            data-cfemail="33525c52404746574a415c5c5e7351415a475a405b5e464056465e1d5c4154"
                                          >
                                            [email&nbsp;protected]
                                          </span>
                                        </a>
                                    ...
                                    <ul>
                                      ...
                                      <li>
                                        Open: Tuesdays to Thursdays,
                                        10.00–17.00.
                                      </li>
                                      <li>
                                        Books needed to support object
                                        consultation in other study rooms can be
                                        managed as before and delivered in
                                        advance.
                                      </li>
                                    </ul>
                                    <p>
                                    ...
                                    <ul>
                                      ...
                                      <li>
                                        Email:&nbsp;
                                        <a href="/cdn-cgi/l/email-protection#c081b3a9a180a2b2a9b4a9b3a8adb5b3a5b5adeeafb2a7">
                                          <span
                                            className="__cf_email__"
                                            data-cfemail="1372607a72606766776a617c7c7e5371617a677a607b7e666076667e3d7c6174"
                                          >
                                            [email&nbsp;protected]
                                          </span>
                                        </a>
                                    ...
                                    <ul>
                                      <li>
                                        Open: Tuesdays to Thursdays, 10.00–13.00
                                        and 14.00–16.00.
                                      </li>
                                      <li>
                                        Email:&nbsp;
                                        <a href="/cdn-cgi/l/email-protection#99dbdcc9d9fbebf0edf0eaf1f4eceafcecf4b7f6ebfe">
                                          <span
                                            className="__cf_email__"
                                            data-cfemail="99fbfce9eaedecfde0ebf6f6f4d9fbebf0edf0eaf1f4eceafcecf4b7f6ebfe"
                                          >
                                            [email&nbsp;protected]
                                          </span>
                                        </a>
                                    ...
                                    <p>
                                      <strong>Egypt and Sudan:</strong>
                                    </p>
                                    <ul>
                                      <li>
                                        Open: Tuesdays to Thursdays, 10.30–13.00
                                        and 14.00–16.00.
                                      </li>
                                      <li>
                                        Email:&nbsp;
                                        <a href="/cdn-cgi/l/email-protection#0b4e6c727b7f626a654b6979627f627863667e786e7e662564796c">
                                          <span
                                            className="__cf_email__"
                                            data-cfemail="bcd9cfcfc8c9d8c5ced3d3d1fcdeced5c8d5cfd4d1c9cfd9c9d192d3cedb"
                                          >
                                            [email&nbsp;protected]
                                          </span>
                                        </a>
                                    ...
                                    <p>
                                      <strong>Greece and Rome:</strong>
                                    </p>
                                    <ul>
                                      <li>
                                        Open: Wednesdays to Fridays 10.30–13.00
                                        and 14.00–16.00.
                                      </li>
                                      <li>
                                        Email:&nbsp;
                                        <a href="/cdn-cgi/l/email-protection#8ec9fcebebe5efe0eadce1e3efe0ceecfce7fae7fde6e3fbfdebfbe3a0e1fce9">
                                          <span
                                            className="__cf_email__"
                                            data-cfemail="442336373031203d362b2b290426362d302d372c2931372131296a2b3623"
                                          >
                                            [email&nbsp;protected]
                                          </span>
                                        </a>
                                    ...
                                    <ul>
                                      ...
                                      <li>
                                        Email:&nbsp;
                                        <a href="/cdn-cgi/l/email-protection#9dd5f2eff2f1f2faf4fefcf1ddffeff4e9f4eef5f0e8eef8e8f0b3f2effa">
                                          <span
                                            className="__cf_email__"
                                            data-cfemail="20484f524f4c4f474943414c60425249544953484d555345554d0e4f5247"
                                          >
                                            [email&nbsp;protected]
                                          </span>
                                        </a>
                                    ...
                                    <ul>
                                      <li>
                                        Email:{" "}
                                        <a href="/cdn-cgi/l/email-protection#6425170d052406160d100d170c0911170111094a0b1603">
                                          <span
                                            className="__cf_email__"
                                            data-cfemail="3a5b49535b494e4f5e43485555577a5848534e534952574f495f4f571455485d"
                                          >
                                            [email&nbsp;protected]
                                          </span>
                                        </a>
                                    ...
                                    <ul>
                                      ...
                                      <li>
                                        Email:&nbsp;
                                        <a href="/cdn-cgi/l/email-protection#e3ae8a87878f86a6829097a381918a978a908b8e969086968ecd8c9184">
                                          <span
                                            className="__cf_email__"
                                            data-cfemail="650800161110011c170a0a082507170c110c160d0810160010084b0a1702"
                                          >
                                            [email&nbsp;protected]
                                          </span>
                                        </a>
                                    ...
                                    <p>
                                      <strong>Money and Medals:</strong>
                                    </p>
                                    <ul>
                                      <li>
                                        Open: Tuesdays to Thursdays, 10.30–13.00
                                      ...
                                      <li>
                                        Treasure appointments will be handled in
                                        the temporary BEP Study Room.
                                      </li>
                                      <li>
                                        Email:&nbsp;
                                        <a href="/cdn-cgi/l/email-protection#62210d0b0c112200100b160b110a0f171107170f4c0d1005">
                                          <span
                                            className="__cf_email__"
                                            data-cfemail="1d7e706e696879646f7272705d7f6f7469746e7570686e78687033726f7a"
                                          >
                                            [email&nbsp;protected]
                                          </span>
                                        </a>
                                    ...
                                    <p>
                                      <strong>Prints and Drawings:</strong>
                                    </p>
                                    <ul>
                                      <li>
                                        Open: Wednesdays to&nbsp;Fridays,
                                      ...
                                      <li>
                                        Email:&nbsp;
                                        <a href="/cdn-cgi/l/email-protection#f5a5b196948790949b91949696908686b597879c819c869d988086908098db9a8792">
                                          <span
                                            className="__cf_email__"
                                            data-cfemail="f9899d8a8d8c9d808b969694b99b8b908d908a91948c8a9c8c94d7968b9e"
                                          >
                                            [email&nbsp;protected]
                                          </span>
                                        </a>
                                    ...
                                    <ul>
                                      <li>
                                        Closed for Blythe House collection move
                                        project.
                                      </li>
                                    </ul>
                                    <p>
                                      Please note that{" "}
                                      <a
                                        href="/our-work/national/treasure-and-portable-antiquities-scheme"
                                        data-entity-type="node"
                                        data-entity-uuid="b4ef2224-2fe2-4621-82f8-cd2a33d12e98"
                                        data-entity-substitution="canonical"
                                        title="Treasure and the Portable Antiquities Scheme"
                                      >
                                        Treasure bookings
                                      </a>{" "}
                                      are made through the dedicated web
                                      pages,&nbsp;but they are received Tuesday
                                      and Wednesday 11.00–13.00 and 14.00–16.00.
                                      All Treasure bookings will be handled
                                      temporarily through the BEP Study Room.
                                    </p>
                                    <h4>
                                      <strong>
                                    ...
                                    <ul>
                                      ...
                                      <li>
                                        Email:&nbsp;
                                        <a href="/cdn-cgi/l/email-protection#70313f310304051409021f1f1d30120219041903181d050315051d5e1f0217">
                                          <span
                                            className="__cf_email__"
                                            data-cfemail="7b1a141a080f0e1f02091414163b1909120f120813160e081e0e165514091c"
                                          >
                                            [email&nbsp;protected]
                                          </span>
                                        </a>
                                    ...
                                    <ul>
                                      ...
                                      <li>
                                        Email:&nbsp;
                                        <a href="/cdn-cgi/l/email-protection#3072756070524259445943585d454355455d1e5f4257">
                                          <span
                                            className="__cf_email__"
                                            data-cfemail="ea888f9a999e9f8e9398858587aa8898839e839982879f998f9f87c485988d"
                                          >
                                            [email&nbsp;protected]
                                          </span>
                                        </a>
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-21342"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-21342"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                  ...
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-21342"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-21342"
                                  >
                                    <ul>
                                      <li>
                                        Some of our study rooms are busier than
                                        others. We recommend that you contact us
                                        at least four weeks before the date you
                                        wish to visit otherwise it may be
                                        difficult to accommodate your
                                        request.&nbsp;
                                      </li>
                                      <li>
                                        We strongly advise that you don't make
                                        special travel arrangements until we've
                                        confirmed the dates of your visit.&nbsp;
                                      </li>
                                      <li>
                                        Please indicate if you're planning an
                                        extended period of study which may
                                        require multiple visits.
                                      </li>
                                      <li>
                                        Please note that the number of items
                                        you're able to study may be limited
                                        because of&nbsp;space considerations and
                                        for security purposes.&nbsp;
                                      </li>
                                      <li>
                                        Any material brought in for comparison
                                        must be agreed with the Museum in
                                        advance.
                                      </li>
                                      <li>
                                        Please note that visitors under the age
                                        of 18 must be accompanied by an adult.
                                      </li>
                                      <li>
                                        If you're a deaf or disabled person and
                                        have specific access requirements or
                                        will need additional support to visit
                                        the study room, please let us know in
                                        advance so we can help you plan your
                                        visit effectively.
                                        <br />
                                        &nbsp;
                                      </li>
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-21343"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-21343"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                  ...
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-21343"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-21343"
                                  >
                                    <ul>
                                      <li>
                                        A member of staff will contact you via
                                        email to confirm the date of your
                                        visit.&nbsp;
                                      </li>
                                      <li>
                                        They'll also send you instructions on
                                        where to come when you arrive at the
                                        Museum.&nbsp;
                                      </li>
                                      <li>
                                        Please note that we may need to clarify
                                        or discuss your application with you
                                        before being able to confirm your
                                        visit.&nbsp;
                                      </li>
                                      <li>
                                        If you're unable to attend on the date
                                        you've agreed, please let us know as
                                        soon as possible so we can offer your
                                        place to another visitor, and to prevent
                                        unnecessary handling and transport of
                                        collection items.&nbsp;
                                        <br />
                                        &nbsp;
                                      </li>
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-21344"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-21344"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                      ...
                                      <span> Study room regulations</span>
                                    </button>
                                  </h3>
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-21344"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-21344"
                                  >
                                    <p>
                                      In addition to the{" "}
                                    ...
                                    <ul>
                                      <li>
                                        Eating, drinking, smoking, vaping and
                                        chewing gum are not permitted.
                                      </li>
                                      <li>
                                        Anyone believed to be under the
                                        influence of alcohol or drugs will not
                                        be allowed access to the study rooms.
                                      </li>
                                      <li>
                                        Coats and bags must be placed in the
                                        designated areas.
                                      </li>
                                      <li>
                                        Large bags and umbrellas must be left in
                                        the public cloakrooms.
                                      </li>
                                      <li>
                                        Bags may be searched for security
                                        reasons.
                                      </li>
                                      <li>
                                        Mobile phones must be switched to
                                        silent, and telephone calls must not be
                                        made in the study rooms (except in an
                                        emergency).
                                      </li>
                                      <li>
                                        Material from the collections must be
                                        treated with utmost care and attention,
                                        and any handling instructions issued
                                        must be strictly followed. Some items
                                        may only be handled by Museum staff.
                                      </li>
                                      <li>
                                        Gloves must be worn to handle some types
                                        of material. These will be provided by
                                        the Museum.
                                      </li>
                                      <li>
                                        Only pencils and plastic/wooden
                                        implements are permitted near the
                                        collections. The use of any other media
                                        is at the discretion of supervising
                                        staff.
                                      </li>
                                      <li>
                                        Photographs may be taken in study rooms
                                        with permission of study room staff but
                                        please note that some parts of the
                                        collection may not be photographed for
                                        reasons connected with security or
                                        preservation. Light sensitive material
                                        must be photographed without flash. The
                                        use of tripods and other photographic
                                        equipment is not permitted in all study
                                        areas. In those areas where it is
                                        permitted, the express permission of the
                                        study room staff must be obtained prior
                                        to doing so and under the direct
                                        supervision of the staff member present.
                                      </li>
                                      <li>
                                        Laptops and tablets may be used, but the
                                        use of any other equipment must be
                                        agreed in advance. Electrical equipment
                                        must be unplugged when not in use.
                                      </li>
                                      <li>
                                        The making of wax or other impressions,
                                        or rubbings, is not permitted.
                                      </li>
                                      <li>
                                        Items will be counted out on delivery to
                                        the visitor, and will be counted in at
                                        the end of each session. A visitor may
                                        not leave until the supervisor is
                                        satisfied that all the objects are in
                                        good order.
                                      </li>
                                      <li>
                                        In the event of an emergency,
                                        instructions from staff must be
                                        followed.
                                      </li>
                                      <li>
                                        Violence or abuse towards any member of
                                        Museum staff will not be tolerated.
                                      </li>
                                      <li>
                                    ...
                                    <p>
                                      View a pdf of the{" "}
                                      <a
                                        href="/sites/default/files/2020-02/study_room_regulations_2020.pdf"
                                        data-entity-type="media"
                                        data-entity-uuid="a0b574b2-9045-4ee5-927b-651fa425735f"
                                        data-entity-substitution="media"
                                        title="Study room regulations 2020"
                                      >
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-11548-title"
                          >
                            <div className="container">
                              <a
                                className="js-jump-link-anchor"
                                id="object-identification-service"
                              />{" "}
                              <div className="section__inner">
                                <h2
                                  id="paragraph-11548-title"
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      The following Departments offer an object
                                      identification service on Wednesdays from
                                      14.00–16.00:
                                    </p>
                                    <ul>
                                      <li>
                                        <a
                                          href="/our-work/departments/asia"
                                          data-entity-type="node"
                                          data-entity-uuid="050278e8-b5a9-4539-8a13-57de79a52567"
                                          data-entity-substitution="canonical"
                                          title="Asia"
                                        >
                                          Asia
                                      ...
                                      <li>
                                        <a
                                          href="/our-work/departments/britain-europe-and-prehistory"
                                          data-entity-type="node"
                                      ...
                                      <li>
                                        <a
                                          href="/our-work/departments/egypt-and-sudan"
                                          data-entity-type="node"
                                          data-entity-uuid="e20eabdc-97f0-4e96-a599-620c98dd6878"
                                          data-entity-substitution="canonical"
                                          title="Egypt and Sudan"
                                        >
                                          Egypt and Sudan
                                        </a>
                                      </li>
                                      <li>
                                        <a
                                          href="/our-work/departments/greece-and-rome"
                                          data-entity-type="node"
                                          data-entity-uuid="679bc6d3-0f90-4cf9-bb95-f3a2b92948f1"
                                          data-entity-substitution="canonical"
                                      ...
                                      <li>
                                        <a
                                          href="/our-work/departments/middle-east"
                                          data-entity-type="node"
                                          data-entity-uuid="c73f915a-6a0a-4167-8273-83aa2c5c3c31"
                                          data-entity-substitution="canonical"
                                          title="Middle East"
                                        >
                                          Middle East
                                      ...
                                      <li>
                                        <a
                                          href="/our-work/departments/money-and-medals"
                                          data-entity-type="node"
                                          data-entity-uuid="10486a03-ffd4-4219-a212-2cb14ba39419"
                                          data-entity-substitution="canonical"
                                          title="Money and Medals"
                                        >
                                          Money and Medals
                                        </a>
                                      </li>
                                      <li>
                                        <a
                                          href="/our-work/departments/prints-and-drawings"
                                          data-entity-type="node"
                                          data-entity-uuid="c22646ba-7cb2-4739-b288-cd621dd9be47"
                                          data-entity-substitution="canonical"
                                    ...
                                    <p>
                                      See individual department pages to find
                                      out how to arrange an object
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-11623-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-11623-title"
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  ...
                                                  <div className="teaser__summary">
                                                    Find out how our Museum
                                                    departments work with,
                                                    research and care for the
