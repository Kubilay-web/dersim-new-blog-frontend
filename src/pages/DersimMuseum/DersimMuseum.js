...
const DersimMuseum = () => {
  ...
  useEffect(() => {
    ...
    const category1 = `${contentPrefix}-content-6`;
    ...
    <div>
      <div>
        ...
        <meta
          ...
          content="Discover the benefits and contribution available for US tax payers."
        />
        <meta
          property="og:image"
          content="/images/DersimMuseum/Junction-Boulevard-Queens-Michael-W-Arike_1.jpg"
        />
        ...
        <link
          ...
          sizes="180x180"
          href="/images/DersimMuseum/apple-touch-icon.png"
        />
        <link
          rel="icon"
          type="image/png"
          href="/images/DersimMuseum/favicon-32x32.png"
          sizes="32x32"
        />
        <link
          rel="icon"
          type="image/png"
          href="/images/DersimMuseum/favicon-16x16.png"
          sizes="16x16"
        />
        <link rel="manifest" href="/site.webmanifest" />
        <link
          rel="mask-icon"
          href="/images/DersimMuseum/safari-pinned-tab.svg"
          color="#5bbad5"
        />
              ...
              <main id="main-content" className="js-main">
                <div>
                  <div
                    ...
                    role="article"
                    aria-labelledby="paragraph-6064-title"
                  >
                    <div className="hero__background">
                      <div className="media media-hero media-image js-media">
                        <picture>
                          ...
                          <source
                            srcSet="/images/DersimMuseum/Junction-Boulevard-Queens-Michael-W-Arike_3.jpg 1x"
                          ...
                          />
                          <source
                            srcSet="/images/DersimMuseum/Junction-Boulevard-Queens-Michael-W-Arike_1.jpg 1x"
                          ...
                          />
                          <source
                            srcSet="/images/DersimMuseum/Junction-Boulevard-Queens-Michael-W-Arike_2.jpg 1x"
                          ...
                          <img
                            ...
                            src="/images/DersimMuseum/Junction-Boulevard-Queens-Michael-W-Arike.jpg"
                                ...
                                <div style={{ width: "25%" }}>
                                  <div className="media media-embed_no_caption media-image js-media">
                                    <img
                                      ...
                                      srcSet="/images/DersimMuseum/AFBM-logo_1.jpg 180w"
                                      sizes="100vw"
                                      width={180}
                                      height={155}
                                      src="/images/DersimMuseum/AFBM-logo.jpg"
                        ...
                        <div className="hero__controls">
                          <div className="hero__caption | js-hero-caption">
                            <button
                              ...
                              id="hero-image-caption-button-6064"
                              aria-expanded="false"
                              aria-controls="hero-image-caption-content-6064"
                            >
                            ...
                            <div
                              ...
                              id="hero-image-caption-content-6064"
                              aria-hidden="true"
                              aria-labelledby="hero-image-caption-button-6064"
                            >
                              <button
                                type="button"
                                className="hero__caption-content-close | js-hero-caption-btn"
                                id="hero-image-caption-close-button-6064"
                                aria-expanded="false"
                                aria-controls="hero-image-caption-content-6064"
                              >
                                <span className="visually-hidden">
                      ...
                      <div>
                        <div>
                          <section
                            ...
                            aria-labelledby="paragraph-7723-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-7723-title"
                                  className="visually-hidden section--slice-content__title"
                                >
                                  American Friends programmes and projects
                                </h2>
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      ...
                                      and is eligible to receive charitable
                                      contributions of cash, objects and stocks.
                                    </p>
                                    <p>
                                      The organisation was founded in 1989
                                      and&nbsp;since then&nbsp;has
                                      contributed&nbsp;to a wide range
                                      of&nbsp;programmes and projects including:
                                    </p>
                                    <ul>
                                      <li>Special exhibitions</li>
                                      <li>Scholarly symposia</li>
                                      <li>Acquisitions</li>
                                      <li>
                                        Staff positions in curatorial and
                                  ...
                                  <div className="paragraph paragraph--type--embedded-media paragraph--view-mode--default">
                                    <figure className="media media-embed media-image js-media">
                                      <img
                                        loading="eager"
                                        className="lazyload not-full-width"
                                        srcSet="/images/DersimMuseum/string-quartet-max-arthur-cohn-small_2.jpg 400w, /images/DersimMuseum/string-quartet-max-arthur-cohn-small_3.jpg 750w, /images/DersimMuseum/string-quartet-max-arthur-cohn-small_1.jpg 1000w"
                                        sizes="100vw"
                                        width={1000}
                                        height={501}
                                        src="/images/DersimMuseum/string-quartet-max-arthur-cohn-small.jpg"
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-6067-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-6067-title"
                                              ...
                                              <div className="teaser__image-container">
                                                <div className="media media-teaser_landscape media-image js-media">
                                                  <img
                                                    ...
                                                    width={750}
                                                    height={422}
                                                    src="/images/DersimMuseum/image-01.jpg"
                                                  />
                                                </div>
                                              </div>
                                              ...
                                              <div className="teaser__image-container">
                                                <div className="media media-teaser_landscape media-image js-media">
                                                  <img
                                                    ...
                                                    width={750}
                                                    height={422}
                                                    src="/images/DersimMuseum/image-02.webp"
                                                  />
                                                </div>
                                              </div>
                                              <div className="teaser__content">
                                              ...
                                              <div className="teaser__image-container">
                                                <div className="media media-teaser_landscape media-image js-media">
                                                  <img
                                                    ...
                                                    width={750}
                                                    height={422}
                                                    src="/images/DersimMuseum/image-03.jpg"
                                                  />
                                                </div>
                                              </div>
                                              <div className="teaser__content">
