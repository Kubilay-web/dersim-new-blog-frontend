...
const TourAndTalk = () => {
  ...
  useEffect(() => {
    ...
    const category1 = `${contentPrefix}-content-49`;
  ...
  return (
    <div>
      <div>
        ...
        <link
          rel="canonical"
          href="http://localhost:3000/visit/tours-and-talks"
        />
        <link
          rel="image_src"
          href="http://localhost:3000/sites/default/files/styles/uncropped_large/public/2019-11/R04%2005%20Egyptian%20sculpture.jpg?itok=nEuhGscH"
        />
        <meta property="og:site_name" content="The Dersim Museum" />
        <meta property="og:type" content="article" />
        <meta
          property="og:url"
          content="http://localhost:3000/visit/tours-and-talks"
        />
        <meta property="og:title" content="Tours and talks" />
        <meta
          property="og:description"
          content="Get to know the collection on a tour, at a talk or at our Hands on desks."
        />
        <meta
          property="og:image"
        ...
        <meta name="twitter:title" content="Tours and talks" />
        <meta
          name="twitter:image"
          content="http://localhost:3000/sites/default/files/styles/uncropped_large/public/2019-11/R04%2005%20Egyptian%20sculpture.jpg?itok=nEuhGscH"
        />
              ...
              <main id="main-content" className="js-main">
                <div>
                  <div
                    ...
                    role="article"
                    aria-labelledby="paragraph-1313-title"
                  >
                        ...
                        <div className="hero__controls">
                          <div className="hero__caption | js-hero-caption">
                            <button
                              ...
                              id="hero-image-caption-button-1313"
                              aria-expanded="false"
                              aria-controls="hero-image-caption-content-1313"
                            >
                            ...
                            <div
                              ...
                              id="hero-image-caption-content-1313"
                              aria-hidden="true"
                              aria-labelledby="hero-image-caption-button-1313"
                            >
                              <button
                                type="button"
                                className="hero__caption-content-close | js-hero-caption-btn"
                                id="hero-image-caption-close-button-1313"
                                aria-expanded="false"
                                aria-controls="hero-image-caption-content-1313"
                              >
                                <span className="visually-hidden">
                              ...
                              <p>
                                {" "}
                                A tour group in Room 33a Asia Gallery © Benedict
                                Johnson
                              </p>
                            </div>
                          </div>
                        ...
                        <ul className="social-share__list">
                          <li className="social-share__item">
                            <a
                              ...
                              href="http://www.facebook.com/share.php?u=http://localhost:3000/visit/tours-and-talks"
                              target="_blank"
                          ...
                          <li className="social-share__item">
                            <a
                              className="social-share__link"
                              href="https://twitter.com/intent/tweet?text=Tours%20and%20talks&url=http://localhost:3000/visit/tours-and-talks"
                              target="_blank"
                              rel="nofollow noopener noreferrer"
                            >
                              <span className="visually-hidden">
                            ...
                            >
                              <ul className="jump-links__list" role="list">
                                <li className="jump-links__item">
                                  <a
                                    href="#around-the-world-in-90-minutes"
                                    className="jump-links__link"
                                  >
                                    <span>Around the world in 90 minutes</span>
                                  </a>
                                </li>
                                <li className="jump-links__item">
                                  <a
                                    ...
                                    className="jump-links__link"
                                  >
                                    <span>LGBTQ tours</span>
                                  </a>
                                </li>
                                <li className="jump-links__item">
                                  <a
                                    href="#reading-room-tour"
                                    className="jump-links__link"
                                  >
                                    <span>Reading Room tour</span>
                                  </a>
                                </li>
                                <li className="jump-links__item">
                                  <a
                                    href="#friday-night-spotlight-tours"
                                    className="jump-links__link"
                                  >
                                    <span>Friday night spotlight tours</span>
                                  </a>
                                </li>
                                <li className="jump-links__item">
                                  <a
                                    href="#eye-opener-tours"
                                    className="jump-links__link"
                                  >
                                    <span>Eye-opener tours</span>
                                  </a>
                                </li>
                                <li className="jump-links__item">
                                  <a
                          ...
                          <div className="section--intro__info">
                            ...
                            <div className="section--intro__info-slices">
                              <div className="paragraph paragraph--type--info-content paragraph--view-mode--default section--intro__info-content wysiwyg">
                                <p>
                                  <a href="#around-the-world-in-90-minutes">
                              ...
                              <div className="paragraph paragraph--type--info-content paragraph--view-mode--default section--intro__info-content wysiwyg">
                                <p>
                                  <a href="#friday-night-spotlight-tours">
                              ...
                              <div className="paragraph paragraph--type--info-content paragraph--view-mode--default section--intro__info-content wysiwyg">
                                <p>
                                  <a href="#hands-on-desks">Hands on desks:</a>{" "}
                                  11.00–16.00
                                </p>
                              </div>
                            </div>
                          ...
                          <div className="section--intro__content">
                            ...
                            <div className="wysiwyg">
                              <p>
                                ...
                                on our guided highlights tour and explore some
                                of the Museum's most famous objects. Or discover
                                LGBTQ themes and histories in the collection
                                with our{" "}
                                <a
                                ...
                                >
                                  Desire, love, identity tour
                                </a>
                                . Take a look below for more details.&nbsp;
                              </p>
                              <p>
                                Please note there will be no Museum tours from
                                Monday 23 December 2024 to Thursday 2 January
                                2025. Tours will restart on Friday 3 January
                                2025.
                              </p>
                              <p>
                                <span>
                                  The specific content of tours and talks may
                                  change due to gallery work, exhibitions or
                                  other essential Museum activities. We are not
                      ...
                      <div>
                        <div>
                          <section
                            ...
                            aria-labelledby="paragraph-29524-title"
                          >
                            <div className="container">
                              <a
                                className="js-jump-link-anchor"
                                id="around-the-world-in-90-minutes"
                              />{" "}
                              <div className="section__inner">
                                <h2
                                  id="paragraph-29524-title"
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <h2>Around the world in 90 minutes tour</h2>
                                    <p>
                                      Explore some of the most famous objects on
                                      display at the Museum on this guided
                                      highlights tour.
                                    </p>
                                    <ul type="disc">
                                      <li>
                                        Each tour lasts for 90 minutes and
                                        covers multiple galleries.
                                      </li>
                                      <li>
                                        Tours take place on Fridays, Saturdays
                                        and Sundays at 11.30 and 14.00.
                                      </li>
                                      <li>
                                      ...
                                      <li>£14 per person.</li>
                                      <li>
                                        This tour is suitable for an adult
                                        audience (16+).
                                      </li>
                                      <li>
                                        Children aged 12+ may attend if
                                        accompanied by an adult. All attendees –
                                        including children – must have a
                                        prebooked ticket.
                                      </li>
                                      <li>
                                        Please note that the tour will visit a
                                        number of galleries on different floors
                                        and involves a considerable amount of
                                        walking.
                                      </li>
                                    </ul>
                                    <div>
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-12841-title"
                          >
                            <div className="container">
                              <a
                                className="js-jump-link-anchor"
                              ...
                              <div className="section__inner">
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    ...
                                    <p>
                                      Explore objects in the collection linked
                                      to the themes of desire, love and
                                      identity.&nbsp;
                                    </p>
                                    <ul>
                                      <li>
                                        This tour focuses on LGBTQ (lesbian,
                                        gay, bisexual, trans and queer) themes
                                        and histories.
                                      </li>
                                      <li>
                                      ...
                                      <li>
                                        Tours are free but booking is strongly
                                        recommended.
                                      </li>
                                      <li>
                                        Each tour has a capacity of
                                        15&nbsp;people.
                                      </li>
                                      <li>
                                        This tour is suitable for an adult
                                      ...
                                      <li>
                                        The tour visits a number of galleries on
                                        different floors and involves a
                                    ...
                                    <div>
                                      <a
                                        className="button"
                                        href="http://localhost:3000/events/desire-love-identity-lgbtq-tour-british-museum"
                                      >
                                        <span>Find out more</span>
                                      </a>
                                    </div>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-32094-title"
                          >
                            <div className="container">
                              <a
                                className="js-jump-link-anchor"
                                id="reading-room-tour"
                              />{" "}
                              <div className="section__inner">
                                <h2
                                  id="paragraph-32094-title"
                                  className="visually-hidden section--slice-content__title"
                                >
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <h2>Spotlight: the Reading Room tour</h2>
                                    <p>
                                      Enjoy a brief tour about the Reading Room
                                      and discover how it's evolved since 1857
                                      and the famous faces that studied there.
                                    </p>
                                    <ul>
                                      <li>
                                        Tours will take place&nbsp;every Tuesday
                                        at 11.00 and 12.00.
                                      </li>
                                      <li>
                                        Each tour lasts 20 minutes and will
                                        start inside the Reading Room by the
                                        meeting point.
                                      </li>
                                      <li>
                                        Each tour has a capacity of
                                        20&nbsp;people. Places are provided on a
                                        first-come, first-served basis.
                                      </li>
                                      <li>
                                        Please note that photography is not
                                        permitted in the Reading Room.&nbsp;
                                      </li>
                                      <li>
                                        These tours are subject to cancellation.
                                        Please ask at the Information Desk in
                                        the Great Court if unsure.&nbsp;
                                      </li>
                                    </ul>
                                    <div className>
                                      <a
                                        className="button"
                                        href="/visit/tours-and-talks/spotlight-reading-room"
                                      >
                                        <span>Find out more</span>
                                      </a>
                                    </div>
                                ...
                                <aside className="section--slice-content__embed">
                                  <div className="paragraph paragraph--type--embedded-media paragraph--view-mode--default">
                                    <figure className="media media-embed media-image js-media">
                                      ...
                                      />
                                      <figcaption>
                                        A view from outside the Reading Room,
                                        with the Great Court glass roof
                                        above.&nbsp;
                                      </figcaption>
                                    </figure>
                                  </div>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-right section--bg-white"
                            aria-labelledby="paragraph-10806-title"
                          >
                            <div className="container">
                              <a
                                className="js-jump-link-anchor"
                                id="friday-night-spotlight-tours"
                              />{" "}
                              <div className="section__inner">
                                <h2
                                  id="paragraph-10806-title"
                                  className="visually-hidden section--slice-content__title"
                                >
                                  Friday night spotlight tours
                                </h2>
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    ...
                                    <p>
                                      Please note there will be no Museum tours
                                      from Monday 23 December 2024 to Thursday 2
                                      January 2025. Tours will restart on Friday
                                      3 January 2025.
                                    </p>
                                    <p>
                                      Join a volunteer guide on one of our free
                                      Friday night spotlight tours focusing on
                                      four remarkable areas of the collection.
                                    </p>
                                    <ul>
                                      <li>
                                        Our free volunteer-led Spotlight tours
                                        are 20 minutes long.&nbsp;
                                      </li>
                                      <li>
                                        They take place on{" "}
                                      ...
                                      <li>
                                        The tours are recommended for adults,
                                      ...
                                      <li>
                                        The availability of tours and talks may
                                        be reduced on bank holidays – see dates
                                        of{" "}
                                        <a href="https://www.gov.uk/bank-holidays">
                                          upcoming bank holidays
                                        </a>
                                        .
                                      </li>
                                      <li>
                                        Please be aware these tours are subject
                                        to cancellation. Please ask at the
                                        Information Desk on the day for details.
                                      </li>
                                    </ul>
                                    <div>
                                      <a
                                ...
                                <aside className="section--slice-content__embed">
                                  <div className="paragraph paragraph--type--embedded-media paragraph--view-mode--default">
                                    <figure className="media media-embed media-image js-media">
                                      ...
                                      />
                                      <figcaption>
                                        A Spotlight tour in the Enlightenment
                                        Gallery. © Benedict Johnson.
                                      </figcaption>
                                    </figure>
                                  </div>
                                </aside>
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-4055-title"
                          >
                            <div className="container">
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-3984-title"
                          >
                            <div className="container">
                              <a
                                className="js-jump-link-anchor"
                              ...
                              <div className="section__inner">
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    ...
                                    <p>
                                      Join a volunteer guide on one of our free
                                      eye-opener tours bringing you closer to
                                      the collection.&nbsp;
                                    </p>
                                    <ul>
                                      <li>
                                        Our free volunteer-led eye-opener tours
                                        are 40 minutes long.
                                      </li>
                                      <li>
                                        The tours are recommended for adults,
                                      ...
                                      <li>
                                        These tours are generally limited to 15
                                        places per session, depending on the
                                        Museum location. Please arrive early at
                                        the meeting point to secure a space.
                                      </li>
                                      <li>
                                        Eye-opener tours run at different times
                                        during the day.
                                      </li>
                                      <li>
                                        The availability of tours and talks may
                                        be reduced on bank holidays
                                        –&nbsp;see&nbsp;dates of&nbsp;
                                        <a
                                          href="https://www.gov.uk/bank-holidays"
                                          data-gc-link="https://www.gov.uk/bank-holidays"
                                        >
                                          upcoming bank holidays
                                        </a>
                                        .
                                ...
                                <aside className="section--slice-content__embed">
                                  <div className="paragraph paragraph--type--embedded-media paragraph--view-mode--default">
                                    <figure className="media media-embed media-image js-media">
                                      ...
                                      />
                                      <figcaption>
                                        A volunteer tour in the Islamic World
                                        Gallery.&nbsp;© Benedict Johnson.
                                      </figcaption>
                                    </figure>
                                  </div>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-right section--bg-white"
                            aria-labelledby="paragraph-3995-title"
                          >
                            <div className="container">
                              <a
                                className="js-jump-link-anchor"
                              ...
                              <div className="section__inner">
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <h2>Hands on desks</h2>
                                    <p>
                                      Please note there will be no Hands on
                                      desks from Monday 23 December 2024 to
                                      Thursday 2 January 2025. Tours and Hands
                                      on desks will restart on Friday 3 January
                                      2025.
                                    </p>
                                    <p>
                                      The Hands on desks allow visitors to
                                      handle real objects and to find out more
                                      about the collection through relaxed,
                                      informal conversations. Volunteers
                                      facilitate the object handling, encourage
                                      discussion and answer visitors' questions.
                                      The handling collection for each desk
                                      relates to the displays around it.
                                    </p>
                                    <p>
                                      Sessions are free&nbsp;and take place
                                      daily from 11.00–16.00,&nbsp;subject to
                                      availability, in the galleries listed
                                      below:
                                    </p>
                                    <p>
                                      <a
                                ...
                                <aside className="section--slice-content__embed">
                                  <div className="paragraph paragraph--type--embedded-media paragraph--view-mode--default">
                                    <figure className="media media-embed media-image js-media">
                                      ...
                                      />
                                      <figcaption>
                                        Hands on desk. © Benedict Johnson.
                                      </figcaption>
                                    </figure>
                                  </div>
                                </aside>
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-4016-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-4016-title"
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  ...
                                                  <div className="teaser__summary">
                                                    From activity&nbsp;trails to
                                                    creative workshops, arrange
