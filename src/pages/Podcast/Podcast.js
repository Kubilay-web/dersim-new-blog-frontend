...
const Podcast = () => {
  ...
  useEffect(() => {
    const someContentId = "67b2ee637ffef8be106d27f4";

    fetchContentById(someContentId, setContent);
  }, []);

  useEffect(() => {
    const category1 = "Explore more treasures in our collection";
              ...
              <main id="main-content" className="js-main">
                <div>
                  <div
                    ...
                    role="article"
                    aria-labelledby="paragraph-13123-title"
                  >
                        ...
                        <div className="hero__controls">
                          <div className="hero__caption | js-hero-caption">
                            <button
                              ...
                              id="hero-image-caption-button-13123"
                              aria-expanded="false"
                              aria-controls="hero-image-caption-content-13123"
                            >
                            ...
                            <div
                              ...
                              id="hero-image-caption-content-13123"
                              aria-hidden="true"
                              aria-labelledby="hero-image-caption-button-13123"
                            >
                              <button
                                type="button"
                                className="hero__caption-content-close | js-hero-caption-btn"
                                id="hero-image-caption-close-button-13123"
                                aria-expanded="false"
                                aria-controls="hero-image-caption-content-13123"
                              >
                                <span className="visually-hidden">
                              ...
                              <p>
                                {" "}
                                Hugo Chapman (left) and Sushma Jansari (right)
                                with Nick Kendall (centre).
                              </p>
                            </div>
                          </div>
                        </div>
                          ...
                          <div className="jump-links">
                            ...
                            >
                              <ul className="jump-links__list" role="list">
                                ...
                                <li className="jump-links__item">
                                  <a
                                    href="#hans-sloane-special"
                                    className="jump-links__link"
                                  >
                                    <span>Hans Sloane special</span>
                                  </a>
                                </li>
                                <li className="jump-links__item">
                                  <a
                                    href="#history-of-ice-cream"
                                    className="jump-links__link"
                                  >
                                    <span>History of ice cream</span>
                                  </a>
                                </li>
                              </ul>
                            </div>
                        ...
                        <div className="section--intro__container">
                          <div className="section--intro__info">
                            ...
                            <div className="section--intro__info-slices">
                              <div className="paragraph paragraph--type--info-content paragraph--view-mode--default section--intro__info-content wysiwyg">
                                <p>
                                  If you enjoy the podcast please take a minute
                                  to rate and review us or send us a tweet{" "}
                                  <a href="https://twitter.com/britishmuseum/status/1121353796943269888">
                                    @britishmuseum
                                  </a>
                                </p>
                              </div>
                              <div className="intro-link--link paragraph paragraph--type--info-link paragraph--view-mode--default">
                                <a
                                  ...
                                  href="https://soundcloud.com/britishmuseum/"
                                >
                                  <span>Listen to more podcasts</span>
                                  <svg
                                    className="icon icon--chevron"
                                    role="presentation"
                                    focusable="false"
                          ...
                          <div className="section--intro__content">
                            ...
                            <div className="wysiwyg">
                              <p>
                                Every month&nbsp;Sushma&nbsp;Jansari, Curator of
                                South Asia, and&nbsp;Hugo Chapman, Keeper of
                                Prints and Drawings, chat with&nbsp;colleagues
                                to bring out the history, research and
                                idiosyncrasies of the Museum.&nbsp;
                              </p>
                              <p>
                                <span>
                                  We also visit the archives with&nbsp;Senior
                                  Archivist Francesca Hillier and podcast
                                  producer Sian Toogood. In each episode, hear
                                  the fascinating and little known stories
                                  behind objects from the Museum's collection.
                                </span>
                              </p>
                            </div> */}
                          </div>
                      ...
                      <div>
                        <div>
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-16837-title"
                          >
                            <div className="container">
                              <a
                              ...
                              <div className="section__inner">
                                ...
                                <div className="object-embed__container">
                                  <div className="object-embed__object">
                                    <div className="paragraph paragraph--type--embed-video-audio paragraph--view-mode--default">
                                      <div className="media media-embed media-soundcloud js-media">
                                        <iframe
                                          width="100%"
                                          height={166}
                                          data-src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/940014697&visual=1&auto_play=false&hide_related=false&show_comments=false&show_user=false&show_reposts=false&color=%23ff5500"
                                          data-cookieconsent="marketing"
                                        />
                                        <div className="wysiwyg | cookieconsent-optout-marketing | js-marketing-message">
                                          <a href="javascript:Cookiebot.renew()">
                                            Please accept marketing cookies to
                                  ...
                                  <div className="object-embed__content">
                                    ...
                                    <p>
                                      ...
                                      of the opening of the Great Court, Sian
                                      and Francesca head to the archives to find
                                      out more about the building of this
                                      incredible space. Plus, Curator Irving
                                      Finkel talks about the history of chess
                                      and backgammon.
                                    </p>
                                  </div>
                                </div>
                          ...
                          <section
                            className="object-embed paragraph paragraph--type--slice-object-embed paragraph--view-mode--default section section--slice-object-embed section--bg-white"
                            aria-labelledby="paragraph-16839-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-16839-title"
                                  className="section__title"
                                >
                                  The Museum podcast episode #19: The Arctic,
                                  Renaissance jewels and illicit antiquities
                                </h2>
                                <div className="object-embed__container">
                                  <div className="object-embed__object">
                                    <div className="paragraph paragraph--type--embed-video-audio paragraph--view-mode--default">
                                      <div className="media media-embed media-soundcloud js-media">
                                        <iframe
                                          width="100%"
                                          height={166}
                                          data-src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/923226421&visual=1&auto_play=false&hide_related=false&show_comments=false&show_user=false&show_reposts=false&color=%23ff5500"
                                          data-cookieconsent="marketing"
                                        />
                                        <div className="wysiwyg | cookieconsent-optout-marketing | js-marketing-message">
                                          <a href="javascript:Cookiebot.renew()">
                                  ...
                                  <div className="object-embed__content">
                                    <p>Nov 2020</p>
                                    <p>
                                      Hugo and Sushma check in with Amber
                                      Lincoln, lead curator of the Citi
                                      exhibition{" "}
                                      <em>Arctic: culture and climate</em>, and
                                      talk with Curator Rachel King&nbsp;about
                                      the Waddesdon Bequest and a display of a
                                      19th-century ewer.
                                    </p>
                                  </div>
                                </div>
                          ...
                          <section
                            className="object-embed paragraph paragraph--type--slice-object-embed paragraph--view-mode--default section section--slice-object-embed section--bg-white"
                            aria-labelledby="paragraph-16841-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-16841-title"
                                  className="section__title"
                                >
                                  The Museum Podcast #18: Collection Care,
                                  Tantra and a return to the archive
                                </h2>
                                <div className="object-embed__container">
                                  <div className="object-embed__object">
                                    <div className="paragraph paragraph--type--embed-video-audio paragraph--view-mode--default">
                                      <div className="media media-embed media-soundcloud js-media">
                                        <iframe
                                          width="100%"
                                          height={166}
                                          data-src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/906570259&visual=1&auto_play=false&hide_related=false&show_comments=false&show_user=false&show_reposts=false&color=%23ff5500"
                                          data-cookieconsent="marketing"
                                        />
                                        <div className="wysiwyg | cookieconsent-optout-marketing | js-marketing-message">
                                          <a href="javascript:Cookiebot.renew()">
                                  ...
                                  <div className="object-embed__content">
                                    <p>Oct 2020</p>
                                    <p>
                                      Head of Collection Care, Sandra Smith,
                                      talks about how your breath helps objects
                                      in the galleries;&nbsp;Sushma chats with
                                      Imma Ramos, lead curator of{" "}
                                      <em>
                                        Tantra: enlightenment to revolution
                                      </em>
                                      ;&nbsp;and Sian and Francesca&nbsp;talk
                                      about the staff canteen, of all things.
                                    </p>
                                  </div>
                                </div>
                              </div>
                          ...
                          <section
                            className="object-embed paragraph paragraph--type--slice-object-embed paragraph--view-mode--default section section--slice-object-embed section--bg-white"
                            aria-labelledby="paragraph-15308-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-15308-title"
                                  className="section__title"
                                >
                                  The Museum podcast #17: National Programmes
                                  and afternoon tea
                                </h2>
                                <div className="object-embed__container">
                                  <div className="object-embed__object">
                                    <div className="paragraph paragraph--type--embed-video-audio paragraph--view-mode--default">
                                      <div className="media media-embed media-soundcloud js-media">
                                        <iframe
                                          width="100%"
                                          height={166}
                                          data-src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/889180408&visual=1&auto_play=false&hide_related=false&show_comments=false&show_user=false&show_reposts=false&color=%23ff5500"
                                          data-cookieconsent="marketing"
                                        />
                                        <div className="wysiwyg | cookieconsent-optout-marketing | js-marketing-message">
                                          <a href="javascript:Cookiebot.renew()">
                                  ...
                                  <div className="object-embed__content">
                                    ...
                                    <p>
                                      ...
                                      tea,&nbsp;and Lead
                                      Archaeologist&nbsp;Sebastien Rey tells
                                      us&nbsp;which object he is most excited to
                                      see at the Museum.
                                    </p>
                                  </div>
                                </div>
                          ...
                          <section
                            className="object-embed paragraph paragraph--type--slice-object-embed paragraph--view-mode--default section section--slice-object-embed section--bg-white"
                            aria-labelledby="paragraph-14821-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-14821-title"
                                  className="section__title"
                                >
                                ...
                                <div className="object-embed__container">
                                    ...
                                    <div className="paragraph paragraph--type--embed-video-audio paragraph--view-mode--default">
                                      <div className="media media-embed media-soundcloud js-media">
                                        <iframe
                                          width="100%"
                                          height={166}
                                          data-src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/873306490&visual=1&auto_play=false&hide_related=false&show_comments=false&show_user=false&show_reposts=false&color=%23ff5500"
                                          data-cookieconsent="marketing"
                                        />
                                        <div className="wysiwyg | cookieconsent-optout-marketing | js-marketing-message">
                                          <a href="javascript:Cookiebot.renew()">
                                  ...
                                  <div className="object-embed__content">
                                    <p>Aug&nbsp;2020</p>
                                    <p>
                                      Hartwig Fischer and Sushma Jansari are
                                      joined by guests Olivette Otele and Bonnie
                                      Greer. They discuss the legacies of
                                      slavery, its impact on today’s society,
                                      and how museums should respond to these
                          ...
                          <section
                            className="object-embed paragraph paragraph--type--slice-object-embed paragraph--view-mode--default section section--slice-object-embed section--bg-white"
                            aria-labelledby="paragraph-14819-title"
                          >
                            <div className="container">
                              <a
                                className="js-jump-link-anchor"
                                id="hans-sloane-special"
                              />{" "}
                              <div className="section__inner">
                                <h2
                                  id="paragraph-14819-title"
                                  className="section__title"
                                >
                                    ...
                                    <div className="paragraph paragraph--type--embed-video-audio paragraph--view-mode--default">
                                      <div className="media media-embed media-soundcloud js-media">
                                        <iframe
                                          width="100%"
                                          height={166}
                                          data-src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/879690892&visual=1&auto_play=false&hide_related=false&show_comments=false&show_user=false&show_reposts=false&color=%23ff5500"
                                          data-cookieconsent="marketing"
                                        />
                                        <div className="wysiwyg | cookieconsent-optout-marketing | js-marketing-message">
                                          <a href="javascript:Cookiebot.renew()">
                                        ...
                                        <span>
                                          <span>
                                            <span>
                                              <span>
                                                <span>
                                                  Guests Miranda Lowe and James
                                                  Delbourgo join Hartwig Fischer
                                                  and Sushma Jansari to explore
                                                  the life, legacy and
                                                  collection of Sir&nbsp;Hans
                                                  Sloane. They examine the role
                                                  of slavery and enslaved people
                                                  in his collecting practices
                                                  and consider how museums
                          ...
                          <section
                            className="object-embed paragraph paragraph--type--slice-object-embed paragraph--view-mode--default section section--slice-object-embed section--bg-white"
                            aria-labelledby="paragraph-13953-title"
                          >
                            <div className="container">
                              <a
                                className="js-jump-link-anchor"
                                id="history-of-ice-cream"
                              />{" "}
                              <div className="section__inner">
                                <h2
                                  id="paragraph-13953-title"
                                  className="section__title"
                                >
                                  The Museum podcast #16: Ice cream, olive oil
                                  and the Phrygian Sibyl
                                </h2>
                                <div className="object-embed__container">
                                  <div className="object-embed__object">
                                    <div className="paragraph paragraph--type--embed-video-audio paragraph--view-mode--default">
                                      <div className="media media-embed media-soundcloud js-media">
                                        <iframe
                                          width="100%"
                                          height={166}
                                          data-src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/850286866&visual=1&auto_play=false&hide_related=false&show_comments=false&show_user=false&show_reposts=false&color=%23ff5500"
                                          data-cookieconsent="marketing"
                                        />
                                        <div className="wysiwyg | cookieconsent-optout-marketing | js-marketing-message">
                                          <a href="javascript:Cookiebot.renew()">
                                  ...
                                  <div className="object-embed__content">
                                    ...
                                    <p>
                                      <span lang="EN-GB">
                                        This month we're talking food history
                                        and Renaissance art.&nbsp;Food historian
                                        Tasha Marks&nbsp;delves into the history
                                        of ice cream, curator Jamie Fraser talks
                                        about&nbsp;olive oil in ancient Levant,
                                        and Hugo Chapman marks&nbsp;the 500th
                                        anniversary
                                        of&nbsp;Raphael’s&nbsp;death.&nbsp;
                                      </span>
                                    </p>
                          ...
                          <section
                            className="object-embed paragraph paragraph--type--slice-object-embed paragraph--view-mode--default section section--slice-object-embed section--bg-white"
                            aria-labelledby="paragraph-13752-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-13752-title"
                                  className="section__title"
                                >
                                  The Museum podcast #15: The inevitable
                                  coronavirus episode
                                </h2>
                                <div className="object-embed__container">
                                  <div className="object-embed__object">
                                    <div className="paragraph paragraph--type--embed-video-audio paragraph--view-mode--default">
                                      <div className="media media-embed media-soundcloud js-media">
                                        <iframe
                                          width="100%"
                                          height={166}
                                          data-src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/833335576&visual=1&auto_play=false&hide_related=false&show_comments=false&show_user=false&show_reposts=false&color=%23ff5500"
                                          data-cookieconsent="marketing"
                                        />
                                        <div className="wysiwyg | cookieconsent-optout-marketing | js-marketing-message">
                                          <a href="javascript:Cookiebot.renew()">
                                        ...
                                        <span>
                                          <span>
                                            <span>
                                              <span>
                                                <span>
                                                  Leonora Baird Smith explains
                                                  collection care in lockdown.
                                                  Dr Janina Ramirez talks about
                                                  scripting her love letter to
                                                  the Museum for BBC4, and Clive
                                                  Gamble examines how humans
                                                  became a global species using
                                                  objects to stay connected over
                                                  long distances.
                                                </span>
                                              </span>
                                            </span>
                          ...
                          <section
                            className="object-embed paragraph paragraph--type--slice-object-embed paragraph--view-mode--default section section--slice-object-embed section--bg-white"
                            aria-labelledby="paragraph-13247-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-13247-title"
                                  className="section__title"
                                >
                                  The Museum podcast #14: Venetian maps and
                                  volunteers
                                </h2>
                                <div className="object-embed__container">
                                  <div className="object-embed__object">
                                    <div className="paragraph paragraph--type--embed-video-audio paragraph--view-mode--default">
                                      <div className="media media-embed media-soundcloud js-media">
                                        <iframe
                                          width="100%"
                                          height={166}
                                          data-src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/815457565&visual=1&auto_play=false&hide_related=false&show_comments=false&show_user=false&show_reposts=false&color=%23ff5500"
                                          data-cookieconsent="marketing"
                                        />
                                        <div className="wysiwyg | cookieconsent-optout-marketing | js-marketing-message">
                                          <a href="javascript:Cookiebot.renew()">
                                  ...
                                  <div className="object-embed__content">
                                    ...
                                    <p>
                                      <span>
                                        <span>
                                          <span lang="EN-GB">
                                            Hugo, Sushma (pre-furlough) and Sian
                                            chat about life in lockdown. Curator
                                            Sarah Vowles gives an in-depth
                                            insight into the monumental Barbari
                                            map of Venice and volunteer Mariu
                                            Huriaga talks about 20 years of
                                            giving tours at the Museum.
                                          </span>
                                        </span>
                                      </span>
                                    </p>
                          ...
                          <section
                            className="object-embed paragraph paragraph--type--slice-object-embed paragraph--view-mode--default section section--slice-object-embed section--bg-white"
                            aria-labelledby="paragraph-13156-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-13156-title"
                                  className="section__title"
                                >
                                  The Museum podcast #13: All about
                                  accessibility
                                </h2>
                                <div className="object-embed__container">
                                  <div className="object-embed__object">
                                    <div className="paragraph paragraph--type--embed-video-audio paragraph--view-mode--default">
                                      <div className="media media-embed media-soundcloud js-media">
                                        <iframe
                                          width="100%"
                                          height={166}
                                          data-src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/787753084&visual=1&auto_play=false&hide_related=false&show_comments=false&show_user=false&show_reposts=false&color=%23ff5500"
                                          data-cookieconsent="marketing"
                                        />
                                        <div className="wysiwyg | cookieconsent-optout-marketing | js-marketing-message">
                                          <a href="javascript:Cookiebot.renew()">
                                  ...
                                  <div className="object-embed__content">
                                    <p>Apr 2020</p>
                                    <p>
                                      This episode sees the Museum closed for
                                      the first time since the war, however, we
                                      soldier on.&nbsp;Hugo and Sushma look at
                                      an area of work that is dear to all of our
                                      hearts: equality and diversity. &nbsp;
                                    </p>
                                  </div>
                                </div>
                              </div>
                          ...
                          <section
                            className="object-embed paragraph paragraph--type--slice-object-embed paragraph--view-mode--default section section--slice-object-embed section--bg-white"
                            aria-labelledby="paragraph-13154-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-13154-title"
                                  className="section__title"
                                >
                                ...
                                <div className="object-embed__container">
                                    ...
                                    <div className="paragraph paragraph--type--embed-video-audio paragraph--view-mode--default">
                                      <div className="media media-embed media-soundcloud js-media">
                                        <iframe
                                          width="100%"
                                          height={166}
                                          data-src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/770598895&visual=1&auto_play=false&hide_related=false&show_comments=false&show_user=false&show_reposts=false&color=%23ff5500"
                                          data-cookieconsent="marketing"
                                        />
                                        <div className="wysiwyg | cookieconsent-optout-marketing | js-marketing-message">
                                          <a href="javascript:Cookiebot.renew()">
                                  ...
                                  <div className="object-embed__content">
                                    <p>Mar 2020</p>
                                    <p>
                                      Hugo chats with archaeologist Alexandra
                                      (AKA Sally) Fletcher and in the archives,
                                      Sian and Francesca discuss some of the
                                      earliest female&nbsp;scholars, as well as
                                      a libel case&nbsp;involving&nbsp;Victoria
                                      Woodhull who ran for the American
                                      Presidency in 1872.&nbsp;&nbsp;
                                    </p>
                                  </div>
                                </div>
                          ...
                          <section
                            className="object-embed paragraph paragraph--type--slice-object-embed paragraph--view-mode--default section section--slice-object-embed section--bg-white"
                            aria-labelledby="paragraph-13152-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-13152-title"
                                  className="section__title"
                                >
                                  The Museum podcast #11: LGBTQ histories, stone
                                  tools and the Museum rifle club
                                </h2>
                                <div className="object-embed__container">
                                  <div className="object-embed__object">
                                    <div className="paragraph paragraph--type--embed-video-audio paragraph--view-mode--default">
                                      <div className="media media-embed media-soundcloud js-media">
                                        <iframe
                                          width="100%"
                                          height={166}
                                          data-src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/755483764&visual=1&auto_play=false&hide_related=false&show_comments=false&show_user=false&show_reposts=false&color=%23ff5500"
                                          data-cookieconsent="marketing"
                                        />
                                        <div className="wysiwyg | cookieconsent-optout-marketing | js-marketing-message">
                                          <a href="javascript:Cookiebot.renew()">
                                  ...
                                  <div className="object-embed__content">
                                    <p>Feb 2020</p>
                                    <p>
                                      Stuart Frost – Head of Interpretation and
                                      Volunteers – discusses how we create
                                      narratives around the collection and how
                                      volunteers are vital in supporting the
                                      Museum. In the archives, Francesca and
                                      Sian look at the history of the Museum’s
                                      clubs and societies.
                                    </p>
                                  </div>
                                </div>
                          ...
                          <section
                            className="object-embed paragraph paragraph--type--slice-object-embed paragraph--view-mode--default section section--slice-object-embed section--bg-white"
                            aria-labelledby="paragraph-13150-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-13150-title"
                                  className="section__title"
                                >
                                ...
                                <div className="object-embed__container">
                                    ...
                                    <div className="paragraph paragraph--type--embed-video-audio paragraph--view-mode--default">
                                      <div className="media media-embed media-soundcloud js-media">
                                        <iframe
                                          width="100%"
                                          height={166}
                                          data-src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/747569602&visual=1&auto_play=false&hide_related=false&show_comments=false&show_user=false&show_reposts=false&color=%23ff5500"
                                          data-cookieconsent="marketing"
                                        />
                                        <div className="wysiwyg | cookieconsent-optout-marketing | js-marketing-message">
                                          <a href="javascript:Cookiebot.renew()">
                                  ...
                                  <div className="object-embed__content">
                                    <p>Jan 2020</p>
                                    <p>
                                      Alexandra Villing, curator of the BP
                                      exhibition{" "}
                                      <a
                                        data-entity-type="node"
                                        data-entity-uuid="e16a2c17-4948-4270-b15a-9193a6d66a84"
                                        href="/exhibitions/troy-myth-and-reality"
                                      >
                                        Troy: myth and reality
                                      </a>{" "}
                                      talks with classicist Natalie Haynes about
                                      the wives, mothers, seers, queens, and
                                      goddesses at the heart of the Trojan myth.
                                    </p>
                                  </div>
                                </div>
                              </div>
                          ...
                          <section
                            className="object-embed paragraph paragraph--type--slice-object-embed paragraph--view-mode--default section section--slice-object-embed section--bg-white"
                            aria-labelledby="paragraph-13148-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-13148-title"
                                  className="section__title"
                                >
                                ...
                                <div className="object-embed__container">
                                    ...
                                    <div className="paragraph paragraph--type--embed-video-audio paragraph--view-mode--default">
                                      <div className="media media-embed media-soundcloud js-media">
                                        <iframe
                                          width="100%"
                                          height={166}
                                          data-src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/736714222&visual=1&auto_play=false&hide_related=false&show_comments=false&show_user=false&show_reposts=false&color=%23ff5500"
                                          data-cookieconsent="marketing"
                                        />
                                        <div className="wysiwyg | cookieconsent-optout-marketing | js-marketing-message">
                                          <a href="javascript:Cookiebot.renew()">
                                  ...
                                  <div className="object-embed__content">
                                    <p>Jan 2020</p>
                                    <p>
                                      Hugo and Sushma kick off 2020 with an
                                      interview with the Museum’s director,
                                      Hartwig Fischer. In the archives,
                                      Francesca and Sian take a look at the
                                      history of the Hirayama Paper conservation
                                      studio.&nbsp;
                                    </p>
                                  </div>
                                </div>
                          ...
                          <section
                            className="object-embed paragraph paragraph--type--slice-object-embed paragraph--view-mode--default section section--slice-object-embed section--bg-white"
                            aria-labelledby="paragraph-13146-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-13146-title"
                                  className="section__title"
                                >
                                  The Museum podcast Christmas special: 12
                                ...
                                <div className="object-embed__container">
                                    ...
                                    <div className="paragraph paragraph--type--embed-video-audio paragraph--view-mode--default">
                                      <div className="media media-embed media-soundcloud js-media">
                                        <iframe
                                          width="100%"
                                          height={166}
                                          data-src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/730265101&visual=1&auto_play=false&hide_related=false&show_comments=false&show_user=false&show_reposts=false&color=%23ff5500"
                                          data-cookieconsent="marketing"
                                        />
                                        <div className="wysiwyg | cookieconsent-optout-marketing | js-marketing-message">
                                          <a href="javascript:Cookiebot.renew()">
                                  ...
                                  <div className="object-embed__content">
                                    ...
                                    <p>
                                      ...
                                      their responses into a special Christmas
                                      compendium.&nbsp;
                                    </p>
                                  </div>
                                </div>
                          ...
                          <section
                            className="object-embed paragraph paragraph--type--slice-object-embed paragraph--view-mode--default section section--slice-object-embed section--bg-white"
                            aria-labelledby="paragraph-13144-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-13144-title"
                                  className="section__title"
                                >
                                ...
                                <div className="object-embed__container">
                                  <div className="object-embed__object">
                                    <div className="paragraph paragraph--type--embed-video-audio paragraph--view-mode--default">
                                      <div className="media media-embed media-soundcloud js-media">
                                        <iframe
                                          width="100%"
                                          height={166}
                                          data-src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/722641813&visual=1&auto_play=false&hide_related=false&show_comments=false&show_user=false&show_reposts=false&color=%23ff5500"
                                          data-cookieconsent="marketing"
                                        />
                                        <div className="wysiwyg | cookieconsent-optout-marketing | js-marketing-message">
                                          <a href="javascript:Cookiebot.renew()">
                                    ...
                                    <div className="caption">
                                      {" "}
                                      <p>
                                        <a href="/sites/default/files/2024-05/The_Museum_podcast_9_transcript.docx">
                                          Read the transcript.
                                        </a>
                                      </p>
                                    </div>
                                  ...
                                  <div className="object-embed__content">
                                    <p>Dec 2019</p>
                                    <p>
                                      We are serving an array of festive
                                      delights, Sushma talks to Tim Clark, Head
                                      of the Japanese Section as he reviews four
                                      decades at the Museum, Francesca and Sian
                                      head to the archives to peruse Christmas
                                      cards from the 30s.&nbsp;
                                    </p>
                                  </div>
                                </div>
                          ...
                          <section
                            className="object-embed paragraph paragraph--type--slice-object-embed paragraph--view-mode--default section section--slice-object-embed section--bg-white"
                            aria-labelledby="paragraph-13142-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-13142-title"
                                  className="section__title"
                                >
                                  The Museum podcast #8: A is for Amazon, B is
                                  for blueprints, C is for communism
                                </h2>
                                <div className="object-embed__container">
                                  <div className="object-embed__object">
                                    <div className="paragraph paragraph--type--embed-video-audio paragraph--view-mode--default">
                                      <div className="media media-embed media-soundcloud js-media">
                                        <iframe
                                          width="100%"
                                          height={166}
                                          data-src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/708638278&visual=1&auto_play=false&hide_related=false&show_comments=false&show_user=false&show_reposts=false&color=%23ff5500"
                                          data-cookieconsent="marketing"
                                        />
                                        <div className="wysiwyg | cookieconsent-optout-marketing | js-marketing-message">
                                          <a href="javascript:Cookiebot.renew()">
                                    ...
                                    <div className="caption">
                                      {" "}
                                      <p>
                                        <a href="/sites/default/files/2024-05/The_Museum_podcast_8_transcript.docx">
                                          Read the transcript.
                                        </a>
                                      </p>
                                    </div>
                                  ...
                                  <div className="object-embed__content">
                                    <p>Nov 2019</p>
                                    <p>
                                      Hugo and Sushma interview Laura Osorio
                                      Sunnucks about the Santo Domingo Centre of
                                      Excellence for Latin American Research. In
                                      the Money gallery, Tom Hockenhull
                                      introduces a communist poster, and
                                      Francesca and Sian review blueprints in
                                      the archives.&nbsp;
                                    </p>
                                  </div>
                                </div>
                          ...
                          <section
                            className="object-embed paragraph paragraph--type--slice-object-embed paragraph--view-mode--default section section--slice-object-embed section--bg-white"
                            aria-labelledby="paragraph-13140-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-13140-title"
                                  className="section__title"
                                >
                                  The Museum podcast #7: Innovative exhibitions,
                                  international gold and noisy children
                                </h2>
                                <div className="object-embed__container">
                                  <div className="object-embed__object">
                                    <div className="paragraph paragraph--type--embed-video-audio paragraph--view-mode--default">
                                      <div className="media media-embed media-soundcloud js-media">
                                        <iframe
                                          width="100%"
                                          height={166}
                                          data-src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/690008506&visual=1&auto_play=false&hide_related=false&show_comments=false&show_user=false&show_reposts=false&color=%23ff5500"
                                          data-cookieconsent="marketing"
                                        />
                                        <div className="wysiwyg | cookieconsent-optout-marketing | js-marketing-message">
                                          <a href="javascript:Cookiebot.renew()">
                                  ...
                                  <div className="object-embed__content">
                                    <p>Oct 2019</p>
                                    <p>
                                      Hugo and Sushma discuss how we reflect
                                      what is happening in the world today in
                                      the changing displays of Room 3. In the
                                      archives, Francesca and Sian chart the
                                      history of children’s visits to the
                                      Museum.&nbsp;
                                    </p>
                                  </div>
                                </div>
                          ...
                          <section
                            className="object-embed paragraph paragraph--type--slice-object-embed paragraph--view-mode--default section section--slice-object-embed section--bg-white"
                            aria-labelledby="paragraph-13138-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-13138-title"
                                  className="section__title"
                                >
                                  The Museum podcast #6: X-rays and pioneering
                                  women
                                </h2>
                                <div className="object-embed__container">
                                  <div className="object-embed__object">
                                    <div className="paragraph paragraph--type--embed-video-audio paragraph--view-mode--default">
                                      <div className="media media-embed media-soundcloud js-media">
                                        <iframe
                                          width="100%"
                                          height={166}
                                          data-src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/678402882&visual=1&auto_play=false&hide_related=false&show_comments=false&show_user=false&show_reposts=false&color=%23ff5500"
                                          data-cookieconsent="marketing"
                                        />
                                        <div className="wysiwyg | cookieconsent-optout-marketing | js-marketing-message">
                                          <a href="javascript:Cookiebot.renew()">
                                  ...
                                  <div className="object-embed__content">
                                    <p>Sept&nbsp;2019</p>
                                    <p>
                                      Hugo and Sushma leave the cosy confines of
                                      the office and head into the basements to
                                      meet with Dan O’Flynn and his X-ray
                                      machine. Francesca and Sian scour the
                                      Trustees’ minutes to talk ‘modesty boards’
                                      and the Museum’s first female curator.
                                      &nbsp;
                                    </p>
                                  </div>
                                </div>
                          ...
                          <section
                            className="object-embed paragraph paragraph--type--slice-object-embed paragraph--view-mode--default section section--slice-object-embed section--bg-white"
                            aria-labelledby="paragraph-13136-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-13136-title"
                                  className="section__title"
                                >
                                  The Museum podcast #5: Trainees, travel and
                                  Tutankhamun
                                </h2>
                                <div className="object-embed__container">
                                  <div className="object-embed__object">
                                    <div className="paragraph paragraph--type--embed-video-audio paragraph--view-mode--default">
                                      <div className="media media-embed media-soundcloud js-media">
                                        <iframe
                                          width="100%"
                                          height={166}
                                          data-src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/662398448&visual=1&auto_play=false&hide_related=false&show_comments=false&show_user=false&show_reposts=false&color=%23ff5500"
                                          data-cookieconsent="marketing"
                                        />
                                        <div className="wysiwyg | cookieconsent-optout-marketing | js-marketing-message">
                                          <a href="javascript:Cookiebot.renew()">
                                  ...
                                  <div className="object-embed__content">
                                    <p>Aug&nbsp;2019</p>
                                    <p>
                                      Hugo and Sushma find out more about the
                                      Museum Futures traineeship and Francesca
                                      and Sian dig into the archives to tell us
                                      about the Museum’s most-visited exhibition
                                      of all time (over 1.6 million
                                      visitors)–the 1972 show on Tutankhamun.
                                    </p>
                                  </div>
                                </div>
                              </div>
                          ...
                          <section
                            className="object-embed paragraph paragraph--type--slice-object-embed paragraph--view-mode--default section section--slice-object-embed section--bg-white"
                            aria-labelledby="paragraph-13134-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-13134-title"
                                  className="section__title"
                                >
                                  The Museum podcast # 4: The balmy heights of
                                  July
                                </h2>
                                <div className="object-embed__container">
                                  <div className="object-embed__object">
                                    <div className="paragraph paragraph--type--embed-video-audio paragraph--view-mode--default">
                                      <div className="media media-embed media-soundcloud js-media">
                                        <iframe
                                          width="100%"
                                          height={166}
                                          data-src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/645692253&visual=1&auto_play=false&hide_related=false&show_comments=false&show_user=false&show_reposts=false&color=%23ff5500"
                                          data-cookieconsent="marketing"
                                        />
                                        <div className="wysiwyg | cookieconsent-optout-marketing | js-marketing-message">
                                          <a href="javascript:Cookiebot.renew()">
                                  ...
                                  <div className="object-embed__content">
                                    <p>Jul&nbsp;2019</p>
                                    <p>
                                      Hugo and Sushma interview Head of the PAS
                                      Michael Lewis. Jenny Ramkalawon examines
                                      how artists have subverted the humble
                                      postcard and Francesca and Sian raid the
                                      archives to find out how Hitchcock shot
                                      the epic final scene of Blackmail
                                      (1929).&nbsp;
                                    </p>
                                  </div>
                                </div>
                          ...
                          <section
                            className="object-embed paragraph paragraph--type--slice-object-embed paragraph--view-mode--default section section--slice-object-embed section--bg-white"
                            aria-labelledby="paragraph-13131-title"
                          >
                            <div className="container">
                              <a
                                className="js-jump-link-anchor"
                                id="sutton-hoo-podcast"
                              />{" "}
                              <div className="section__inner">
                                <h2
                                  id="paragraph-13131-title"
                                  className="section__title"
                                >
                                ...
                                <div className="object-embed__container">
                                    ...
                                    <div className="paragraph paragraph--type--embed-video-audio paragraph--view-mode--default">
                                      <div className="media media-embed media-soundcloud js-media">
                                        <iframe
                                          width="100%"
                                          height={166}
                                          data-src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/632193600&visual=1&auto_play=false&hide_related=false&show_comments=false&show_user=false&show_reposts=false&color=%23ff5500"
                                          data-cookieconsent="marketing"
                                        />
                                        <div className="wysiwyg | cookieconsent-optout-marketing | js-marketing-message">
                                          <a href="javascript:Cookiebot.renew()">
                                  ...
                                  <div className="object-embed__content">
                                    <p>Jun&nbsp;2019</p>
                                    <p>
                                      We commemorate the excavation of Sutton
                                      Hoo with an interview with curator Sue
                                      Brunning and a trip to the archives.
                                      Sushma takes a tour of 'Reimagining
                                      Captain Cook: Pacific perspectives' with
                                      the show's curator Julie Adams. &nbsp;
                                    </p>
                                  </div>
                                </div>
                              </div>
                          ...
                          <section
                            className="object-embed paragraph paragraph--type--slice-object-embed paragraph--view-mode--default section section--slice-object-embed section--bg-white"
                            aria-labelledby="paragraph-13129-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-13129-title"
                                  className="section__title"
                                >
                                  The Museum podcast #2: Dirty dishes, poison
                                  and black goo
                                </h2>
                                <div className="object-embed__container">
                                  <div className="object-embed__object">
                                    <div className="paragraph paragraph--type--embed-video-audio paragraph--view-mode--default">
                                      <div className="media media-embed media-soundcloud js-media">
                                        <iframe
                                          width="100%"
                                          height={166}
                                          data-src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/614050506&visual=1&auto_play=false&hide_related=false&show_comments=false&show_user=false&show_reposts=false&color=%23ff5500"
                                          data-cookieconsent="marketing"
                                        />
                                        <div className="wysiwyg | cookieconsent-optout-marketing | js-marketing-message">
                                          <a href="javascript:Cookiebot.renew()">
                                  ...
                                  <div className="object-embed__content">
                                    <p>May 2019</p>
                                    <p>
                                      Kate Fulcher discusses her research into
                                      ancient Egyptian coffin residue –
                                      otherwise known as ‘black goo’ – and
                                      Leonora Baird-Smith delves into the
                                      complex world of collections care.
                                      Francesca and Sian examine some unexpected
                                      finds from the archives relating to
                                      Montague House.
                                    </p>
                                  </div>
                                </div>
                          ...
                          <section
                            className="object-embed paragraph paragraph--type--slice-object-embed paragraph--view-mode--default section section--slice-object-embed section--bg-white"
                            aria-labelledby="paragraph-13127-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                ...
                                <div className="object-embed__container">
                                    ...
                                    <div className="paragraph paragraph--type--embed-video-audio paragraph--view-mode--default">
                                      <div className="media media-embed media-soundcloud js-media">
                                        <iframe
                                          width="100%"
                                          height={166}
                                          data-src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/600348798&visual=1&auto_play=false&hide_related=false&show_comments=false&show_user=false&show_reposts=false&color=%23ff5500"
                                          data-cookieconsent="marketing"
                                        />
                                        <div className="wysiwyg | cookieconsent-optout-marketing | js-marketing-message">
                                          <a href="javascript:Cookiebot.renew()">
                                  ...
                                  <div className="object-embed__content">
                                    <p>Apr 2019</p>
                                    <p>
                                      Hugo and Sushma chat with Ceri Ashley
                                      about the Endangered Material Knowledge
                                      Project and with Nick Kendall one of the
                                      longest-serving members of staff.
                                      Francesca introduces the archive and
                                      curator Julia Farley speaks about the
                                      Aylesford Bucket.&nbsp;
                                    </p>
                                  </div>
                                </div>
                ...
                <div>
                  ...
                  >
                    <div className="container">
                      <div className="section__inner">
                        <h2>Explore more treasures in our collection</h2>
                                  ...
                                  <div className="teaser__wrapper">
                                    ...
                                    <div className="teaser__content">
                                      <div className="teaser__content-push">
                                        <h3 className="teaser__title">
                                          <a
                                            href="/collection/galleries/prints-and-drawings-virtual-gallery"
                                            className="teaser__anchor"
                                          >
                                            <span>
                                              <span>
                                                Prints and drawings virtual
                                                gallery
                                              </span>
                                            </span>
                                  ...
                                  <div className="teaser__wrapper">
                                    ...
                                    <div className="teaser__content">
                                      <div className="teaser__content-push">
                                        <h3 className="teaser__title">
                                          <a
                                            href="/collection/americas/shitikari-expanding-collections-museum"
                                            className="teaser__anchor"
                                          >
                                            <span>
                                              <span>
                                                Shitikari: expanding collections
                                                at the Museum
                                              </span>
                                            </span>
                                        ...
                                        <div className="teaser__summary">
                                          Discover more about
                                          Yanomami-Venezuelan artist Sheroanawë
                                          Hakihiiwë's 'Shitikari', an
                                          extraordinary example of Latin
                                          American art.
                                        </div>
                                      </div>
                                    </div>
                                  ...
                                  <div className="teaser__wrapper">
                                    ...
                                    <div className="teaser__content">
                                      <div className="teaser__content-push">
                                        <h3 className="teaser__title">
                                          <a
                                            href="/collection/americas/hieroglyphic-stairway-palenque"
                                            className="teaser__anchor"
                                          >
                                            <span>
                                              <span>
                                                The hieroglyphic stairway at
                                                Palenque
                                              </span>
                                            </span>
                                  ...
                                  <div className="teaser__wrapper">
                                    ...
                                    <div className="teaser__content">
                                      <div className="teaser__content-push">
                                        ...
                                        <div className="teaser__summary">
                                          We've relaunched Collection online.
                                          Find out about the ongoing
                                          improvements and how you can help us
                                          refine the search.
                                        </div>
                                      </div>
                                    </div>
