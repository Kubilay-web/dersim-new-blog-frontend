...
const FoodDrink = () => {
  ...
  useEffect(() => {
    ...
    const category1 = `${contentPrefix}-content-24`;
              ...
              <main id="main-content" className="js-main">
                <div>
                  <div
                    ...
                    role="article"
                    aria-labelledby="paragraph-830-title"
                  >
                        ...
                        <div className="hero__controls">
                          <div className="hero__caption | js-hero-caption">
                            <button
                              ...
                              id="hero-image-caption-button-830"
                              aria-expanded="false"
                              aria-controls="hero-image-caption-content-830"
                            >
                            ...
                            <div
                              ...
                              id="hero-image-caption-content-830"
                              aria-hidden="true"
                              aria-labelledby="hero-image-caption-button-830"
                            >
                              <button
                                type="button"
                                className="hero__caption-content-close | js-hero-caption-btn"
                                id="hero-image-caption-close-button-830"
                                aria-expanded="false"
                                aria-controls="hero-image-caption-content-830"
                              >
                                <span className="visually-hidden">
                              ...
                              <p>
                                {" "}
                                A table filled with cakes at the&nbsp;Court
                                Café.
                              </p>
                            </div>
                          </div>
                            ...
                            >
                              <ul className="jump-links__list" role="list">
                                <li className="jump-links__item">
                                  ...
                                  >
                                    <span>Court Cafés</span>
                                  </a>
                                </li>
                                <li className="jump-links__item">
                                  <a
                                    href="#great-court-restaurant"
                                    className="jump-links__link"
                                  >
                                    <span>Great Court Restaurant</span>
                                  </a>
                                </li>
                                <li className="jump-links__item">
                                  <a
                        ...
                        <div className="section--intro__container">
                          <div className="section--intro__info">
                            ...
                            <div className="section--intro__info-slices">
                              <div className="paragraph paragraph--type--info-content paragraph--view-mode--default section--intro__info-content wysiwyg">
                                <p>
                                  For allergy information, please email:{" "}
                                  <a href="/cdn-cgi/l/email-protection#6301110a170a100b0e161006160e2301060d16040c4d000c0e">
                                    <span
                                      className="__cf_email__"
                                      data-cfemail="d3b1a1baa7baa0bbbea6a0b6a6be93b1b6bda6b4bcfdb0bcbe"
                                    >
                                      [email&nbsp;protected]
                                    </span>
                                  </a>
                          ...
                          <div className="section--intro__content">
                            ...
                            <div className="wysiwyg">
                              <p>
                                These include cafés, a pizzeria and the Great
                                Court Restaurant. Families are welcome to use
                                our{" "}
                                <a
                                  href="/visit/family-visits#family-facilities"
                                  data-entity-type="node"
                                  data-entity-uuid="5f1e29d0-d3ce-4977-adb5-e7bc71906b38"
                                >
                                  family-friendly eating areas
                                </a>
                      ...
                      <div>
                        <div>
                          <section
                            ...
                            aria-labelledby="paragraph-873-title"
                          >
                            <div className="container">
                              <a
                              ...
                              <div className="section__inner">
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      On the ground floor of the Great Court
                                      you'll find the Court Cafés,
                                      serving&nbsp;freshly made sandwiches,
                                      snacks, salads and cakes as well as a
                                      selection of hot and cold drinks. Ideal
                                      for&nbsp;grabbing a quick bite or having a
                                      coffee break while you plan the next step
                                      of your Museum visit.
                                    </p>
                                    <p>
                                      We have plenty of seating for individuals
                                      and groups at the long sharing tables in
                                      both the west and north-east corners of
                                      the Great Court.
                                    </p>
                                    <p>
                                      <strong>Open: daily, 10.00–17.00</strong>
                                    </p>
                                  </div>
                                </div>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-834-title"
                          >
                            <div className="container">
                              <a
                                className="js-jump-link-anchor"
                                id="great-court-restaurant"
                              />{" "}
                              <div className="section__inner">
                                <h2
                                  id="paragraph-834-title"
                                  className="section__title section--slice-content__title"
                                >
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      Dine under the magnificent roof of the
                                      Great Court. At the Great Court
                                      Restaurant, you can enjoy a refined dining
                                    ...
                                    <p>
                                      ...
                                      table and service times, please refer to
                                      the{" "}
                                      <a
                                    ...
                                    <p>
                                      <strong>
                                        Advance booking is essential, but
                                        walk-ins may be available on the day.
                                        Please speak with a member of the team.
                                      </strong>
                                    </p>
                                    <p>
                                      <strong>
                                        Open: daily, 11.30–17.00 (last sitting
                                        16.00)&nbsp;
                                      </strong>
                                    </p>
                                  </div>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-838-title"
                          >
                            <div className="container">
                              <a
                                className="js-jump-link-anchor"
                              ...
                              <div className="section__inner">
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      A family-friendly restaurant serving
                                      freshly made hand-tossed pizzas, fresh
                                      salads and decadent desserts for an
                                      unforgettable treat. Don't miss the
                                      gelato!&nbsp;We offer gluten-free bases
                                      and both vegetarian and vegan pizzas. For
                                      full details, you can view the{" "}
                                      <a href="/sites/default/files/2024-10/Pizzeria_menu.pdf">
                                        Pizzeria menu
                                      </a>
                                      &nbsp;and{" "}
                                    ...
                                    <p>
                                      The Pizzeria is in the south-west corner
                                      of the Ground floor – just turn left
                                      immediately after you enter the Main
                                      Entrance and keep going. For assisted
                                      disabled access, please ask a member of
                                      staff.&nbsp;
                                    </p>
                                    <p>
                                      <strong>
                                        Open: Monday to Friday, 12.00–15.00 and
                                ...
                                <aside className="section--slice-content__embed">
                                  <div className="paragraph paragraph--type--embedded-media paragraph--view-mode--default">
                                    <figure className="media media-embed media-image js-media">
                                      ...
                                      />
                                      <figcaption>
                                        Enjoy a family-friendly meal in the
                                        Pizzeria.
                                      </figcaption>
                                    </figure>
                                  </div>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-885-title"
                          >
                            <div className="container">
                              <a
                                className="js-jump-link-anchor"
                              ...
                              <div className="section__inner">
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      This first-floor café is found at the
                                      south side of the Museum overlooking the
                                      Great Court with a wonderful view of the
                                      iconic Reading Room. With plenty of
                                      seating and a&nbsp;lively atmosphere, the
                                      lounge serves savoury meals, salads, cakes
                                      and hot and cold drinks.&nbsp;
                                    </p>
                                    <p>
                                      <strong>Open: daily, 10.30–16.30</strong>
                                    </p>
                                  </div>
                                </div>
                                <aside className="section--slice-content__embed">
                                  <div className="paragraph paragraph--type--embedded-media paragraph--view-mode--default">
                                    <figure className="media media-embed media-image js-media">
                                      ...
                                      />
                                      <figcaption>
                                        A selection of ready-to-eat food
                                        options.
                                      </figcaption>
                                    </figure>
                                  </div>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-887-title"
                          >
                            <div className="container">
                              <a
                                className="js-jump-link-anchor"
                              ...
                              <div className="section__inner">
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      Fancy dining alfresco? We have two food
                                      trucks which sell{" "}
                                      <a href="/sites/default/files/2023-11/Van_food_menu_2023.pdf">
                                        snacks
                                      </a>{" "}
                                      and{" "}
                                      <a href="/sites/default/files/2023-11/Van_drinks_menu_2023.pdf">
                                        drinks
                                      </a>{" "}
                                      that can be eaten in the seated areas
                                      outdoors.
                                    </p>
                                    <p>
                                      <strong>
                                        Open: daily, 10.00–17.00. Please note
                                        opening times may vary during poor
                                        weather.&nbsp;
                                      </strong>
                                    </p>
                                  </div>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-889-title"
                          >
                            <div className="container">
                              <a
                                className="js-jump-link-anchor"
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      ...
                                      10%&nbsp;discount on food at any of the
                                      Museum's cafés or restaurants, as well as
                                      exclusive access to the Members' café.
                                    </p>
                                    <p>
                                      Members also receive a 10% discount from
                                      all our Museum shops. Please see the{" "}
                                      <a
                                        data-entity-substitution="canonical"
                                        data-entity-type="node"
                                        data-entity-uuid="09aff57c-7b58-4166-9383-16c339dffc2e"
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-1335-title"
                          >
                            <div className="container">
                              <div className="banner__outer">
                                <div className="banner__inner">
                                  ...
                                  <div className="banner__content">
                                    <p>
                                      Become a Member and enjoy a&nbsp;discount
                                      at all the Museum's cafés and restaurants.
                                    </p>
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-890-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-890-title"
                                              ...
                                              <div className="teaser__image-container">
                                                <div className="media media-teaser_landscape media-image js-media">
                                                  <img
                                                    ...
                                                    width={750}
                                                    height={422}
                                                    src="/images/FoodDrink/image-01.jpg"
                                                  />
                                                </div>
                                              </div>
                                              ...
                                              <div className="teaser__image-container">
                                                <div className="media media-teaser_landscape media-image js-media">
                                                  <img
                                                    ...
                                                    width={750}
                                                    height={422}
                                                    src="/images/FoodDrink/image-02.webp"
                                                  />
                                                </div>
                                              </div>
                                              <div className="teaser__content">
                                              ...
                                              <div className="teaser__image-container">
                                                <div className="media media-teaser_landscape media-image js-media">
                                                  <img
                                                    ...
                                                    width={750}
                                                    height={422}
                                                    src="/images/FoodDrink/image-03.webp"
                                                  />
                                                </div>
                                              </div>
                                              <div className="teaser__content">
                                              ...
                                              <div className="teaser__image-container">
                                                <div className="media media-teaser_landscape media-image js-media">
                                                  <img
                                                    ...
                                                    width={750}
                                                    height={422}
                                                    src="/images/FoodDrink/image-04.jpg"
                                                  />
                                                </div>
                                              </div>
                                              <div className="teaser__content">
