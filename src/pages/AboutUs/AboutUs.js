...
const AboutUs = () => {
  ...
  useEffect(() => {
    ...
    const category1 = `${categoryPrefix}-2`;
  ...
  useEffect(() => {
    ...
    // Kategoriler dil bazında dinamik olarak ayarlanıyor
    const category1 = `${contentPrefix}-content-3`;
    ...
    <div>
      <div>
        ...
        <meta
          ...
          content="Find about the Museum's history, architecture, research and governance, plus info on jobs, press, commercial and public enquiries."
        />
        <meta
          property="og:image"
              ...
              <main id="main-content" className="js-main">
                <div>
                  <div
                    ...
                    role="article"
                    aria-labelledby="paragraph-9182-title"
                  >
                          ...
                          <div className="section--intro__content">
                            ...
                            <div className="wysiwyg">
                              ...
                              <p>
                                ...
                                from small communities to vast empires, to
                                discover the many forms and expressions human
                      ...
                      <div>
                        <div>
                          {/* <section
                            ...
                            aria-labelledby="paragraph-9200-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-9200-title"
                          ...
                          <section
                            className="paragraph paragraph--type--slice-teaser paragraph--view-mode--default section section--slice-teaser section--z-index-scope section--has-carousel section--bg-white"
                            aria-labelledby="paragraph-9206-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-9206-title"
                                    className="visually-hidden teaser-listing__title"
                                  >
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  ...
                                                  <div className="teaser__summary">
                                                    Read our FAQs and if you
                                                    still have a question, get
                                                    in touch via our contact us
                                                    form.
                                                  </div>
                                                </div>
                                              </div>
                                  ...
                                  <div className="teaser__wrapper">
                                    ...
                                    <div className="teaser__content">
                                      <div className="teaser__content-push">
                                        ...
                                        <div className="teaser__summary">
                                          Book our unique spaces, explore
                                          options for film makers and access
                                          high quality images and books.
                                        </div>
                                      </div>
                                    </div>
                                  </div>
