...
const ExistPatron = () => {
  ...
  useEffect(() => {
    const someContentId = "67b31a6d7ffef8be106d2938";
  ...
  return (
    <div>
      <div>
        ...
        <meta
          name="description"
          content="Find out how to get the most out of your Patronage."
        />
        <link
          rel="canonical"
              ...
              <main id="main-content" className="js-main">
                <div>
                  <div
                    ...
                    role="article"
                    aria-labelledby="paragraph-28333-title"
                  >
                        ...
                        <div className="hero__controls">
                          <div className="hero__caption | js-hero-caption">
                            <button
                              ...
                              id="hero-image-caption-button-28333"
                              aria-expanded="false"
                              aria-controls="hero-image-caption-content-28333"
                            >
                            ...
                            <div
                              ...
                              id="hero-image-caption-content-28333"
                              aria-hidden="true"
                              aria-labelledby="hero-image-caption-button-28333"
                            >
                              <button
                                type="button"
                                className="hero__caption-content-close | js-hero-caption-btn"
                                id="hero-image-caption-close-button-28333"
                                aria-expanded="false"
                                aria-controls="hero-image-caption-content-28333"
                              >
                                <span className="visually-hidden">
                              ...
                              <p>
                                {" "}
                                Patrons visiting 'Hokusai: The Great Picture
                                Book of Everything'.&nbsp;Photo ©&nbsp;Benedict
                                Johnson Photography Limited.
                              </p>
                            </div>
                          </div>
                        </div>
                            ...
                            >
                              <ul className="jump-links__list" role="list">
                                <li className="jump-links__item">
                                  ...
                                  >
                                    <span>Patrons' content</span>
                                  </a>
                                </li>
                                <li className="jump-links__item">
                                  <a
                                    href="#how-your-money-helps"
                                    className="jump-links__link"
                                  >
                        ...
                        <div className="section--intro__container">
                            ...
                            <div className="section--intro__info-slices section--intro__info-slices-no-title">
                              <div className="intro-link--link paragraph paragraph--type--info-link paragraph--view-mode--default">
                                <a
                                  ...
                                  href="/support-us/existing-patrons/patron-renewal"
                                >
                                  <span>Renew your Patronage</span>
                                  <svg
                                    className="icon icon--chevron"
                                    role="presentation"
                                    focusable="false"
                              ...
                              <div className="intro-link--link paragraph paragraph--type--info-link paragraph--view-mode--default">
                                <a
                                  data-tracking="cta"
                                  className="link link--chevron"
                                  href="/support-us/patrons/patrons-events"
                                >
                                  <span>Patrons' events</span>
                                  <svg
                                    className="icon icon--chevron"
                                    role="presentation"
                                    focusable="false"
                              ...
                              <div className="intro-link--link paragraph paragraph--type--info-link paragraph--view-mode--default">
                                <a
                                  data-tracking="cta"
                                  className="link link--chevron"
                                  href="/membership/how-your-money-helps/fundraising-scientific-research"
                                >
                                  <span>Patrons' appeal</span>
                                  <svg
                                    className="icon icon--chevron"
                                    role="presentation"
                                    focusable="false"
                          ...
                          <div className="section--intro__content">
                            ...
                            <div className="wysiwyg">
                              <p>
                                Our Patrons truly make a big difference in what
                                the Museum is able to achieve. Find out more
                                about{" "}
                                <a href="#how-your-money-helps">
                                  how your money helps
                                </a>
                                .<br />
                                <br />
                                As a Patron, you have access to a number of
                                exclusive benefits:
                              </p>
                              <ul>
                                <li>
                                  ...
                                  <a
                                    ...
                                    data-entity-uuid="93aaf69e-1696-4a65-859d-39c8f464e35d"
                                    href="/support-us/patrons/patrons-events"
                                  >
                                ...
                                <li>
                                  Unlimited access for you and a guest to our{" "}
                                ...
                                <li>
                                  Entry to a selection of private exhibition
                                  viewings. This gives you the opportunity to
                                  enjoy the exhibitions in a quiet setting
                                  before the Museum opens to the
                                  public.&nbsp;Please email&nbsp;
                                  <a href="/cdn-cgi/l/email-protection#e4948590968b8a97a486968d908d978c899197918189ca8b9683">
                                    <span
                                      className="__cf_email__"
                                      data-cfemail="35455441475a5b467557475c415c465d5840464050581b5a4752"
                                    >
                                      [email&nbsp;protected]
                                    </span>
                                  </a>{" "}
                                  to receive your invitation to upcoming
                                  viewings.
                                </li>
                                <li>
                                  <a href="#content">
                      ...
                      <div>
                        <div>
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-28344-title"
                          >
                            <div className="container">
                              <a className="js-jump-link-anchor" id="content" />{" "}
                              <div className="section__inner">
                                <h2
                                  id="paragraph-28344-title"
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    ...
                                    <h4>Patrons' e-newsletter</h4>
                                    <p>
                                      We send Patrons regular e-newsletters to
                                      update you on upcoming events and
                                      interesting stories from across the
                                      Museum. If you have updated your email
                                      address or you aren't receiving the
                                      e-newsletter please get in touch by
                                      emailing&nbsp;
                                      <a href="/cdn-cgi/l/email-protection#7e0e1f0a0c11100d3e1c0c170a170d16130b0d1b0b1350110c19">
                                        <span
                                          className="__cf_email__"
                                          data-cfemail="26564752544948556644544f524f554e4b535543534b08495441"
                                        >
                                          [email&nbsp;protected]
                                        </span>
                                      </a>
                                    ...
                                    <p>
                                      ...
                                      conservation. The magazine also explores
                                      our exhibitions programme, provides
                                      updates about recent acquisitions and
                                    ...
                                    <p>
                                      ...
                                      collection in person. As a Patron, you can
                                      enjoy exclusive digital content which
                                      brings you closer to the collection and
                                      our current work wherever you are in the
                                      world. Enjoy exclusive Patrons' content
                                      and presentations, both live and with our{" "}
                                      <a href="https://www.youtube.com/playlist?list=PLHcErFdjbqlwD9fPdqS-wtxQ3_bzl_mOA">
                                        past online events
                                      </a>
                                      . We also invite Patrons to enjoy the
                                      Museum's&nbsp;
                                      <a href="http://www.youtube.com/c/britishmuseumevents/videos">
                                        past public events programme
                                      </a>
                                      .
                                    </p>
                                  </div>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-28352-title"
                          >
                            <div className="container">
                              <a
                                className="js-jump-link-anchor"
                                id="how-your-money-helps"
                              />{" "}
                              <div className="section__inner">
                                <h2
                                  id="paragraph-28352-title"
                                  className="section__title section--slice-content__title"
                                >
                                  How your money helps
                                </h2>
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      The generous donations made by our Patrons
                                      provide much-needed support to the Museum,
                                      facilitating the allocation of resources
                                      to the areas most in need. The Museum is
                                      committed to conserving and sharing the
                                      two million years of human history and
                                      culture within its walls; ensuring it
                                      remains a museum of the world for the
                                      world.&nbsp;
                                      <br />
                                      <br />
                                      The Museum is a charity and the vital
                                      donations made by our Patrons go towards
                                      supporting the Museum across many
                                      different areas and making sure that we
                                      are able to remain accessible and open to
                                      public audiences from across the world.
                                      This can include contributing to the care,
                                      preservation and display of the
                                      collection, as well as enabling the Museum
                                      ...
                                      helped fund projects across the Museum,
                                      including:
                                    </p>
                                  </div>
                                </div>
                          ...
                          <section
                            className="listing section--no-keyline-current section--no-keyline-next paragraph paragraph--type--slice-list paragraph--view-mode--default section section--slice-list section--bg-white"
                            aria-labelledby="paragraph-28356-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-28356-title"
                                  className="visually-hidden"
                                >
                                  Projects
                                </h2>
                                <div className="paragraph paragraph--type--list-item paragraph--view-mode--default listing__item">
                                  <div className="listing__intro">
                                  ...
                                  <div className="listing__content-group">
                                    <div className="listing__content wysiwyg">
                                      <h3 className="listing__title">
                                        {" "}
                                        Divine creatures: Egyptian animal
                                        mummies
                                      </h3>
                                      <p>
                                        ...
                                        the practicalities and significance of
                                        this unique ancient Egyptian practice.
                                        <br />
                                        <br />
                                        Beginning in 2022, this project uses the
                                        latest technology&nbsp;(including CT
                                        scanning, isotopic analysis and
                                        radiocarbon dating) to explore the
                                        tradition of embalming animals and
                                        revealing what lies beneath their
                                        wrappings. The work&nbsp;shows how these
                                        animals lived, died and were mummified.
                                        It also considers the human component of
                                        these mummies, looking into religious,
                                        social, economic and practical aspects
                                        of the custom within Egyptian society.
                                      </p>
                                    </div>
                                ...
                                <div className="paragraph paragraph--type--list-item paragraph--view-mode--default listing__item">
                                  ...
                                  <div className="listing__content-group">
                                    <div className="listing__content wysiwyg">
                                      <h3 className="listing__title">
                                        {" "}
                                        Furniture mount in the form of a bust of
                                        Oceanus
                                      </h3>
                                      <p>
                                      ...
                                      <p>
                                        The furniture mount takes the form of
                                        Oceanus, the Titan god of rivers and
                                        water. Its heavy-lidded wide eyes, with
                                        deep recesses for pupils, were likely
                                        originally set with glass or precious
                                        stones. This decorative bust was
                                        acquired alongside a metal plate,
                                        believed to be its mount. Subsequent
                                        work revealing more about the object has
                                        included&nbsp;x-radiography, dirt and
                                        soil removal using a scalpel under
                                        a&nbsp;
                                        <span>
                                          <span>
                                            <span>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-28336-title"
                          >
                            <div className="container">
                              <a
                                className="js-jump-link-anchor"
                              ...
                              <div className="section__inner">
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      Email:{" "}
                                      <a href="/cdn-cgi/l/email-protection#01716075736e6f7241637368756872696c747264746c2f6e7366">
                                        <span
                                          className="__cf_email__"
                                          data-cfemail="53233227213c3d201331213a273a203b3e262036263e7d3c2134"
                                        >
                                          [email&nbsp;protected]
                                        </span>
                                      </a>
