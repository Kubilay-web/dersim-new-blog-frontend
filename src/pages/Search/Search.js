    ...
    <div>
      <div>
        ...
        <meta
          ...
          content="Search the British Museum website."
        />
        ...
        />
        <title>Search | British Museum</title>
        <link rel="preconnect" href="https://googletagmanager.com" />
        <link rel="preconnect" href="https://google-analytics.com" />
        <link
          rel="stylesheet"
          media="all"
          href="/sites/default/files/css/css_VAvkHRcLHSWwq0ovHYJ-IGyjWbQie-FPraftF1kr7dQ.css?delta=0&language=en&theme=numiko&include=eJxtyUEKxCAMQNELWT1THIOGRg2JaentC90Uymz-4n27bGFPGQzD8E77TJVnBt5sXUyjfvWnJMu2hlBQ_88goFAVpFkq6gIcX4k-xDOTNSzhIDwtPY19Fme8AenXOGM"
        />
        <link
          rel="stylesheet"
          media="print"
                          ...
                          <div className="container">
                            <div className="section__inner">
                              <div className="listing-header">
                                ...
                                <div className="listing-header__filter filter"></div>
                              </div>
                            </div>
                          </div>
                        </header>
                            ...
                            <div className="container">
                              <div className="section__inner">
                                <div className="views-element-container">
                                  <div
                                    className="js-view-dom-id-43b7c97eeeebb35d4e75b160e25dd4e9ce2d748810b4fbb1af13f51e8c8dc725 listing listing--search"
                                    data-gtm-vis-recent-on-screen1766321_929={
                                      172
                                    }
                                    data-gtm-vis-first-on-screen1766321_929={
                                      172
                                    }
                                    data-gtm-vis-total-visible-time1766321_929={
                                      100
                                    }
                                    data-gtm-vis-has-fired1766321_929={1}
                                  >
                                    <div className="listing--search__pre-header">
                                      <div data-js-site-search data-v-app>
                                        <form className="views-exposed-form">
                                          <div
                                            className="c-autocomplete"
                                            id="global-keyword-search-results"
                                          >
                            ...
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  ...
                                  >
                                    Looking for an object in the collection?
                                  </h2>
