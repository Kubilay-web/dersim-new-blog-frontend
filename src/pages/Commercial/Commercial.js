...
const Commercial = () => {
  ...
  useEffect(() => {
    ...
    const category1 = `${categoryPrefix}-9`;
  ...
  useEffect(() => {
    ...
    // Kategoriler dil bazında dinamik olarak ayarlanıyor
    const category1 = `${contentPrefix}-content-10`;
    ...
    <div>
      <div>
        ...
        <meta
          ...
          content="Book our unique spaces, explore options for film makers and access high quality images and books."
        />
        <meta
          property="og:image"
              ...
              <main id="main-content" className="js-main">
                <div>
                  <div
                    ...
                    role="article"
                    aria-labelledby="paragraph-6930-title"
                  >
                        ...
                        <div className="hero__controls">
                          <div className="hero__caption | js-hero-caption">
                            <button
                              ...
                              id="hero-image-caption-button-6930"
                              aria-expanded="false"
                              aria-controls="hero-image-caption-content-6930"
                            >
                            ...
                            <div
                              ...
                              id="hero-image-caption-content-6930"
                              aria-hidden="true"
                              aria-labelledby="hero-image-caption-button-6930"
                            >
                              <button
                                type="button"
                                className="hero__caption-content-close | js-hero-caption-btn"
                                id="hero-image-caption-close-button-6930"
                                aria-expanded="false"
                                aria-controls="hero-image-caption-content-6930"
                              >
                                <span className="visually-hidden">
                              ...
                              <p>
                                {" "}
                                An event held in&nbsp;the Egyptian Sculpture
                                Gallery, just one of the many spaces available
                                for hire.
                              </p>
                            </div>
                          </div>
                        ...
                        <div className="section--intro__container">
                          ...
                          <div className="section--intro__content">
                            ...
                            <div className="wysiwyg">
                              <p>
                                There are many ways to collaborate with us: book
                                a unique event space, film at the Museum, use
                                our high-quality images commercially, stock our
                      ...
                      <div>
                        <div>
                          <section
                            ...
                            aria-labelledby="paragraph-6938-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-6938-title"
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  ...
                                                  <div className="teaser__summary">
                                                    The Museum's public
                                                    galleries are complemented
                                                    with a suite of contemporary
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  ...
                                                  <div className="teaser__summary">
                                                    Licensing service offering
                                                    images, videos and 3D data
                                                    of the collection,
                                                    representing world culture
                                                    and history.
                                                  </div>
                                                </div>
                                              </div>
