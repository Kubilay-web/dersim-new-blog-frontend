...
const Contact = () => {
  ...
  useEffect(() => {
    ...
    const category1 = `${contentPrefix}-content-13`;
  ...
  useEffect(() => {
    ...
    // Kategoriler dil bazında dinamik olarak ayarlanıyor
    const accordion1 = `${accordionPrefix}-accordion-8`;
    const accordion2 = `${accordionPrefix}-accordion-21`;
    ...
    <div>
      <div>
        ...
        <meta
          ...
          content="Read our FAQs and if you still have a question, get in touch via our contact us form."
        />
        <meta
          property="og:image"
        ...
        <link
          rel="stylesheet"
          media="all"
          href="css/css__0ynhjt8Rkt7wus3y-ifOnI1d7xLqZ1uqdX86oGcU0A.css"
        />
        <link
          rel="stylesheet"
          media="all"
              ...
              <main id="main-content" className="js-main">
                <div>
                  <div
                    ...
                    role="article"
                    aria-labelledby="paragraph-5941-title"
                  >
                    ...
                    <div className="container">
                      <div className="hero__inner">
                        <div className="hero__content-container">
                          ...
                          {/* <h1 id="paragraph-5941-title" className="hero__title">
                            {" "}
                            Contact us
                          </h1> */}
                        </div>
                        <div className="hero__controls">
                          <div className="hero__caption | js-hero-caption">
                            <button
                              ...
                              id="hero-image-caption-button-5941"
                              aria-expanded="false"
                              aria-controls="hero-image-caption-content-5941"
                            >
                            ...
                            <div
                              ...
                              id="hero-image-caption-content-5941"
                              aria-hidden="true"
                              aria-labelledby="hero-image-caption-button-5941"
                            >
                              <button
                                type="button"
                                className="hero__caption-content-close | js-hero-caption-btn"
                                id="hero-image-caption-close-button-5941"
                                aria-expanded="false"
                                aria-controls="hero-image-caption-content-5941"
                              >
                                <span className="visually-hidden">
                              ...
                              <p> Visitors in Room 95.</p>
                              <a href="/collection/galleries/chinese-ceramics">
                                <span>Room 95</span>
                              </a>
                            </div>
                          </div>
                      ...
                      <div className="section__inner">
                        <div className="section--intro__container">
                          ...
                          <div className="section--intro__content">
                            ...
                            {/* <p className="h3">
                              Take a look at our FAQs for answers to our most
                              common queries, or get in touch using the contact
                              form below.
                            </p> */}
                      ...
                      <div>
                        <div>
                          <section
                            ...
                            aria-labelledby="paragraph-14624-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-14620"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-14620"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                  ...
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-14620"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-14620"
                                  >
                                    <p>
                                    ...
                                    <p>
                                      ...
                                      , both free and paid, which require
                                      booking in advance.
                                    </p>
                                    <p>
                                      In line with current government and NHS
                                      guidance, face masks are not mandatory but
                                      visitors are welcome to wear them if they
                                      wish. The Museum maintains a robust
                                      cleaning schedule and hand sanitiser
                                      stations are available across the
                                      site.&nbsp;
                                    </p>
                                    <p>
                                      For the latest updates about booking
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-14627"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-14627"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                  ...
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-14627"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-14627"
                                  >
                                    <p>
                                      All tickets for the permanent collection
                                      can be&nbsp;
                                      <a
                                      ...
                                      for those who arrive at the Museum without
                                      advance bookings.&nbsp;But this does
                                      depend on capacity, as&nbsp;walk-up entry
                                      cannot be guaranteed. Please speak to
                                      staff on your arrival to enquire about
                                      availability.&nbsp;Find out more on
                                      our&nbsp;
                                      <a
                                        href="/visit"
                                        data-entity-type="node"
                                    ...
                                    <p>
                                      You can book tickets for up to&nbsp;nine
                                      people.
                                    </p>
                                    <p>
                                      Self-led groups of 10 or more people will
                                    ...
                                    <p>
                                      ...
                                      page to see what's on and to book tickets.
                                    </p>
                                    <p>
                                      For access assistance with your booking,
                                      please see our&nbsp;
                                      <a
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-19235"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-19235"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                  ...
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-19235"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-19235"
                                  >
                                    <p>
                                      The Museum is&nbsp;open daily, 10.00–17.00
                                      (last entry at 16.45). On Fridays the
                                      Museum is open until 20.30 (last entry at
                                      20.15). Find out about upcoming&nbsp;
                                      <a
                                    ...
                                    <p>
                                      Special exhibitions will be open Fridays
                                      until 20.30 (last entry at 19.30).&nbsp;
                                    </p>
                                    <p>
                                      The Museum is closed on 24, 25 and 26
                                      December.&nbsp;
                                    </p>
                                  </div>
                                </div>
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-16589"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-16589"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                      ...
                                      <span> What can I bring?</span>
                                    </button>
                                  </h3>
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-16589"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-16589"
                                  >
                                    <p>
                                      All bags, rucksacks, packages and personal
                                      items may be searched before entry
                                      so&nbsp;we suggest allowing extra time for
                                      your visit.
                                    </p>
                                    <p>
                                      ...
                                      Pushchairs are welcome but will need to be
                                      kept with you for the duration of your
                                      visit.
                                    </p>
                                    <p>
                                    ...
                                    <p>
                                      Please don't leave your bags unattended at
                                      any point during your visit.
                                    </p>
                                    <p>
                                      You're welcome to bring food and drink,
                                      but we ask that you don't consume these in
                                      the galleries.
                                    </p>
                                  </div>
                                </div>
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-16590"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-16590"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                  ...
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-16590"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-16590"
                                  >
                                    <p>
                                      View the{" "}
                                      <a
                                      ...
                                      &nbsp;to help navigate the Museum and
                                      explore&nbsp;incredible cultures from
                                      around the world.&nbsp;Discover ancient
                                      Egypt, Assyria and the Mediterranean and
                                      reconnect with objects including the
                                      Rosetta Stone, the treasures of Sutton Hoo
                                      and the Portland Vase.
                                    </p>
                                    <p>
                                      There are also themed object trails to
                                      follow:
                                    </p>
                                    <ul>
                                      <li>
                                        <a
                                          href="/visit/object-trails/one-hour-museum"
                                          data-entity-type="node"
                                          data-entity-uuid="adb77e28-bac1-400e-9ccb-cbbceb8a11ee"
                                      ...
                                      <li>
                                        <a
                                          ...
                                          data-entity-type="node"
                                          data-entity-uuid="401e921c-339f-4104-88e9-3934ded3fda9"
                                      ...
                                      <li>
                                        <a
                                          ...
                                          data-entity-type="node"
                                          data-entity-uuid="e9387daf-24ba-440a-a375-8bb07952a6ad"
                                      ...
                                      <li>
                                        <a
                                          ...
                                          data-entity-type="node"
                                          data-entity-uuid="827f01d0-00dd-4249-a9bf-b349d20ca637"
                                          title="Desire, love, identity: LGBTQ histories"
                                        >
                                          Desire, love, identity: LGBTQ
                                          histories trail
                                        </a>
                                      </li>
                                    </ul>
                                    ...
                                    <ul>
                                      <li>
                                        <a
                                          href="/events/out-hours-tour-introduction-ancient-egypt"
                                          data-entity-type="node"
                                          data-entity-uuid="c97d1420-59ce-425c-8bdf-ebbbd1d25d31"
                                          data-entity-substitution="canonical"
                                          title="Out-of-hours tour: an introduction to ancient Egypt "
                                        >
                                          Out-of-hours: an introduction to
                                          ancient Egypt
                                        </a>
                                      </li>
                                      <li>
                                        <a
                                          href="/events/out-hours-tour-life-and-death-ancient-egypt"
                                          data-entity-type="node"
                                          data-entity-uuid="a715da0c-34d4-4537-9c2a-4b97ad8ee9ec"
                                          data-entity-substitution="canonical"
                                          title="Out-of-hours tour: life and death in ancient Egypt"
                                        >
                                          Out-of-hours: life and death in
                                          ancient Egypt
                                        </a>
                                      </li>
                                      <li>
                                      ...
                                      <li>
                                        ...
                                        <a
                                          href="/events/out-hours-tour-introduction-china"
                                          data-entity-type="node"
                                          data-entity-uuid="61f726c9-3b2f-409b-9c18-7667f12776c5"
                                          data-entity-substitution="canonical"
                                          title="Out-of-hours tour: an introduction to China "
                                        >
                                      ...
                                      <li>
                                        ...
                                        <a
                                          href="/events/out-hours-tour-introduction-ancient-greece"
                                          data-entity-type="node"
                                          data-entity-uuid="695830af-1477-480e-87e9-16b18f64cc9f"
                                          data-entity-substitution="canonical"
                                          title="Out-of-hours tour: an introduction to the ancient Greek world "
                                        >
                                          n introduction to the ancient Greek
                                          world
                                        </a>
                                      </li>
                                      <li>
                                        <a
                                          href="/events/around-world-90-minutes-tour"
                                          data-entity-type="node"
                                          data-entity-uuid="4b155db9-37dc-4124-96d4-4c6086f0915d"
                                          data-entity-substitution="canonical"
                                          title="Around the world in 90 minutes tour"
                                        >
                                      ...
                                      <li>
                                        <a
                                          href="/visit/tours-and-talks/eye-opener-tours"
                                          data-entity-type="node"
                                          data-entity-uuid="7eb8fa84-11b5-4dd7-91e8-a51c06ed0eab"
                                          data-entity-substitution="canonical"
                                          title="Eye-opener tours"
                                        >
                                          Eye-opener tours
                                        </a>
                                      </li>
                                      <li>
                                        <a
                                          href="/visit/tours-and-talks/spotlight-tours"
                                          data-entity-type="node"
                                          data-entity-uuid="d9e67bb4-25b5-44b5-b253-45a2db31e76c"
                                          data-entity-substitution="canonical"
                                          title="Spotlight tours"
                                        >
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-16591"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-16591"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                      ...
                                      <span> What is there for families?</span>
                                    </button>
                                  </h3>
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-16591"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-16591"
                                  >
                                    <p>
                                    ...
                                    <p>
                                      If you're visiting on a weekend head to
                                      the Families Desk and chat to one of our
                                      friendly family facilitators to make the
                                      most of your visit. Make sure to collect a{" "}
                                      <a
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-16592"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-16592"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                      ...
                                      <span>
                                        {" "}
                                        Where can I find advice for disabled
                                        visitors?
                                      </span>
                                    </button>
                                  </h3>
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-16592"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-16592"
                                  >
                                    <p>
                                      For information about facilities for those
                                      with specific access requirements, please
                                      see the&nbsp;
                                      <a
                                        href="/visit/accessibility-museum"
                                        data-entity-type="node"
                                      ...
                                      . This includes how to book parking,
                                      reserve a wheelchair and information on
                                      access.
                                    </p>
                                    <p>
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-19236"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-19236"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                  ...
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-19236"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-19236"
                                  >
                                    <p>
                                      We offer a wide range of food and drink
                                      options, including:&nbsp;
                                    </p>
                                    <ul>
                                      <li>
                                      ...
                                      <li>Montague Café&nbsp;- closed</li>
                                      <li>Coffee Lounge - closed</li>
                                    </ul>
                                    <p>
                                      Visit our&nbsp;
                                      <a
                                      ...
                                      <br />
                                      <br />
                                      You can bring your own food and drink and
                                      can consume it in the Great Court.
                                      Families can bring packed lunches to the
                                      Ford Young Visitors Centre during weekends
                                      and school holidays.&nbsp;
                                    </p>
                                  </div>
                                </div>
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-16593"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-16593"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                      ...
                                      <span> Can I book a school visit?</span>
                                    </button>
                                  </h3>
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-16593"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-16593"
                                  >
                                    <p>
                                      Explore learning opportunities for a range
                                      of ages and educational needs.&nbsp;
                                    </p>
                                    <p>
                                      Plan a{" "}
                                      ...
                                      special exhibitions. Book onto one of our
                                      popular{" "}
                                      <a
                                        href="/learn/schools"
                                        data-entity-type="node"
                                        data-entity-uuid="cf5340e9-975b-46ba-8819-01fecee754c7"
                                        data-entity-substitution="canonical"
                                        title="Schools "
                                      >
                                        school sessions
                                      ...
                                      <a
                                        ...
                                        data-entity-type="node"
                                        data-entity-uuid="bb58a2fc-eeed-4be1-8e74-39e53286bc91"
                                        data-entity-substitution="canonical"
                                        title="Virtual Visits"
                                      >
                                        free live interactive workshop
                                      </a>
                                      .&nbsp;
                                    </p>
                                    <p>
                                      ...
                                      <a
                                        ...
                                        data-entity-type="node"
                                        data-entity-uuid="ce689373-de8a-49db-8bd3-921d2bcc715d"
                                        data-entity-substitution="canonical"
                                        title="Home Educators "
                                      >
                                        Home Education
                                      </a>{" "}
                                      page, for on-site activities, events and
                                      at home resources.&nbsp;Access facilities
                                      on-site and learning opportunities for
                                      SEN. Search our{" "}
                                      <a
                                      ...
                                      page, for inclusive learning
                                      opportunities.
                                    </p>
                                    <p>
                                      Explore our learning and activity
                                      resources on our{" "}
                                      <a
                                        href="/learn/schools"
                                        data-entity-type="node"
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-14629"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-14629"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                      ...
                                      <span>
                                        {" "}
                                        How do I find an object from the
                                        collection?
                                      </span>
                                    </button>
                                  </h3>
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-14629"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-14629"
                                  >
                                    <p>
                                      Search&nbsp;
                                      <a
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-14630"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-14630"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                      ...
                                      <span> How can I identify objects?</span>
                                    </button>
                                  </h3>
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-14630"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-14630"
                                  >
                                    <p>
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-14634"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-14634"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                      ...
                                      <span>
                                        {" "}
                                        How can I contact a department with a
                                        collection or research enquiry?
                                      </span>
                                    </button>
                                  </h3>
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-14634"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-14634"
                                  >
                                    <p>
                                      Please see our&nbsp;
                                      <a
                                        ...
                                        data-entity-type="node"
                                        data-entity-uuid="de957004-9688-4db8-9b1d-0b13ab351b83"
                                        data-entity-substitution="canonical"
                                        title="Departments"
                                      >
                                        Departments page
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-14631"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-14631"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                      ...
                                      <span>
                                        {" "}
                                        Can I use images belonging to the
                                        Museum?
                                      </span>
                                    </button>
                                  </h3>
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-14631"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-14631"
                                  >
                                    <p>
                                      ...
                                      available. Click on the 'Use this image'
                                      link on the bottom right of the page.
                                    </p>
                                    <p>
                                      To request images for publication, or any
                                      commercial use, please visit{" "}
                                      <a href="https://www.bmimages.com/index.asp">
                                        www.bmimages.com
                                      </a>
                                      &nbsp;or contact{" "}
                                      <a href="/cdn-cgi/l/email-protection#7506141910063517181c18141210065b161a18">
                                        <span
                                          className="__cf_email__"
                                          data-cfemail="2e5d4f424b5d6e4c4347434f494b5d004d4143"
                                        >
                                          [email&nbsp;protected]
                                        </span>
                                      </a>
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-14632"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-14632"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                  ...
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-14632"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-14632"
                                  >
                                    <p>
                                      The Museum doesn't accept speculative
                                      applications for jobs, work experience or
                                      internships and is&nbsp;unable to respond
                                      to these requests.
                                    </p>
                                    <p>
                                      ...
                                      and submit your application via the online
                                      recruitment system.
                                    </p>
                                    <p>
                                      ...
                                      <a
                                        ...
                                        data-entity-type="node"
                                        data-entity-uuid="34d3c736-95b7-4e61-aba9-44c1db0dfe98"
                                        data-entity-substitution="canonical"
                                        title="Volunteer"
                                      >
                                        Volunteer page
                          ...
                          <section
                            className="paragraph paragraph--type--slice-form paragraph--view-mode--default section section--form section--bg-black"
                            aria-labelledby="paragraph-5943-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="section--form__outer">
                                  <div className="section--form__container">
                                    <div className="section--form__content">
                                      <h2
                                        id="paragraph-5943-title"
                                        className="visually-hidden"
                                      >
                                        Get in touch
                                      </h2>
                                    ...
                                    <div className="section--form__form">
                                      ...
                                      >
                                        ...
                                        <fieldset
                                          ...
                                          className="webform-email-confirm--wrapper fieldgroup form-composite webform-composite-hidden-title js-webform-type-webform-email-confirm webform-type-webform-email-confirm js-form-item form-item js-form-wrapper form-wrapper webform-type-fieldset--hidden-title"
                                        >
                                          ...
                                          <div className="fieldset-wrapper">
                                            <div className="js-form-item form-item js-form-type-email form-item-confirm-your-email-mail-1 js-form-item-confirm-your-email-mail-1">
                                              <label
                                                htmlFor="edit-confirm-your-email-mail-1"
                                                className="js-form-required form-required"
                                              >
                                                Your email
                                              </label>
                                              <input
                                                data-drupal-selector="edit-confirm-your-email-mail-1"
                                                className="webform-email form-email required"
                                                data-parsley-email-message="Your email does not contain a valid email."
                                                data-parsley-maxlength-message="Your email field has a maximum length of 254."
                                                data-parsley-required-message="Your email field is required."
                                                type="email"
                                                id="edit-confirm-your-email-mail-1"
                                            ...
                                            {/* <div className="js-form-item form-item js-form-type-email form-item-confirm-your-email-mail-2 js-form-item-confirm-your-email-mail-2">
                                              ...
                                              <input
                                                data-drupal-selector="edit-confirm-your-email-mail-2"
                                                className="webform-email-confirm form-email required"
                                                data-parsley-email-message="Confirm your email does not contain a valid email."
                                                data-parsley-maxlength-message="Confirm your email field has a maximum length of 254."
                                                data-parsley-required-message="Confirm your email field is required."
                                                type="email"
                                                id="edit-confirm-your-email-mail-2"
                                                name="confirm_your_email[mail_2]"
                                                defaultValue
                                                size={60}
                                                maxLength={254}
                                                placeholder="Your email address"
                                        ...
                                        {/* <div className="js-form-item form-item js-form-type-select form-item-department js-form-item-department">
                                          ...
                                          <select
                                            data-drupal-selector="edit-department"
                                            data-parsley-required-message="What is your enquiry about? field is required."
                                            id="edit-department"
                                            name="department"
                                          ...
                                          >
                                            ...
                                            <option value="Access (disability, inclusion and equity)">
                                              Access (disability, inclusion and
                                              equity)
                                            </option>
                                            <option value="Adult learning">
                                              Adult learning
                                            </option>
                                            <option value="Conference facilities">
                                              Conference facilities
                                            </option>
                                            <option value="Corporate sponsorship/partnerships">
                                              Corporate sponsorship/partnerships
                                            </option>
                                            <option value="Donations and legacies">
                                              Donations and legacies
                                            </option>
                                            <option value="ESOL (English for Speakers of Other Languages)">
                                            ...
                                            <option value="Freedom of Information/Data Protection Officer">
                                              Freedom of Information/Data
                                              Protection Officer
                                            </option>
                                            <option value="Image licensing">
                                              Image licensing
                                            </option>
                                            <option value="Archives">
                                              Archives
                                            </option>
                                            <option value="Restaurants at the Museum">
                                              Restaurants at the Museum
                                            </option>
                                            <option value="Schools programme">
                                              Schools programme
                                            </option>
                                            <option value="Shop customer services">
                                              Shop customer services
                                            </option>
                                            <option value="Website support">
                                              Website support
                                            </option>
                                            <option value="Museum feedback">
                                              Museum feedback
                                            </option>
                                        ...
                                        {/* <div className="js-form-item form-item js-form-type-textfield form-item-enquiry-title js-form-item-enquiry-title">
                                          ...
                                          <input
                                            data-drupal-selector="edit-enquiry-title"
                                            data-parsley-maxlength-message="Enquiry subject field has a maximum length of 255."
                                            data-parsley-required-message="Enquiry subject field is required."
                                            type="text"
                                            id="edit-enquiry-title"
                                            name="enquiry_title"
                                            defaultValue
                                            size={60}
                                            maxLength={255}
                                            placeholder="A short description of your enquiry"
                                            className="form-text required"
                                            required="required"
                                            aria-required="true"
                                          />
                                        ...
                                        >
                                          ...
                                          <p>
                                            ...
                                            because we need to in order to
                                            provide you with the information you
                                            have requested from us. Your
                                            personal data will only be used by
                                            us to communicate with you about
                                            your request for information and we
                                            will only share it for the purpose
                                            set out above (for example, with the
                                            relevant Museum department involved
                                            in provision of
                                            information).&nbsp;We will keep your
                                            personal data just for as long as we
                                            need it to process your request and
                                            we will delete it following the
                                          ...
                                          <p>
                                            ...
                                            for more details about how we use
                                            your personal data and about your
                                            rights or contact the Museum’s Data
                                            Protection Officer at{" "}
                                            <a href="/cdn-cgi/l/email-protection#4e0d21233e22272f202d2b0e2c3c273a273d26233b3d2b3b2360213c29">
                                              <span
                                                className="__cf_email__"
                                                data-cfemail="c88ba7a5b8a4a1a9a6abad88aabaa1bca1bba0a5bdbbadbda5e6a7baaf"
                                              >
                                                [email&nbsp;protected]
                                              </span>
                                            </a>
                                        ...
                                        >
                                          <legend className="captcha__title js-form-required form-required">
                                            CAPTCHA
                                          </legend>
                                          <div className="captcha__element">
                                            <input
                                              ...
                                              type="hidden"
                                              name="captcha_sid"
                                              defaultValue={5678836}
                                            />
                                            <input
                                              data-drupal-selector="edit-captcha-token"
                                              type="hidden"
                                              name="captcha_token"
                                              defaultValue="H_-Pw4Hawfc8PJTDqIB2S5nLb_NxJnGiidSNWmajLxU"
                                            />
                                            <input
                                              data-drupal-selector="edit-captcha-response"
                                              type="hidden"
                                              name="captcha_response"
                                              defaultValue="Turnstile no captcha"
                                            />
                                            <div
                                              className="cf-turnstile"
                                              data-sitekey="0x4AAAAAAAc20w2go4uyWzEp"
                                              data-theme="dark"
                                              data-size="normal"
                                              data-language="auto"
                                              data-retry="auto"
                                            ...
                                            />
                                            <input
                                              data-drupal-selector="edit-captcha-cacheable"
                                              type="hidden"
                                              name="captcha_cacheable"
                                              defaultValue={1}
                                            />
                                          </div>
                                          <div className="captcha__description description">
                                            This question is for testing whether
                                            or not you are a human visitor and
                                        ...
                                        >
                                          <button
                                            className="webform-button--submit button button--primary js-form-submit form-submit button--chevron"
                                        ...
                                        <input
                                          autoComplete="off"
                                          data-drupal-selector="form-ihhaemktucjyc2kkflyt-n8dhttnekbpvigzk4652h8"
                                          type="hidden"
                                          name="form_build_id"
                                          defaultValue="form-IhhaemKtuCjyc2KKFlyT-n8DhttnekbpvigZk4652H8"
                                        />
                                        <input
                                          data-drupal-selector="edit-webform-submission-contact-us-paragraph-5943-add-form"
                                          type="hidden"
                                          name="form_id"
                                          defaultValue="webform_submission_contact_us_paragraph_5943_add_form"
                                        />
                                        <div
                                        ...
                                        >
                                          {/* <div className="js-form-item form-item js-form-type-textfield form-item-url js-form-item-url">
                                            ...
                                            <input
                                              ...
                                              data-parsley-maxlength-message="Leave this field blank field has a maximum length of 128."
                                              type="text"
                                              id="edit-url"
                                              name="url"
                                              defaultValue
                                    ...
                                    <div className="section--form__image"></div>
                                  </div>
                                </div>
                              </div>
                            </div>
                          ...
                          <section
                            className="accordion section--no-keyline-next js-accordion paragraph paragraph--type--slice-accordion paragraph--view-mode--default section section--slice-accordion section--bg-white"
                            aria-labelledby="paragraph-6000-title"
                          >
                            <div className="container">
                              <a
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-5995"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-5995"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                      ...
                                      <span> Museum switchboard</span>
                                    </button>
                                  </h3>
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-5995"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-5995"
                                  >
                                    <p>Phone: +44 (0)20 7323 8000</p>
                                    <p>
                                      Because our phone lines can be very busy,
                                      we strongly recommend contacting us using
                                      the form&nbsp;above.
                                    </p>
                                  </div>
                                </div>
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-5996"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-5996"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                  ...
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-5996"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-5996"
                                  >
                                    <p>
                                      Email:&nbsp;
                                      <a href="/cdn-cgi/l/email-protection#ee9a878d858b9a9dae8c9c879a879d86839b9d8b9b83c0819c89">
                                        <span
                                          className="__cf_email__"
                                          data-cfemail="cdb9a4aea6a8b9be8dafbfa4b9a4bea5a0b8bea8b8a0e3a2bfaa"
                                        >
                                          [email&nbsp;protected]
                                        </span>
                                      </a>
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-5997"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-5997"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                  ...
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-5997"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-5997"
                                  >
                                    <p>
                                      Email:{" "}
                                      <a href="/cdn-cgi/l/email-protection#4b2d39222e252f380b2939223f223823263e382e3e266524392c">
                                        <span
                                          className="__cf_email__"
                                          data-cfemail="86e0f4efe3e8e2f5c6e4f4eff2eff5eeebf3f5e3f3eba8e9f4e1"
                                        >
                                          [email&nbsp;protected]
                                        </span>
                                      </a>
                          ...
                          <div className="spacer spacer--small-divider" />
                          <section
                            className="listing section--no-keyline-next paragraph paragraph--type--slice-list paragraph--view-mode--default section section--slice-list section--bg-white"
                            aria-labelledby="paragraph-5984-title"
                          >
                            <div className="container">
                              <a
                                className="js-jump-link-anchor"
                              ...
                              <div className="section__inner">
                                <h2
                                  id="paragraph-5984-title"
                                  className="section__title"
                                >
                                  Registered addresses
                                </h2>
                                <div className="paragraph paragraph--type--list-item paragraph--view-mode--default listing__item">
                                  <div className="listing__content-group">
                                    <div className="listing__content wysiwyg">
                                      ...
                                      <p>
                                        ...
                                        Wales (registered number 1079888) having
                                        ...
                                        <br />
                                        <br />
                                        and an exempt charity (by virtue of ss 3
                                        &amp; 96 and Schedule 2 paragraphs (p)
                                        and (w) Charities Act 1993).
                                      </p>
                                      <p>
                                ...
                                <div className="paragraph paragraph--type--list-item paragraph--view-mode--default listing__item">
                                  <div className="listing__content-group">
                                    <div className="listing__content wysiwyg">
                                      ...
                                      <p>
                                        A company incorporated in England and
                                        Wales (registered number 4098945) having
                                        its registered office at:
                                        <br />
                                        <br />
                                        The Dersim Museum
                                ...
                                <div className="paragraph paragraph--type--list-item paragraph--view-mode--default listing__item">
                                  <div className="listing__content-group">
                                    <div className="listing__content wysiwyg">
                                      ...
                                      <p>
                                        A company incorporated in England and
                                        Wales and limited by guarantee (no.
                                        04133346) and a registered charity in
                                        England and Wales (charity no. 1086080)
                                ...
                                <div className="paragraph paragraph--type--list-item paragraph--view-mode--default listing__item">
                                  <div className="listing__content-group">
                                    <div className="listing__content wysiwyg">
                                      ...
                                      <p>
                                        A company incorporated in England and
                                        Wales (registered number 1442912) having
                                        its registered office at:&nbsp;
                                      </p>
                                      <p>
                                        The Dersim Museum&nbsp;
                                ...
                                <div className="paragraph paragraph--type--list-item paragraph--view-mode--default listing__item">
                                  <div className="listing__content-group">
                                    <div className="listing__content wysiwyg">
                                      <h3 className="listing__title">
                                        {" "}
                                        The BMCo Pension Trustee Company Limited
                                      </h3>
                                      <p>
                                        A company incorporated in England and
                                        Wales (registered number 04901380)
                                        having its registered office at:&nbsp;
                                      </p>
                                      <p>
                                        The Dersim Museum&nbsp;
