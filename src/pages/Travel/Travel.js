...
const Travel = () => {
  ...
  useEffect(() => {
    const someContentId = "67af23b58b2864c833c09936";
              ...
              <main id="main-content" className="js-main">
                <div>
                  <div
                    ...
                    role="article"
                    aria-labelledby="paragraph-5937-title"
                  >
                    ...
                    <div className="container">
                      <div className="hero__inner">
                        <div className="hero__content-container">
                          ...
                          {/* <h1 id="paragraph-5937-title" className="hero__title">
                            {" "}
                            Travel trade tours
                          </h1> */}
                        </div>
                        <div className="hero__controls">
                          <div className="hero__caption | js-hero-caption">
                            <button
                              ...
                              id="hero-image-caption-button-5937"
                              aria-expanded="false"
                              aria-controls="hero-image-caption-content-5937"
                            >
                            ...
                            <div
                              ...
                              id="hero-image-caption-content-5937"
                              aria-hidden="true"
                              aria-labelledby="hero-image-caption-button-5937"
                            >
                              <button
                                type="button"
                                className="hero__caption-content-close | js-hero-caption-btn"
                                id="hero-image-caption-close-button-5937"
                                aria-expanded="false"
                                aria-controls="hero-image-caption-content-5937"
                              >
                                <span className="visually-hidden">
                              ...
                              <p> Tour group in the Parthenon gallery</p>
                              <a href="/collection/galleries/greece-parthenon">
                                <span>Greece: Parthenon (Room 18)</span>
                              </a>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="section--intro__container">
                          <div className="section--intro__info">
                            ...
                            <div className="section--intro__info-slices">
                              <div className="paragraph paragraph--type--info-content paragraph--view-mode--default section--intro__info-content wysiwyg">
                                <p>
                                  Email:&nbsp;
                                  <a href="/cdn-cgi/l/email-protection#86f2f4e7f0e3eaf2f4e7e2e3e4e9e9edefe8e1f5c6e4f4eff2eff5eeebf3f5e3f3eba8e9f4e1">
                                    <span
                                      className="__cf_email__"
                                      data-cfemail="bdc9cfdccbd8d1c9cfdcd9d8dfd2d2d6d4d3dacefddfcfd4c9d4ced5d0c8ced8c8d093d2cfda"
                                    >
                                      [email&nbsp;protected]
                                    </span>
                                  </a>
                          ...
                          <div className="section--intro__content">
                            ...
                            <div className="wysiwyg">
                              <p>
                                Whether your clients wish to navigate the
                                history of China, or walk in the footsteps of
                                pharaohs, one of the largest collections
                                dedicated to history, art and culture in
                                existence will be all theirs for the duration of
                                the tour.
                              </p>
                              <p>
                                With so much to discover, your clients are
                                guaranteed an unforgettable experience, with
                      ...
                      <div>
                        <div>
                          <section
                            ...
                            aria-labelledby="paragraph-5965-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-5965-title"
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      Private access for your group only. Tours
                                      currently available:
                                    </p>
                                    <p>
                                      <strong>
                                      ...
                                      the world was understood by Europeans in
                                      the 18th century&nbsp;– tracing the
                                      Museum's founding collection and its
                                      extraordinary journey to the present.
                                    </p>
                                    <p>
                                      <strong>
                                      ...
                                      <br />
                                      Encounter impressive statues of kings and
                                      gods, monumental tomb architecture and
                                      ancient tomb reliefs spanning 3,000 years
                                      – including the colossal bust of Ramesses
                                      II, the Gayer-Anderson Cat and the
                                      world-famous Rosetta Stone.
                                    </p>
                                    <p>
                                      <strong>
                                      ...
                                      <br />
                                      From mummification and preparations for
                                      the afterlife to magic and immortalising
                                      animals, your group will navigate the
                                      fascinating history and significance of
                                      death and the afterlife in ancient Egypt,
                                      from about 2600 BC to AD 200.
                                    </p>
                                    <p>
                                      <strong>China and South Asia</strong>
                                      <br />
                                      In this beautiful gallery, your group will
                                      gain an insight into the development of
                                      these civilisations, from 5000 BC to the
                                      present day. Explore the history of China
                                      and South Asia through a range of
                                      magnificent objects – from Ming Dynasty
                                      porcelain to South Asian sculpture.
                                      <br />
                                      <br />
                                      <strong>Japan</strong>
                                      <br />
                                      From samurai armour to contemporary manga,
                                      explore the expansive history and culture
                                      of Japan in these beautiful galleries,
                                      which showcase one of the most
                                      comprehensive collections of Japanese art
                                      and artefacts outside of Japan.
                                    </p>
                                    <p>
                                      <strong>The ancient Greeks</strong>
                                      <br />
                                      Embark on a journey through ancient Greek
                                      legends, following the famous heroes
                                      Achilles and Herakles, and explore the
                                      spectacular remains of two of the Seven
                                      Wonders of the Ancient World.
                                    </p>
                                    <p>
                                      <strong>Ancient Rome</strong>
                                      <br />
                                      On this tour your group will uncover the
                                      history of ancient Rome and how their
                                      cultural life was influenced by the
                                      ancient Greeks. On your journey you'll
                                      encounter the famous emperors Augustus and
                                      Hadrian, alongside everyday objects
                                      spanning the vast geographical range of
                                      the Roman Empire&nbsp;
                                    </p>
                                    <p>
                                      Please note, as a working museum, tours
                                      are occasionally subject to variation or
                                      cancellation. Some rooms or objects may
                                      not be available on all tours.&nbsp;
                                    </p>
                                    <p>
                                      Further information on the tours above can
                                      be found in the&nbsp;
                                      <strong>
                                        Travel Trade Private Tours brochure
                                        2020:
                                      </strong>
                                    </p>
                                    <p>
                                      <a href="/sites/default/files/2019-11/out-of-hours%20tours-2019_0.pdf">
                                        View the&nbsp;brochure in English
                                      </a>
                                      <br />
                                      <a href="/sites/default/files/2019-10/traveltrade_brochure_japanese_2019.pdf">
                                        View the brochure in Japanese
                                      </a>
                                      <br />
                                      <a href="/sites/default/files/2019-10/traveltrade_brochure_chinese_2019.pdf">
                                        View the&nbsp;brochure in Chinese
                                      </a>
                                    </p>
                                  </div>
                                </div>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-5966-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-5966-title"
                                  className="section__title section--slice-content__title"
                                >
                                  Guiding options
                                </h2>
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      Travel trade companies can bring their own
                                      guide for any of our out-of-hours tours.
                                      Alternatively, during the booking process
                                      we can advise you on booking an accredited
                                      guide for your clients, who regularly
                                      deliver tours of the Museum's collection.
                                    </p>
                                    <p>
                                      If your clients would like to experience
                                      the galleries out of hours without a tour
                                      guide, then you're welcome to book the
                                      space for private access.
                                    </p>
                                  </div>
                                </div>
                              </div>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-5967-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-5967-title"
                                  className="section__title section--slice-content__title"
                                >
                                  Catering
                                </h2>
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      Make your clients' experience even more
                                      memorable with breakfast under the
                                      Museum's iconic glass roof.
                                    </p>
                                    <p>
                                      Choose from an English breakfast or a
                                      selection of pastries, or speak to us
                                      about how we can tailor a menu suited to
                                      your clients'&nbsp;needs.
                                    </p>
                                    <p>
                                      Should your clients wish to extend their
                                      visit, lunch options are available from
                                      11am.
                                    </p>
                                    <p>
                                      <a
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-5970-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-5970-title"
                                  className="section__title section--slice-content__title"
                                >
                                  Book today
                                </h2>
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      Prices vary for booking the Egyptian
                                      sculpture gallery, please phone
                                      us&nbsp;for a quote. For all other spaces
                                      we charge a minimum of £360 for up to 12
                                      people. Additional guests will be charged
                                      £30 each.
                                    </p>
                                    <p>
                                      Our team will be of assistance throughout
                                      your booking, from initial enquiries to
                                      the tour itself.
                                    </p>
                                    <p>
                                      We recommend that bookings are made at the
                                      earliest opportunity. All tours are
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-6920-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-6920-title"
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-9604-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-9604-title"
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  ...
                                                  <div className="teaser__summary">
                                                    Book our unique spaces,
                                                    explore options for film
                                                    makers and access high
                                                    quality images and books.
                                                  </div>
                                                </div>
                                              </div>
                                            </div>
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  ...
                                                  <div className="teaser__summary">
                                                    Plan a visit for a group of
                                                    10 or more people and find
                                                    out about our exclusive
                                                    group tours.
                                                  </div>
                                                </div>
                                              </div>
