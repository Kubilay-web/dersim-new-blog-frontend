    ...
    <div>
      <div>
        ...
        <link
          ...
          sizes="180x180"
          href="/images/Blog/apple-touch-icon.png"
        />
        <link
          rel="icon"
          type="image/png"
          href="/images/Blog/favicon-32x32.png"
          sizes="32x32"
        />
        <link
          rel="icon"
          type="image/png"
          href="/images/Blog/favicon-16x16.png"
          sizes="16x16"
        />
        <link rel="manifest" href="/site.webmanifest" />
        <link
          rel="mask-icon"
          href="/images/Blog/safari-pinned-tab.svg"
          color="#5bbad5"
        />
                ...
                <div className="layout-content">
                  <div>
                    <div id="block-numiko-mainpagecontent">
                      <div>
                        <header className="section section--no-padding-bottom">
                            ...
                            <div className="section__inner">
                              ...
                              <div className="listing-dropdown listing-inline filter">
                                <div
                                  ...
                                  id="block-blogcategory"
                                >
                                  <button
                                    type="button"
                                    className="filters__filter-tab filters__filter-tab--horizontal | js-dropdown-button"
                                    id="dropdown-block-blogcategory"
                                    aria-expanded="false"
                                    aria-controls="dropdown-content-block-blogcategory"
                                  >
                                  ...
                                  <div
                                    ...
                                    aria-hidden="true"
                                    aria-labelledby="dropdown-block-blogcategory"
                                  >
                                    <div className="facets-widget-links">
                                      <ul
                                        data-drupal-facet-id="blog_category"
                            ...
                            <div className="container">
                              <div className="section__inner">
                                <div className="views-element-container">
                                  <div className="js-view-dom-id-cfbea6c4812c66154a512c8912f1747c1d71ffbd37a2246979d8115919ea0356">
                                    <div className="views-element-container">
                                      <div className="section__inner section__inner--border">
                                        <div className="l-grid horizontal l-grid--1-col">
                                          <div className="l-grid__item col-1">
                                            <div className="teaser--featured teaser teaser--has-meta-top">
                                              <div className="teaser__wrapper">
                                                <div className="teaser__image-container">
                                                  <div className="media media-teaser_landscape media-image js-media">
                                                    <img
                                            ...
                                            <div className="teaser__content">
                                              <div className="teaser__content-push">
                                                ...
                                                <div className="teaser__summary">
                                                  ...
                                                  you'd have probably
                                                  encountered the Sogdians. But
                                                  who were these enigmatic
                                                  people?
                                                </div>
                                              </div>
                                              <span className="teaser__button | button button--chevron">
                                            ...
                                            <div className="teaser__content">
                                              <div className="teaser__content-push">
                                                ...
                                                <div className="teaser__summary">
                                                  ...
                                                  parent, or looking for ways to
                                                  explore the history of
                                                  colonialism with young people,
                                                  poetry may be the key.
                                                </div>
                                              </div>
                                              <span className="teaser__button | button button--chevron">
                                                {" "}
                                          ...
                                          <div className="teaser__wrapper">
                                            ...
                                            <div className="teaser__content">
                                              <div className="teaser__content-push">
                                                ...
                                                <h3 className="teaser__title">
                                                  <a
                                                    href="/blog/mowaa-breaking-ground"
                                                    className="teaser__anchor"
                                                  >
                                                    <span>
                                                      <span>
                                                ...
                                                <div className="teaser__summary">
                                                  Excavations in Benin City are
                                                  making way for a museum and
                                                  research institute training
                                                  the next generation of West
                                          ...
                                          <div className="teaser__wrapper">
                                            ...
                                            <div className="teaser__content">
                                              <div className="teaser__content-push">
                                                ...
                                                <div className="teaser__summary">
                                                  Discover key Silk Roads cities
                                                  across Central Asia – and win
                                          ...
                                          <div className="teaser__wrapper">
                                            ...
                                            <div className="teaser__content">
                                              <div className="teaser__content-push">
                                                ...
                                                <h3 className="teaser__title">
                                                  <a
                                                    href="/blog/frightening-fiestas-and-sacred-ceremonies"
                                                    className="teaser__anchor"
                                                  >
                                                    <span>
                                                      <span>
                                                        Frightening fiestas and
                                                        sacred ceremonies
                                                      </span>
                                                    </span>
                                                    {/* Add visually hidden defacer for screen-reader. Use full stops for reader punctuation. */}
                                                ...
                                                <div className="teaser__summary">
                                                  Halloween might feel a long
                                                  way from anything 'spiritual',
                                                  but these festivals show there
                                                  can be meaning in the macabre.
                                                </div>
                                              </div>
                                              <span className="teaser__button | button button--chevron">
                                                {" "}
                                          ...
                                          <div className="teaser__wrapper">
                                            ...
                                            <div className="teaser__content">
                                              <div className="teaser__content-push">
                                                ...
                                                <div className="teaser__summary">
                                                  Look forward to 2024/2025
                                                  exhibitions featuring Japanese
                                                  artist Hiroshige, the art of
                                                  Ancient India and Picasso's
                                          ...
                                          <div className="teaser__wrapper">
                                            ...
                                            <div className="teaser__content">
                                              <div className="teaser__content-push">
                                                ...
                                                <h3 className="teaser__title">
                                                  <a
                                                    href="/blog/one-kind-hirayama-conservation-studio"
                                                    className="teaser__anchor"
                                                  >
                                                    <span>
                                                      <span>
                                                        One of a kind: the
                                                        Hirayama Conservation
                                                        Studio
                                                      </span>
                                                    </span>
                                                    {/* Add visually hidden defacer for screen-reader. Use full stops for reader punctuation. */}
                                                ...
                                                <div className="teaser__summary">
                                                  Step inside the Hirayama
                                                  Studio as it celebrates 30
                                                  years conserving East Asian
                                                  masterpieces on paper and silk
                                                  in a unique space.
                                                </div>
                                              </div>
                                              <span className="teaser__button | button button--chevron">
                                          ...
                                          <div className="teaser__wrapper">
                                            ...
                                            <div className="teaser__content">
                                              <div className="teaser__content-push">
                                                ...
                                                <h3 className="teaser__title">
                                                  <a
                                                    href="/blog/timetable-travellers"
                                                    className="teaser__anchor"
                                                  >
                                                    <span>
                                                      <span>
                                                        Time(table) travellers
                                                      </span>
                                                    </span>
                                                    {/* Add visually hidden defacer for screen-reader. Use full stops for reader punctuation. */}
                                                  </a>
                                                ...
                                                <div className="teaser__summary">
                                                  Missing the summer holidays?
                                                  Tour the world through the
                                                  ages and land back in the
                                                  classroom with a fresh
                                                  perspective.
                                                </div>
                                              </div>
                                              <span className="teaser__button | button button--chevron">
