...
const Membership = () => {
  ...
  useEffect(() => {
    const someContentId = "67b2fb017ffef8be106d2842";

    fetchContentById(someContentId, setContent);
  }, []);

  useEffect(() => {
    const category1 = "Make the most of your Membership";
    ...
    <div>
      <div>
        ...
        <meta
          ...
          content="Become a Member and get closer to the collection."
        />
        <meta
          property="og:image"
              ...
              <main id="main-content" className="js-main">
                <div>
                  <div
                    ...
                    aria-labelledby="paragraph-4830-title"
                  >
                    ...
                    >
                      <source
                        src="media/Membership_Christmas_2024.mp4"
                        type="video/mp4"
                      />
                    </video>
                    <div className="container">
                      <div className="hero__inner">
                        <div className="hero__content-container">
                          ...
                          {/* <h1 id="paragraph-4830-title" className="hero__title">
                            {" "}
                            Membership
                          </h1> */}
                          <a
                            href="#choose-your-membership"
                        ...
                        <div className="hero__controls">
                          <button
                            className="hero__video-control | js-hero-video-control"
                            aria-live="polite"
                          ...
                          <div className="hero__caption">
                            <a
                              href="https://youtu.be/xqy295CWu9Q"
                              className="hero__caption-button"
                            >
                              <svg
                                className="icon icon--audio-description"
                                role="presentation"
                                focusable="false"
                                aria-hidden="true"
                              >
                                <use xlinkHref="#sprite-icon-audio-description" />
                              </svg>
                              <span className="visually-hidden">
                      ...
                      <div className="section__inner">
                        <div className="section--intro__container">
                          ...
                          <div className="section--intro__content">
                            ...
                            {/* <p className="h3">
                              Become a Member today or purchase the perfect
                            ...
                            <div className="wysiwyg">
                              <p>
                                ...
                                give someone special unlimited entry to
                                exhibitions and many more benefits. Start
                                together on a journey of adventure and discovery
                                this Christmas.
                              </p>
                            </div> */}
                          </div>
                      ...
                      <div>
                        <div>
                          ...
                          >
                            <div className="section__inner">
                              <div className="container">
                                <div className="l-grid--5-col">
                                  <div className="icon-block">
                                    <svg
                                      className="icon-block__icon | icon"
                                      aria-hidden="true"
                                      focusable="false"
                                    >
                                      <use xlinkHref="#sprite-icon-ticket" />
                                    </svg>
                                    <p className="icon-block__description">
                                  ...
                                  <div className="icon-block">
                                    <svg
                                      ...
                                      focusable="false"
                                    >
                                      <use xlinkHref="#sprite-icon-tea" />
                                    </svg>
                                    <p className="icon-block__description">
                                      Exclusive Members' space
                                    </p>
                                  </div>
                                  <div className="icon-block">
                                    <svg
                                      ...
                                      focusable="false"
                                    >
                                      <use xlinkHref="#sprite-icon-magazine" />
                                    </svg>
                                    <p className="icon-block__description">
                                      <span className="icon-block__italic">
                                        BM Magazine
                                      </span>{" "}
                                      subscription
                                    </p>
                                  ...
                                  <div className="icon-block">
                                    <svg
                                      ...
                                      focusable="false"
                                    >
                                      <use xlinkHref="#sprite-icon-ten-percent-tag" />
                                    </svg>
                                    <p className="icon-block__description">
                              ...
                              <div className="section__inner">
                                ...
                                <div className="section--slice-quote__container">
                                  <blockquote className="section--slice-quote__quote">
                                    <p>
                                      <em>
                                        Each visit to the Museum is different. I
                                        notice new things every time I return.
                                        Unlimited access to the exhibitions as a
                                        Member is great. I know I can take my
                                        time and even come back for a second (or
                                        third!) look.
                                      </em>
                                    </p>
                                    <cite>Yinsey, Member since 2013</cite>
                                  </blockquote>
                                </div>
                              </div>
                            </div>
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-4844-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-4844-title"
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  ...
                                                  <div className="teaser__summary">
                                                    See every exhibition as many
                                                    times as you want, and
                                                    experience the depth and
                                                    detail of the curators'
                                                    work.
                                                  </div>
                                                </div>
                                              </div>
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  ...
                                                  <div className="teaser__summary">
                                                    ...
                                                    highlight trails and a
                                                    wealth of ideas on what to
                                                    see and do.
                                                  </div>
                                                </div>
                                              </div>
                          ...
                          {/* <section
                            className="paragraph paragraph--type--slice-teaser paragraph--view-mode--default section section--slice-teaser section--z-index-scope section--has-carousel section--bg-white"
                            aria-labelledby="paragraph-4857-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-4857-title"
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  ...
                                                  <div className="teaser__summary">
                                                    ...
                                                    benefits and find out how
                                                    your support is integral to
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  ...
                                                  <div className="teaser__summary">
                                                    ...
                                                    with ease, plus contact
                                                    details for when you need
                                                    more information.
                                                  </div>
                                                </div>
                                              </div>
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  ...
                                                  <div className="teaser__summary">
                                                    10% off purchases in the
                                                    Museum's shops, cafés and
                                                    restaurants.
                                                  </div>
                                                </div>
                                              </div>
                          ...
                          <section
                            aria-labelledby="paragraph-37455-title"
                            className="paragraph paragraph--type--slice-quote paragraph--view-mode--default section section--slice-quote section--bg-white"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-37455-title"
                                  className="visually-hidden"
                                >
                                  Quotes from Members
                                </h2>
                                <div className="section--slice-quote__container">
                                  <blockquote className="section--slice-quote__quote">
                                    <p>
                                      <em>
                                        The ability to share all that the Museum
                                        has to offer with friends and family
                                        gives me great satisfaction. An
                                        experience shared is always better.
                                      </em>
                                    </p>
                                    <cite>Paul, Member since 2013</cite>
                                  </blockquote>
                                </div>
                              </div>
                            </div>
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-5856-title"
                          >
                            <div className="container">
                              <div className="banner__outer">
                                <div className="banner__inner">
                                  ...
                                  <div className="banner__content">
                                    <p>
                                      Sign up and receive emails packed full of
                                      fun activities, information on family
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-5022-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-5022-title"
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      Email:{" "}
                                      <a
                                        href="/cdn-cgi/l/email-protection#9cfaeef5f9f2f8efdcfeeef5e8f5eff4f1e9eff9e9f1b2f3eefb"
