...
const Departments = () => {
  ...
  useEffect(() => {
    ...
    const category1 = `${categoryPrefix}-13`;
    const category2 = `${categoryPrefix}-3`;
  ...
  useEffect(() => {
    ...
    // Kategoriler dil bazında dinamik olarak ayarlanıyor
    const category1 = `${contentPrefix}-content-15`;
              ...
              <main id="main-content" className="js-main">
                <div>
                  <div
                    ...
                    role="article"
                    aria-labelledby="paragraph-8401-title"
                  >
                        ...
                        <div className="section--intro__container">
                          ...
                          <div className="section--intro__content">
                            ...
                            <div className="wysiwyg">
                              <p>
                                The work of our curatorial departments is
                                focused on specific parts of the collection,
                                whereas Collection Care and Scientific Research
                                support work across the Museum. On the
                                department pages, you will find information
                                about:
                              </p>
                              <ul>
                                <li>How you can access the collection</li>
                                <li>Research facilities available to you</li>
                                <li>Department staff</li>
                                <li>Research and collaboration</li>
                                <li>
                                  How we conserve and preserve the collection
                                </li>
                                <li>Publications&nbsp;</li>
                                <li>Exhibitions&nbsp;</li>
                      ...
                      <div>
                        <div>
                          <section
                            ...
                            aria-labelledby="paragraph-8570-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-8570-title"
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  <h3 className="teaser__title">
                                                    <a
                                                      href="/our-work/departments/africa-oceania-and-americas"
                                                      className="teaser__anchor"
                                                    >
                                                      <span>
                                                        <span>
                          ...
                          {/* <section
                            className="paragraph paragraph--type--slice-teaser paragraph--view-mode--default section section--slice-teaser section--z-index-scope section--has-carousel section--bg-white"
                            aria-labelledby="paragraph-8572-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-8572-title"
                                    className="visually-hidden teaser-listing__title"
                                  >
                                    Departments
                                  </h2>
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  ...
                                                  <div className="teaser__summary">
                                                    This department houses one
                                                    of the world's finest
                                                    numismatic collections, from
                                                    the origin of coinage in the
                                                    7th century BC to today.
                                                  </div>
                                                </div>
                                              </div>
                                            </div>
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  ...
                                                  <div className="teaser__summary">
                                                    This department holds one of
                                                    the world's greatest works
                                                    on paper collections, from
                                                    the development of the
                                                    graphic arts in Europe to
                                                    today.
                                                  </div>
                                                </div>
                                              </div>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-teaser paragraph--view-mode--default section section--slice-teaser section--z-index-scope section--has-carousel section--bg-white"
                            aria-labelledby="paragraph-9617-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-9617-title"
                          ...
                          <section
                            className="paragraph paragraph--type--slice-teaser paragraph--view-mode--default section section--slice-teaser section--z-index-scope section--has-carousel section--bg-white"
                            aria-labelledby="paragraph-10938-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-10938-title"
                                    className="section__title teaser-listing__title"
                                  >
