...
const GroupVisit = () => {
  ...
  useEffect(() => {
    ...
    const category1 = `${contentPrefix}-content-27`;
  ...
  useEffect(() => {
    ...
    // Kategoriler dil bazında dinamik olarak ayarlanıyor
    const accordion1 = `${accordionPrefix}-accordion-19`;
    const accordion2 = `${accordionPrefix}-accordion-22`;
    const accordion3 = `${accordionPrefix}-accordion-7`;
    ...
    <div>
      <div>
        ...
        <meta
          ...
          content="Plan a visit for a group of 10 or more people and find out about our exclusive group tours."
        />
        <meta
          property="og:image"
        ...
        <link
          rel="stylesheet"
          media="all"
          href="css/css_beC1W7WKygBwxiCzhlgs5ynAS7LfHVjYhtrCWBT0NB8.css"
        />
        <link
          rel="stylesheet"
          media="all"
              ...
              <main id="main-content" className="js-main">
                <div>
                  <div
                    ...
                    role="article"
                    aria-labelledby="paragraph-730-title"
                  >
                        ...
                        <div className="hero__controls">
                          <div className="hero__caption | js-hero-caption">
                            <button
                              ...
                              id="hero-image-caption-button-730"
                              aria-expanded="false"
                              aria-controls="hero-image-caption-content-730"
                            >
                            ...
                            <div
                              ...
                              id="hero-image-caption-content-730"
                              aria-hidden="true"
                              aria-labelledby="hero-image-caption-button-730"
                            >
                              <button
                                type="button"
                                className="hero__caption-content-close | js-hero-caption-btn"
                                id="hero-image-caption-close-button-730"
                                aria-expanded="false"
                                aria-controls="hero-image-caption-content-730"
                              >
                                <span className="visually-hidden">
                          ...
                          <div className="jump-links">
                            ...
                            >
                              <ul className="jump-links__list" role="list">
                                ...
                                <li className="jump-links__item">
                                  <a
                                    href="#guided-tours-for-groups"
                                    className="jump-links__link"
                                  >
                                    <span>Guided tours for groups</span>
                                  </a>
                                </li>
                                <li className="jump-links__item">
                                  <a
                                ...
                                <li className="jump-links__item">
                                  <a href="#faqs" className="jump-links__link">
                                    <span>FAQs</span>
                                  </a>
                                </li>
                              </ul>
                        ...
                        <div className="section--intro__container">
                            ...
                            <div className="section--intro__info-slices">
                              <div className="intro-link--button paragraph paragraph--type--info-link paragraph--view-mode--default">
                                <a
                                  ...
                                  href="https://ticketing.britishmuseum.org/events?k=group%20bookings"
                                >
                                  <span>Book a self-led group visit</span>
                                </a>
                              </div>
                              <div className="intro-link--link paragraph paragraph--type--info-link paragraph--view-mode--default">
                                ...
                                >
                                  <span>Find out about school visits</span>
                                  <svg
                                    className="icon icon--chevron"
                                    role="presentation"
                                    focusable="false"
                              ...
                              <div className="intro-link--link paragraph paragraph--type--info-link paragraph--view-mode--default">
                                ...
                                >
                                  <span>See our accessibility information</span>
                                  <svg
                                    className="icon icon--chevron"
                                    role="presentation"
                                    focusable="false"
                          ...
                          <div className="section--intro__content">
                            ...
                            <div className="wysiwyg">
                              <ul>
                                <li>
                                  If you plan to attend as a self-led group of
                                  10 people or more, please{" "}
                                ...
                                <li>
                                  ...
                                  &nbsp;in advance to check if any galleries you
                                  plan to visit are closed.
                                </li>
                                <li>
                                  Tour groups are not permitted in Rooms 33,
                                  33a, 33b, 61, 62, 63 and 91a or any
                                  exhibitions.
                                </li>
                                <li>
                                ...
                                <li>
                                  If you're a travel company booking a group
                                  visit, you may be able to offer an exclusive
                                  out-of-hours tour. See our&nbsp;
                                  <a
                                    href="/commercial/travel-trade-tours"
                                    data-entity-type="node"
                                    data-entity-uuid="c49f8bd1-fa1e-4371-b4aa-9d63bdfe6173"
                                  >
                                    Travel trade tours
                                  </a>
                                  &nbsp;section for details.
                                ...
                                <li>
                                  If anyone in&nbsp;your group has accessibility
                                ...
                                <li>
                                  Please make sure you're mindful of other
                                  visitors in the Museum. Don't block exits or
                                  entrances.&nbsp;
                                </li>
                                <li>
                      ...
                      <div>
                        <div>
                          <section
                            ...
                            aria-labelledby="paragraph-9279-title"
                          >
                            <div className="container">
                              <a
                              ...
                              <div className="section__inner">
                                ...
                                <div className="object-embed__container">
                                    ...
                                    <div className="paragraph paragraph--type--embed-google-map paragraph--view-mode--default">
                                      ...
                                      >
                                        ...
                                        <div
                                          ...
                                          id="675c1cba68735"
                                          data-lat="51.520098019979"
                                          data-lng="-0.12828220000006"
                                        ...
                                        >
                                          ...
                                          >
                                            <meta
                                              property="latitude"
                                              content="51.520098019979"
                                            />
                                            <meta
                                              property="longitude"
                                              content="-0.12828220000006"
                                            />
                                          </span>
                                          <h2
                                            ...
                                            property="name"
                                          >
                                            51.520098019979, -0.12828220000006
                                          </h2>
                                        </div>
                                      </div>
                                    </div>
                                  ...
                                  <div className="object-embed__content">
                                    <p>
                                      If you're in a group of 10 or more, you
                                      must use the Montague Place entrance,
                                      which has a dedicated reception and entry
                                      with coach parking nearby and level
                                      access. You can get directions to this
                                      entrance by using the postcode WC1E 7JW.
                                    </p>
                                    <p>
                                      Groups will still need to pass through the
                                      usual security checks when entering the
                                      Museum. Please see the{" "}
                                      <a
                                        href="/visit"
                                        data-entity-type="node"
                                        data-entity-uuid="17ee0511-d112-48d2-b74e-bd44b7549db6"
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-25758-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-25758-title"
                                  className="visually-hidden"
                                >
                                  title
                                </h2>
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-25756"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-25756"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                  ...
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-25756"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-25756"
                                  >
                                    <p>
                                      Coach parties are advised to use the
                                      metered parking on Montague Place, less
                                      than a 30-second walk from the Museum. We
                                      kindly ask coach drivers to turn their
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-25757"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-25757"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                  ...
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-25757"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-25757"
                                  >
                                    <p>
                                      If you're arriving on public transport,
                                      please remember to aim for the Montague
                                      Place entrance at the rear of the Museum.
                                      You can use the postcode&nbsp;WC1E 7JW to
                                      find it.
                                    </p>
                                    <p>
                                      You can find more details about getting
                                      here on public transport on the main{" "}
                                      <a
                                        data-entity-substitution="canonical"
                                        data-entity-type="node"
                                        data-entity-uuid="17ee0511-d112-48d2-b74e-bd44b7549db6"
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-9185-title"
                          >
                            <div className="container">
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-9280-title"
                          >
                            <div className="container">
                              <a
                                className="js-jump-link-anchor"
                                id="guided-tours-for-groups"
                              />{" "}
                              <div className="section__inner">
                                <h2
                                  id="paragraph-9280-title"
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      You can book a number of private guided
                                      tours for groups or individuals, allowing
                                      you to see and learn about the highlights
                                      of the Museum's collection – see below for
                                      details.&nbsp;
                                    </p>
                                    <p>
                                      These tours are for adult audiences and
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-25763-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-25759"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-25759"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                  ...
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-25759"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-25759"
                                  >
                                    <ul>
                                      <li>
                                        Explore some of the most famous objects
                                        on display at the Museum, including the
                                        Rosetta Stone, Lewis Chessmen and the
                                        Parthenon frieze, as well as some
                                        lesser-known but equally fascinating
                                        objects.
                                      </li>
                                      <li>Allow 90 minutes for the tour.</li>
                                      <li>
                                        Please note that this tour involves
                                        visiting a number of galleries on
                                        different floors of the Museum with a
                                        considerable amount of walking.
                                      </li>
                                      <li>
                                        To book, please email&nbsp;
                                        <a
                                          href="/cdn-cgi/l/email-protection#b6d1c4d9c3c6c5f6d4c4dfc2dfc5dedbc3c5d3c3db98d9c4d189c5c3d4dcd3d5c28bf7c4d9c3d8d2938486c2ded3938486c1d9c4dad2938486dfd89384868f86938486dbdfd8c3c2d3c58c938486d1c4d9c3c6938486c2d9c3c4"
                                          data-gc-link="mailto:groups@britishmuseum.org?subject=Around%20the%20world%20in%2090%20minutes:%20group%20tour"
                                        >
                                          <span
                                            className="__cf_email__"
                                            data-cfemail="9ff8edf0eaefecdffdedf6ebf6ecf7f2eaecfaeaf2b1f0edf8"
                                          >
                                            [email&nbsp;protected]
                                          </span>
                                        </a>
                                      ...
                                      <li>
                                        This tour has a minimum cost of £180 for
                                        groups of 15 people or less.
                                      </li>
                                      <li>
                                        For larger groups, there is a charge of
                                        £12 per head.
                                      </li>
                                      <li>
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-25760"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-25760"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                      ...
                                      <span>
                                        {" "}
                                        Enlightenment gallery – one hour
                                      </span>
                                    </button>
                                  </h3>
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-25760"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-25760"
                                  >
                                    <ul>
                                      <li>
                                      ...
                                      <li>
                                        To book, email&nbsp;
                                        <a
                                          href="/cdn-cgi/l/email-protection#fa9d88958f8a89ba9888938e938992978f899f8f97d495889dc5898f98909f998ec7ae929fdfc8cabf9496939d928e9f94979f948edfc8cabd9b96969f8883c0dfc8ca9d88958f8adfc8ca8e958f88"
                                          data-gc-link="mailto:groups@britishmuseum.org?subject=The%20Enlightenment%20Gallery:%20group%20tour"
                                        >
                                          <span
                                            className="__cf_email__"
                                            data-cfemail="5334213c2623201331213a273a203b3e262036263e7d3c2134"
                                          >
                                            [email&nbsp;protected]
                                          </span>
                                        </a>
                                      ...
                                      <li>
                                        This tour has a minimum cost of
                                        £135&nbsp;for groups of 15 people or
                                        less.
                                      </li>
                                      <li>
                                        For larger groups, there is a charge of
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-25761"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-25761"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                      ...
                                      <span> Ancient Egypt – one hour</span>
                                    </button>
                                  </h3>
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-25761"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-25761"
                                  >
                                    <ul>
                                      <li>
                                        Be amazed by the world of ancient Egypt
                                        through monumental stone sculpture,
                                        including the colossal statue of
                                        Ramesses II.
                                      </li>
                                      <li>Allow one hour for the tour.</li>
                                      <li>
                                        To book, email&nbsp;
                                        <a
                                          href="/cdn-cgi/l/email-protection#a3c4d1ccd6d3d0e3c1d1cad7cad0cbced6d0c6d6ce8dccd1c49cd0d6c1c9c6c0d79ee2cdc0cac6cdd783e6c4dad3d79983c4d1ccd6d383d7ccd6d1"
                                          data-gc-link="mailto:groups@britishmuseum.org?subject=The%20Enlightenment%20Gallery:%20group%20tour"
                                        >
                                          <span
                                            className="__cf_email__"
                                            data-cfemail="177065786267645775657e637e647f7a626472627a39786570"
                                          >
                                            [email&nbsp;protected]
                                          </span>
                                        </a>
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-25762"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-25762"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                      ...
                                      <span> Ancient Greece – one hour</span>
                                    </button>
                                  </h3>
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-25762"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-25762"
                                  >
                                    <ul>
                                      <li>
                                        Explore highlights from the classical
                                        Greek world, including statues, painted
                                        pottery and the world-famous Parthenon
                                        frieze.
                                      </li>
                                      <li>Allow one hour for the tour.</li>
                                      <li>
                                        To book, email&nbsp;
                                        <a
                                          href="/cdn-cgi/l/email-protection#80e7f2eff5f0f3c0e2f2e9f4e9f3e8edf5f3e5f5edaeeff2e7bff3f5e2eae5e3f4bdc1eee3e9e5eef4a0c7f2e5e5e3e5baa0e7f2eff5f0a0f4eff5f2"
                                          data-gc-link="mailto:groups@britishmuseum.org?subject=The%20Enlightenment%20Gallery:%20group%20tour"
                                        >
                                          <span
                                            className="__cf_email__"
                                            data-cfemail="2443564b5154576446564d504d574c4951574151490a4b5643"
                                          >
                                            [email&nbsp;protected]
                                          </span>
                                        </a>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-banner paragraph--view-mode--default section section--slice-banner section--maintain-spacer-top section--bg-white banner"
                            aria-labelledby="paragraph-9320-title"
                          >
                            <div className="container">
                              <div className="banner__outer">
                                <div className="banner__inner">
                                  ...
                                  <div className="banner__content">
                                    <p>
                                      We offer several exclusive out-of-hours
                                      tours which can be booked for private
                                      groups.&nbsp;
                                    </p>
                                    <div className="banner__button-container">
                                      <a
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-right section--bg-white"
                            aria-labelledby="paragraph-749-title"
                          >
                            <div className="container">
                              <a
                                className="js-jump-link-anchor"
                              ...
                              <div className="section__inner">
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      Groups are welcome to dine in the Great
                                      Court Restaurant, but we ask that you make
                                      a separate booking for this using the
                                    ...
                                    <p>
                                      ...
                                      &nbsp;for more details about dining at the
                                      Museum.
                                    </p>
                                  </div>
                                </div>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-banner paragraph--view-mode--default section section--slice-banner section--maintain-spacer-top section--bg-white banner"
                            aria-labelledby="paragraph-9188-title"
                          >
                            <div className="container">
                              <div className="banner__outer">
                                <div className="banner__inner">
                                  <div className="banner__title">
                                    <h2
                                      id="paragraph-9188-title"
                                      className="section__title"
                                    >
                                      Souvenir guides for groups
                                    </h2>
                                  </div>
                                  <div className="banner__content">
                                    <p>
                                    ...
                                    <ul>
                                      <li>
                                        Email:{" "}
                                        <a href="/cdn-cgi/l/email-protection#8ffbfdeef9eae3fbfdeeebeaede0e0e4e6e1e8fccfedfde6fbe6fce7e2fafceafae2a1e0fde8">
                                          <span
                                            className="__cf_email__"
                                            data-cfemail="7c080e1d0a1910080e1d18191e13131715121b0f3c1e0e1508150f1411090f19091152130e1b"
                                          >
                                            [email&nbsp;protected]
                                          </span>
                                        </a>
                                      </li>
                                      <li>Phone:&nbsp;+44 (0)20 3073 4970</li>
                                    </ul>
                                  </div>
                                </div>
                              </div>
                          ...
                          <section
                            className="accordion section--no-keyline-next js-accordion paragraph paragraph--type--slice-accordion paragraph--view-mode--default section section--slice-accordion section--bg-white"
                            aria-labelledby="paragraph-25775-title"
                          >
                            <div className="container">
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-25764"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-25764"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                      ...
                                      <span>
                                        {" "}
                                        Can we bring a small group to the Museum
                                        without booking?
                                      </span>
                                    </button>
                                  </h3>
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-25764"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-25764"
                                  >
                                    <ul>
                                      <li>
                                      ...
                                      <li>
                                        Groups with special accessibility
                                        requirements should see the{" "}
                                        <a
                                          href="/visit/accessibility-museum"
                                          data-entity-type="node"
                                          data-entity-uuid="377d1eaf-caa3-4fba-8eeb-7eb62bb562e9"
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-26303"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-26303"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                      ...
                                      <span>
                                        {" "}
                                        Will a fee be charged for group
                                        bookings?
                                      </span>
                                    </button>
                                  </h3>
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-26303"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-26303"
                                  >
                                    <p>
                                      There's no fee for visiting the Museum or
                                      for making a group booking.&nbsp;
                                    </p>
                                    <p>
                                      As the Museum continues to be affected by
                                      the coronavirus pandemic, your support is
                                      vitally important. Donations help support
                                      the work of the Museum from conserving the
                                      collection and funding scientific and
                                      archaeological research, to working with
                                      schools and communities both locally and
                                      across the globe to share the collection
                                      both now and for future generations. Every
                                      donation makes a real difference. If
                                      you're able, please support the Museum
                                      today. Thank you.
                                    </p>
                                  </div>
                                </div>
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-25766"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-25766"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                      ...
                                      <span>
                                        {" "}
                                        Will we be turned away if we haven't
                                        booked?
                                      </span>
                                    </button>
                                  </h3>
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-25766"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-25766"
                                  >
                                    <p>
                                      Tour groups who haven't&nbsp;booked in
                                      advance won't&nbsp;be turned away but may
                                      be denied immediate entry.
                                    </p>
                                  </div>
                                </div>
                                <div
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-25767"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-25767"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                      ...
                                      <span>
                                        {" "}
                                        Can we book without seven days' notice?
                                      </span>
                                    </button>
                                  </h3>
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-25767"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-25767"
                                  >
                                    <ul>
                                      <li>
                                        Tour groups must book their visit at
                                        least seven days in advance.
                                      </li>
                                      <li>
                                        Groups without a booking made at least
                                        seven days in advance may be denied
                                        immediate entry.
                                      </li>
                                    </ul>
                                  </div>
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-25768"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-25768"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                      ...
                                      <span>
                                        {" "}
                                        How important is it to keep to the entry
                                        time?
                                      </span>
                                    </button>
                                  </h3>
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-25768"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-25768"
                                  >
                                    <ul>
                                      <li>
                                        Tour groups should stick to their
                                        booking time wherever possible.
                                      </li>
                                      <li>
                                        The Museum will endeavour to grant
                                        access for late running tour groups but
                                        immediate entry can't be guaranteed.
                                      </li>
                                    </ul>
                                  </div>
                                </div>
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-25769"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-25769"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                      ...
                                      <span>
                                        {" "}
                                        If numbers change after a booking is
                                        made, can the booking be amended?
                                      </span>
                                    </button>
                                  </h3>
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-25769"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-25769"
                                  >
                                    <ul>
                                      <li>
                                        Tour group leaders bringing fewer people
                                        than originally booked are requested to
                                        inform the uniformed member of Museum
                                        staff welcoming groups on arrival.
                                      </li>
                                      <li>
                                        Tour group leaders bringing more people
                                        than originally booked will need to make
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-25770"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-25770"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                      ...
                                      <span>
                                        {" "}
                                        How long can we stay once inside?
                                      </span>
                                    </button>
                                  </h3>
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-25770"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-25770"
                                  >
                                    <ul>
                                      <li>
                                        Tour group bookings are for the arrival
                                        time only.
                                      </li>
                                      <li>
                                        Once inside, there's no limit on the
                                        time tour groups can spend in the
                                        Museum, subject to the Museum's opening
                                        and closing times.
                                      </li>
                                    </ul>
                                  </div>
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-25771"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-25771"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                      ...
                                      <span>
                                        {" "}
                                        Are there any areas where guiding is not
                                        allowed?
                                      </span>
                                    </button>
                                  </h3>
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-25771"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-25771"
                                  >
                                    <p>
                                      Guiding in the following galleries isn't
                                      permitted:
                                    </p>
                                    <ul>
                                      <li>
                                      ...
                                      <li>
                                        <a
                                          ...
                                          data-entity-type="node"
                                          data-entity-uuid="f83be226-dc44-4e10-812e-db5874cbeb10"
                                          data-entity-substitution="canonical"
                                    ...
                                    <p>
                                      ...
                                      regardless of size, will not be permitted
                                      in any exhibitions. See&nbsp;
                                      <a
                                      ...
                                      &nbsp;and our&nbsp;
                                      <a
                                        href="/sites/default/files/2023-11/British_Museum-Visitor_Regulations.pdf"
                                        target="_blank"
                                      >
                                        Visitor regulations
                                      </a>
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-25772"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-25772"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                      ...
                                      <span>
                                        {" "}
                                        What happens if members of our group
                                  ...
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-25772"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-25772"
                                  >
                                    <ul>
                                      <li>
                                        The Montague Place entrance is
                                        accessible to all visitors.
                                      </li>
                                      <li>
                                        Groups using the Disabled Parking
                                        facilities at the front of the Museum
                                        will be permitted to enter via the Main
                                        entrance.
                                      </li>
                                      <li>
                                        More details of the Museum's
                                        accessibility provisions can be found on
                                        the{" "}
                                        <a
                                          href="/visit/accessibility-museum"
                                          data-entity-type="node"
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-25773"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-25773"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                      ...
                                      <span>
                                        {" "}
                                        Can we exit and return through the front
                                        gates at a later time once we have
                                        checked in at the Montague Place
                                        entrance?
                                      </span>
                                    </button>
                                  </h3>
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-25773"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-25773"
                                  >
                                    <p>
                                      All groups arriving at the front gates
                                      will be directed to use the Montague Place
                                      entrance, even if they have already
                                      checked in.
                                    </p>
                                  </div>
                                </div>
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-25774"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-25774"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                      ...
                                      <span> Are school groups included?</span>
                                    </button>
                                  </h3>
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-25774"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-25774"
                                  >
                                    <p>
                                      There's a separate booking process for
                                      school groups. You can find out more about
                                      it on the{" "}
                                      <a
                                        href="/learn/schools/school-visits"
                                        data-entity-type="node"
                          ...
                          <section
                            className="paragraph paragraph--type--slice-banner paragraph--view-mode--default section section--slice-banner section--maintain-spacer-top section--bg-white banner"
                            aria-labelledby="paragraph-7110-title"
                          >
                            <div className="container">
                              <div className="banner__outer">
                                <div className="banner__inner">
                                  ...
                                  <div className="banner__content">
                                    <p>
                                      Enjoy a self-guided tour whenever and
                                      wherever with expert commentaries in five
                                      languages on 250 objects and 65 galleries.
                                    </p>
                                    <div className="banner__button-container">
                                      <a
                                        ...
                                        data-tracking="cta"
                                      >
                                        <span>Discover the Audio app</span>
                                      </a>
                                    </div>
                                  </div>
                                </div>
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-756-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-756-title"
                                              ...
                                              <div className="teaser__image-container">
                                                <div className="media media-teaser_landscape media-image js-media">
                                                  <img
                                                    ...
                                                    width={750}
                                                    height={422}
                                                    src="/images/GroupVisit/image-01.jpg"
                                                  />
                                                </div>
                                              </div>
                                              ...
                                              <div className="teaser__image-container">
                                                <div className="media media-teaser_landscape media-image js-media">
                                                  <img
                                                    ...
                                                    width={750}
                                                    height={422}
                                                    src="/images/GroupVisit/image-02.webp"
                                                  />
                                                </div>
                                              </div>
                                              <div className="teaser__content">
                                              ...
                                              <div className="teaser__image-container">
                                                <div className="media media-teaser_landscape media-image js-media">
                                                  <img
                                                    ...
                                                    width={750}
                                                    height={422}
                                                    src="/images/GroupVisit/image-03.webp"
                                                  />
                                                </div>
                                              </div>
                                              <div className="teaser__content">
                                              ...
                                              <div className="teaser__image-container">
                                                <div className="media media-teaser_landscape media-image js-media">
                                                  <img
                                                    ...
                                                    width={750}
                                                    height={422}
                                                    src="/images/GroupVisit/image-04.jpg"
                                                  />
                                                </div>
                                              </div>
                                              <div className="teaser__content">
