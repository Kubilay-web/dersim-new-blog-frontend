  ...
  return (
    <div>
      <div>
        ...
        <meta
          name="description"
          content="Join classicist and author Bettany Hughes and Silk Roads exhibition co-curator Sue Brunning for this fascinating in-conversation event."
        />
        <link
          rel="canonical"
        ...
        <meta
          property="og:image"
          content="/images/Nexus/Hagia_Sophia_Istanbul_1920x1080_2.jpg"
        />
        ...
        <meta
          name="twitter:title"
          content="Istanbul: nexus on the Silk Roads"
        />
        <meta
          name="twitter:image"
        ...
        <title>Istanbul: nexus on the Silk Roads | British Museum</title>
        ...
        <link
          ...
          sizes="180x180"
          href="/images/Nexus/apple-touch-icon.png"
        />
        <link
          rel="icon"
          type="image/png"
          href="/images/Nexus/favicon-32x32.png"
          sizes="32x32"
        />
        <link
          rel="icon"
          type="image/png"
          href="/images/Nexus/favicon-16x16.png"
          sizes="16x16"
        />
        <link rel="manifest" href="/site.webmanifest" />
        <link
          rel="mask-icon"
          href="/images/Nexus/safari-pinned-tab.svg"
          color="#5bbad5"
        />
            ...
            <div className="layout-container">
              ...
              <main id="main-content" className="js-main">
                  ...
                  <div>
                    <div>
                      <div
                        ...
                        role="article"
                        aria-labelledby="paragraph-42641-title"
                      >
                        <div className="hero__background">
                          <div className="media media-hero media-image js-media">
                            <picture>
                              ...
                              <source
                                srcSet="/images/Nexus/Hagia_Sophia_Istanbul_1920x1080_1.jpg 1x"
                              ...
                              />
                              <source
                                srcSet="/images/Nexus/Hagia_Sophia_Istanbul_1920x1080_2.jpg 1x"
                              ...
                              />
                              <source
                                srcSet="/images/Nexus/Hagia_Sophia_Istanbul_1920x1080_3.jpg 1x"
                              ...
                              <img
                                ...
                                src="/images/Nexus/Hagia_Sophia_Istanbul_1920x1080.jpg"
                        ...
                        <div className="container">
                          <div className="hero__inner">
                            <div className="hero__content-container hero__content-container--boxed ">
                              ...
                              <p className="hero__meta hero__meta--large">
                                Bettany Hughes in conversation
                              </p>
                              <p className="hero__meta">
                                <span>Lectures &amp; discussions</span>/ 8
                                February 2025
                              </p>
                              <div className="hero__button-container">
                                <a
                                  href="https://ticketing.britishmuseum.org/14514"
                              ...
                              <div className="hero__sponsors">
                                <div className="paragraph paragraph--type--sponsor paragraph--view-mode--default hero__sponsor -has-logo">
                                  <p className="hero__meta">Sponsored by</p>
                                    ...
                                    <div style={{ width: "40%" }}>
                                      <div className="media media-embed_no_caption media-image js-media">
                                        <img
                                          ...
                                          srcSet="/images/Nexus/Huo%20logo%20280px%20wide%20reversed%20out_1.png 282w"
                                          sizes="100vw"
                                          width={282}
                                          height={113}
                                          src="/images/Nexus/Huo%20logo%20280px%20wide%20reversed%20out.png"
                                    ...
                                    <div style={{ width: "40%" }}>
                                      <div className="media media-embed_no_caption media-image js-media">
                                        <img
                                          loading="eager"
                                          className="lazyload not-full-width"
                                          srcSet="/images/Nexus/UACF-logo%20white-EN-space3-280px_1.png 280w"
                                          sizes="100vw"
                                          width={280}
                                          height={170}
                                          src="/images/Nexus/UACF-logo%20white-EN-space3-280px.png"
                            ...
                            <div className="hero__controls">
                              <div className="hero__caption | js-hero-caption">
                                <button
                                  ...
                                  id="hero-image-caption-button-42641"
                                  aria-expanded="false"
                                  aria-controls="hero-image-caption-content-42641"
                                >
                                  <span className="visually-hidden">
                                    Show image caption
                                  </span>
                                ...
                                <div
                                  ...
                                  id="hero-image-caption-content-42641"
                                  aria-hidden="true"
                                  aria-labelledby="hero-image-caption-button-42641"
                                >
                                  <button
                                    type="button"
                                    className="hero__caption-content-close | js-hero-caption-btn"
                                    id="hero-image-caption-close-button-42641"
                                    aria-expanded="false"
                                    aria-controls="hero-image-caption-content-42641"
                                  >
                                    <span className="visually-hidden">
                        ...
                        <nav aria-labelledby="system-breadcrumb">
                          ...
                          <ul className="breadcrumb__list">
                            ...
                            <li className="breadcrumb__item breadcrumb__item--link">
                              ...
                              <a href="/events" className="breadcrumb__link">
                                <span>Events</span>
                              </a>
                            </li>
                ...
                <div>
                  ...
                  <section className="section section--intro section--intro-event section--bg-white">
                    <div className="container">
                      <div className="section__inner">
                        <div className="section--intro__container">
                          <div className="section--intro__info">
                            <div className="section--intro__info-slices">
                              ...
                              <div className="paragraph paragraph--type--info-content paragraph--view-mode--default section--intro__info-content">
                                <h3 className="section--intro__info-content-title">
                                  <svg
                                    className="section--intro__icon icon icon--calendar"
                                    role="presentation"
                                    focusable="false"
                                    aria-hidden="true"
                                  >
                              ...
                              <div className="paragraph paragraph--type--info-content paragraph--view-mode--default section--intro__info-content">
                                <h3 className="section--intro__info-content-title">
                                  <svg
                                    className="section--intro__icon icon icon--pin"
                                    role="presentation"
                                    focusable="false"
                                    aria-hidden="true"
                                  >
                              ...
                              <div className="paragraph paragraph--type--info-content paragraph--view-mode--default section--intro__info-content -has-list">
                                <h3 className="section--intro__info-content-title visually-hidden">
                                  Price
                                </h3>
                                <svg
                                  className="section--intro__icon icon icon--ticket"
                                  role="presentation"
                                  focusable="false"
                                  aria-hidden="true"
                                >
                              ...
                              <div className="intro-link--button paragraph paragraph--type--info-link paragraph--view-mode--default">
                                <a
                                  ...
                                  href="https://ticketing.britishmuseum.org/overview/14514"
                                >
                                  <span>Book now</span>
                                </a>
                              </div>
                              <div className="paragraph paragraph--type--info-content paragraph--view-mode--default section--intro__info-content wysiwyg">
                                <p>
                                  <a href="https://emails.britishmuseum.org/k/British-Museum/sign_up_form_from_website_box?_gl=1*5tv4d1*_gcl_aw*R0NMLjE2MzQ3MzMyNzcuQ2p3S0NBandfTDZMQmhCYkVpd0E0YzQ2dW5iZkoya3RMRVhxOE10YWVmZjNySnc1blVDVDNXcjlBbDJrSmF1QzM5U19qWFczVFJUME1Sb0MwTFVRQXZEX0J3RQ..*_ga*NjM0NDUzMDYuMTYwMzQ2OTYzNw..*_ga_08TLB9R8X1*MTYyMTI0MDY4OC4yODUuMC4xNjIxMjQwNjg4LjA.">
                          ...
                          <div className="section--intro__content">
                            <div className="wysiwyg">
                              <h3>
                                Join renowned broadcaster, classicist and author
                                Bettany Hughes and{" "}
                                <a
                                ...
                                exhibition co-curator Sue Brunning for this
                                thought-provoking in-conversation event.
                              </h3>
                              <p>
                                Hughes, author of{" "}
                                <em>Istanbul: a Tale of Three Cities</em> (2017)
                                and Brunning, curator of European Early Medieval
                                and Sutton Hoo Collections will explore this
                                endlessly fascinating, multi-layered city and
                                its role as a meeting place for ideas, religion,
                                philosophy, art and trade on the historic Silk
                                Roads.
                              </p>
                              <p>
                                Byzantium, Constantinople, Istanbul – one city,
                                three names – has stood at the gateway between
                                East and West for millennia, a bridge between
                                continents and cultures. It has served as the
                                capital of the Roman, Byzantine, Latin and
                                Ottoman empires and is one of the world's
                                greatest cities.
                              </p>
                              <p>
                                Many waves of inhabitants include the
                                Phoenicians, Genoese, Venetians, Vikings and{" "}
                                <span>Azerbaijanis</span>, each bringing their
                                cultural and religious ideas to the life of the
                                city. Hughes and Brunning will discuss the
                                importance of Istanbul as a melting pot of ideas
                                and cultures from all along the Silk Roads,
                                meeting and mingling in this vital city. &nbsp;
                              </p>
                              <p>
                                The event concludes with a book-signing session
                                by Hughes, from 12.30<span>–</span>13.00, of{" "}
                                <em>Istanbul: a Tale of Three Cities</em> (2017)
                                and{" "}
                                <em>The Seven Wonders of the Ancient World </em>
                                (2024).
                                <br />
                                <br />
                                <span dir="ltr">
                                  This event is part of the public programme
                                ...
                                >
                                  <em>
                                    <span dir="ltr">Silk Roads</span>
                                  </em>
                                </a>
                                <span dir="ltr">
                                  &nbsp;(open until 23 February).
                                </span>
                              </p>
                              <h3>Booking information</h3>
                              <ul>
                                <li>
                                  <a href="https://ticketing.britishmuseum.org/14514">
                                    <span dir="ltr">Book now</span>
                                  </a>
                                  <span dir="ltr">
                                    {" "}
                                ...
                                <li>
                                  <span dir="ltr">
                                    Concessions include Disabled visitors, job
                                    seekers, seniors (60+) and students. The
                                    event is free for Disabled visitors'
                                    assistants (booking required).
                                  </span>
                                </li>
                                <li>
                                  <span dir="ltr">
                                    Doors to the BP Lecture Theatre will open at
                                    approximately 11.15 for the audience to take
                                    their seats.
                                  </span>
                                </li>
                                <li>
                                  <span dir="ltr">
                                    Please note only bottled water is permitted
                                    in the theatre. No food or other drinks are
                                    allowed.
                                  </span>
                                </li>
                                <li>
                                  <span dir="ltr">
                                    Event ticket holders no longer need to join
                                    queues that develop outside the Museum
                                    gates. Instead, you can go straight to the
                                    front of the queue, show your confirmation
                                    email or paper ticket – and security
                                    colleagues will guide you to the fast-track
                                    lane (leading to the security tent). This
                                    procedure will be in place at both
                                    entrances, but we recommend that you use the
                                    Main entrance on Great Russell Street for
                                    the quickest possible access.
                                  </span>
                                </li>
                                <li>
                                  <span dir="ltr">
                                    Please allow time to go through a security
                                    check, which includes a bag check upon entry
                                    to the Museum.
                                  </span>
                                </li>
                              </ul>
                            </div>
                            <div className="occurrence-list-container | js-accordion">
                              <a
                      ...
                      <div>
                        <div>
                          <section
                            ...
                            aria-labelledby="paragraph-42710-title"
                          >
                            <div className="container">
                              <a
                                className="js-jump-link-anchor"
                                id="about-the-speakers"
                              />{" "}
                              <div className="section__inner">
                                <h2
                                  id="paragraph-42710-title"
                                  className="section__title section--slice-content__title"
                                >
                                  About the speakers
                                </h2>
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg"></div>
                                </div>
                              </div>
                            </div>
                          </section>
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-42712-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-42712-title"
                                  className="visually-hidden section--slice-content__title"
                                >
                                  Prof Bettany Hughes OBE
                                </h2>
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      <strong>Prof Bettany Hughes OBE</strong>{" "}
                                      is an award-winning historian, author and
                                      broadcaster, specialising in ancient and
                                      medieval history and culture. A Scholar at
                                      Oxford University, she has taught at
                                      universities including Oxford, Cambridge,
                                      Bristol, Utrecht and Swansea. Hughes has
                                      published widely, including
                                      <em>
                                        {" "}
                                        Helen of Troy: Goddess, Princess, Whore
                                      </em>{" "}
                                      (2005) which has been translated into 10
                                      languages. Her book{" "}
                                      <em>
                                        Istanbul: A Tale of Three Cities
                                      </em>{" "}
                                      (2017) was shortlisted for the Runciman
                                      Award, was a <em>Sunday Times</em>{" "}
                                      bestseller, and has been translated into
                                      12 languages. She has written and
                                      presented more than 50 TV and radio
                                      documentaries including for the BBC,
                                      Channel 4 and ITV.
                                    </p>
                                  </div>
                                </div>
                                  ...
                                  <div className="paragraph paragraph--type--embedded-media paragraph--view-mode--default">
                                    <figure className="media media-embed media-image js-media">
                                      <img
                                        loading="eager"
                                        className="lazyload not-full-width"
                                        srcSet="/images/Nexus/Bettany-Hughes-250x250_1.jpg 250w"
                                        sizes="100vw"
                                        width={250}
                                        height={250}
                                        src="/images/Nexus/Bettany-Hughes-250x250.jpg"
                                        alt="Prof Bettany Hughes with long brown hair and a pink scarf in front of a turkish flag."
                                      />
                                      <figcaption>
                                        Prof Bettany Hughes OBE
                                      </figcaption>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-42714-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-42714-title"
                                  className="visually-hidden section--slice-content__title"
                                >
                                  Dr Sue Brunning FSA
                                </h2>
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      <strong>Dr Sue Brunning FSA</strong>{" "}
                                      researched her PhD at University College
                                      London. She works as an archaeologist in
                                      Early Medieval material culture. She is
                                      co-curator of the British Museum
                                      exhibition{" "}
                                      <a
                                        href="/exhibitions/silk-roads"
                                        data-entity-type="node"
                                      ...
                                      and is the co-author of the exhibition
                                      catalogue. Brunning is the Curator of
                                      Early Medieval European Collections at the
                                      British Museum and has worked extensively
                                      on the Sutton Hoo collections, being an
                                      expert on Medieval swords. She was an
                                  ...
                                  <div className="paragraph paragraph--type--embedded-media paragraph--view-mode--default">
                                    <figure className="media media-embed media-image js-media">
                                      <img
                                        loading="eager"
                                        className="lazyload not-full-width"
                                        srcSet="/images/Nexus/Sue_Brunning_250_1.jpg 250w"
                                        sizes="100vw"
                                        width={250}
                                        height={250}
                                        src="/images/Nexus/Sue_Brunning_250.jpg"
                                        alt="Headshot of Sue Brunning"
                                      />
                                      <figcaption>Dr Sue Brunning.</figcaption>
                                    </figure>
                                  </div>
                                </aside>
                              </div>
