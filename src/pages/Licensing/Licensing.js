...
const Licensing = () => {
  ...
  useEffect(() => {
    ...
    const category1 = `${categoryPrefix}-47`;
    const category2 = `${categoryPrefix}-28`;
  ...
  useEffect(() => {
    ...
    // Kategoriler dil bazında dinamik olarak ayarlanıyor
    const category1 = `${contentPrefix}-content-18`;
  ...
  return (
    <div>
      <div>
        ...
        <meta
          name="description"
          content="We offer a broad range of commercial opportunities reaching consumers around the world. "
        />
        <link
          rel="canonical"
              ...
              <main id="main-content" className="js-main">
                <div>
                  <div
                    ...
                    role="article"
                    aria-labelledby="paragraph-23855-title"
                  >
                    <div className="hero__background">
                      <div className="media media-hero media-image js-media">
                        <picture>
                          ...
                          <source
                            src="/images/Licensing/image-01.jpg"
                        ...
                        <div className="hero__controls">
                          <div className="hero__caption | js-hero-caption">
                            <button
                              ...
                              id="hero-image-caption-button-23855"
                              aria-expanded="false"
                              aria-controls="hero-image-caption-content-23855"
                            >
                            ...
                            <div
                              ...
                              id="hero-image-caption-content-23855"
                              aria-hidden="true"
                              aria-labelledby="hero-image-caption-button-23855"
                            >
                              <button
                                type="button"
                                className="hero__caption-content-close | js-hero-caption-btn"
                                id="hero-image-caption-close-button-23855"
                                aria-expanded="false"
                                aria-controls="hero-image-caption-content-23855"
                              >
                                <span className="visually-hidden">
                              ...
                              <p>
                                {" "}
                                Katsushika Hokusai (1760–1849), 'Under the wave
                                off Kanagawa' ('The Great Wave') (Thirty-six
                                views of Mt Fuji). Colour woodblock print on
                        ...
                        <div className="section--intro__container">
                            ...
                            <div className="section--intro__info-slices">
                              <div className="paragraph paragraph--type--info-content paragraph--view-mode--default section--intro__info-content wysiwyg">
                                <p>
                                  ...
                                  <br />
                                  Email:&nbsp;
                                  <a href="mailto:productlicensing@britishmuseum.org">
                                    productlicensing@britishmuseum.org
                                  </a>
                                </p>
                              </div>
                            </div>
                          ...
                          <div className="section--intro__content">
                            ...
                            <div className="wysiwyg">
                              <p>
                                Read about our licensing partnering programme,
                      ...
                      <div>
                        <div>
                          <section
                            ...
                            aria-labelledby="paragraph-23849-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-23849-title"
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    ...
                                    <p>
                                      ...
                                      collection and its stories with consumers
                                      and fans worldwide in creative and unique
                                      ways.&nbsp;
                                    </p>
                                    <p>
                                      When partnering with us, you're partnering
                                      with a globally recognised museum. You're
                                      also supporting our work; all profits
                                      return to the Museum so we can continue
                                      preserving and sharing the
                                      collection.&nbsp;
                                    </p>
                                    <h2>Work with us</h2>
                                    <p>
                                      The Museum's licensing programme offers a
                                      strong commercial approach. We work with
                                      partners to deliver sector best practice
                                      commercial support, through collection
                                      consultation, product development and
                                      campaign collaboration and a focus on
                                      delivering best-practice business
                                      efficiencies.
                                    </p>
                                    <p>
                                      Our programme is truly global, available
                                      in Asia, Australasia, North America and
                                      Europe. Our broad range of products span
                                      from fashion and homewares to jewellery
                                      and stationery.
                                    </p>
                                  </div>
                                </div>
                                  ...
                                  <div className="paragraph paragraph--type--embedded-media paragraph--view-mode--default">
                                    <figure className="media media-embed media-image js-media">
                                      <img
                                        ...
                                        width={1600}
                                        height={1066}
                                        src="/images/Licensing/image-02.jpg"
                                        alt="The Great Court and view of Reading Room at the centre."
                                      />
                                      <figcaption>The Great Court.</figcaption>
                                    </figure>
                                  </div>
                                </aside>
                              </div>
                                ...
                                <div className="carousel--gallery__container | js-carousel-container js-carousel-container--gallery">
                                  <div className="carousel__title-container">
                                    <h2
                                      ...
                                      className="section__title"
                                    >
                                      Examples from our product licensing
                                      programme
                                    </h2>
                                    ...
                                    >
                                      ...
                                      >
                                        <button
                                          type="button"
                                          className="carousel--gallery__button | js-photoswipe-item"
                                          data-large-image-url="/images/Licensing/image-03.webp"
                                          data-large-image-width={1280}
                                          data-large-image-height={720}
                                          data-description="LaCollection NFTs"
                                          data-caption
                                          data-lang
                                        >
                                          <span className="visually-hidden">
                                            LaCollection NFTs - opens in a modal
                                        ...
                                        <div className="carousel--gallery__content">
                                          <div className="media media-gallery media-image js-media">
                                            <img
                                              ...
                                              width={1244}
                                              height={700}
                                              src="/images/Licensing/image-03.webp"
                                              data-sizes="auto"
                                              data-focal-position="center center"
                                            />
                                          </div>
                                      ...
                                      >
                                        ...
                                        >
                                          <span className="visually-hidden">
                                            Warehouse fashion - opens in a modal
                                            which shows a larger image and a
                                            caption
                                          </span>
                                        </button>
                                        <div className="carousel--gallery__content">
                                          <div className="media media-gallery media-image js-media">
                                            <img
                                              ...
                                              data-sizes="auto"
                                              data-focal-position="center center"
                                              src="/images/Licensing/image-04.jpg"
                                            />
                                          </div>
                                          <p className="carousel--gallery__item-title">
                                            Warehouse fashion
                                      ...
                                      >
                                        ...
                                        >
                                          <span className="visually-hidden">
                                            Rosland Capital - opens in a modal
                                            which shows a larger image and a
                                            caption
                                          </span>
                                        </button>
                                        <div className="carousel--gallery__content">
                                          <div className="media media-gallery media-image js-media">
                                            <img
                                              ...
                                              data-sizes="auto"
                                              data-focal-position="center center"
                                              src="/images/Licensing/image-05.webp"
                                            />
                                          </div>
                                          <p className="carousel--gallery__item-title">
                                            Rosland Capital
                                      ...
                                      >
                                        ...
                                        >
                                          <span className="visually-hidden">
                                            Onoto pen - opens in a modal which
                                        ...
                                        <div className="carousel--gallery__content">
                                          <div className="media media-gallery media-image js-media">
                                            <img
                                              ...
                                              data-sizes="auto"
                                              data-focal-position="center center"
                                              src="/images/Licensing/image-06.jpg"
                                            />
                                          </div>
                                          <p className="carousel--gallery__item-title">
                                            Onoto pen
                                      ...
                                      >
                                        <button
                                          type="button"
                                          className="carousel--gallery__button | js-photoswipe-item"
                                          data-large-image-url="/images/Licensing/image-07.webp"
                                          data-large-image-width={616}
                                          data-large-image-height={780}
                                          data-description=" "
                                          data-caption
                                          data-lang
                                        >
                                        ...
                                        <div className="carousel--gallery__content">
                                          <div className="media media-gallery media-image js-media">
                                            <img
                                              ...
                                              data-sizes="auto"
                                              data-focal-position="center center"
                                              src="/images/Licensing/image-07.webp"
                                            />
                                          </div>
                                          <p className="carousel--gallery__item-title">
                                            Museums &amp; Galleries notebook
                                        ...
                                        <div className="carousel--gallery__content">
                                          <div className="media media-gallery media-image js-media">
                                            <img
                                              ...
                                              data-sizes="auto"
                                              data-focal-position="center center"
                                              src="/images/Licensing/image-08.webp"
                                              alt="Three candles on a table with a spoon. The candles have illustrations of flowers on them."
                                            />
                                          </div>
                                          <p className="carousel--gallery__item-title">
                                            H&amp;M home
                                      ...
                                      >
                                        ...
                                        >
                                          <span className="visually-hidden">
                                            Alfilo Brands - opens in a modal
                                            which shows a larger image and a
                                            caption
                                          </span>
                                        </button>
                                        <div className="carousel--gallery__content">
                                          <div className="media media-gallery media-image js-media">
                                            <img
                                              ...
                                              width={843}
                                              height={700}
                                              src="/images/Licensing/image-09.webp"
                                              data-sizes="auto"
                                              data-focal-position="center center"
                                            />
                                          </div>
                                      ...
                                      <li className="paragraph paragraph--type--review-item paragraph--view-mode--default l-grid__item swiper-slide review-slice__item">
                                        <div className="review-slice__content review-slice__content--has-quote">
                                          <blockquote className="review-slice__quote">
                                            ...
                                            <cite>
                                              {" "}
                                              Darren Chang, Senior Director –
                                              Museum Relationship &amp; Major
                                              Projects, Alfilo Brands
                                            </cite>
                                          </blockquote>
                                        </div>
                                      </li>
                                        ...
                                        <div className="review-slice__content review-slice__content--has-quote">
                                          <blockquote className="review-slice__quote">
                                            ...
                                            <cite>
                                              ...
                                              Co-founder and CEO, LaCollection
                                            </cite>
                                          </blockquote>
                                        </div>
                                      </li>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-23984-title"
                          >
                            <div className="container">
                              <a
                                className="js-jump-link-anchor"
                                  ...
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      ...
                                      <a
                                        ...
                                        data-entity-uuid="a6c73de7-4e91-4e56-9840-b4e51a522486"
                                        href="/collection/egypt/explore-rosetta-stone"
                                        title="Explore the Rosetta Stone"
                                      >
                                        Rosetta Stone
                                      </a>
                                      , to more{" "}
                                      <a
                                        data-entity-substitution="canonical"
                                        data-entity-type="node"
                                        data-entity-uuid="8484d245-ce6b-4e03-8698-d3578c49cb30"
                                        href="/about-us/british-museum-story/collecting-histories/recent-acquisitions"
                                      ...
                                      <br />
                                      <br />
                                      The Museum houses renowned collections,
                                      including from ancient Egypt and the
                                      ancient Near East, the Classical World,
                                    ...
                                    <p>
                                      The Museum holds the national collection
                                      of Western prints and drawings, in the
                                      same way as the National Gallery and Tate
                                      hold the national collection of paintings.
                                      It's one of the top three collections of
                                      its kind in the world. The collection
                                      ...
                                      collections of historical, satirical and
                                      topographical prints, and important
                                      collections of printed ephemera, such as
                                      trade cards, fans and playing cards.
                                    </p>
                                  </div>
                                </div>
                                <aside className="section--slice-content__embed">
                                  ...
                                  >
                                    ...
                                    >
                                        ...
                                        <div className="carousel--gallery__content">
                                          <div className="media media-gallery media-image js-media">
                                            <img
                                              ...
                                              src="/images/Licensing/image-11.webp"
                                            />
                                          </div>
                                          <p className="carousel--gallery__item-title">
                                            The Lewis Chessmen
                                      ...
                                      >
                                        ...
                                        >
                                          <span className="visually-hidden">
                                            'Pancratium Maritinum' by Mary
                                            Delany - opens in a modal which
                                            shows a larger image and a caption
                                          </span>
                                        </button>
                                        <div className="carousel--gallery__content">
                                          <div className="media media-gallery media-image js-media">
                                            <img
                                              ...
                                              data-sizes="auto"
                                              data-focal-position="center center"
                                              src="/images/Licensing/image-13.webp"
                                            />
                                          </div>
                                          <p className="carousel--gallery__item-title">
                                            'Pancratium Maritinum' by Mary
                                        ...
                                        <div className="carousel--gallery__content">
                                          <div className="media media-gallery media-image js-media">
                                            <img
                                              ...
                                              src="/images/Licensing/image-14.jpg"
                                            />
                                          </div>
                                          <p className="carousel--gallery__item-title">
                                            'Rhinoceros' by Albrecht Dürer
...
"
                                        ...
                                        >
                                          <span className="visually-hidden">
                                            Drawing of a toucan by Maria Sibylla
                                            Merian - opens in a modal which
                                            shows a larger image and a caption
                                          </span>
                                        </button>
                                        <div className="carousel--gallery__content">
                                          <figure className="media media-gallery media-image js-media">
                                            <img
                                              loading="eager"
                                              className="lazyload not-full-width"
                                              width={939}
                                              ...
                                              data-sizes="auto"
                                              data-focal-position="center center"
                                              src="/images/Licensing/image-15.webp"
                                            />
                                ...
                                <div className="banner__inner">
                                  ...
                                  <div className="banner__content">
                                    ...
                                    <div className="banner__button-container">
                                      <a
                                        href="mailto:productlicensing@britishmuseum.org"
                                    ...
                                    <div className="teaser__image-container">
                                      <div className="media media-teaser_landscape media-image js-media">
                                        <img
                                          ...
                                          data-sizes="auto"
                                          data-focal-position="center center"
                                          src="/images/Licensing/image-16.jpg"
                                        />
                                      </div>
                                    </div>
                                    <div className="teaser__content">
                                      <div className="teaser__content-push">
                                        ...
                                        <div className="teaser__summary">
                                          The Museum's public galleries are
                                          complemented with a suite of
                                          contemporary conference facilities.
                                        </div>
                                      </div>
                                    </div>
                                  </div>
                                    ...
                                    <div className="teaser__image-container">
                                      <div className="media media-teaser_landscape media-image js-media">
                                        <img
                                          ...
                                          data-sizes="auto"
                                          data-focal-position="center center"
                                          src="/images/Licensing/image-17.jpg"
                                        />
                                      </div>
                                    </div>
                                    <div className="teaser__content">
                                    ...
                                    <div className="teaser__image-container">
                                      <div className="media media-teaser_landscape media-image js-media">
                                        <img
                                          ...
                                          data-sizes="auto"
                                          data-focal-position="center center"
                                          src="/images/Licensing/image-18.webp"
                                        />
                                      </div>
                                    </div>
                                    <div className="teaser__content">
                                    ...
                                    <div className="teaser__image-container">
                                      <div className="media media-teaser_landscape media-image js-media">
                                        <img
                                          ...
                                          data-sizes="auto"
                                          data-focal-position="center center"
                                          src="/images/Licensing/image-19.jpg"
                                        />
                                      </div>
                                    </div>
                                    <div className="teaser__content">
