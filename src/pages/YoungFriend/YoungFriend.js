...
const YoungFriend = () => {
  ...
  useEffect(() => {
    const someContentId = "67b2fc247ffef8be106d2852";

    fetchContentById(someContentId, setContent);
  }, []);

  useEffect(() => {
    const category1 = "Explore Young Friends";
  ...
  return (
    <div>
      <div>
        ...
        <meta
          name="description"
          content="Young Friend Membership for 8–15 year olds includes discounts shops, cafes and for sleepovers at the Museum, a goodie bag and the official Remus magazine."
        />
        <link
          rel="canonical"
        ...
        <meta
          ...
          content="Get closer to history as a Young Friend subscriber."
        />
        <meta
          property="og:image"
              ...
              <main id="main-content" className="js-main">
                <div>
                  <div
                    ...
                    role="article"
                    aria-labelledby="paragraph-522-title"
                  >
                    ...
                    <div className="container">
                      <div className="hero__inner">
                        <div className="hero__content-container">
                          ...
                          {/* <h1 id="paragraph-522-title" className="hero__title">
                            {" "}
                            Young Friends
                          </h1> */}
                        </div>
                        <div className="hero__controls">
                          <div className="hero__caption | js-hero-caption">
                            <button
                              ...
                              id="hero-image-caption-button-522"
                              aria-expanded="false"
                              aria-controls="hero-image-caption-content-522"
                            >
                            ...
                            <div
                              ...
                              id="hero-image-caption-content-522"
                              aria-hidden="true"
                              aria-labelledby="hero-image-caption-button-522"
                            >
                              <button
                                type="button"
                                className="hero__caption-content-close | js-hero-caption-btn"
                                id="hero-image-caption-close-button-522"
                                aria-expanded="false"
                                aria-controls="hero-image-caption-content-522"
                              >
                                <span className="visually-hidden">
                            ...
                            >
                              <ul className="jump-links__list" role="list">
                                <li className="jump-links__item">
                                  <a
                                    href="#young-friends-content"
                                    className="jump-links__link"
                                  >
                                    <span>Young Friends content</span>
                                  </a>
                                </li>
                                <li className="jump-links__item">
                                  <a
                                    href="#previous-young-friends"
                                    className="jump-links__link"
                                  >
                                    <span>Previous Young Friends</span>
                                  </a>
                                </li>
                                <li className="jump-links__item">
                                  <a
                      ...
                      <div className="section__inner">
                        <div className="section--intro__container">
                          <div className="section--intro__info">
                            ...
                            <div className="section--intro__info-slices">
                              ...
                              <div className="intro-link--link paragraph paragraph--type--info-link paragraph--view-mode--default">
                                ...
                                >
                                  <span>Find out about Museum sleepovers</span>
                                  <svg
                                    className="icon icon--chevron"
                                    role="presentation"
                                    focusable="false"
                          ...
                          <div className="section--intro__content">
                            ...
                            {/* 
                            <p className="h3">
                              Explore two million years of human history
                            </p>
                            <div className="wysiwyg">
                              <p>
                                Our Young Friends scheme is now open to all,
                                free of charge. We are inviting all young people
                                with curious minds to explore the marvels housed
                                within the world's first national public Museum.
                                Founded in 1753, the Museum collection contains
                                millions of objects documenting two million
                                years of world history.
                              </p>
                              <p>
                                The Young Friends scheme offers a fun way for
                                families to explore the collection both at the
                                Museum and from the comfort of your own home.
                                You'll receive the latest news on all family
                                events and activities, as well as access to our
                              ...
                              <ul>
                                <li>
                                  Bi-weekly emails packed full of fun activities
                                  such as trails, quizzes and craft activities.
                                </li>
                                <li>
                                ...
                                <li>
                                  Digital copies of Remus magazine three times a
                                  year and access to the full archive.
                                </li>
                                <li>Access to our activity archive.</li>
                              </ul>
                              <p>
                                The new scheme will be launching on 1 April
                                2023.
                              </p>
                            </div> */}
                          </div>
                      ...
                      <div>
                        <div>
                              ...
                              <div className="section__inner">
                                ...
                                <div className="section--slice-quote__container">
                                  <blockquote className="section--slice-quote__quote">
                                    <p>
                                      <em>
                                        It was really cool to look at artefacts
                                        that were 3,000 years old and imagine
                                        that the mummies were once real humans.
                                        I learnt my name in hieroglyphs and drew
                                        amulets – very fun!
                                      </em>
                                    </p>
                                    <cite>
                                      Eva, aged 12, after a Museum sleepover
                                    </cite>
                                  </blockquote>
                                </div>
                              </div>
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  <h3 className="teaser__title">
                                                    <a
                                                      href="https://ocean.exacteditions.com/magazines/23659/issues"
                                                      className="teaser__anchor"
                                                    >
                                                      <span>
                                                        <span>
                                                  ...
                                                  <div className="teaser__summary">
                                                    With more than 60 magazines
                                                    packed full of fun facts and
                                                    activities, and three new
                                                    issues added each year.
                                                  </div>
                                                </div>
                                              </div>
                                            </div>
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  ...
                                                  <div className="teaser__summary">
                                                    ...
                                                    dark and learn about a
                                                    specially selected
                                                    historical theme through
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  ...
                                                  <div className="teaser__summary">
                                                    Imagine you're an
                                                    archaeologist and discover
                                                    extraordinary Anglo-Saxon
                                                    finery with this Sutton Hoo
                                                    activity trail.
                                                  </div>
                                                </div>
                                              </div>
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-32350-title"
                          >
                            <div className="container">
                              <a
                                className="js-jump-link-anchor"
                                id="previous-young-friends"
                              />{" "}
                              <div className="section__inner">
                                <h2
                                  id="paragraph-32350-title"
                                  className="section__title section--slice-content__title"
                                >
                                  Previous Young Friends Members
                                </h2>
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      If you previously held a Young Friends
                                      Membership, you will have received an
                                      email from us about how to continue with a
                                      free Young Friend subscription. If you
                                      have any queries about the scheme, or did
                                      not receive an email, please contact
                                      Membership Services at{" "}
                                      <a href="/cdn-cgi/l/email-protection#3553475c505b51467557475c415c465d5840465040581b5a4752">
                                        <span
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-8050-title"
                          >
                            <div className="container">
                              <a
                                className="js-jump-link-anchor"
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      Email:{" "}
                                      <a
                                        href="/cdn-cgi/l/email-protection#096f7b606c676d7a496b7b607d607a61647c7a6c7c6427667b6e"
