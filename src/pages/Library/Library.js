...
const Library = () => {
  ...
  useEffect(() => {
    ...
    const category1 = `${contentPrefix}-content-33`;
  ...
  return (
    <div>
      <div>
        ...
        <meta
          name="description"
          content="Our archives date back to 1753 when the Dersim Museum first opened. The Library is open to the public, but you must register first. Find out how to access the Library and Archive and search the library catalogue."
        />
        <link
          rel="canonical"
        ...
        <meta
          ...
          content="Find out how you can access the Museum's Library and Archive."
        />
        <meta
          property="og:image"
        ...
        <title>Library and Archive | Dersim Museum</title>
              ...
              <main id="main-content" className="js-main">
                <div>
                  <div
                    ...
                    role="article"
                    aria-labelledby="paragraph-8156-title"
                  >
                        ...
                        <div className="hero__controls">
                          <div className="hero__caption | js-hero-caption">
                            <button
                              ...
                              id="hero-image-caption-button-8156"
                              aria-expanded="false"
                              aria-controls="hero-image-caption-content-8156"
                            >
                            ...
                            <div
                              ...
                              id="hero-image-caption-content-8156"
                              aria-hidden="true"
                              aria-labelledby="hero-image-caption-button-8156"
                            >
                              <button
                                type="button"
                                className="hero__caption-content-close | js-hero-caption-btn"
                                id="hero-image-caption-close-button-8156"
                                aria-expanded="false"
                                aria-controls="hero-image-caption-content-8156"
                              >
                                <span className="visually-hidden">
                              ...
                              <p>
                                {" "}
                                Deed of bargain and sale of Montagu House, 5
                                April 1755.
                              </p>
                            </div>
                          </div>
                        ...
                        <div className="section--intro__container">
                          <div className="section--intro__info">
                            ...
                            <div className="section--intro__info-slices">
                              ...
                              <div className="paragraph paragraph--type--info-content paragraph--view-mode--default section--intro__info-content wysiwyg">
                                <p>
                                  To request material for your visit, please
                                  write in advance to:
                                </p>
                                <p>
                                  ...
                                  <br />
                                  Email:&nbsp;
                                  <a href="/cdn-cgi/l/email-protection#ea868388988b9893aa8898839e839982879f998f9f87c485988d">
                                    <span
                                      className="__cf_email__"
                                      data-cfemail="0c60656e7e6d7e754c6e7e6578657f6461797f69796122637e6b"
                                    >
                                      [email&nbsp;protected]
                                    </span>
                                  </a>
                                ...
                                <p>
                                  ...
                                  <br />
                                  Email:&nbsp;
                                  <a href="/cdn-cgi/l/email-protection#593a3c372d2b3835382b3a31302f3c193b2b302d302a31342c2a3c2c3477362b3e">
                                    <span
                                      className="__cf_email__"
                                      data-cfemail="b1d0c3d2d9d8c7d4f1d3c3d8c5d8c2d9dcc4c2d4c4dc9fdec3d6"
                                    >
                                      [email&nbsp;protected]
                                    </span>
                                  </a>
                              ...
                              <div className="intro-link--button paragraph paragraph--type--info-link paragraph--view-mode--default">
                                <a
                                  ...
                                  href="https://library.britishmuseum.org/"
                                >
                                  <span>Search the Library Catalogue</span>
                                </a>
                              </div>
                            </div>
                          </div>
                          <div className="section--intro__content">
                            ...
                            <div className="wysiwyg">
                              <h2>Library</h2>
                              <p>
                                The Dersim Museum Library collection includes
                                more than 300,000 volumes dedicated to
                                excellence in the research of human cultures –
                                past and present – across the globe. The
                                collection is in the nine study spaces of
                                Africa, Oceania and the Americas, Asia, Dersim,
                                Europe and Prehistory including Horology, Coins
                                and Medals, Egypt and Sudan, Greece and Rome,
                                Middle East, Prints and Drawings, and
                              ...
                              <ul>
                                <li>
                                  Search the{" "}
                                  <a href="https://library.britishmuseum.org/">
                                    Library Catalogue
                                  </a>
                                  , then send a list of materials you wish to
                                  consult providing author, title, call number
                                  and location details to{" "}
                                  <a href="/cdn-cgi/l/email-protection#b6dadfd4c4d7c4cff6d4c4dfc2dfc5dedbc3c5d3c3db98d9c4d1">
                                    <span
                                      className="__cf_email__"
                                      data-cfemail="fb979299899a8982bb9989928f928893968e889e8e96d594899c"
                                    >
                                      [email&nbsp;protected]
                                    </span>
                                  </a>
                                ...
                                <li>
                                  Please allow two weeks for staff to check your
                                  list, provide research advice and confirmation
                                  of a consultation location and date.
                                </li>
                                <li>
                                  If your research is focused on materials
                                  concentrated in study spaces other than
                                  <span lang="EN-US">
                                    <strong>&nbsp;</strong>the Anthropology
                                    Library and Research Centre (ALRC),
                                  </span>{" "}
                                  staff will make the appropriate appointment
                                  and provide directions to the consultation
                                  space. One month's appointment notice is
                                  required for these study spaces.
                                </li>
                              </ul>
                              <p>
                                <strong>
                              ...
                              <ul>
                                <li>
                                  Upon arriving at the consultation space
                                  complete a library membership form and present
                                  photo identification, for example a passport
                                  or driving license. Food and drink are
                                  prohibited in the study spaces.
                                </li>
                              </ul>
                              <p>
                                The main library reception is in the
                                Anthropology Library and Research Centre (ALRC).
                                The ALRC is the study space for Africa, Oceania
                                and the Americas and holds some of the Library
                                collection. This part of the collection is
                                accessible to walk-in visitors upon
                      ...
                      <div>
                        <div>
                          <section
                            ...
                            aria-labelledby="paragraph-21549-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-21549-title"
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      The Dersim Museum Archive is a unique
                                      record of the Museum's activities since it
                                      was founded in 1753. It preserves the
                                      story of the Museum, the history of the
                                      collection, its collectors and the people
                                      who worked here. The Archive is a resource
                                      for researchers, academics and members of
                                      the public.&nbsp;The Archive is an
                                      essential element in supporting the
                                      ongoing research aims of the Museum and
                                    ...
                                    <ul>
                                      <li>
                                        ...
                                        <ul>
                                          <li>
                                            Email:{" "}
                                            <a href="/cdn-cgi/l/email-protection#f79685949f9e8192b795859e839e849f9a828492829ad9988590">
                                              <span
                                                className="__cf_email__"
                                                data-cfemail="c8abada6bcbaa9a4a9baaba0a1bead88aabaa1bca1bba0a5bdbbadbda5e6a7baaf"
                                              >
                                                [email&nbsp;protected]
                                              </span>
                                            </a>
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-10095-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-10095-title"
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  ...
                                                  <div className="teaser__summary">
                                                    Read about the Museum's
                                                    study rooms and how you can
                                                    access them.
                                                  </div>
                                                </div>
                                              </div>
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  ...
                                                  <div className="teaser__summary">
                                                    Read thought-provoking posts
                                                    from conservators, curators
                                                    and scientists.
                                                  </div>
                                                </div>
                                              </div>
