...
const LearnSchool = () => {
  ...
  useEffect(() => {
    ...
    const category1 = `${categoryPrefix}-22`;
    const category2 = `${categoryPrefix}-56`;
  ...
  useEffect(() => {
    ...
    // Kategoriler dil bazında dinamik olarak ayarlanıyor
    const category1 = `${contentPrefix}-content-43`;
              ...
              <main id="main-content" className="js-main">
                <div>
                  <div
                    ...
                    role="article"
                    aria-labelledby="paragraph-7327-title"
                  >
                            ...
                            >
                              <ul className="jump-links__list" role="list">
                                <li className="jump-links__item">
                                  <a
                                    href="#explore-our-sessions-and-resources"
                                ...
                                <li className="jump-links__item">
                                  <a
                                    href="#visiting-the-museum"
                                    className="jump-links__link"
                                  >
                                    <span>Visiting the Museum</span>
                                  </a>
                                </li>
                              </ul>
                            </div>
                      ...
                      <div>
                        <div>
                          <section
                            ...
                            aria-labelledby="paragraph-9804-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-9804-title"
                                  className="visually-hidden section--slice-content__title"
                                >
                                  We’re delighted to be welcoming back visitors
                                  to the Museum.
                                </h2>
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    ...
                                    <p className="x">
                                      ...
                                      of ages&nbsp;and educational needs. We
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-9510-title"
                          >
                            <div className="container">
                              <a
                                className="js-jump-link-anchor"
                                id="explore-our-sessions-and-resources"
                              />{" "}
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-9510-title"
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  <h3 className="teaser__title">
                                                    <a
                                                      href="/learn/schools/tablet-tours"
                                                      className="teaser__anchor"
                                                    >
                                                      <span>
                                                        <span>
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  ...
                                                  <div className="teaser__summary">
                                                    Take a look at our ages 7–11
                                                    (KS2) schools programme.
                                                  </div>
                                                </div>
                                              </div>
                                            </div>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-teaser paragraph--view-mode--default section section--slice-teaser section--z-index-scope section--has-carousel section--bg-white"
                            aria-labelledby="paragraph-7339-title"
                          >
                            <div className="container">
                              <a
                                className="js-jump-link-anchor"
                                id="visiting-the-museum"
                              />{" "}
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-7339-title"
                                    className="section__title teaser-listing__title"
                                  >
                                    Visiting the Museum
                                  </h2>
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  ...
                                                  <div className="teaser__summary">
                                                    The school's team has a
                                                    strong ethos of offering
                                                    inclusive learning
