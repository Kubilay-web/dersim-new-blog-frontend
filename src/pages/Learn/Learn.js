...
const Learn = () => {
  ...
  useEffect(() => {
    ...
    const category1 = `${categoryPrefix}-36`;
    const category2 = `${categoryPrefix}-20`;
  ...
  useEffect(() => {
    ...
    // Kategoriler dil bazında dinamik olarak ayarlanıyor
    const category1 = `${contentPrefix}-content-31`;
  ...
  return (
    <div>
      <div>
        ...
        <meta
          property="og:image"
          content="images/140-BM_MangaLate-Jul19_3.jpg"
        />
              ...
              <main id="main-content" className="js-main">
                <div>
                  <div
                    ...
                    role="article"
                    aria-labelledby="paragraph-6832-title"
                  >
                    ...
                    <div className="container">
                      <div className="hero__inner">
                        <div className="hero__content-container">
                          ...
                          {/* <h1 id="paragraph-6832-title" className="hero__title">
                            {" "}
                            Learn&nbsp;
                          </h1> */}
                        </div>
                        ...
                        <div className="section--intro__container">
                          ...
                          <div className="section--intro__content">
                            ...
                            {/* <div className="wysiwyg">
                              <p>
                                Discover ancient civilisations, learn from the
                                incredible achievements and challenges of people
                                and societies past and present, and immerse
                                yourself in the culture, languages,
                                environments, people and debates of our
                                ever-changing world.&nbsp;
                              </p>
                              <p>
                                From courses to live music and performance,
                      ...
                      <div>
                        <div>
                          {/* <section
                            ...
                            aria-labelledby="paragraph-8105-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-8105-title"
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  ...
                                                  <div className="teaser__summary">
                                                    Organise a school visit and
                                                    find inspiring classroom
                                                    resources that will bring
                                                    history to life.
                                                  </div>
                                                </div>
                                              </div>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-teaser paragraph--view-mode--default section section--slice-teaser section--z-index-scope section--has-carousel section--bg-white"
                            aria-labelledby="paragraph-12368-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-12368-title"
                                    className="visually-hidden teaser-listing__title"
                                  >
                                    Learn more
                                  </h2>
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-8127-title"
                          >
                            <div className="container">
                              <div className="banner__outer">
                                <div className="banner__inner">
                                  ...
                                  <div className="banner__content">
                                    <p>
                                      To hear about our latest learning events
                                      and news via email, sign up to our mailing
                                      list.&nbsp;
                                    </p>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-teaser paragraph--view-mode--default section section--slice-teaser section--z-index-scope section--has-carousel section--bg-white"
                            aria-labelledby="paragraph-8126-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-8126-title"
