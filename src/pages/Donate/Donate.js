...
const Donate = () => {
  ...
  useEffect(() => {
    const someContentId = "67b30b867ffef8be106d2903";

    fetchContentById(someContentId, setContent);
  }, []);

  useEffect(() => {
    const category1 = "Other ways to support";
              ...
              <main id="main-content" className="js-main">
                <div>
                  <div
                    ...
                    role="article"
                    aria-labelledby="paragraph-13275-title"
                  >
                        ...
                        <div className="hero__controls">
                          <div className="hero__caption | js-hero-caption">
                            <button
                              ...
                              id="hero-image-caption-button-13275"
                              aria-expanded="false"
                              aria-controls="hero-image-caption-content-13275"
                            >
                            ...
                            <div
                              ...
                              id="hero-image-caption-content-13275"
                              aria-hidden="true"
                              aria-labelledby="hero-image-caption-button-13275"
                            >
                              <button
                                type="button"
                                className="hero__caption-content-close | js-hero-caption-btn"
                                id="hero-image-caption-close-button-13275"
                                aria-expanded="false"
                                aria-controls="hero-image-caption-content-13275"
                              >
                                <span className="visually-hidden">
                              ...
                              <p>
                                {" "}
                                Visitor&nbsp;by Neo-Assyrian relief sculpture
                      ...
                      <div className="section__inner">
                        <div className="section--intro__container">
                            ...
                            <div className="section--intro__info-slices">
                              <div className="paragraph paragraph--type--info-content paragraph--view-mode--default section--intro__info-content wysiwyg">
                                <p>
                                  ...
                                  <br />
                                  Email:&nbsp;
                                  <a href="/cdn-cgi/l/email-protection#76121300131a19061b1318023614041f021f051e1b030513031b58190411">
                                    <span
                          ...
                          <div className="section--intro__content">
                            ...
                            {/* <p className="h3">
                              Support two million years of global history and
                              culture.
                            </p>
                            <div className="wysiwyg">
                              ...
                              <p>
                                As a charity the Museum relies on donations.
                                Gifts support the care, preservation and display
                                of the collection, and make the inspirational
                                work of our curators, conservators, scientists
                                and educators possible.
                              </p>
                              <p>
                                Large or small, every donation helps secure the
                                future of the collection. We are truly grateful
                                for your support.
                              </p>
                            </div> */}
                          </div>
                      ...
                      <div>
                        <div>
                          <section
                            ...
                            aria-labelledby="paragraph-35463-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-35463-title"
                                ...
                                <aside className="section--slice-content__embed">
                                  <div className="paragraph paragraph--type--embedded-media paragraph--view-mode--default">
                                    <figure className="media media-embed media-image js-media">
                                      ...
                                      />
                                      <figcaption>
                                        Collection Care student takes a dust
                                        sample from the base of the totem pole
                                        in the Great Court.
                                      </figcaption>
                                    </figure>
                                  </div>
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-35464-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-35464-title"
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <h3>Caring for the collection</h3>
                                    <p>
                                      Conserving the eight million objects at
                                      the Museum is an ongoing and vital part of
                                      the Museum's work – and donations help
                                      safeguard the collection for future
                                      generations.
                                    </p>
                                  </div>
                                </div>
                                <aside className="section--slice-content__embed">
                                  <div className="paragraph paragraph--type--embedded-media paragraph--view-mode--default">
                                    <figure className="media media-embed media-image js-media">
                                      ...
                                      />
                                      <figcaption>
                                        Conservator working on the lid of an
                                        ancient Egyptian coffin of Muthotep.
                                      </figcaption>
                                    </figure>
                                  </div>
                                </aside>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-35467-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-35467-title"
                                  className="visually-hidden section--slice-content__title"
                                >
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    ...
                                    <p>
                                      From loaning objects to museums nationwide
                                      to community outreach and from relaxed
                                      events for the learning disabled to free
                                      family activities, donations help us to
                                      share the Collection with more people, in
                                      more ways.
                                    </p>
                                  </div>
                                </div>
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-13286-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-13286-title"
                                  className="visually-hidden"
                                >
                                  Supporter messages
                                </h2>
                                              ...
                                              <span lang="EN-GB">
                                                <span>
                                                  <span>
                                                    <span>
                                                      <span>
                                                        I support the Museum as
                                                        I value greatly its
                                                        collections, ethos of
                                                        operating, and free
                                                        access to anyone wishing
                                                        to visit, either in
                                                        person or online. I
                                                        particularly enjoy the
                                                        art works and
                                                        exhibitions and have
                                                        spent many inspiring
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-13282-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-13282-title"
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  ...
                                                  <div className="teaser__summary">
                                                    Able to donate £69 or more?
                                                    Support the work of the
                                                    Museum while enjoying
                                                    Membership benefits.
                                                  </div>
                                                </div>
                                              </div>
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  ...
                                                  <div className="teaser__summary">
                                                    ...
                                                    you can make as a Patron,
                                                    and become more involved in
                                                    the life and evolution of
                                                    the Museum.
                                                  </div>
                                                </div>
                                              </div>
