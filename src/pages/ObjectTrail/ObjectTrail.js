...
const ObjectTrail = () => {
  ...
  useEffect(() => {
    ...
    const category1 = `${categoryPrefix}-55`;
  ...
  useEffect(() => {
    ...
    // Kategoriler dil bazında dinamik olarak ayarlanıyor
    const category1 = `${contentPrefix}-content-37`;
              ...
              <main id="main-content" className="js-main">
                <div>
                  <div
                    ...
                    role="article"
                    aria-labelledby="paragraph-7711-title"
                  >
                    ...
                    <div className="container">
                      <div className="hero__inner">
                        <div className="hero__content-container">
                          ...
                          {/* <h1 id="paragraph-7711-title" className="hero__title">
                            {" "}
                            Object trails
                          </h1> */}
                        </div>
                        <div className="hero__controls">
                          <div className="hero__caption | js-hero-caption">
                            <button
                              ...
                              id="hero-image-caption-button-7711"
                              aria-expanded="false"
                              aria-controls="hero-image-caption-content-7711"
                            >
                            ...
                            <div
                              ...
                              id="hero-image-caption-content-7711"
                              aria-hidden="true"
                              aria-labelledby="hero-image-caption-button-7711"
                            >
                              <button
                                type="button"
                                className="hero__caption-content-close | js-hero-caption-btn"
                                id="hero-image-caption-close-button-7711"
                                aria-expanded="false"
                                aria-controls="hero-image-caption-content-7711"
                              >
                                <span className="visually-hidden">
                      ...
                      <div className="section__inner">
                        <div className="section--intro__container">
                          ...
                          <div className="section--intro__content">
                            ...
                            {/* <p className="h3">
                              Choose from a selection of object trails around
                              the Museum.
                            </p>
                            <div className="wysiwyg">
                              <p>
                                Our trails will take you on fascinating tours,
                                highlighting the most popular objects on display
                                and covering a variety of themes.
                              </p>
                              <p>
                                Please note a small number of galleries remain
                                closed and you will not be able to view objects
                                within them.
                              </p>
                            </div> */}
                          </div>
                      ...
                      <div>
                        <div>
                          <section
                            ...
                            aria-labelledby="paragraph-7713-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-7713-title"
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  <h3 className="teaser__title">
                                                    <a
                                                      href="/visit/object-trails/three-hours-museum"
                                                      className="teaser__anchor"
                                                    >
                                                      <span>
                                                        <span>
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  <h3 className="teaser__title">
                                                    <a
                                                      href="/visit/object-trails/tutankhamun-ancient-and-modern-perspectives"
                                                      className="teaser__anchor"
                                                    >
                                                      <span>
                                                        <span>
                          ...
                          {/* <section
                            className="paragraph paragraph--type--slice-teaser paragraph--view-mode--default section section--slice-teaser section--z-index-scope section--has-carousel section--bg-white"
                            aria-labelledby="paragraph-9404-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-9404-title"
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  ...
                                                  <div className="teaser__summary">
                                                    Trails that highlight
                                                    objects that have a
                                                    connection with LGBTQ
                                                    history
                                                  </div>
                                                </div>
                                              </div>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-teaser paragraph--view-mode--default section section--slice-teaser section--z-index-scope section--has-carousel section--bg-white"
                            aria-labelledby="paragraph-9492-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-9492-title"
                                    className="section__title teaser-listing__title"
                                  >
