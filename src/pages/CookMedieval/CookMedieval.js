  ...
  return (
    <div>
      <div>
        ...
        <meta
          name="description"
          content="Whip up a medieval feast with 11 recipes from the Middle Ages. Meat, vegetarian or vegan - we've got you covered!"
        />
        <link
          rel="canonical"
        ...
        <meta
          property="og:title"
          content="How to cook a medieval feast: 11 recipes from the Middle Ages"
        />
        <meta
              ...
              <main id="main-content" className="js-main">
                <div>
                  <div
                    ...
                    role="article"
                    aria-labelledby="paragraph-28150-title"
                  >
                    ...
                    <div className="container">
                      <div className="hero__inner">
                        <div className="hero__content-container">
                          <h1
                            id="paragraph-28150-title"
                            className="hero__title hero__title--small"
                          >
                            {" "}
                            How to cook a medieval feast: 11 recipes from the
                            Middle Ages
                          </h1>
                        </div>
                        <div className="hero__controls">
                          <div className="hero__caption | js-hero-caption">
                            <button
                              ...
                              id="hero-image-caption-button-28150"
                              aria-expanded="false"
                              aria-controls="hero-image-caption-content-28150"
                            >
                            ...
                            <div
                              ...
                              id="hero-image-caption-content-28150"
                              aria-hidden="true"
                              aria-labelledby="hero-image-caption-button-28150"
                            >
                              <button
                                type="button"
                                className="hero__caption-content-close | js-hero-caption-btn"
                                id="hero-image-caption-close-button-28150"
                                aria-expanded="false"
                                aria-controls="hero-image-caption-content-28150"
                              >
                                <span className="visually-hidden">
                          ...
                          <ul className="breadcrumb__list">
                            ...
                            <li className="breadcrumb__item breadcrumb__item--current">
                              ...
                              <a
                                ...
                                aria-current="page"
                              >
                                How to cook a medieval feast: 11 recipes from
                                the Middle Ages
                              </a>
                            </li>
                          </ul>
                      ...
                      <div className="section__inner">
                        <div className="section--intro__container">
                            ...
                            <div className="section--intro__info-slices section--intro__info-slices-no-title">
                              <div className="paragraph paragraph--type--info-author paragraph--view-mode--default section--intro__info-author">
                                <div className="author__item_wrapper">
                                  <p className="paragraph paragraph--type--info-author paragraph--view-mode--default section--intro__info-author"></p>
                                  <div>Publication date: 16 December 2020</div>
                                </div>
                              </div>
                            </div>
                          </div>
                          <div className="section--intro__content">
                            <p className="h3">
                              Looking for an alternative Christmas dinner? Whip
                              up a medieval feast with 11 recipes from the
                              Middle Ages.
                            </p>
                      ...
                      <div>
                        <div>
                          <section
                            ...
                            aria-labelledby="paragraph-27392-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-27392-title"
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      Food has been central to the social life
                                      of humans for thousands of years and, in
                                      medieval Europe, food consumption ranged
                                      from everyday sustenance to extravagant
                                      feasts.
                                    </p>
                                    <p>
                                      The diet of the rich and poor was very
                                      different. While the upper classes and
                                      their households enjoyed fresh and
                                      imported foods, the rest of the population
                                      had to live off what the local land could
                                      produce which, at the end of winter or in
                                      times of shortage, might be very little!
                                    </p>
                                    <p>
                                      Diet wasn't just affected by the seasons,
                                      religion also played a part in what people
                                      ate. Fridays (and, in the earlier period,
                                      Wednesdays and Saturdays) were obligatory
                                      weekly fasting or 'fysshe' days, when it
                                      was prohibited to eat meat. There were
                                      also annual fasts such as Rogation Days,
                                      Advent and Lent, which restricted diets.
                                      Medieval cooks invented creative recipes
                                      for wealthy diners during fast periods –
                                      including mock hard-boiled eggs made of
                                      coloured almond paste inside blown shells
                                      for Lent, when dairy was prohibited!
                                    </p>
                                    <p>
                                      A huge amount of preparation went into the
                                      creation of feasts. When the whole royal
                                      court assembled, hundreds of people could
                                      be sitting down to eat. For the two great
                                      feasts at Easter and Christmas,
                                      preparations had to start months ahead,
                                      when preserves were ordered and made.
                                      Fasting took place in the Advent period,
                                      meaning four weeks of lean eating to
                                      prepare for the feast.
                                    </p>
                                    <p>
                                      We have compiled 11 of our favourite
                                      recipes from the Middle Ages, which you
                                      can recreate at home to make your own
                                      medieval feast! And while meat is clearly
                                      a feature, there are a surprising number
                                      of vegan and vegetarian dishes, so there's
                                      something for everyone.
                                    </p>
                                    <p>
                                      These recipes are all from{" "}
                                      <a
                                        href="https://www.waterstones.com/book/the-medieval-cookbook/maggie-black/9780714128290"
                                        target="_blank"
                                        rel="noopener"
                                        className=" external-link"
                                      >
                                        <em>
                                          <strong>The Medieval Cookbook</strong>
                                        </em>
                                        <span className="visually-hidden">
                                          {" "}
                                          (Opens in new window)
                                    ...
                                    <div
                                      ...
                                      data-entity-uuid="cadb31fe-3b27-4ac4-8698-1336eec8ff8c"
                                    ...
                                    >
                                      <figure className="media media-embed media-image js-media">
                                        <img
                                          ...
                                          srcSet="/sites/default/files/styles/uncropped_tiny/public/2022-07/Fortezza_Verrucole_Archeopark-1200x800.jpg?itok=P1K1KEQF 400w, /sites/default/files/styles/uncropped_small/public/2022-07/Fortezza_Verrucole_Archeopark-1200x800.jpg?itok=dAe5GAkw 750w, /sites/default/files/styles/uncropped_medium/public/2022-07/Fortezza_Verrucole_Archeopark-1200x800.jpg?itok=LeZU-ExA 1000w, /sites/default/files/styles/uncropped_large/public/2022-07/Fortezza_Verrucole_Archeopark-1200x800.jpg?itok=C8xCXo1b 1200w"
                                          sizes="100vw"
                                          width={1200}
                                          height={800}
                                          src="/sites/default/files/styles/uncropped_huge/public/2022-07/Fortezza_Verrucole_Archeopark-1200x800.jpg?itok=3O9qOU8D"
                                          alt="Photo of a kitchen with lots of culinary equipment scattering surfaces, lack of light obscures detail, daytime visible through window"
                                        />
                                        <figcaption>
                                          A restored medieval kitchen inside
                                          Verrucole Castle, Tuscany. Photo:
                                          Simone Letari. CC BY-SA 4.0.
                                        </figcaption>
                                      </figure>
                                    </div>
                                  </div>
                                  ...
                                  <div className="paragraph paragraph--type--embedded-media paragraph--view-mode--default">
                                    <figure className="media media-embed media-image js-media">
                                      ...
                                      <figcaption>
                                        ...
                                        Around 1450-1500. Print made by
                                        Monogrammist AG.
                                      </figcaption>
                                    </figure>
                                  </div>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-29091-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-29091-title"
                                  className="visually-hidden section--slice-content__title"
                                >
                                  Starters and snacks
                                </h2>
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <h3>Starters and snacks</h3>
                                    <h4>
                                      Mixed pickles (vegetarian, can be made
                                      vegan)
                                    </h4>
                                    <blockquote>
                                      <p>
                                        Take rote of persel, of pasternak, of
                                        rafens, scrape hem and waische him
                                        clene. Take rapes &amp; caboches, ypared
                                        and ycorue. Take an erthen panne with
                                        clene water &amp; set it on the fire;
                                        cast all thise therinne. Whan they buth
                                        boiled cast therto peeres &amp; perboile
                                        hem wel. Take alle thise thynges vp
                                        &amp; lat it kele on a faire cloth. Do
                                        therto salt; whan it is colde, do hit in
                                        a vessel; take vyneger &amp; powdour
                                        &amp; safroun &amp; do therto, &amp; lat
                                        alle thise thynges lye therein at night,
                                        other al day. Take wyne greke &amp; hony
                                        clarified togider; take lumbarde mustard
                                        &amp; raisouns coraunce, al hoole, &amp;
                                        grynde powdour of canel, powdour douce
                                        &amp; aneys hole, &amp; fenell seed.
                                        Take alle thise thynges &amp; cast
                                        togyder in a pot of erthe, &amp; take
                                        thereof whan thou wilt &amp; serue
                                        forth.
                                      </p>
                                    </blockquote>
                                    <p>
                                      <cite>– Curye on Inglysch, IV. 103.</cite>
                                    </p>
                                    <p>
                                      This recipe creates the perfect
                                      accompaniment to your Christmas cheese and
                                      crackers. Pickling was an important way of
                                      preserving vegetables in the Middle Ages,
                                      and still is.
                                    </p>
                                    <p>
                                      The French Medieval household book{" "}
                                      <em>Le Ménagier de Paris </em>(the Goodman
                                      of Paris) had recipes for pickling walnuts
                                      and various vegetables and fruits grown on
                                      the fictional writer's farm, but he soaked
                                      the whole lot in honey – probably ruining
                                      the teeth of everyone in his household!
                                      This recipe is not quite as sweet and is
                                      more like modern recipes.
                                    </p>
                                    <p>
                                      Swap the honey for sugar to make this
                                      vegan.
                                    </p>
                                    <p>Makes 2.3kg</p>
                                    <p>
                                    ...
                                    <ul>
                                      <li>
                                        900g mixed parsley roots, carrots,
                                        radishes and turnips
                                      </li>
                                      <li>450g white cabbage</li>
                                      <li>450g hard eating pears</li>
                                      <li>6 tbsp salt</li>
                                      <li>1 tsp ground ginger</li>
                                      <li>1⁄2 tsp dried saffron strands</li>
                                      <li>425ml white wine vinegar</li>
                                      <li>50g currants</li>
                                      <li>575ml fruity white wine</li>
                                      <li>6 tbsp clear honey</li>
                                      <li>1 tsp of French mustard</li>
                                      <li>
                                        1⁄8 tsp each of ground cinnamon and
                                        black pepper
                                      </li>
                                      <li>
                                        1⁄4 tsp each of anise and fennel seeds
                                      </li>
                                      <li>50g white sugar</li>
                                    </ul>
                                    <p>
                                      <strong>Method</strong>
                                    </p>
                                    <p>
                                      Wash and peel the root vegetables and
                                      slice them thinly. Core and shred the
                                      cabbage. Put the vegetables into a large
                                      pan of water and slowly bring to the boil.
                                      Peel, core and cut up the pears and add
                                      them to the pan. Cook until they start to
                                      soften. Drain the contents of the pan and
                                      spread in a 5cm layer in a shallow
                                      non-metallic dish. Sprinkle with the salt,
                                      ginger, saffron and 4 tbsp of the vinegar.
                                      Leave, covered, for 12 hours. Rinse well,
                                      then add the currants. Pack into
                                      sterilised storage jars, with at least
                                      2.5cm headspace. Put the wine and honey in
                                      a pan. Bring to simmering point and skim.
                                      Add the rest of the vinegar and all the
                                      remaining spices and sugar. Reduce the
                                      heat and stir without boiling until the
                                      sugar dissolves. Bring back to the boil.
                                      Pour over the vegetables, covering them
                                      with 1cm of liquid. Cover with
                                    ...
                                    <figure className="media media-embed media-image js-media">
                                      ...
                                      <figcaption>
                                        <a href="/collection/object/H_1885-0508-2">
                                          Silver plaque depicting the Last
                                          Supper.
                                        </a>{" "}
                                        14th century.
                                      </figcaption>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-29093-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-29093-title"
                                  className="visually-hidden section--slice-content__title"
                                >
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <h4>Cabbage chowder (vegan)</h4>
                                    <blockquote>
                                      <p>
                                        Take caboches and quarter hem, and seeth
                                        hem in gode broth with oynouns ymynced
                                        and the whyte of lekes yslyt and ycorue
                                        smale. And do therto safroun &amp; salt,
                                        and force it with powdour douce.
                                      </p>
                                    </blockquote>
                                    <p>
                                      <cite>Curye on Inglysch, III. 26.</cite>
                                    </p>
                                    <p>
                                      The French Medieval household book{" "}
                                      <em>Le Ménagier de Paris</em> (the Goodman
                                      of Paris), has quite a lot to say about
                                      cabbages, from the small spring sprouts
                                      for salads to the frostbitten winter
                                      leaves. However, the recommendation to
                                      boil cabbages all morning is best ignored!
                                      This recipe could be made as a starter, or
                                      as a main course if you add small pieces
                                      of toast and small strips of fried bacon –
                                      both well-known medieval additions.
                                    </p>
                                    <p>Serves 4</p>
                                    <p>
                                      <strong>Ingredients</strong>
                                    ...
                                    <ul>
                                      <li>
                                        600g firm-hearted cabbage or 700g
                                      ...
                                      <li>
                                        225g white part of leeks, thinly sliced
                                        into rings
                                      </li>
                                      <li>A tsp of dried saffron strands</li>
                                      <li>1⁄2 tsp of salt</li>
                                      <li>
                                        1⁄4 tsp each of ground coriander,
                                        cinnamon and sugar
                                      </li>
                                      <li>850ml chicken or vegetable stock</li>
                                    </ul>
                                    <p>
                                      <strong>Method</strong>
                                    </p>
                                    <p>
                                      ...
                                      into eight segments and remove the centre
                                      core. If using an open-hearted cabbage or
                                      greens, cut off the stalks and cut the
                                      leaves into strips. Put into a large pan
                                      with the prepared onions and leeks. Stir
                                      the saffron, salt and spices into the
                                      stock, adjusting the quantity of salt if
                                      required, then pour the mixture over the
                                      vegetables. Cook gently, covered, for
                                      about 20 minutes or until segments of firm
                                      cabbage are tender.
                                    </p>
                                  </div>
                                </div>
                                    ...
                                    <figure className="media media-embed media-image js-media">
                                      ...
                                      <figcaption>
                                        <a href="/collection/object/H_1996-0601-1">
                                          A lead-glazed earthenware tripod
                                          pipkin.
                                        </a>{" "}
                                        Around 15th century.
                                      </figcaption>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-29095-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-29095-title"
                                  className="visually-hidden section--slice-content__title"
                                >
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <h4>'Departed' creamed fish</h4>
                                    <blockquote>
                                      <p>
                                        To make mortreux of fisch. Tak plays or
                                        fresch meluel or merlyng &amp; seth it
                                        in fayre water, and then tak awey the
                                        skyn &amp; the bones &amp; presse the
                                        fisch in a cloth &amp; bray it in a
                                        mortere, and tempre it vp with almond
                                        melk, &amp; bray poudere of gynger &amp;
                                        sugre togedere &amp; departe the
                                        mortreux on tweyne in two pottes &amp;
                                        coloure that on with saffroun &amp;
                                        dresch it in disches, half of that on
                                        &amp; half of that other, &amp; strawe
                                        poudere of gyngere &amp; sugre on that
                                        on &amp; clene sugre on that other &amp;
                                        serue it forth.
                                      </p>
                                    </blockquote>
                                    <p>
                                    ...
                                    <p>
                                      Mortrews was a type of pottage or paté
                                      that contained either fish or meat, mixed
                                      with almonds. 'Departed' just means that
                                      the dish is 'parted in two' different
                                      colours. The Medieval household book
                                      <em> Le Ménagier de Paris</em> (the
                                      Goodman of Paris) suggested a chicken
                                      liver or meat mortrews, but this fish
                                      option would be a good substitute on
                                      'fysshe' days when eating meat was
                                      forbidden.
                                    </p>
                                    ...
                                    <p>
                                      ...
                                      <br />• 125g ground almonds
                                      <br />• 2 tsp rice flour or corn flour
                                      <br />• 3 tbsp deep yellow saffron water
                                      or food colouring
                                      <br />• 1⁄2 tsp ground ginger
                                      <br />• 3⁄4 tsp white sugar
                                    </p>
                                    <p>
                                      <strong>Method</strong>
                                    </p>
                                    <p>
                                      Poach the fish fillet in about 575ml of
                                      salted water until cooked through. Drain
                                      off the cooking liquid into a measuring
                                      jug. Pour 275ml of this liquid over the
                                      almonds in a bowl. Press the ﬁsh under a
                                      cloth or kitchen paper to squeeze out
                                      excess moisture, then flake it. Strain the
                                      almond 'milk' into a jug, stirring to
                                      separate the free liquid from the almond
                                      sludge in the strainer. Put the liquid
                                      into an electric blender, followed by the
                                      flaked fish, and process until smooth. If
                                      the mixture is too stiff to process
                                      easily, add a little more fish cooking
                                      liquid. Turn the mixture into a bowl. In a
                                      small saucepan, cream the rice flour or
                                      cornflour with 3 or 4 tbsp of fish cooking
                                      liquid, then heat the mixture gently until
                                      it thickens. Stir this 'cream' into the
                                      fish mixture and season with salt. Put
                                      half the mixture into a separate bowl and
                                      tint it deep gold with the saffron water
                                      or food colouring. Combine the ground
                                      ginger and 1⁄4 tsp of the sugar and mix
                                      into the golden fish, reserving a little
                                      of the mixture for sprinkling. If you like
                                      ginger, increase the quantity. Serve the
                                      mortrews in six small bowls or plates,
                                      putting a coloured and a plain spoonful of
                                      mixture side by side in each. Chill until
                                      needed. Just before serving, sprinkle the
                                      remaining ginger/sugar mix on the gold
                                      portions and the remaining 1⁄2 tsp plain
                                      sugar on the white portions.
                                    </p>
                                  </div>
                                </div>
                                <aside className="section--slice-content__embed">
                                    ...
                                    <figure className="media media-embed media-image js-media">
                                      ...
                                      <figcaption>
                                        <a href="/collection/object/H_1921-0328-1">
                                          Pottery figurine of a woman carrying a
                                          fish
                                        </a>
                                        . 14th century.
                                      </figcaption>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-29107-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-29107-title"
                                  className="visually-hidden section--slice-content__title"
                                >
                                  Main dishes
                                </h2>
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <h3>Main dishes</h3>
                                    <h4>Spit-roasted or grilled steak</h4>
                                    <blockquote>
                                      <p>
                                        To make Stekys of venson or bef. Take
                                        Venyson or Bef, &amp; leche &amp; gredyl
                                        it vp broun; then take Vynegre &amp; a
                                        litel verious, &amp; a lytil Wyne, and
                                        putte pouder perpir ther-on y-now, and
                                        pouder Gyngere; and atte the dressoure
                                        straw on pouder Canelle y-now, that the
                                        stekys be al y-helid ther-wyth, and but
                                        a litel; Sawce &amp; then serue it
                                        forth.
                                      </p>
                                    </blockquote>
                                    <p>
                                    ...
                                    <p>
                                      ...
                                      <br />• Oil or fat for grilling
                                    </p>
                                    <p>
                                      Basting sauce:
                                      <br />• 2 tsp red wine vinegar
                                      <br />• 1–2 tbsp Seville orange juice
                                      <br />• 4 tbsp red wine
                                      <br />• Pinch each of ground black pepper
                                      and ginger
                                    </p>
                                    <p>
                                      Garnish:
                                      <br />• Sprinkling of ground cinnamon
                                    </p>
                                    <p>
                                      <strong>Method</strong>
                                    </p>
                                    <p>
                                      The original recipe calls for 'verjuice',
                                      a popular medieval condiment made from
                                      specially grown or (in England) unripe
                                      grapes. But another recipe from the
                                      Medieval household book{" "}
                                      <em>Le Ménagier de Paris</em> (the Goodman
                                      of Paris) suggests using the juice of
                                      Seville oranges. If you can get these in
                                      season and freeze them, you can use their
                                      juice as a substitute for verjuice – it
                                      makes a delicious sauce. Nick the edges of
                                      the steaks and grease them. Mix the sauce
                                      ingredients in a jug, adjusting the
                                      proportions if you wish. Then grill the
                                      steaks as you prefer. Warm the sauce and
                                      sprinkle a few drops over the meat while
                                      grilling it. Serve the steaks lightly
                                      sprinkled with cinnamon and any remaining
                                      sauce.
                                    </p>
                                  </div>
                                </div>
                                    ...
                                    <figure className="media media-embed media-image js-media">
                                      ...
                                      <figcaption>
                                        <a href="/collection/object/P_1868-0822-193">
                                          Albrecht Dürer. A cook and his wife.
                                        </a>{" "}
                                        The cook is holding an empty frying pan,
                                        on his shoulder is sitting a magpie.
                                        Around 1496. Engraving.
                                      </figcaption>
                                    </figure>
                                  </div>
                                </aside>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-29109-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-29109-title"
                                  className="visually-hidden section--slice-content__title"
                                >
                                  Mushroom pasties (vegetarian, can be made
                                  vegan)
                                </h2>
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    ...
                                    <blockquote>
                                      <p>
                                        Mushrooms of one night are the best, if
                                        they are small, red inside, and closed
                                        at the top: and they should be peeled
                                        and then washed in hot water and
                                        parboiled, and if you wish to put them
                                        in a pasty add oil, cheese and spice
                                        powder.
                                      </p>
                                    </blockquote>
                                    <p>
                                    ...
                                    <p>
                                      This recipe is from the Medieval household
                                      book <em>Le Ménagier de Paris</em> (the
                                      Goodman of Paris). At home it is likely
                                      that the fictional narrator of the book,
                                      who kept a well-furnished table, would
                                      serve a large double-crust pasty or plate
                                      pie – but on his journeys to and from the
                                      farm, small ones probably seemed more
                                      suitable.
                                    </p>
                                    <p>Serves 6</p>
                                    <p>
                                    ...
                                    <p>
                                      • 450g home-made or bought shortcrust
                                      pastry, thawed if frozen
                                      <br />• 450g button mushrooms
                                      <br />• Pinch of salt
                                      <br />• 2 tbsp olive oil
                                      <br />• 50g Cheddar cheese, grated
                                      <br />• 1⁄2 tsp salt
                                      <br />• 1⁄8 tsp freshly ground black
                                      pepper
                                      <br />• 1⁄4 tsp dry mustard powder
                                      <br />• 1 egg, beaten
                                    </p>
                                    <p>
                                      To make this recipe vegan use vegan
                                      pastry, omit the cheese or use vegan
                                      cheese, and use soy, rice or almond milk
                                      instead of the egg to seal the pastry.
                                    </p>
                                    <p>
                                      <strong>Method</strong>
                                    </p>
                                    <p>
                                      Use two-thirds of the pastry to line
                                      small, deep pans. Chill while making the
                                      filling. Preheat the oven to 200°C. Trim
                                      off and discard the bottoms of the
                                      mushroom stems, then dip the mushrooms in
                                      boiling salted water, holding them in a
                                      sieve. Drain them, pat dry, then chop or
                                      slice them. Put them in a bowl and mix
                                      them with the oil, cheese and seasonings.
                                      Fill the mixture into the pastry cases.
                                      Roll out the remaining pastry and use it
                                      to make lids for the pasties. Seal the
                                      lids with beaten egg. Decorate the tops
                                      with pastry trimmings and brush with the
                                      remaining egg. Make a small crosscut in
                                      the centre of each lid. Bake the little
                                      pies in the oven for 15–18 minutes. Serve
                                      warm.
                                    </p>
                                  </div>
                                </div>
                                    ...
                                    <figure className="media media-embed media-image js-media">
                                      ...
                                      <figcaption>
                                        <a href="/collection/object/P_1961-0211-1">
                                          The Meal of Sorgheloos
                                        </a>{" "}
                                        (allegory on Carelessness). Anonymous. A
                                        group of five figures dining, a servant
                                        with food entering the doorway at left,
                                        a child reaching up to the table at
                                        right and a small dog in the foreground.
                                        Around 1490–1500.
                                      </figcaption>
                                    </figure>
                                  </div>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-29111-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-29111-title"
                                  className="visually-hidden section--slice-content__title"
                                >
                                  Lamb or mutton stew
                                </h2>
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <h4>Lamb or mutton stew</h4>
                                    <blockquote>
                                      <p>
                                        Take veel other[wise] motoun and smyte
                                        it to gobettes. Seeth it in gode broth;
                                        cast therto erbes yhewe gode won, and a
                                        quantite of oynouns mynced, powdour fort
                                        and safroun, and alye it with ayren and
                                        verious: but let it not seeth after.
                                      </p>
                                    </blockquote>
                                    <p>
                                      <cite>Curye on Inglysch, IV.18.</cite>
                                    </p>
                                    <p>Serves 6</p>
                                    <p>
                                      <strong>Ingredients</strong>
                                    ...
                                    <p>
                                      ...
                                      <br />• 425ml chicken stock
                                      <br />• 2 medium onions, peeled and finely
                                      chopped
                                      <br />• 1 tbsp chopped parsley
                                      <br />• 1/2–1 tsp each fresh rosemary
                                      leaves, thyme leaves, and savory or
                                      marjoram leaves, bruised in a mill (use
                                      less if using dried herbs)
                                      <br />• 1/4 tsp each ground ginger, cumin
                                      and coriander
                                      <br />• Salt to taste
                                      <br />• 225ml white wine
                                      <br />• 2 eggs
                                    ...
                                    <p>
                                      Cut the meat into 5cm cubes. Put the stock
                                      into a stewpan and bring to the boil. Add
                                      the meat and bring back to the boil. Skim
                                      if needed, then add the prepared onions,
                                      herbs, spices, salt and wine. Reduce the
                                      heat, cover the pan and cook gently until
                                      the meat cubes are cooked through and
                                      tender (1–1 1/2 hours). Beat the eggs with
                                      the lemon juice until blended, then take
                                      the pan off the heat and stir the egg
                                      mixture gradually into the stew to thicken
                                      it slightly. Do not re-boil.
                                    </p>
                                  </div>
                                </div>
                                <aside className="section--slice-content__embed">
                                    ...
                                    <figure className="media media-embed media-image js-media">
                                      ...
                                      <figcaption>
                                        <a href="/collection/object/P_1849-1031-247">
                                          Emperor Maximillian I (1459–1519)
                                          directing a group of soldiers wearing
                                          bird masks and Hungarian costume
                                        </a>
                                        , musicians in the foreground and
                                        ladies-in waiting feasting in the
                                        background. Hans Burgkmair the Elder,
                                        German, 1514–16. Woodcut print (book
                                        illustration).
                                      </figcaption>
                                    </figure>
                                  </div>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-29113-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-29113-title"
                                  className="visually-hidden section--slice-content__title"
                                >
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <h4>Haddock in tasty sauce</h4>
                                    <blockquote>
                                      <p>
                                        Shal be yopened &amp; ywasshe clene
                                        &amp; ysode &amp; yrosted on a gridel;
                                        grind peper &amp; saffron, bred and ale
                                        mynce oynons, fri hem in ale, and do
                                        therto, and salt: boille hit, do thyn
                                        haddok in plateres, and the ciuey aboue,
                                        and ghif forth.
                                      </p>
                                    </blockquote>
                                    <p>
                                    ...
                                    <p>Serves 6</p>
                                    <p>
                                      This dish is a type of <em>civet</em>,
                                      which is a form of stew, usually made with
                                      meat of game. In old dishes the cook is
                                      usually told to 'drawe' a fish, animal or
                                      bird, so this recipe interprets 'yopened'
                                      to mean that the fish or meat should be
                                      cut open and boned. It could then easily
                                      be cut in pieces and eaten with a spoon.
                                      Oil could be used by strict (and wealthy)
                                      dieters for frying food in Lent, but poor
                                      people would probably use butter, and omit
                                      the costly saffron, as we've done here as
                                      it’s still costly!
                                    </p>
                                    <p>
                                      <strong>Ingredients</strong>
                                    ...
                                    <ul>
                                      ...
                                      <li>75g fine soft white breadcrumbs</li>
                                      <li>125ml brown ale</li>
                                    </ul>
                                    <p>
                                      <strong>Method</strong>
                                    </p>
                                    <p>
                                      Skin the haddock fillet and cut into
                                      several pieces. Put enough salted water
                                      into a shallow pan to cover the fish and
                                      bring it to the boil. Put in the fish and
                                      simmer for a moment or two, then cover the
                                      pan and remove from the heat – the fish
                                      will continue to cook in the hot water
                                      while you make the sauce. For this, fry
                                      the onions in the fat until just beginning
                                      to brown. Mix the pepper with the
                                      breadcrumbs and add them to the onions
                                      with the ale and 225ml of the water used
                                      to cook the fish. Process until smooth in
                                      an electric blender, then simmer for a few
                                      minutes to reheat.
                                    </p>
                                    <p>
                                      While simmering, drain the remaining water
                                      from the cooked fish and put the pieces on
                                      the grill rack. Brush them with a little
                                      melted fat, then place them under a hot
                                      grilling flame until they are just
                                      beginning to glaze. Cut them into
                                      bite-sized or serving portions and spoon
                                      some sauce over them. Serve the rest
                                      separately. If you don't like ale or beer
                                      you can use cider instead.
                                    </p>
                                  </div>
                                </div>
                                <aside className="section--slice-content__embed">
                                  <div className="paragraph paragraph--type--embedded-media paragraph--view-mode--default">
                                    <figure className="media media-embed media-image js-media">
                                      ...
                                      <figcaption>
                                        ...
                                        Anonymous artist, Augsburg, Germany,
                                        1475–81. Woodcut print with
                                        hand-colouring (book illustration).
                                      </figcaption>
                                    </figure>
                                  </div>
                                </aside>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-29115-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-29115-title"
                                  className="visually-hidden section--slice-content__title"
                                >
                                  Desserts
                                </h2>
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <h3>Desserts</h3>
                                    <h4>Cherry pottage (vegetarian)</h4>
                                    <blockquote>
                                      <p>
                                        Tak cheryes &amp; do out the stones
                                        &amp; grynde hem wel &amp; draw hem
                                        thorw a streynour &amp; do it in a pot.
                                        &amp; do therto whit gres or swete
                                        botere &amp; myed wastel bred, &amp;
                                        cast therto good wyn &amp; sugre, &amp;
                                        salte it &amp; stere it wel togedere,
                                        &amp; dresse it in disches; and set
                                        theryn clowe gilofre, &amp; strewe sugre
                                        aboue.
                                      </p>
                                    </blockquote>
                                    <p>
                                      <cite>
                                        Mnesitheus, quoted in Oribasius, Medical
                                        Collections 4, 4, 1.
                                      </cite>
                                    </p>
                                    <p>
                                      This cherry pottage was a genteel dish,
                                      being made with wine and white bread, and
                                      called for the use of precious white
                                      sugar! Soluble gold gouache can be used to
                                      gild the tops of whole cloves, but don't
                                      eat them as they are very strong – they're
                                      just for decoration here.
                                    </p>
                                    <p>Serves 6</p>
                                    <p>
                                      <strong>Ingredients</strong>
                                    ...
                                    <ul>
                                      <li>900g fresh ripe red cherries</li>
                                      <li>350ml red wine</li>
                                      <li>175g white sugar</li>
                                      <li>50g unsalted butter</li>
                                      <li>225g soft white breadcrumbs</li>
                                      <li>Pinch of salt</li>
                                      <li>
                                        Flower heads of small clove pinks or
                                        gilded whole cloves (according to
                                        season)
                                      </li>
                                      <li>Coarse white sugar for sprinkling</li>
                                    </ul>
                                    <p>
                                      <strong>Method</strong>
                                    </p>
                                    <p>
                                      Wash the cherries and discard the stems
                                      and stones. Purée the fruit in a blender
                                      with 150ml of the wine and half the sugar.
                                      Add a little more wine if you need to.
                                      Melt the butter in a saucepan and add the
                                      fruit purée, breadcrumbs, remaining wine,
                                      sugar and salt. Simmer, stirring steadily,
                                      until the purée is very thick. Pour into a
                                      serving bowl, cover and leave to cool.
                                      When quite cold, decorate the edge of the
                                      bowl with flowers or whole cloves, and
                                      sprinkle coarse sugar over the centre.
                                    </p>
                                  </div>
                                </div>
                                <aside className="section--slice-content__embed">
                                  <div className="paragraph paragraph--type--embedded-media paragraph--view-mode--default">
                                    <figure className="media media-embed media-image js-media">
                                      ...
                                      <figcaption>
                                        ...
                                        trees. Anonymous artist, Augsburg,
                                        Germany, 1475–81. Woodcut print with
                                        hand-colouring (book illustration).
                                      </figcaption>
                                    </figure>
                                  </div>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-29119-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-29119-title"
                                  className="visually-hidden section--slice-content__title"
                                >
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <h4>Cream custard tart (vegetarian)</h4>
                                    <blockquote>
                                      <p>
                                        Doucetes. Take Creme a gode cupfulle,
                                        &amp; put it on a straynour, thanne take
                                        yolkes of Eyroun, and put ther-to, &amp;
                                        a lytel mylke; then strayne it throw a
                                        straynour in-to a bolle; then take Sugre
                                        y-now, put ther-to, or ellys hony forde
                                        faute of Sugre, than coloure it with
                                        Safroun; than take thin cofyns, &amp;
                                        put it in the ovynne letre, &amp; tat
                                        hem ben hardyd; than take a dyssche
                                        y-fastenyd on the pelys ende, &amp; pore
                                        thin comade in-to the dyssche, &amp; fro
                                        the dyssche in-to the cofyns; &amp; whan
                                        they don a-ryse wet, teke hem out, ee
                                        serue hem forth.
                                      </p>
                                    </blockquote>
                                    <p>
                                    ...
                                    <ul>
                                      <li>Pulverized dried saffron strands</li>
                                      <li>
                                        Shortcrust pastry made with 225g flour,
                                        65g butter, 40g lard, and cold water to
                                        mix (use butter instead of lard to make
                                        this vegetarian)
                                      </li>
                                      <li>6 egg yolks</li>
                                    ...
                                    <p>
                                      Soak the saffron in 2 tbsp water until the
                                      water is deep gold in colour. Add the
                                      pastry to a 20cm pie plate or cake tin
                                      with a loose bottom, with a depth of 5cm.
                                      Bake 'blind' in a preheated oven at 200°C
                                      for 15–20 minutes, then remove the filling
                                      of dried beans and return the case to the
                                      oven at about 160°C for 6–8 minutes until
                                      dried out and firm. Remember a cake tin is
                                      deeper than a pie plate so the case in it
                                      may need longer baking than usual. Beat
                                      the egg yolks lightly in a bowl, then beat
                                      in the cream, milk, sugar, saffron water
                                      and salt. Pour the custard into the pastry
                                      case. Bake it at 160°C for about 45
                                      minutes or until it is just set in the
                                      centre. Serve warm. Make small tarts if
                                      you prefer. The full recipe quantity of
                                      pastry will make 36 tarts, using a 7.5cm
                                      cutter. You will need two thirds of the
                                      filling for them.
                                    </p>
                                  </div>
                                </div>
                                    ...
                                    <figure className="media media-embed media-image js-media">
                                      ...
                                      <figcaption>
                                        <a href="/collection/object/P_1837-0616-272">
                                          A farmer delivers some eggs. Leonhard
                                          Beck
                                        </a>
                                        , German, provenance unknown, around
                                        1514–16. Woodcut print.
                                      </figcaption>
                                    </figure>
                                  </div>
                                </aside>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-29130-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-29130-title"
                                  className="visually-hidden section--slice-content__title"
                                >
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <h4>Rose pudding (vegetarian)</h4>
                                    <blockquote>
                                      <p>
                                        Take thyk milke; sethe it. Cast therto
                                        sugur, a gode porcioun; pynes, dates
                                        ymynced, canel, &amp; powdour gynger;
                                        and seeth it, and alye it with flours of
                                        white rosis, and flour of rys. Cole it;
                                        salt it &amp; messe it forth. If thou
                                        wilt in stede of almounde mylke, take
                                        swete crem of kyne.
                                      </p>
                                    </blockquote>
                                    <p>
                                      <cite>Curye on Inglysch, IV. 53.</cite>
                                    </p>
                                    <p>Serves 6</p>
                                    <p>
                                      <strong>Ingredients</strong>
                                    ...
                                    <ul>
                                      <li>Petals of one white rose</li>
                                      <li>
                                      ...
                                      <li>575ml single cream</li>
                                      <li>Pinch of salt</li>
                                      <li>
                                        10 dessert dates, stoned and finely
                                        chopped
                                      </li>
                                      <li>1 tbsp chopped pine nut kernels</li>
                                    </ul>
                                    <p>
                                      <strong>Method</strong>
                                    </p>
                                    <p>
                                      Take the petals off the rose one by one.
                                      Blanch the petals in boiling water for 2
                                      minutes, then press them between several
                                      sheets of soft kitchen paper and put a
                                      heavy flat weight on top to squeeze them
                                      dry. (They may look depressingly greyish
                                      but blending will improve the dish's
                                      colour.) Put the rice flour or cornflour
                                      in a saucepan, and blend into it enough of
                                      the milk to make a smooth cream. Stir in
                                      the remaining milk. Place the pan over low
                                      heat and stir until the mixture starts to
                                      thicken. Put in a (non-medieval!) electric
                                      blender, and add the sugar, spices and
                                      rose petals. Process until fully blended,
                                      then add and blend in the cream and salt.
                                      Turn the mixture into a heavy saucepan,
                                      and stir over very low heat, below the
                                      boil, until it is the consistency of
                                      softly whipped cream. Stir in most of the
                                      chopped dates and pine nut kernels and
                                      stir for 2 more minutes. Turn into a glass
                                      or decorative bowl and cool. Stir
                                      occasionally while cooling to prevent a
                                      skin forming. Chill. Just before serving
                                      decorate with the remaining dates and
                                      nuts.
                                    </p>
                                  </div>
                                </div>
                                  ...
                                  <div className="paragraph paragraph--type--embedded-media paragraph--view-mode--default">
                                    <figure className="media media-embed media-image js-media">
                                      ...
                                      <figcaption>
                                        ...
                                        Print by Israhel van Meckenem. c. 1480.
                                        Engraving.
                                      </figcaption>
                                    </figure>
                                  </div>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-29132-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-29132-title"
                                  className="visually-hidden section--slice-content__title"
                                >
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <h4>
                                      <em>Piment</em> or medieval mulled wine
                                      (vegan)
                                    </h4>
                                    <blockquote>
                                      <p>
                                        Pur fait ypocras. Troys vnces de canell
                                        &amp; iii vnces gyngeuer; spykenard de
                                        Spayn, le pays dun denerer; garyngale,
                                        clowes gylofre, poeure long, noiey
                                        mugadey, mayioyame, cardemonii, de
                                        chescun i quarter donce; grayne de
                                        paradys, flour de queynel, de chescun
                                        dm. vnce; de tout soit fait powdour
                                        &amp;c.
                                      </p>
                                    </blockquote>
                                    <p>
                                      <cite>Curye on Inglysch, IV.199.</cite>
                                    </p>
                                    <p>
                                      <em>Piment</em> was the general name for
                                      sweetened spiced wines in the Middle Ages.
                                      The first recipes for spiced wine appeared
                                      at the end of the 13th century and the
                                      beginning of the 14th century. The recipe
                                      above is for <em>Hypocras</em>, another
                                      type of spiced wine but it contains long
                                      pepper (<em>poeure long</em>), the grains
                                      of paradise (<em>grayne de paradis</em>),
                                      spikenard (<em>spykenard</em>), which are
                                      very hard to get hold of today.
                                    </p>
                                    <p>
                                      The drink became extremely popular and was
                                      regarded as having various medicinal or
                                      even aphrodisiac properties. Spices were
                                    ...
                                    <ul>
                                      <li>
                                        2 ltr red wine (check the label to
                                        ensure that ingredients are vegan if you
                                        want to make this recipe vegan)
                                      </li>
                                      <li>175g white sugar</li>
                                      <li>1 tbsp ground cinnamon</li>
                                      <li>1/4 tbsp ground ginger</li>
                                      <li>
                                        1 tsp each ground cloves, grated nutmeg,
                                        marjoram (fresh if possible), ground
                                        cardamom, ground black pepper and a
                                        pinch of grated galingale (if available)
                                      </li>
                                    </ul>
                                    <p>
                                      <strong>Method</strong>
                                    ...
                                    <p>
                                      Warm the wine until it just begins to
                                      steam. Add the sugar and allow to
                                      dissolve. Mix all the spices and herbs
                                      together. Stir half this mixture into the
                                      wine, then taste and slowly add more until
                                      you achieve a flavour you like (you will
                                      probably need most, or all, of the
                                      mixture). Simmer your 'mix' very gently
                                      for 10 minutes. Strain through a jelly bag
                                      (which may take some hours). Bottle when
                                      cold, then cork securely. Use within a
                                      week.
                                    </p>
                                  </div>
                                </div>
                                  ...
                                  <div className="paragraph paragraph--type--embedded-media paragraph--view-mode--default">
                                    <figure className="media media-embed media-image js-media">
                                      ...
                                      <figcaption>
                                        ...
                                        Silver-gilt drinking cup with lid. 15th
                                        century.
                                      </figcaption>
                                    </figure>
                                  </div>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-29134-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-29134-title"
                                  className="visually-hidden section--slice-content__title"
                                >
                                  About the book
                                </h2>
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    ...
                                    <p>
                                      <strong>
                                        We would love to see your medieval
                                        feasts – send us pictures of your
                                        creations using @britishmuseum on
                                        Instagram and Twitter. Happy cooking!
                                      </strong>
                                    </p>
                                  </div>
                                </div>
                                      ...
                                      <div className="teaser__content-push">
                                        <div className="teaser__meta teaser__meta--top">
                                          <div className="teaser__meta-item">
                                            <span>
                                              Museum stories / 18 June 2020
                                            </span>
                                          </div>
                                        </div>
                                        <h3 className="teaser__title">
                                          <a
                                            href="/blog/cook-classical-feast-nine-recipes-ancient-greece-and-rome"
                                            className="teaser__anchor"
                                          >
                                            <span>
                                              <span>
                                                Cook a classical feast: nine
                                                recipes from ancient Greece and
                                                Rome
                                              </span>
                                            </span>
                                        ...
                                        <div className="teaser__summary">
                                          Bored with banana bread? Whip up a
                                          classical feast with nine recipes from
                                    ...
                                    <div className="teaser__content">
                                      <div className="teaser__content-push">
                                        <div className="teaser__meta teaser__meta--top">
                                          <div className="teaser__meta-item">
                                            <span>
                                              Museum stories / 28 January 2021
                                            </span>
                                          </div>
                                        </div>
                                        <h3 className="teaser__title">
                                          <a
                                            href="/blog/inside-dig-how-star-studded-film-squares-reality-sutton-hoo"
                                            className="teaser__anchor"
                                          >
                                            <span>
                                              <span>
                                                Inside 'The Dig': how the
                                                star-studded film squares with
                                                reality of Sutton Hoo
                                              </span>
                                            </span>
                                            {/* Add visually hidden defacer for screen-reader. Use full stops for reader punctuation. */}
                                          </a>
                                        ...
                                        <div className="teaser__summary">
                                          Curator Sue Brunning looks at how
                                          Netflix film The Dig compares to the
                                          momentous historical excavation of the
                                    ...
                                    <div className="teaser__content">
                                      <div className="teaser__content-push">
                                        <div className="teaser__meta teaser__meta--top">
                                          <div className="teaser__meta-item">
                                            <span>
                                              Objects in focus / 5 February 2016
                                            </span>
                                          </div>
                                        </div>
                                        <h3 className="teaser__title">
                                          <a
                                            href="/blog/medieval-alchemical-book-reveals-new-secrets"
                                            className="teaser__anchor"
                                          >
                                            <span>
                                              <span>
                                                A medieval alchemical book
                                                reveals new secrets
                                              </span>
                                            </span>
                                            {/* Add visually hidden defacer for screen-reader. Use full stops for reader punctuation. */}
                                        ...
                                        <div className="teaser__summary">
                                          Bink Hallum and&nbsp;Marcel Marée
                                          discuss hieroglyphic texts and in
                                          particular the&nbsp;18th-century copy
                                          of the Book of the Seven Climes.
                                        </div>
                                      </div>
                                      <span className="teaser__button | button button--chevron">
                                        {" "}
