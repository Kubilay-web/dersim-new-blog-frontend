...
const International = () => {
  ...
  useEffect(() => {
    const category1 = "Sharing the collection";
    const category2 = "Sharing expertise";
    const category3 = "Sharing knowledge";
  ...
  useEffect(() => {
    const someContentId = "67af1fb08b2864c833c0991f";
  ...
  return (
    <div>
      <div>
        ...
        <meta
          name="abstract"
          content="Museums work internationally to make the most of their collections, knowledge and expertise."
        />
        <link
          rel="canonical"
        ...
        <meta
          ...
          content="Loans, research and touring exhibitions are some of the many ways we build ties internationally. See our current collaborations."
        />
        <meta
          property="og:image"
              ...
              <main id="main-content" className="js-main">
                <div>
                  <div
                    ...
                    role="article"
                    aria-labelledby="paragraph-2166-title"
                  >
                    ...
                    <div className="container">
                      <div className="hero__inner">
                        <div className="hero__content-container">
                          ...
                          {/* <h1 id="paragraph-2166-title" className="hero__title">
                            {" "}
                            International
                          </h1> */}
                        </div>
                        <div className="hero__controls">
                          <div className="hero__caption | js-hero-caption">
                            <button
                              ...
                              id="hero-image-caption-button-2166"
                              aria-expanded="false"
                              aria-controls="hero-image-caption-content-2166"
                            >
                            ...
                            <div
                              ...
                              id="hero-image-caption-content-2166"
                              aria-hidden="true"
                              aria-labelledby="hero-image-caption-button-2166"
                            >
                              <button
                                type="button"
                                className="hero__caption-content-close | js-hero-caption-btn"
                                id="hero-image-caption-close-button-2166"
                                aria-expanded="false"
                                aria-controls="hero-image-caption-content-2166"
                              >
                                <span className="visually-hidden">
                        ...
                        <div className="section--intro__container">
                          ...
                          <div className="section--intro__content">
                            ...
                            <div className="wysiwyg">
                              <p>
                                Loans, touring exhibitions, research,
                                archaeology, consultancy and training build
                                strong ties with other countries and
                                institutions.
                              </p>
                            </div> */}
                          </div>
                      ...
                      <div>
                        <div>
                          <section
                            ...
                            aria-labelledby="paragraph-6734-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-6734-title"
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  <h3 className="teaser__title">
                                                    <a
                                                      href="/our-work/international/lending-across-world"
                                                      className="teaser__anchor"
                                                    >
                                                      <span>
                                                        <span>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-teaser paragraph--view-mode--default section section--slice-teaser section--z-index-scope section--has-carousel section--bg-white"
                            aria-labelledby="paragraph-7044-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-7044-title"
                                    className="section__title teaser-listing__title"
                                  >
                                    Sharing expertise
                                  </h2>
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  <h3 className="teaser__title">
                                                    <a
                                                      href="/our-work/international/international-training-programme"
                                                      className="teaser__anchor"
                                                    >
                                                      <span>
                                                        <span>
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  <h3 className="teaser__title">
                                                    <a
                                                      href="/research/projects/girsu-project"
                                                      className="teaser__anchor"
                                                    >
                                                      <span>
                                                        <span>
                                                  ...
                                                  <div className="teaser__summary">
                                                    Rediscovering ancient Girsu
                                                    in Southern Iraq, the
                                                    heartland of the first
                                                    cities and birthplace of
                                                    writing.
                                                  </div>
                                                </div>
                                              </div>
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  <h3 className="teaser__title">
                                                    <a
                                                      href="/research/projects/mowaa-archaeology-project-benin-city-nigeria"
                                                      className="teaser__anchor"
                                                    >
                                                      <span>
                                                        <span>
                                                  ...
                                                  <div className="teaser__summary">
                                                    What can pre-construction
                                                    archaeology tell us about
                                                    Benin City's historic urban
                          ...
                          <section
                            className="paragraph paragraph--type--slice-teaser paragraph--view-mode--default section section--slice-teaser section--z-index-scope section--has-carousel section--bg-white"
                            aria-labelledby="paragraph-36582-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-36582-title"
                                    className="section__title teaser-listing__title"
                                  >
                                    Sharing knowledge
                                  </h2>
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  ...
                                                  <div className="teaser__summary">
                                                    The Endangered Material
                                                    Knowledge Programme (EMKP)
                                                    is a major programme to help
                                  ...
                                  <div className="teaser__wrapper">
                                    ...
                                    <div className="teaser__content">
                                      <div className="teaser__content-push">
                                        <h3 className="teaser__title">
                                          <a
                                            href="/research/projects/lower-niger-bronzes-scientific-research"
                                            className="teaser__anchor"
                                          >
                                            <span>
                                              <span>
                                        ...
                                        <div className="teaser__summary">
                                          ...
                                          diversity of copper-alloy objects
                                          known as the Lower Niger Bronzes.
                                        </div>
                                      </div>
                                    </div>
                                  </div>
                                  ...
                                  <div className="teaser__wrapper">
                                    ...
                                    <div className="teaser__content">
                                      <div className="teaser__content-push">
                                        <h3 className="teaser__title">
                                          <a
                                            href="/research/projects/ancestors-artefacts-empire-mobilising-aboriginal-objects"
                                            className="teaser__anchor"
                                          >
                                            <span>
                                              <span>
                                                Ancestors, artefacts, empire –
                                                mobilising Aboriginal objects
                                              </span>
                                            </span>
                                            {/* Add visually hidden defacer for screen-reader. Use full stops for reader punctuation. */}
                                          </a>
                                  ...
                                  <div className="teaser__wrapper">
                                    ...
                                    <div className="teaser__content">
                                      <div className="teaser__content-push">
                                        ...
                                        <h3 className="teaser__title">
                                          <a
                                            href="/our-work/international/international-touring-exhibitions/egyptian-mummies-exploring-ancient-lives"
                                            className="teaser__anchor"
                                          >
                                            <span>
                                              <span>
                                                Egyptian mummies: exploring
                                                ancient lives
                                              </span>
                                            </span>
                                            {/* Add visually hidden defacer for screen-reader. Use full stops for reader punctuation. */}
                                        ...
                                        <div className="teaser__summary">
                                          Discover the lives of six mummies who
                                          lived and died in Egypt between 3,000
                                          and 1,800 years ago. On tour at venues
                                          in Spain from 2022–24.
                                        </div>
                                      </div>
