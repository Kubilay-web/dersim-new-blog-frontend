...
const YoungPeople = () => {
  ...
  useEffect(() => {
    ...
    const category1 = `${categoryPrefix}-60`;
  ...
  useEffect(() => {
    ...
    // Kategoriler dil bazında dinamik olarak ayarlanıyor
    const category1 = `${contentPrefix}-content-55`;
              ...
              <main id="main-content" className="js-main">
                <div>
                  <div
                    ...
                    role="article"
                    aria-labelledby="paragraph-17571-title"
                  >
                        ...
                        <div className="hero__controls">
                          <div className="hero__caption | js-hero-caption">
                            <button
                              ...
                              id="hero-image-caption-button-17571"
                              aria-expanded="false"
                              aria-controls="hero-image-caption-content-17571"
                            >
                            ...
                            <div
                              ...
                              id="hero-image-caption-content-17571"
                              aria-hidden="true"
                              aria-labelledby="hero-image-caption-button-17571"
                            >
                              <button
                                type="button"
                                className="hero__caption-content-close | js-hero-caption-btn"
                                id="hero-image-caption-close-button-17571"
                                aria-expanded="false"
                                aria-controls="hero-image-caption-content-17571"
                              >
                                <span className="visually-hidden">
                              ...
                              <p>
                                {" "}
                                Young people at a Manga late. Photo ©&nbsp;Clive
                                Arrowsmith.
                              </p>
                            </div>
                          </div>
                          ...
                          <div className="section--intro__info">
                            ...
                            <div className="section--intro__info-slices">
                              <div className="paragraph paragraph--type--info-content paragraph--view-mode--default section--intro__info-content wysiwyg">
                                <p>
                                  &nbsp;Follow{" "}
                                  <a href="https://www.instagram.com/bmyoungpeople/">
                                    @bmyoungpeople
                                  </a>{" "}
                                  on Instagram.
                                </p>
                      ...
                      <div>
                        <div>
                          <section
                            ...
                            aria-labelledby="paragraph-17573-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-17573-title"
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  <h3 className="teaser__title">
                                                    <a
                                                      href="/learn/young-people/where-we-are-programme"
                                                      className="teaser__anchor"
                                                    >
                                                      <span>
                                                        <span>
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-17574-title"
                          >
                            <div className="container">
                              <div className="banner__outer">
                                <div className="banner__inner">
                                  ...
                                  <div className="banner__content">
                                    <p>
                                      Get free access to special exhibitions,
                                      events and out-of-hours experiences with
                                      an Under 26 Membership.
                                    </p>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-teaser paragraph--view-mode--default section section--slice-teaser section--z-index-scope section--has-carousel section--bg-white"
                            aria-labelledby="paragraph-17575-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-17575-title"
