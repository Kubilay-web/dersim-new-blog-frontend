...
const Borrow = () => {
  ...
  useEffect(() => {
    ...
    const category1 = `${categoryPrefix}-42`;
  ...
  useEffect(() => {
    ...
    // Kategoriler dil bazında dinamik olarak ayarlanıyor
    const category1 = `${contentPrefix}-content-28`;
  ...
  useEffect(() => {
    ...
    // Kategoriler dil bazında dinamik olarak ayarlanıyor
    const accordion1 = `${accordionPrefix}-accordion-20`;
              ...
              <main id="main-content" className="js-main">
                <div>
                  <div
                    ...
                    role="article"
                    aria-labelledby="paragraph-6708-title"
                  >
                        ...
                        <div className="hero__controls">
                          <div className="hero__caption | js-hero-caption">
                            <button
                              ...
                              id="hero-image-caption-button-6708"
                              aria-expanded="false"
                              aria-controls="hero-image-caption-content-6708"
                            >
                            ...
                            <div
                              ...
                              id="hero-image-caption-content-6708"
                              aria-hidden="true"
                              aria-labelledby="hero-image-caption-button-6708"
                            >
                              <button
                                type="button"
                                className="hero__caption-content-close | js-hero-caption-btn"
                                id="hero-image-caption-close-button-6708"
                                aria-expanded="false"
                                aria-controls="hero-image-caption-content-6708"
                              >
                                <span className="visually-hidden">
                    ...
                    <div className="breadcrumb__inner">
                      <div id="block-breadcrumbs">
                        <nav aria-labelledby="system-breadcrumb">
                          ...
                          >
                            You are in the Our work section
                          </h2>
                          <ul className="breadcrumb__list">
                            ...
                            <li className="breadcrumb__item breadcrumb__item--link">
                              ...
                              <a href="/our-work" className="breadcrumb__link">
                                <span>Our work</span>
                              </a>
                            </li>
                            ...
                            >
                              <ul className="jump-links__list" role="list">
                                <li className="jump-links__item">
                                  <a
                                    href="#making-your-request"
                                    className="jump-links__link"
                                  >
                                    <span>Making your request</span>
                                  </a>
                                </li>
                                <li className="jump-links__item">
                                  <a
                                    href="#how-loans-are-agreed"
                                    className="jump-links__link"
                                  >
                                    <span>How loans are agreed</span>
                                  </a>
                                </li>
                                <li className="jump-links__item">
                                  <a
                                    href="#security-and-facilities-documentation"
                                    className="jump-links__link"
                                  >
                                    <span>
                        ...
                        <div className="section--intro__container">
                          <div className="section--intro__info">
                            ...
                            <div className="section--intro__info-slices">
                              <div className="paragraph paragraph--type--info-content paragraph--view-mode--default section--intro__info-content wysiwyg">
                                <p>
                                  Email:&nbsp;
                                  <a href="/cdn-cgi/l/email-protection#c8a4a7a9a6bb88aabaa1bca1bba0a5bdbbadbda5e6a7baaf">
                                    <span
                                      className="__cf_email__"
                                      data-cfemail="78141719160b381a0a110c110b10150d0b1d0d1556170a1f"
                                    >
                                      [email&nbsp;protected]
                                    </span>
                                  </a>
                              ...
                              <div className="paragraph paragraph--type--info-content paragraph--view-mode--default section--intro__info-content wysiwyg">
                                ...
                                <p>
                                  In case of incidents&nbsp;involving loaned
                                  objects, please contact your Loans Coordinator
                                  or the Control Room&nbsp;immediately.
                                </p>
                                <p>
                                  Phone:&nbsp;<span>+44 (0)</span>20 7323 8210
                                </p>
                              </div>
                            </div>
                          </div>
                          <div className="section--intro__content">
                            ...
                            <div className="wysiwyg">
                              ...
                              <p>
                                The{" "}
                                <a href="/files/loans-policy">Loans Policy</a>{" "}
                                provides further information on broad principles
                                governing loans from the collection.
                              </p>
                            </div> */}
                          </div>
                        </div>
                      ...
                      <div>
                        <div>
                          <section
                            ...
                            aria-labelledby="paragraph-8269-title"
                          >
                            <div className="container">
                              <a
                                className="js-jump-link-anchor"
                                id="making-your-request"
                              />
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-8266"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-8266"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                      ...
                                      <span> Preparing your loan request</span>
                                    </button>
                                  </h3>
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-8266"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-8266"
                                  >
                                    <p>
                                      Prospective borrowers are encouraged to
                                      carry out preliminary research before
                                      making a loan request.
                                    </p>
                                    <p>
                                      A useful resource for planning a loan
                                      request is the&nbsp;
                                      <a
                                        href="/collection"
                                      ...
                                      &nbsp;which gives details on more than
                                      two&nbsp;million items from the
                                      collection.
                                    </p>
                                    <p>
                                      The Museum&nbsp;welcomes informal, early
                                      contact to discuss object selection and
                                      the practicalities of borrowing. Please
                                      contact&nbsp;either&nbsp;the Loans
                                      Section,&nbsp;
                                      <a href="/cdn-cgi/l/email-protection#b7dbd8d6d9c4f7d5c5dec3dec4dfdac2c4d2c2da99d8c5d0">
                                        <span
                                          className="__cf_email__"
                                          data-cfemail="0c60636d627f4c6e7e6578657f6461797f69796122637e6b"
                                        >
                                          [email&nbsp;protected]
                                        </span>
                                      </a>
                                    ...
                                    <p>
                                      For very large requests, it's highly
                                      recommended that you discuss the
                                      loan&nbsp;with the Museum before
                                      ...
                                      intend to request are affected, please
                                      email{" "}
                                      <a href="/cdn-cgi/l/email-protection#2f43404e415c6f4d5d465b465c47425a5c4a5a4201405d48">
                                        <span
                                          className="__cf_email__"
                                          data-cfemail="bdd1d2dcd3cefddfcfd4c9d4ced5d0c8ced8c8d093d2cfda"
                                        >
                                          [email&nbsp;protected]
                                        </span>
                                      </a>
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-8267"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-8267"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                  ...
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-8267"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-8267"
                                  >
                                    <ul>
                                      <li>
                                        Exhibition or display title, venue(s),
                                        and opening and closing dates
                                      </li>
                                      <li>
                                        Details of main exhibition or display
                                        themes
                                      </li>
                                      <li>
                                      ...
                                      <li>
                                        Explanation of how the requested items
                                        fit into a proposed display context or
                                        exhibition concept
                                      </li>
                                      <li>
                                        Names and contact details of the
                                        person(s) responsible at each venue
                                      </li>
                                      <li>
                                        Details of how the requested items will
                                        be insured or indemnified
                                      </li>
                                    </ul>
                                  </div>
                                </div>
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-8268"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-8268"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                  ...
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-8268"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-8268"
                                  >
                                    <p>
                                      Loan requests should be made by formal
                                      letter at least one year in advance of the
                                      exhibition or display opening date.
                                    ...
                                    <p>
                                      ...
                                      address above, or emailed to&nbsp;
                                      <a href="/cdn-cgi/l/email-protection#204449524543544f5241544560425249544953484d555345554d0e4f5247">
                                        <span
                                          className="__cf_email__"
                                          data-cfemail="3a5e53485f594e55485b4e5f7a5848534e534952574f495f4f571455485d"
                                        >
                                          [email&nbsp;protected]
                                        </span>
                                      </a>
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-6714-title"
                          >
                            <div className="container">
                              <a
                                className="js-jump-link-anchor"
                                id="how-loans-are-agreed"
                              />{" "}
                              <div className="section__inner">
                                <h2
                                  id="paragraph-6714-title"
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      A loan request will be reviewed and a
                                      decision will be made based upon advice
                                      from the curatorial and conservation
                                      departments.
                                    </p>
                                    <p>Key considerations:</p>
                                    <ul>
                                      <li>
                                        Relevance of the requested object(s) to
                                        the exhibition/display
                                      </li>
                                      <li>Object(s) availability</li>
                                      <li>
                                        Object(s) suitability for travel and
                                        display
                                      </li>
                                      <li>
                                        Administrative and technical work
                                        involved, in the context of the Museum's
                                        existing programme of activity
                                      </li>
                                    </ul>
                                    <p>
                                      Prospective borrowers should receive a
                                      response within three months of the formal
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-6715-title"
                          >
                            <div className="container">
                              <a
                                className="js-jump-link-anchor"
                                id="security-and-facilities-documentation"
                              />{" "}
                              <div className="section__inner">
                                <h2
                                  id="paragraph-6715-title"
                                  className="section__title section--slice-content__title"
                                >
                                  Security and facilities documentation
                                </h2>
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      Before the loan agreement is signed, the
                                      borrower will be asked to complete
                                      Standard Facilities Reports which will
                                      provide essential information connected
                                      with venue, access, security,
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-6716-title"
                          >
                            <div className="container">
                              <a
                                className="js-jump-link-anchor"
                              ...
                              <div className="section__inner">
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    ...
                                    <ul>
                                      <li>Transportation and courier costs</li>
                                      <li>Crating and packing materials</li>
                                      <li>
                                        Insurance or cover through a national
                                        indemnity scheme
                                      </li>
                                      <li>Condition photography</li>
                                    </ul>
                                    <p>
                                      International borrowers&nbsp;may also be
                                      asked to contribute to the costs of
                                      preparing the items for loan, including
                                      administration, technical and essential
                                      conservation work.
                                    </p>
                                  </div>
                                </div>
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-6717-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-6717-title"
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  <h3 className="teaser__title">
                                                    <a
                                                      href="/our-work/national/uk-touring-exhibitions-and-loans/partnership-galleries"
                                                      className="teaser__anchor"
                                                    >
                                                      <span>
                                                        <span>
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  <h3 className="teaser__title">
                                                    <a
                                                      href="/our-work/international/international-touring-exhibitions"
                                                      className="teaser__anchor"
                                                    >
                                                      <span>
                                                        <span>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-teaser paragraph--view-mode--default section section--slice-teaser section--z-index-scope section--has-carousel section--bg-white"
                            aria-labelledby="paragraph-10940-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-10940-title"
                                    className="section__title teaser-listing__title"
                                  >
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  ...
                                                  <div className="teaser__summary">
                                                    We have records of over four
                                                    million objects online for
                                                    you to explore. What would
