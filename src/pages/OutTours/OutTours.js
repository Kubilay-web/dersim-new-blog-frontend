...
const OutTours = () => {
  ...
  useEffect(() => {
    ...
    // Kategoriler dil bazında dinamik olarak ayarlanıyor
    const category1 = `${contentPrefix}-content-39`;
  ...
  useEffect(() => {
    ...
    // Kategoriler dil bazında dinamik olarak ayarlanıyor
    const accordion1 = `${accordionPrefix}-accordion-9`;
    ...
    <div>
      <div>
        ...
        <meta
          ...
          content="Book your ticket in advance and enjoy an exclusive out-of-hours tour before the gates open to the public. Adults £33."
        />
        <meta
          property="og:image"
              ...
              <main id="main-content" className="js-main">
                <div>
                  <div
                    ...
                    role="article"
                    aria-labelledby="paragraph-2880-title"
                  >
                        ...
                        <div className="hero__controls">
                          <div className="hero__caption | js-hero-caption">
                            <button
                              ...
                              id="hero-image-caption-button-2880"
                              aria-expanded="false"
                              aria-controls="hero-image-caption-content-2880"
                            >
                            ...
                            <div
                              ...
                              id="hero-image-caption-content-2880"
                              aria-hidden="true"
                              aria-labelledby="hero-image-caption-button-2880"
                            >
                              <button
                                type="button"
                                className="hero__caption-content-close | js-hero-caption-btn"
                                id="hero-image-caption-close-button-2880"
                                aria-expanded="false"
                                aria-controls="hero-image-caption-content-2880"
                              >
                                <span className="visually-hidden">
                            ...
                            >
                              <ul className="jump-links__list" role="list">
                                <li className="jump-links__item">
                                  <a
                                    href="#an-introduction-to-the-british-museum"
                                ...
                                <li className="jump-links__item">
                                  <a
                                    href="#an-introduction-to-ancient-egypt"
                                    className="jump-links__link"
                                  >
                                    <span>
                                ...
                                <li className="jump-links__item">
                                  <a
                                    href="#life-and-death-in-ancient-egypt"
                                    className="jump-links__link"
                                  >
                                    <span>Life and death in ancient Egypt</span>
                                  </a>
                                </li>
                                <li className="jump-links__item">
                                  <a
                                    href="#an-introduction-to-china"
                                    className="jump-links__link"
                                  >
                                    <span>An introduction to China</span>
                                  </a>
                                </li>
                                <li className="jump-links__item">
                                  <a
                                    href="#an-introduction-to-the-ancient-greek-world"
                                    className="jump-links__link"
                                  >
                                    <span>
                        ...
                        <div className="section--intro__container">
                          <div className="section--intro__info">
                            ...
                            <div className="section--intro__info-slices">
                              ...
                              <div className="paragraph paragraph--type--info-content paragraph--view-mode--default section--intro__info-content wysiwyg">
                                ...
                                <p>
                                  Main entrance – Great Russell Street (WC1B
                                  3DG)
                                  <br />
                              ...
                              <div className="paragraph paragraph--type--info-content paragraph--view-mode--default section--intro__info-content wysiwyg">
                                ...
                                <p>
                                  <strong>Advance&nbsp;booking only</strong>
                                  <br />
                                  £33 (Adults)
                                  <br />
                                  £30 (Members)
                                  <br />
                                  £30 (Concessions: students, jobseekers,
                                  disabled visitors)
                                  <br />
                                  £16.50&nbsp;(Ages 5–15 years)
                                  <br />
                                  Free for under 5s and disabled visitors'
                                  assistant (no booking required)
                                </p>
                              </div>
                              <div className="paragraph paragraph--type--info-content paragraph--view-mode--default section--intro__info-content wysiwyg">
                                <p>
                                  For any queries on booking please email:&nbsp;
                                  <a href="/cdn-cgi/l/email-protection#fd89949e9698898ebd9f8f9489948e9590888e988890d3928f9a">
                                    <span
                                      className="__cf_email__"
                                      data-cfemail="b8ccd1dbd3ddcccbf8dacad1ccd1cbd0d5cdcbddcdd596d7cadf"
                                    >
                                      [email&nbsp;protected]
                                    </span>
                                  </a>
                          ...
                          <div className="section--intro__content">
                            ...
                            <div className="wysiwyg">
                              <p>
                                Whether you want to navigate the history of the
                                ancient Greeks or walk in the footsteps of
                                pharaohs, immerse yourself in humanity's
                                greatest civilisations without the crowds.
                              </p>
                              <p>
                                Choose from:&nbsp;
                                <br />
                                ...
                                <br />
                                <a href="#life-and-death-in-ancient-egypt">
                                  Life and death in ancient Egypt
                                </a>
                                <br />
                                <a href="#an-introduction-to-china">
                                  An introduction to China
                                </a>
                                <br />
                                <a href="#an-introduction-to-the-ancient-greek-world">
                                  An introduction to the ancient Greek world
                                </a>
                                <br />
                                <br />
                      ...
                      <div>
                        <div>
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-2890-title"
                          >
                            <div className="container">
                              <a
                                className="js-jump-link-anchor"
                                id="an-introduction-to-the-british-museum"
                              />{" "}
                              <div className="section__inner">
                                <h2
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      Explore the oldest room in the Museum in
                                      this special guided tour before the
                                    ...
                                    <p>
                                      ...
                                      ) focuses on the 18th century, an era of
                                      new knowledge, scientific discovery and
                                      European colonialism. The Collecting the
                                      world gallery (
                                      <a
                                        data-entity-type="node"
                                      ...
                                      collection from the 18th century to the
                                      present day.
                                    </p>
                                    <p>
                                      This tour provides a thought-provoking
                                      introduction to the Museum, which you're
                                      free to explore afterwards.
                                    </p>
                                    <p>
                                      <strong>Galleries on this tour:</strong>
                                    </p>
                                    <ul>
                                      <li>
                                        <a
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-2892-title"
                          >
                            <div className="container">
                              <a
                                className="js-jump-link-anchor"
                                id="an-introduction-to-ancient-egypt"
                              />{" "}
                              <div className="section__inner">
                                <h2
                                  id="paragraph-2892-title"
                                  className="section__title section--slice-content__title"
                                >
                                  An introduction to ancient Egypt
                                </h2>
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      Enjoy exploring one of the most iconic
                                      spaces in the Museum and discover the
                                      fascinating history of ancient Egypt in
                                      this special guided tour, before the
                                      galleries open to the public.
                                    </p>
                                    <p>
                                      ...
                                      ), you can&nbsp;see impressive statues of
                                      kings and gods, monumental tomb
                                      architecture and ancient tomb reliefs
                                      spanning 3,000&nbsp;years. These include
                                      the imposing colossal bust of Ramesses II
                                      and the Gayer-Anderson Cat. You
                                      can&nbsp;learn the importance of
                                      large-scale sculpture in ancient Egyptian
                                      temples and tombs, and get the perfect
                                      introduction to this unmissable
                                      collection.&nbsp;
                                    </p>
                                    <p>
                                      <strong>
                                        <span>Gallery on this tour:&nbsp;</span>
                                      </strong>
                                    </p>
                                    <ul>
                                      <li>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-19618-title"
                          >
                            <div className="container">
                              <a
                                className="js-jump-link-anchor"
                                id="life-and-death-in-ancient-egypt"
                              />{" "}
                              <div className="section__inner">
                                <h2
                                  id="paragraph-19618-title"
                                  className="section__title section--slice-content__title"
                                >
                                  Life and death in ancient Egypt
                                </h2>
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      Discover how people lived and died in
                                      ancient Egypt and explore their hopes and
                                      aspirations for the afterlife.&nbsp;
                                      <br />
                                      &nbsp;
                                      <br />
                                      From human remains, painted coffins,
                                      amulets, shabtis and tomb models of daily
                                      life to spectacular wall paintings and
                                      papyri; investigate what tombs, human
                                      remains and burial goods tell us about the
                                      lives and afterlives of ancient Egyptian
                                      people. The tour will explore the
                                      preparation of the deceased for burial,
                                      including mummification, the furnishing of
                                      the tomb for an eternal restful existence,
                                      and the use of magic to guide and protect
                                      people on their perilous journey to the
                                      afterlife. It will also show how funerary
                                      remains can tell us about the lives of the
                                      ancient Egyptians.
                                    </p>
                                    <p>
                                      ...
                                      holding, display and study of&nbsp;
                                      <a
                                        href="/our-work/departments/human-remains"
                                        data-entity-type="node"
                                        data-entity-uuid="cc85a006-bb78-4eb7-b60c-f8a098ba3d65"
                                        data-entity-substitution="canonical"
                                        title="Human remains"
                                      >
                                        human remains
                                ...
                                <aside className="section--slice-content__embed">
                                  <div className="paragraph paragraph--type--embedded-media paragraph--view-mode--default">
                                    <figure className="media media-embed media-image js-media">
                                      ...
                                      />
                                      <figcaption>
                                        A visitor inspecting the Nebamun tomb
                                        paintings in{" "}
                                        <a
                                          data-entity-substitution="canonical"
                                          data-entity-type="node"
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-22343-title"
                          >
                            <div className="container">
                              <a
                                className="js-jump-link-anchor"
                                id="an-introduction-to-china"
                              />{" "}
                              <div className="section__inner">
                                <h2
                                  id="paragraph-22343-title"
                                  className="section__title section--slice-content__title"
                                >
                                  An introduction to China
                                </h2>
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      Journey through the extraordinary cultures
                                      of China in this special guided tour
                                    ...
                                    <p>
                                      ...
                                      development of Chinese history and culture
                                      from 5000 BC to the present day.
                                    </p>
                                    <p>
                                      In a beautifully refurbished space which
                                      has recently re-opened, this introductory
                                      tour will give you a deep appreciation for
                                      the magnificent objects on display.
                                      Featuring spectacular Tang dynasty tomb
                                      figures buried around AD 728 and beautiful
                                      Ming dynasty blue-and-white porcelain.
                                    </p>
                                    <p>
                                      <strong>Gallery on this tour:</strong>
                                    </p>
                                    <ul type="disc">
                                      <li>
                                        <a href="http://localhost:3000/collection/galleries/china-and-south-asia">
                                    ...
                                    <figure className="media media-embed media-image js-media">
                                      ...
                                      <figcaption>
                                        ...
                                        >
                                          ...
                                          <em>The Sir Joseph Hotung Gallery</em>
                                        </a>
                                        .
                                      </figcaption>
                                    </figure>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-24012-title"
                          >
                            <div className="container">
                              <a
                                className="js-jump-link-anchor"
                                id="an-introduction-to-the-ancient-greek-world"
                              />{" "}
                              <div className="section__inner">
                                <h2
                                  id="paragraph-24012-title"
                                  className="section__title section--slice-content__title"
                                >
                                  An introduction to the ancient Greek world
                                </h2>
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      Embark on a guided journey through the
                                      ancient Greek world; from the rise of the
                                      Greek city states to the empire of
                                      Alexander the Great.
                                    </p>
                                    <p>
                                      Enjoy some of the highlights of the
                                      Museum's exceptional collection, including
                                      sculptures from the Parthenon and
                                      Mausoleum of Halikarnassos, regarded as
                                ...
                                <aside className="section--slice-content__embed">
                                  <div className="paragraph paragraph--type--embedded-media paragraph--view-mode--default">
                                    <figure className="media media-embed media-image js-media">
                                      ...
                                      />
                                      <figcaption>
                                        <a href="/collection/object/G_1816-0610-46-b">
                                          Marble relief from the North frieze of
                                          the Parthenon
                                        </a>
                                        .
                                      </figcaption>
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-19761-title"
                          >
                            <div className="container">
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-19755"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-19755"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                      ...
                                      <span>
                                        {" "}
                                        How many places are available on each
                                        tour?
                                      </span>
                                    </button>
                                  </h3>
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-19755"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-19755"
                                  >
                                    <p>
                                      Tours are limited to a maximum of 20
                                      places per session (14 for Life and death
                                      in ancient Egypt). If you would like to
                                      bring a group of 10 or more people or
                                      arrange a special out-of-hours tour,
                                      please email{" "}
                                      <a href="/cdn-cgi/l/email-protection#3642445740535a42445752535459595d5f5851457654445f425f455e5b434553435b18594451">
                                        <span
                                          className="__cf_email__"
                                          data-cfemail="4f3b3d2e392a233b3d2e2b2a2d2020242621283c0f2d3d263b263c27223a3c2a3a2261203d28"
                                        >
                                          [email&nbsp;protected]
                                        </span>
                                      </a>{" "}
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-19756"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-19756"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                      ...
                                      <span>
                                        {" "}
                                        Can I bring wheeled cases and large
                                        items of luggage with me?
                                      </span>
                                    </button>
                                  </h3>
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-19756"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-19756"
                                  >
                                    <p>
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-19757"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-19757"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                      ...
                                      <span> Will the cloakroom be open?</span>
                                    </button>
                                  </h3>
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-19757"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-19757"
                                  >
                                    <p>
                                      Cloakroom facilities are not available on
                                      these tours.
                                    </p>
                                  </div>
                                </div>
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-19758"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-19758"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                      ...
                                      <span> When does the tour start?</span>
                                    </button>
                                  </h3>
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-19758"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-19758"
                                  >
                                    <p>
                                      <span>
                                        Each tour starts at 09.00&nbsp;and lasts
                                        for one&nbsp;hour, including time at the
                                        end for you to take photographs.
                                      </span>
                                    </p>
                                  </div>
                                </div>
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-19759"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-19759"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                      ...
                                      <span>
                                        {" "}
                                        Can I continue my Museum visit after the
                                        tour?
                                      </span>
                                    </button>
                                  </h3>
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-19759"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-19759"
                                  >
                                    <p>
                                      Once the tour ends
                                      your&nbsp;tour&nbsp;ticket enables access
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-19760"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-19760"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                      ...
                                      <span> Can groups visit the Museum?</span>
                                    </button>
                                  </h3>
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-19760"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-19760"
                                  >
                                    <p className="MsoNormal">
                                      If you wish to bring a group of eight or
                                      more people or arrange a special
                                      out-of-hours tour, please email{" "}
                                      <a href="/cdn-cgi/l/email-protection#542026352231382026353031363b3b3f3d3a33271436263d203d273c3921273121397a3b2633">
                                        <span
                                          className="__cf_email__"
                                          data-cfemail="fc888e9d8a9990888e9d98999e93939795929b8fbc9e8e9588958f9491898f998991d2938e9b"
                                        >
                                          [email&nbsp;protected]
                                        </span>
                                      </a>{" "}
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-6645-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-6645-title"
                                              ...
                                              <div className="teaser__image-container">
                                                <div className="media media-teaser_landscape media-image js-media">
                                                  <img
                                                    ...
                                                    width={750}
                                                    height={422}
                                                    src="/images/OutTours/image-01.jpg"
                                                  />
                                                </div>
                                              </div>
                                              ...
                                              <div className="teaser__image-container">
                                                <div className="media media-teaser_landscape media-image js-media">
                                                  <img
                                                    ...
                                                    width={750}
                                                    height={422}
                                                    src="/images/OutTours/image-02.jpg"
                                                  />
                                                </div>
                                              </div>
                                              <div className="teaser__content">
                                              ...
                                              <div className="teaser__image-container">
                                                <div className="media media-teaser_landscape media-image js-media">
                                                  <img
                                                    ...
                                                    width={750}
                                                    height={422}
                                                    src="/images/OutTours/image-03.jpg"
                                                  />
                                                </div>
                                              </div>
                                              <div className="teaser__content">
                                              ...
                                              <div className="teaser__image-container">
                                                <div className="media media-teaser_landscape media-image js-media">
                                                  <img
                                                    ...
                                                    width={750}
                                                    height={422}
                                                    src="/images/OutTours/image-04.jpg"
                                                  />
                                                </div>
                                              </div>
                                              <div className="teaser__content">
