...
const Filming = () => {
  ...
  useEffect(() => {
    ...
    const category1 = `${categoryPrefix}-26`;
  ...
  useEffect(() => {
    ...
    // Kategoriler dil bazında dinamik olarak ayarlanıyor
    const category1 = `${contentPrefix}-content-23`;
              ...
              <main id="main-content" className="js-main">
                <div>
                  <div
                    ...
                    role="article"
                    aria-labelledby="paragraph-5879-title"
                  >
                        ...
                        <div className="hero__controls">
                          <div className="hero__caption | js-hero-caption">
                            <button
                              ...
                              id="hero-image-caption-button-5879"
                              aria-expanded="false"
                              aria-controls="hero-image-caption-content-5879"
                            >
                            ...
                            <div
                              ...
                              id="hero-image-caption-content-5879"
                              aria-hidden="true"
                              aria-labelledby="hero-image-caption-button-5879"
                            >
                              <button
                                type="button"
                                className="hero__caption-content-close | js-hero-caption-btn"
                                id="hero-image-caption-close-button-5879"
                                aria-expanded="false"
                                aria-controls="hero-image-caption-content-5879"
                              >
                                <span className="visually-hidden">
                        ...
                        <div className="section--intro__container">
                          <div className="section--intro__info">
                            ...
                            <div className="section--intro__info-slices">
                              <div className="paragraph paragraph--type--info-content paragraph--view-mode--default section--intro__info-content wysiwyg">
                                <p>
                                  Email:{" "}
                                  <a href="/cdn-cgi/l/email-protection#b2d4dbdedfdbdcd5f2d0c0dbc6dbc1dadfc7c1d7c7df9cddc0d5">
                                    <span
                                      className="__cf_email__"
                                      data-cfemail="1d7b74717074737a5d7f6f7469746e7570686e78687033726f7a"
                                    >
                                      [email&nbsp;protected]
                                    </span>
                                  </a>
                                  <br />
                                  Please don't contact curators directly.
                                </p>
                              </div>
                              <div className="paragraph paragraph--type--info-content paragraph--view-mode--default section--intro__info-content wysiwyg">
                                <p>Phone: +44 (0)20 7323 8016</p>
                              </div>
                              <div className="intro-link--button paragraph paragraph--type--info-link paragraph--view-mode--default">
                                <a
                                  ...
                                  href="/terms-use/filming"
                                >
                                  <span>See filming terms and conditions</span>
                                </a>
                              </div>
                            </div>
                          </div>
                          <div className="section--intro__content">
                            ...
                            <div className="wysiwyg">
                              <p>
                                You'll be guided through every stage of the
                                process. From site visit, administration and
                                pre-planning through to managing your filming
                                day, the Museum has dedicated staff&nbsp;to help
                                you.
                              </p>
                              <p>
                                If you're looking for footage of our objects and
                                spaces and don't have time to film, we have a
                                growing archive of high-quality video footage
                                which we license to programme-makers.
                              </p>
                              <p>
                                Contact{" "}
                                <a href="https://www.bmimages.com">BM Images</a>{" "}
                                if you'd like to license existing footage.
                              </p>
                            </div> */}
                          </div>
                        </div>
                      ...
                      <div>
                        <div>
                          <section
                            ...
                            aria-labelledby="paragraph-7179-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-7179-title"
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  <h3 className="teaser__title">
                                                    <a
                                                      href="/commercial/filming/locations"
                                                      className="teaser__anchor"
                                                    >
                                                      <span>
                                                        <span>Locations</span>
                          ...
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-5891-title"
                                    className="visually-hidden teaser-listing__title"
                                  >
                                    Further information about filming
                                  </h2>
                                  <div className="carousel-container | js-carousel-container">
                                    <div
                                      className="teaser-listing carousel carousel--2-col swiper-container | js-carousel-2-col"
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  <h3 className="teaser__title">
                                                    <a
                                                      href="/commercial/filming/consult-curators"
                                                      className="teaser__anchor"
                                                    >
                                                      <span>
                                                        <span>
                                                  ...
                                                  <div className="teaser__summary">
                                                    The Museum's curators are
                                                    experts in their fields and
                                                    can give advice, insight and
                                                    information.
                                                  </div>
                                                </div>
                                              </div>
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  <h3 className="teaser__title">
                                                    <a
                                                      href="/commercial/filming/making-your-application"
                                                      className="teaser__anchor"
                                                    >
                                                      <span>
                                                        <span>
                              ...
                              <div className="section__inner">
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      If you decide to film at the Museum,
                                      you'll be in good company. The following
                                      were all filmed here:
                                    </p>
                                    <ul>
                                      <li>The Wakefield Case&nbsp;(1921)</li>
                                      <li>
                                        Blackmail&nbsp;(1929) (low-level light
                                        meant Hitchcock used photographic
                                        backdrops)
                                      </li>
                                      <li>Bulldog Jack&nbsp;(1935)</li>
                                      <li>Night of the Demon&nbsp;(1957)</li>
                                      <li>Phaedra&nbsp;(1962)</li>
                                      <li>The Ipcress File&nbsp;(1965)</li>
                                      <li>Day of the Jackal&nbsp;(1973)</li>
                                      <li>Maurice&nbsp;(1987)</li>
                                      <li>Tale of the Mummy&nbsp;(1998)</li>
                                      <li>The Mummy Returns&nbsp;(2001)</li>
                                      <li>Possession&nbsp;(2002)</li>
                                      <li>
                                      ...
                                      <li>
                                        Wonder Woman (2017) (not set in the
                                        museum)
                                      </li>
                                      <li>Gold Digger (2019) BBC Drama</li>
                                      <li>Ammonite (2019)</li>
                                    </ul>
                                    <p>&nbsp;</p>
                                  </div>
