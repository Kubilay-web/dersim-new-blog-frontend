    ...
    <div>
      <div>
        ...
        <meta
          ...
          content="Explore the British Museum collection and journey through two million years of human history."
        />
        <meta
          property="og:image"
        ...
        <link
          rel="stylesheet"
          media="all"
          href="/sites/default/files/css/css_0kuC3UYdcfwlYha80V5JqkujpbPzqxW_GPn3cKpr41U.css?delta=0&language=en&theme=numiko&include=eJxtzTEOwzAIQNELOfGRImwjG5UAAjPk9u1Wqer6_vDjiY13bRBYJG96aZ2sDfiI_TDJ_NXuZDuOhTDQ_8di4DAdbEUdngZ8fuVMsWxMsXCUrszYN6nEpfLZYW0pg_ENgpk7UA"
        />
        <link
          rel="stylesheet"
          media="all"
          href="/sites/default/files/css/css_VAvkHRcLHSWwq0ovHYJ-IGyjWbQie-FPraftF1kr7dQ.css?delta=1&language=en&theme=numiko&include=eJxtzTEOwzAIQNELOfGRImwjG5UAAjPk9u1Wqer6_vDjiY13bRBYJG96aZ2sDfiI_TDJ_NXuZDuOhTDQ_8di4DAdbEUdngZ8fuVMsWxMsXCUrszYN6nEpfLZYW0pg_ENgpk7UA"
        />
        <link
          rel="stylesheet"
          media="print"
          ...
          >
            <div className="layout-container">
              ...
              <div>
                <div id="block-alerts">
                  <div
                    className="alert alert--type--content-alert alert--polite js-alert"
                    role="alert"
                    style={{ display: "block" }}
                  >
                    <div className="container">
                      <div className="alert__inner">
                        <svg
                          ...
                          aria-hidden="true"
                        >
                          <use xlinkHref="#sprite-icon-alert" />
                        </svg>
                        <div className="alert__content | js-alert-text">
                          We're aware that some users are still experiencing
                          issues with Collection online. We're working hard to
                          resolve this.
                        </div>
                        <div className="alert__controls">
                          <button type="button" className="js-alert-close">
                            <span>Close</span>{" "}
              ...
              <main id="main-content" className="js-main">
                <div>
                  <section
                    className="paragraph paragraph--type--slice-collection-hero paragraph--view-mode--default hero hero--has-overlay hero--collection js-hero"
                    aria-labelledby="paragraph-13081-title"
                  >
                    <div className="hero__background">
                      <div className="media media-hero media-image js-media">
                        <picture>
                          ...
                          <source
                            src="/images/Collection/image-01.jpg"
                    ...
                    <div className="hero__inner">
                      <div
                        className="hero__content-full-width | js-collections-hero"
                        data-hero-title='"Explore the&nbsp;collection"'
                        data-hero-caption='"<p>Welcome to the new version of Collection online. Find out more about <a href=\"\/development\" data-entity-type=\"node\" data-entity-uuid=\"b9286e1d-19cc-4144-8a67-750fd7bd13b1\">ongoing improvements<\/a>. For help and further information read our <a href=\"\/collection\/collection-online\/guide\" data-entity-type=\"node\" data-entity-uuid=\"0c04fef0-b57e-43cd-9fa0-fe40cdfcfa1b\" data-entity-substitution=\"canonical\">online guide<\/a>.<\/p>"'
                      >
                        <header>
                                ...
                                <div className="hero-col__heading">
                                  ...
                                  <div className="hero-col__caption">
                                    <p>
                                      ...
                                      online. Find out more about{" "}
                                      <a
                                        href="/development"
                                        data-entity-type="node"
                                        data-entity-uuid="b9286e1d-19cc-4144-8a67-750fd7bd13b1"
                                      >
                                        ongoing improvements
                                      </a>
                                      . For help and further information read
                                      our{" "}
                                      <a
                                        href="/collection/collection-online/guide"
                                        data-entity-type="node"
                                        data-entity-uuid="0c04fef0-b57e-43cd-9fa0-fe40cdfcfa1b"
                                          ...
                                          >
                                            ...
                                            <div className="vs__actions">
                                              ...
                                              <svg
                                                ...
                                                focusable="false"
                                                aria-hidden="true"
                                                className="icon icon--chevron vs__open-indicator"
                                              >
                                    ...
                                    <div className="hero-col-search__field hero-col-search__field--input">
                                      <div className="hero-col-search__group">
                                        <div className="hero-col-search__field--input">
                                          ...
                                          >
                                            Enter a <strong>keyword</strong>,{" "}
                                            <strong>person</strong>,{" "}
                                            <strong>place</strong> or{" "}
                                          ...
                                          <div className="hero-col-search__input-container">
                                            <input
                                              ...
                                              type="search"
                                              placeholder="Enter a keyword, person, place, or museum number"
                                              role="combobox"
                                              maxLength={128}
                                              required="required"
                                              aria-expanded="false"
                        ...
                        <div className="section__inner">
                          <div className="jump-links">
                            <button
                              ...
                              aria-expanded="false"
                              aria-controls="jump-link-content"
                            >
                              Contents
                              <svg
                                className="icon icon--chevron"
                            ...
                            <div
                              ...
                              aria-hidden="true"
                              aria-labelledby="jump-link-button"
                            >
                              <ul className="jump-links__list" role="list">
                                ...
                                <li className="jump-links__item">
                                  <a href="#blog" className="jump-links__link">
                                    <span>Blog</span>
                                  </a>
                                </li>
                              </ul>
                        ...
                        <div className="section--intro__container">
                          <div className="section--intro__info">
                            <div className="section--intro__info-slices section--intro__info-slices-no-title">
                              <div className="intro-link--link paragraph paragraph--type--info-link paragraph--view-mode--default">
                                ...
                                >
                                  <span>Explore the galleries</span>
                                  <svg
                                    className="icon icon--chevron"
                                    role="presentation"
                                    focusable="false"
                          ...
                          <div className="section--intro__content">
                            ...
                            <div className="wysiwyg">
                              <p>
                                Collection online allows access to almost four
                                and a half million objects in more than two
                                million records. High definition images can be
                                enlarged and examined in detail which will
                                enable you to view the incredible workmanship on
                                the{" "}
                                <a href="/collection/object/W_1928-1009-378">
                                  Royal Game of Ur
                                </a>
                                , or the intricate carving on this{" "}
                                <a href="/collection/object/E_Af1979-01-3156">
                                  African hunting horn
                                </a>{" "}
                                – just a few of the thousands of highlights to
                                discover.&nbsp;
                              </p>
                              <p>
                                Enjoy exploring the collection – from some of
                                the earliest objects created by humankind to
                                works by contemporary artists. Or choose from
                                the curated collections below, which reveal the
                                fascinating stories that transcend time.
                              </p>
                              <ul>
                                <li>
                                  <a
                                    href="/collection/desire-love-and-identity"
                                    data-entity-type="node"
                                    data-entity-uuid="1070f664-670b-4fe4-97f5-a10529282c3f"
                                  >
                                ...
                                <li>
                                  <a
                                    ...
                                    data-entity-type="node"
                                    data-entity-uuid="a33472e9-3bc2-4bdc-8fba-0559200c75a1"
                                  >
                                    Death and memory
                                  </a>
                                </li>
                                <li>
                                  <a
                                    ...
                                    data-entity-type="node"
                                    data-entity-uuid="613638c1-6e04-487d-af34-756d528f4072"
                                  >
                                    Americas
                                  </a>
                                </li>
                                <li>
                                  <a
                                    ...
                                    data-entity-type="node"
                                    data-entity-uuid="0e491fd1-50da-40bb-ac2c-80fc75b8d667"
                                  >
                                    China
                                  </a>
                                </li>
                    ...
                    <div id="block-numiko-mainpagecontent">
                      <div>
                        <div>
                                    ...
                                    >
                                      ...
                                      >
                                        <button
                                          type="button"
                                          className="carousel--gallery__button | js-photoswipe-item"
                                          data-large-image-url="/sites/default/files/styles/uncropped_huge/public/2019-10/Brass%20head%20with%20a%20beaded%20crown%20and%20plume%2C%20Ife%2C%20Nigeria.jpg"
                                          data-large-image-width={1501}
                                          data-large-image-height={2000}
                                          data-description='<strong>Brass head of an Ooni (king) of Ife, Nigeria 1300s – early 1400s</strong><br>This crowned head was discovered by accident in 1939 during digging close to the royal palace in Ife. Between 1100 and 1400 Ife was one of the great city-states in West Africa and flourished as a commercial centre within regional and long-distance trade networks. <a href="/collection/object/E_Af1939-34-1"><span>Collection online</span></a>'
                                          data-caption
                                          data-lang
                                        >
                                          <span className="visually-hidden">
                                        ...
                                        <div className="carousel--gallery__content">
                                          <div className="media media-gallery media-image js-media">
                                            <img
                                              ...
                                              data-sizes="auto"
                                              data-focal-position="center center"
                                              alt="Brass head wearing a crown. "
                                              sizes="518px"
                                              src="/images/Collection/image-03.webp"
                                            />
                                          </div>
                                          <p className="carousel--gallery__item-title">
                                            Brass head of an Ooni (king) of Ife
                                      ...
                                      >
                                        <button
                                          type="button"
                                          className="carousel--gallery__button | js-photoswipe-item"
                                          data-large-image-url="/sites/default/files/styles/uncropped_huge/public/2019-10/goddess-tara-south-asia-buddhism-british-museum.jpg"
                                          data-large-image-width={921}
                                          data-large-image-height={2000}
                                          data-description='<strong>The goddess Tara, found between Trincomalee and Batticaloa, Sri Lanka, made AD 700–750</strong><br>This bronze statue of Buddhist goddess Tara was found on the east coast of Sri Lanka, and is evidence of the presence in the medieval period of Mahayana Buddhism. <a href="/collection/object/A_1830-0612-4"><span>Collection online</span></a>'
                                          data-caption
                                          data-lang
                                        >
                                          <span className="visually-hidden">
                                            Goddess Tara - opens in a modal
                                        ...
                                        <div className="carousel--gallery__content">
                                          <div className="media media-gallery media-image js-media">
                                            <img
                                              ...
                                              data-sizes="auto"
                                              data-focal-position="center center"
                                              alt="Gold female naked from waste up."
                                              sizes="518px"
                                              src="/images/Collection/image-04.webp"
                                            />
                                          </div>
                                          <p className="carousel--gallery__item-title">
                                            Goddess Tara
                                      ...
                                      >
                                        <button
                                          type="button"
                                          className="carousel--gallery__button | js-photoswipe-item"
                                          data-large-image-url="/sites/default/files/styles/uncropped_huge/public/2019-11/Raphael.jpg"
                                          data-large-image-width={1600}
                                          data-large-image-height={2145}
                                          data-description="<strong>Raphael cartoon for 'Virgin and Child', 1509–1511</strong><br>This is a cartoon for a painting in the National Gallery of the 'Virgin and Child' (NG 2069), a work generally known as the 'Mackintosh Madonna' after its donor Miss Eva Mackintosh. The National Gallery picture is in a ruinous and repainted condition, in part due to it having been transferred from panel to canvas in the 18th century. Although the cartoon is in a better state than the painting it too has suffered: the chalk or charcoal (or perhaps a combination of the two) and the paper are much abraded. As a result, in the more shadowed areas the tonal gradations and the underlying modelling of form have been blurred to a virtually impenetrable blackness. <a href=&quot;/collection/object/P_1894-0721-1&quot;><span>Collection online</span></a>"
                                          data-caption
                                          data-lang
                                        >
                                          <span className="visually-hidden">
                                            Raphael cartoon for 'Virgin and
                                            Child' - opens in a modal which
                                            shows a larger image and a caption
                                          </span>
                                        </button>
                                        <div className="carousel--gallery__content">
                                          <div className="media media-gallery media-image js-media">
                                            <img
                                              ...
                                              data-sizes="auto"
                                              data-focal-position="center center"
                                              alt="drawing of virgin and baby christ"
                                              sizes="518px"
                                              src="/images/Collection/image-05.jpg"
                                            />
                                          </div>
                                          <p className="carousel--gallery__item-title">
                                            Raphael cartoon for 'Virgin and
                                      ...
                                      >
                                        <button
                                          type="button"
                                          className="carousel--gallery__button | js-photoswipe-item"
                                          data-large-image-url="/sites/default/files/styles/uncropped_huge/public/2019-10/lewis-chessmen-carved-scotland-british-museum.jpg"
                                          data-large-image-width={1600}
                                          data-large-image-height={1309}
                                          data-description='<strong>Lewis Chessmen, 1150–1200</strong><br>These chess pieces, found on the Isle of Lewis, Scotland,&nbsp;are made from elaborately worked walrus ivory and whales&apos; teeth in the forms of seated kings and queens, bishops, knights on their mounts, standing warders and pawns in the shape of obelisks. They form a remarkable group of iconic objects within the world collection of the British Museum. They were probably made in Scandinavia, thought to be Norway, about AD 1150–1200. <a href="/collection/search?keyword=%22The%20Lewis%20Chessmen%22&object=chess-piece&dateFrom=1100&eraFrom=ad&dateTo=1200&eraTo=ad&view=grid&sort=object_name__asc&page=1"><span>Collection online</span></a>'
                                          data-caption
                                          data-lang
                                        >
                                          <span className="visually-hidden">
                                            Lewis Chessmen - opens in a modal
                                            which shows a larger image and a
                                            caption
                                          </span>
                                        </button>
                                        <div className="carousel--gallery__content">
                                          <div className="media media-gallery media-image js-media">
                                            <img
                                              ...
                                              width={856}
                                              height={700}
                                              data-src="/sites/default/files/styles/bm_gallery_medium_700h/public/2019-10/lewis-chessmen-carved-scotland-british-museum.jpg?itok=2uXe_igl"
                                              data-sizes="auto"
                                              data-srcset="/sites/default/files/styles/bm_gallery_medium_700h/public/2019-10/lewis-chessmen-carved-scotland-british-museum.jpg?itok=2uXe_igl 856w"
                                              data-focal-position="top center"
                                              alt="The Lewis Chessmen on a chessboard mid-game, three figures in focus with eyes wide."
                                              sizes="518px"
                                              srcSet="/sites/default/files/styles/bm_gallery_medium_700h/public/2019-10/lewis-chessmen-carved-scotland-british-museum.jpg?itok=2uXe_igl 856w"
                                              src="/sites/default/files/styles/bm_gallery_medium_700h/public/2019-10/lewis-chessmen-carved-scotland-british-museum.jpg?itok=2uXe_igl"
                                            />
                                            <noscript>
                                              &lt;img loading="eager"
                                              srcset="/sites/default/files/styles/bm_gallery_medium_700h/public/2019-10/lewis-chessmen-carved-scotland-british-museum.jpg?itok=2uXe_igl
                                              856w" width="856" height="700"
                                              data-src="/sites/default/files/styles/bm_gallery_medium_700h/public/2019-10/lewis-chessmen-carved-scotland-british-museum.jpg?itok=2uXe_igl"
                                              data-sizes="auto" alt="The Lewis
                                              Chessmen on a chessboard mid-game,
                                              three figures in focus with eyes
                                              wide." /&gt;
                                            </noscript>
                                          </div>
                                          <p className="carousel--gallery__item-title">
                                      ...
                                      >
                                        <button
                                          type="button"
                                          className="carousel--gallery__button | js-photoswipe-item"
                                          data-large-image-url="/sites/default/files/styles/uncropped_huge/public/2019-10/west-papua-asmat-sheild-british-musuem.jpg"
                                          data-large-image-width={799}
                                          data-large-image-height={2000}
                                          data-description='<strong>Shield from West Papua, mid-20th century</strong><br>This wood shield is carved in relief and coloured red and white. The pattern includes zoomorphic heads and feet or hands. The back is coloured half red and half white, divided longitudinally. <a href="/collection/object/E_Oc1969-13-78"><span>Collection online</span></a>'
                                          data-caption
                                          data-lang
                                        >
                                          <span className="visually-hidden">
                                            Shield from West Papua - opens in a
                                        ...
                                        <div className="carousel--gallery__content">
                                          <div className="media media-gallery media-image js-media">
                                            <img
                                              ...
                                              width={280}
                                              height={700}
                                              data-src="/sites/default/files/styles/bm_gallery_medium_700h/public/2019-10/west-papua-asmat-sheild-british-musuem.jpg?itok=TFvI7CGE"
                                              data-sizes="auto"
                                              data-srcset="/sites/default/files/styles/bm_gallery_medium_700h/public/2019-10/west-papua-asmat-sheild-british-musuem.jpg?itok=TFvI7CGE 280w"
                                              data-focal-position="center center"
                                              alt="Large human shield with white and orange detail."
                                            />
                                            <noscript>
                                              &lt;img loading="eager"
                                              srcset="/sites/default/files/styles/bm_gallery_medium_700h/public/2019-10/west-papua-asmat-sheild-british-musuem.jpg?itok=TFvI7CGE
                                              280w" width="280" height="700"
                                              data-src="/sites/default/files/styles/bm_gallery_medium_700h/public/2019-10/west-papua-asmat-sheild-british-musuem.jpg?itok=TFvI7CGE"
                                              data-sizes="auto" alt="Large human
                                              shield with white and orange
                                              detail." /&gt;
                                            </noscript>
                                          </div>
                                          <p className="carousel--gallery__item-title">
                                      ...
                                      >
                                        <button
                                          type="button"
                                          className="carousel--gallery__button | js-photoswipe-item"
                                          data-large-image-url="/sites/default/files/styles/uncropped_huge/public/2019-09/Achilles%20defeating%20Penthesilea%2C%20the%20Amazon%20Queen.%20Black-figured%20amphora%20%28wine-jar%29%20signed%20by%20Exekias.%20Athens%2C%20Attica%2C%20Greece.%20c.540-530%20BC.jpg"
                                          data-large-image-width={1600}
                                          data-large-image-height={1902}
                                          data-description='<strong>Ancient Greek black-figured amphora (wine jar), dated 540–530 BC</strong><br>Signed by Exekias as potter and attributed to him as painter. The scene on this vase shows Achilles looming above Amazon warrior Penthesilea as she sinks to the ground. <a href="/collection/object/G_1849-0518-10"><span>Collection online</span></a>'
                                          data-caption
                                          data-lang
                                        >
                                          <span className="visually-hidden">
                                            Ancient Greek black-figured amphora
                                            (wine jar) - opens in a modal which
                                            shows a larger image and a caption
                                          </span>
                                        </button>
                                        <div className="carousel--gallery__content">
                                          <div className="media media-gallery media-image js-media">
                                            <img
                                              ...
                                              width={589}
                                              height={700}
                                              data-src="/sites/default/files/styles/bm_gallery_medium_700h/public/2019-09/Achilles%20defeating%20Penthesilea%2C%20the%20Amazon%20Queen.%20Black-figured%20amphora%20%28wine-jar%29%20signed%20by%20Exekias.%20Athens%2C%20Attica%2C%20Greece.%20c.540-530%20BC.jpg?itok=X_SFi-CL"
                                              data-sizes="auto"
                                              data-srcset="/sites/default/files/styles/bm_gallery_medium_700h/public/2019-09/Achilles%20defeating%20Penthesilea%2C%20the%20Amazon%20Queen.%20Black-figured%20amphora%20%28wine-jar%29%20signed%20by%20Exekias.%20Athens%2C%20Attica%2C%20Greece.%20c.540-530%20BC.jpg?itok=X_SFi-CL 589w"
                                              data-focal-position="center center"
                                              alt="Greek wine jar depicting Achilles defeating Penthesilea, the Amazon Queen."
                                            />
                                            <noscript>
                                              &lt;img loading="eager"
                                              srcset="/sites/default/files/styles/bm_gallery_medium_700h/public/2019-09/Achilles%20defeating%20Penthesilea%2C%20the%20Amazon%20Queen.%20Black-figured%20amphora%20%28wine-jar%29%20signed%20by%20Exekias.%20Athens%2C%20Attica%2C%20Greece.%20c.540-530%20BC.jpg?itok=X_SFi-CL
                                              589w" width="589" height="700"
                                              data-src="/sites/default/files/styles/bm_gallery_medium_700h/public/2019-09/Achilles%20defeating%20Penthesilea%2C%20the%20Amazon%20Queen.%20Black-figured%20amphora%20%28wine-jar%29%20signed%20by%20Exekias.%20Athens%2C%20Attica%2C%20Greece.%20c.540-530%20BC.jpg?itok=X_SFi-CL"
                                              data-sizes="auto" alt="Greek wine
                                              jar depicting Achilles defeating
                                      ...
                                      >
                                        ...
                                        >
                                          <span className="visually-hidden">
                                            The Lycurgus Cup - opens in a modal
                                            which shows a larger image and a
                                            caption
                                          </span>
                                        </button>
                                        <div className="carousel--gallery__content">
                                          <div className="media media-gallery media-image js-media">
                                            <img
                                              ...
                                              width={525}
                                              height={700}
                                              data-src="/sites/default/files/styles/bm_gallery_medium_700h/public/2019-10/lycurgus-cup-rome-british-museum.jpg?itok=begRDDEr"
                                              data-sizes="auto"
                                              data-srcset="/sites/default/files/styles/bm_gallery_medium_700h/public/2019-10/lycurgus-cup-rome-british-museum.jpg?itok=begRDDEr 525w"
                                              data-focal-position="center center"
                                              alt="Glass cup covered with depiction of the death of King Lycurgus. "
                                            />
                                            <noscript>
                                              &lt;img loading="eager"
                                              srcset="/sites/default/files/styles/bm_gallery_medium_700h/public/2019-10/lycurgus-cup-rome-british-museum.jpg?itok=begRDDEr
                                              525w" width="525" height="700"
                                              data-src="/sites/default/files/styles/bm_gallery_medium_700h/public/2019-10/lycurgus-cup-rome-british-museum.jpg?itok=begRDDEr"
                                              data-sizes="auto" alt="Glass cup
                                              covered with depiction of the
                                              death of King Lycurgus. " /&gt;
                                            </noscript>
                                          </div>
                                          <p className="carousel--gallery__item-title">
                                            The Lycurgus Cup
                                              ...
                                              <div className="teaser__image-container">
                                                <div className="media media-teaser_landscape media-image js-media">
                                                  <img
                                                    ...
                                                    sizes="516px"
                                                    src="/images/Collection/image-07.webp"
                                                  />
                                                </div>
                                              </div>
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  ...
                                                  <div className="teaser__summary">
                                                    Explore the many wild and
                                                    wonderful depictions of
                                              ...
                                              <div className="teaser__image-container">
                                                <div className="media media-teaser_landscape media-image js-media">
                                                  <img
                                                    ...
                                                    alt="BM Dragon"
                                                    sizes="516px"
                                                    src="/images/Collection/image-08.webp"
                                                  />
                                                </div>
                                              </div>
                                              <div className="teaser__content">
                                              ...
                                              <div className="teaser__image-container">
                                                <div className="media media-teaser_landscape media-image js-media">
                                                  <img
                                                    ...
                                                    sizes="516px"
                                                    src="/images/Collection/image-09.webp"
                                                  />
                                                </div>
                                              </div>
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  ...
                                                  <div className="teaser__summary">
                                                    Discover the many tales of
                                                    death and memory from the
                                                    Museum.
                                                  </div>
                                                </div>
                                              </div>
                                              ...
                                              <div className="teaser__image-container">
                                                <div className="media media-teaser_landscape media-image js-media">
                                                  <img
                                                    ...
                                                    sizes="516px"
                                                    src="/images/Collection/image-10.jpg"
                                                  />
                                                </div>
                                              </div>
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  ...
                                                  <div className="teaser__summary">
                                                    Love and desire is a theme
                                                    found across the Museum's
                                                    collection.
                                                  </div>
                                                </div>
                                              </div>
                                              ...
                                              <div className="teaser__image-container">
                                                <div className="media media-teaser_landscape media-image js-media">
                                                  <img
                                                    ...
                                                    data-sizes="auto"
                                                    data-focal-position="center center"
                                                    alt="Silk garment plain weave."
                                                    sizes="516px"
                                                    src="/images/Collection/image-11.webp"
                                                  />
                                                </div>
                                              </div>
                                              <div className="teaser__content">
                          ...
                          <section
                            className="paragraph paragraph--type--slice-teaser paragraph--view-mode--default section section--slice-teaser section--z-index-scope section--has-carousel section--bg-black"
                            aria-labelledby="paragraph-7727-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-7727-title"
                                    className="visually-hidden teaser-listing__title"
                                  >
                                    blank
                                  </h2>
                                              ...
                                              <div className="teaser__image-container">
                                                <div className="media media-teaser_landscape media-image js-media">
                                                  <img
                                                    ...
                                                    sizes="516px"
                                                    src="/images/Collection/image-12.jpg"
                                                  />
                                                </div>
                                              </div>
                                              <div className="teaser__content">
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-12854-title"
                          >
                            <div className="container">
                                ...
                                <div className="banner__inner">
                                  ...
                                  <div className="banner__content">
                                    <p>
                                      ...
                                      news, stories and ways to explore the
                          ...
                          <section
                            className="paragraph paragraph--type--slice-teaser paragraph--view-mode--default section section--slice-teaser section--z-index-scope section--has-carousel section--bg-black"
                            aria-labelledby="paragraph-4313-title"
                          >
                            <div className="container">
                              <a className="js-jump-link-anchor" id="blog" />{" "}
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-4313-title"
                                    className="section__title teaser-listing__title"
                                  >
                                              ...
                                              <div className="teaser__image-container">
                                                <div className="media media-teaser_landscape media-image js-media">
                                                  <img
                                                    ...
                                                    src="/images/Collection/image-13.webp"
                                                  />
                                                </div>
                                              </div>
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  ...
                                                  <div className="teaser__summary">
                                                    Thought-provoking posts from
                                                    conservators, curators and
                                                    scientists that give you the
                                                    inside knowledge on our
                                                    collection.
                                                  </div>
                                                </div>
                                              </div>
                ...
                <div>
                  <div
                    id="block-secondary-navigation"
                    className="section section--bg-black"
                  >
                    <div className="container">
                      <div className="section__inner menu-secondary-container">
                        <h2>In collection</h2>
                        <div className="menu-secondary">
                          <ul className="menu menu--level-0 js-drilldown-root">
                            <li className="menu__item menu__item--level-0 menu__item--Collection homepage">
                              <a
                                href="/collection"
                                className="menu__link menu__link--level-0 menu__toggle menu__link--Collection homepage js-Collection homepage"
                              >
                            ...
                            <li className="menu__item menu__item--collapsed menu__item--level-0">
                              <a
                                href="/collection/galleries"
                                className="menu__link menu__link--level-0 menu__toggle"
                              >
