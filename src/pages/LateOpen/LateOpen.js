...
const LateOpen = () => {
  ...
  useEffect(() => {
    ...
    const category1 = `${categoryPrefix}-17`;
  ...
  useEffect(() => {
    ...
    // Kategoriler dil bazında dinamik olarak ayarlanıyor
    const category1 = `${contentPrefix}-content-30`;
  ...
  useEffect(() => {
    ...
    // Kategoriler dil bazında dinamik olarak ayarlanıyor
    const accordion1 = `${accordionPrefix}-accordion-16`;
  ...
  return (
    <div>
      <div>
        ...
        <meta
          name="description"
          content="Explore the Museum during our Friday night lates. Book a curated Spotlight tour, lectures, discussions, film screenings or a delicious three-course meal."
        />
        <link
          rel="canonical"
              ...
              <main id="main-content" className="js-main">
                <div>
                  <div
                    ...
                    role="article"
                    aria-labelledby="paragraph-3135-title"
                  >
                        ...
                        <div className="hero__controls">
                          <div className="hero__caption | js-hero-caption">
                            <button
                              ...
                              id="hero-image-caption-button-3135"
                              aria-expanded="false"
                              aria-controls="hero-image-caption-content-3135"
                            >
                            ...
                            <div
                              ...
                              id="hero-image-caption-content-3135"
                              aria-hidden="true"
                              aria-labelledby="hero-image-caption-button-3135"
                            >
                              <button
                                type="button"
                                className="hero__caption-content-close | js-hero-caption-btn"
                                id="hero-image-caption-close-button-3135"
                                aria-expanded="false"
                                aria-controls="hero-image-caption-content-3135"
                              >
                                <span className="visually-hidden">
                        ...
                        <div className="section--intro__container">
                            ...
                            <div className="section--intro__info-slices">
                              <div className="paragraph paragraph--type--info-content paragraph--view-mode--default section--intro__info-content wysiwyg">
                                ...
                                <p>
                                  17.00–20.30 (Fridays)
                                  <br />
                                  Last entry: 20.15 (Fridays)
                                  <br />
                                  No late opening on Good Friday, 18 April 2025
                                </p>
                              </div>
                              <div className="paragraph paragraph--type--info-content paragraph--view-mode--default section--intro__info-content wysiwyg">
                                <h3 className="section--intro__info-content-title">
                                ...
                                <p>
                                  ...
                                  &nbsp;to guarantee entry&nbsp;for an upcoming
                                  Friday.
                                </p>
                              </div>
                          ...
                          <div className="section--intro__content">
                            ...
                            <div className="wysiwyg">
                              <p>
                                <span>
                                  Visit the Museum every Friday (except Good
                                  Friday, 18 April 2025) until 20.30.
                                  Attend&nbsp;a
                                </span>
                      ...
                      <div>
                        <div>
                          <section
                            ...
                            aria-labelledby="paragraph-22123-title"
                          >
                            <div className="container">
                              <a
                              ...
                              <div className="section__inner">
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <ul>
                                      <li>
                                        Late opening on Fridays are free to
                                        visit, just{" "}
                                        <a href="https://ticketing.britishmuseum.org/events?k=general%20admission">
                                          book a timed slot in advance
                                        </a>
                                        &nbsp;to guarantee entry. The last
                                        timeslot&nbsp;is 19.00.
                                      </li>
                                      <li>
                                        Our&nbsp;
                                        ...
                                        &nbsp;will be open for evening
                                        visits.&nbsp;Please note there is a
                                        charge for special exhibitions.
                                      </li>
                                      <li>
                                        Most of the Museum will be available to
                                        enjoy, see below for a{" "}
                                        <a href="#gallery-information">
                                          full list of galleries
                                        </a>{" "}
                                        open until 20.20. Please note these are
                                        subject to close at short notice.&nbsp;
                                      </li>
                                      <li>
                                        The Court Cafés, situated on the ground
                                        floor of the Great Court, will serve
                                        sandwiches, snacks, salads, cakes and
                                        hot and cold drinks until 20.00. Find
                                        out more about&nbsp;
                                        <a
                                      ...
                                      <li>
                                        All the Museum shops will remain open
                                        until 20.15.
                                      </li>
                                    </ul>
                                  </div>
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-4802-title"
                          >
                            <div className="container">
                              <div className="banner__outer">
                                <div className="banner__inner">
                                  ...
                                  <div className="banner__content">
                                    <p>
                                      Enjoy free unlimited entry to all
                                      exhibitions and get access to the
                                      Members'&nbsp;Room and exclusive
                                      Members'&nbsp;events.
                                    </p>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-22119-title"
                          >
                            <div className="container">
                              <a
                                className="js-jump-link-anchor"
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-22092-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-22092-title"
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  ...
                                                  <div className="teaser__summary">
                                                    Stay late on a Friday and
                                                    enjoy 20-minute free
                                                    spotlight tours focusing on
                                                    four iconic areas of the
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-22089-title"
                          >
                            <div className="container">
                              <a
                                className="js-jump-link-anchor"
                              ...
                              <div className="section__inner">
                                <h2
                                  ...
                                  className="section__title"
                                >
                                  Gallery information for late opening on
                                  Fridays
                                </h2>
                                <div
                                  className="accordion__item | js-accordion-item"
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-22088"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-22088"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                  ...
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-22088"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-22088"
                                  >
                                    <p>
                                      See the list of galleries available to
                                      enjoy until 20.20 for late opening on
                                      Fridays (please note this list is subject
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-22090"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-22090"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                  ...
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-22090"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-22090"
                                  >
                                    <p>
                                      See the list of galleries closed for late
                                      opening on Fridays (please note this list
                                    ...
                                    <ul>
                                      ...
                                      <li>
                                        ...
                                        >
                                          Room 20: Greeks and Lycians 400
                                        </a>
                                        <a
                                          href="/collection/galleries/greece-1050-520-bc"
                                          data-entity-type="node"
                          ...
                          <section
                            className="paragraph paragraph--type--slice-teaser paragraph--view-mode--default section section--slice-teaser section--z-index-scope section--has-carousel section--bg-white"
                            aria-labelledby="paragraph-6487-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-6487-title"
