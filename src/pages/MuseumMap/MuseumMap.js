...
const MuseumMap = () => {
  ...
  useEffect(() => {
    const someContentId = "67af1e918b2864c833c0990b";
    ...
    <div>
      <div>
        ...
        <meta
          ...
          content="Information on where you can find paper and digital copies of the Museum map."
        />
        <meta
          property="og:image"
              ...
              <main id="main-content" className="js-main">
                <div>
                  <div
                    ...
                    role="article"
                    aria-labelledby="paragraph-4022-title"
                  >
                    ...
                    <div className="container">
                      <div className="hero__inner">
                        <div className="hero__content-container">
                          ...
                          {/* <h1 id="paragraph-4022-title" className="hero__title">
                            {" "}
                            Museum map
                          </h1> */}
                        </div>
                        <div className="hero__controls">
                          <div className="hero__caption | js-hero-caption">
                            <button
                              ...
                              id="hero-image-caption-button-4022"
                              aria-expanded="false"
                              aria-controls="hero-image-caption-content-4022"
                            >
                            ...
                            <div
                              ...
                              id="hero-image-caption-content-4022"
                              aria-hidden="true"
                              aria-labelledby="hero-image-caption-button-4022"
                            >
                              <button
                                type="button"
                                className="hero__caption-content-close | js-hero-caption-btn"
                                id="hero-image-caption-close-button-4022"
                                aria-expanded="false"
                                aria-controls="hero-image-caption-content-4022"
                              >
                                <span className="visually-hidden">
                              ...
                              <p>
                                {" "}
                                Two visitors looking at a map in the Living and
                                Dying gallery (Room 24).
                              </p>
                              <a href="/collection/galleries/living-and-dying">
                                <span>Visit Room 24</span>
                              </a>
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="section__inner">
                        <div className="section--intro__container">
                          ...
                          <div className="section--intro__content">
                            ...
                            {/* <p className="h3">
                              Explore the Museum and enjoy incredible cultures
                              from around the world.
                            </p>
                            <div className="wysiwyg">
                              <p>
                                Discover ancient Egypt, Assyria and the
                                Mediterranean and connect with objects including
                                the Bust of Ramesses II, the Lewis Chessmen and
                                the Oxus Treasure from ancient Iran. Experience
                                the rich and diverse history and cultures of
                                Africa, before journeying across North America
                  ...
                  <div>
                    <div id="block-numiko-mainpagecontent">
                      <div>
                        <div>
                          <section
                            aria-labelledby="paragraph-14595-title"
                            className="paragraph paragraph--type--slice-media paragraph--view-mode--default section section--slice-media section--bg-white"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-14595-title"
                          ...
                          <section
                            aria-labelledby="paragraph-15762-title"
                            className="paragraph paragraph--type--slice-media paragraph--view-mode--default section section--slice-media section--bg-white"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-15762-title"
                                  className="visually-hidden"
                                >
                                  Museum map
                                </h2>
                          ...
                          <section
                            aria-labelledby="paragraph-14596-title"
                            className="paragraph paragraph--type--slice-media paragraph--view-mode--default section section--slice-media section--bg-white"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-14596-title"
                                  className="visually-hidden"
                                >
                                  Museum map
                                </h2>
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-4065-title"
                          >
                            <div className="container">
                                ...
                                <div className="banner__inner">
                                  ...
                                  <div className="banner__content">
                                    <p>
                                      ...
                                      exhibitions and access to exclusive
                                      Members' events and the Members' Room.
                                    </p>
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-6650-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-6650-title"
