...
const OurWork = () => {
  ...
  const getLanguageParam = (language) => {
    if (language === "ger") {
      ...
      return "zazaki";
    } else return languageMap[language] || "turkish";
  };
  ...
  useEffect(() => {
    ...
    // Kategoriler dil bazında dinamik olarak ayarlanıyor
    const category1 = `${contentPrefix}-content-38`;
    ...
    <div>
      <div>
        ...
        <meta
          ...
          content="Discover how the Museum promotes and provides access to the collection through its research departments, tours and initiatives."
        />
        <meta
          property="og:image"
              ...
              <main id="main-content" className="js-main">
                <div>
                  <div
                    ...
                    role="article"
                    aria-labelledby="paragraph-7614-title"
                  >
                      ...
                      <div>
                        <div>
                          <section
                            ...
                            aria-labelledby="paragraph-8403-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-8403-title"
                                  ...
                                  <div className="teaser__wrapper">
                                    ...
                                    <div className="teaser__content">
                                      <div className="teaser__content-push">
                                        ...
                                        <div className="teaser__summary">
                                          How the PAS records archaeological
                                  ...
                                  <div className="teaser__wrapper">
                                    ...
                                    <div className="teaser__content">
                                      <div className="teaser__content-push">
                                        <h3 className="teaser__title">
                                          <a
                                            href="/our-work/international/iraq-scheme"
                                            className="teaser__anchor"
                                          >
                                            <span>
                                              <span>Iraq Scheme</span>
                                            </span>
                                            {/* Add visually hidden defacer for screen-reader. Use full stops for reader punctuation. */}
                                          </a>
                                        </h3>
