  ...
  return (
    <div>
      <div>
        ...
        <meta
          name="description"
          content="Discover how the Silk Roads linked communities across continents in our current exhibition through this British Sign Language tour."
        />
        <link
          rel="canonical"
        ...
        <meta
          property="og:image"
          content="/images/DeafLed/Silk_Roads_embroidered_textile_teaser.jpg"
        />
        ...
        <title>Deaf-led BSL tour of Silk Roads | British Museum</title>
        ...
        <link
          ...
          sizes="180x180"
          href="/images/DeafLed/apple-touch-icon.png"
        />
        <link
          rel="icon"
          type="image/png"
          href="/images/DeafLed/favicon-32x32.png"
          sizes="32x32"
        />
        <link
          rel="icon"
          type="image/png"
          href="/images/DeafLed/favicon-16x16.png"
          sizes="16x16"
        />
        <link rel="manifest" href="/site.webmanifest" />
        <link
          rel="mask-icon"
          href="/images/DeafLed/safari-pinned-tab.svg"
          color="#5bbad5"
        />
                  ...
                  <div>
                    <div>
                      <div
                        ...
                        role="article"
                        aria-labelledby="paragraph-41397-title"
                      >
                        <div className="hero__background">
                          <div className="media media-hero media-image js-media">
                            <picture>
                              ...
                              <source
                                srcSet="/images/DeafLed/Silk_Roads_embroidered_textile_1920x1080_3.jpg 1x"
                              ...
                              />
                              <source
                                srcSet="/images/DeafLed/Silk_Roads_embroidered_textile_1920x1080_1.jpg 1x"
                              ...
                              />
                              <source
                                srcSet="/images/DeafLed/Silk_Roads_embroidered_textile_1920x1080_2.jpg 1x"
                              ...
                              <img
                                ...
                                src="/images/DeafLed/Silk_Roads_embroidered_textile_1920x1080.jpg"
                          ...
                          <div className="hero__inner">
                            <div className="hero__content-container hero__content-container--boxed -has-link">
                              ...
                              <p className="hero__meta">
                                <span>Gallery talks &amp; tours / </span>
                                <span>Accessible event</span>/ 20 January 2025
                              </p>
                              <p className="hero__meta">18+</p>
                              <div className="hero__button-container">
                                <a
                                  href="https://ticketing.britishmuseum.org/13728"
                                  className="hero__button button button--chevron"
                                >
                                  <span>
                                    Book{" "}
                                    <span className="visually-hidden">
                                      Deaf-led BSL tour of Silk Roads
                                    </span>{" "}
                                    now
                                  </span>
                                </a>
                                    ...
                                    <div style={{ width: "40%" }}>
                                      <div className="media media-embed_no_caption media-image js-media">
                                        <img
                                          ...
                                          srcSet="/images/DeafLed/Huo%20logo%20280px%20wide%20reversed%20out_1.png 282w"
                                          sizes="100vw"
                                          width={282}
                                          height={113}
                                          src="/images/DeafLed/Huo%20logo%20280px%20wide%20reversed%20out.png"
                                    ...
                                    <div style={{ width: "40%" }}>
                                      <div className="media media-embed_no_caption media-image js-media">
                                        <img
                                          loading="eager"
                                          className="lazyload not-full-width"
                                          srcSet="/images/DeafLed/UACF-logo%20white-EN-space3-280px_1.png 280w"
                                          sizes="100vw"
                                          width={280}
                                          height={170}
                                          src="/images/DeafLed/UACF-logo%20white-EN-space3-280px.png"
                            ...
                            <div className="hero__controls">
                              <div className="hero__caption | js-hero-caption">
                                <button
                                  ...
                                  id="hero-image-caption-button-41397"
                                  aria-expanded="false"
                                  aria-controls="hero-image-caption-content-41397"
                                >
                                  <span className="visually-hidden">
                                    Show image caption
                                  </span>
                                ...
                                <div
                                  ...
                                  id="hero-image-caption-content-41397"
                                  aria-hidden="true"
                                  aria-labelledby="hero-image-caption-button-41397"
                                >
                                  <button
                                    type="button"
                                    className="hero__caption-content-close | js-hero-caption-btn"
                                    id="hero-image-caption-close-button-41397"
                                    aria-expanded="false"
                                    aria-controls="hero-image-caption-content-41397"
                                  >
                                    <span className="visually-hidden">
                        ...
                        <div className="section--intro__container">
                            ...
                            <div className="section--intro__info-slices">
                              ...
                              <div className="paragraph paragraph--type--info-content paragraph--view-mode--default section--intro__info-content">
                                ...
                                <p>
                                  ...
                                  <br />
                                  See{" "}
                                  <a href="#scheduled-dates">scheduled dates</a>
                                </p>
                              </div>
                              <div className="paragraph paragraph--type--info-content paragraph--view-mode--default section--intro__info-content">
                                <h3 className="section--intro__info-content-title">
                              ...
                              <div className="paragraph paragraph--type--info-content paragraph--view-mode--default section--intro__info-content wysiwyg">
                                <h3 className="section--intro__info-content-title">
                                  <svg
                                    ...
                                    aria-hidden="true"
                                  >
                                    <use xlinkHref="#sprite-icon-person" />
                                  </svg>
                                  18+
                                </h3>
                              </div>
                          ...
                          <div className="section--intro__content">
                            <div className="wysiwyg">
                              <h3>
                                <span dir="ltr">
                                  Join Jason Tennant for a Deaf-led British Sign
                                  Language (BSL) tour of the{" "}
                                </span>
                                <a
                                ...
                                <span dir="ltr"> exhibition.</span>
                                <span>&nbsp;</span>
                              </h3>
                              <p>
                                <span dir="ltr">
                                  Camel caravans crossing desert dunes,
                                  merchants trading silks and spices at bazaars
                                  – these are the images that come to mind when
                                  we think of the Silk Roads. But the reality
                              ...
                              <p>
                                <span dir="ltr">
                                  ...
                                  West, the Silk Roads were made up of
                                  overlapping networks linking communities
                                  across Asia, Africa and Europe, from East Asia
                                  to Britain, and from Scandinavia to
                                  Madagascar. This major exhibition unravels how
                                  the journeys of people, objects and ideas that
                                  formed the Silk Roads shaped cultures and
                                  histories.
                                </span>
                                <span>&nbsp;</span>
                              </p>
                              <p>
                                <span dir="ltr">
                                  ...
                                  defining period in their history, from about
                                  AD 500 to 1000. This time witnessed
                                  significant leaps in connectivity and the rise
                                  of universal religions that linked communities
                                  across continents.
                                </span>
                                <span>&nbsp;</span>
                              </p>
                              ...
                              <h3>
                                <span dir="ltr">Booking information</span>
                                <span>&nbsp;</span>
                              </h3>
                              <ul>
                                <li>
                                  <a href="https://ticketing.britishmuseum.org/13728">
                                    <span dir="ltr">Book now</span>
                                  </a>
                                  <span dir="ltr"> to secure your place.</span>
                                </li>
                                <li>
                                  Please meet at the Montague Place entrance at
                                  18.00. View the{" "}
                                  <a href="/files/museum-map.pdf">Museum map</a>{" "}
                                  for more information.
                                </li>
                                <li>
                                  <span dir="ltr">
                                    Carers and Disabled people's companions do
                                    not need to book a ticket.
                                  </span>
                                </li>
                                <li>
                                  <span dir="ltr">
                                    Assistance dogs are very welcome in the
                                    Museum.
                                  </span>
                                </li>
                                <li>
                                  <span dir="ltr">
                                    If you have any access requirements or need
                                    assistance booking this event, please email{" "}
                                  </span>
                                  <a href="/cdn-cgi/l/email-protection#6e0f0d0d0b1d1d2e0c1c071a071d06031b1d0b1b0340011c09">
                                    <span dir="ltr">
                                      <span
                                        className="__cf_email__"
                                        data-cfemail="4c2d2f2f293f3f0c2e3e2538253f2421393f29392162233e2b"
                                      >
                                        [email&nbsp;protected]
                                      </span>
                                    </span>
                      ...
                      <div>
                        <div>
                          <section
                            ...
                            aria-labelledby="paragraph-41932-title"
                          >
                            <div className="container">
                              <a
                                className="js-jump-link-anchor"
                              ...
                              <div className="section__inner">
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      <span dir="ltr">
                                        <strong>Jason Tennant </strong>is a
                                        British Sign Language (BSL) teacher and
                                        presenter who has made a name for
                                        himself conducting engaging art tours
                                        throughout museums and galleries in
                                        Kent. With a passion for installation
                                        art, Jason brings a unique perspective
                                        to his tours. For eight years, Tennant
                                        has been sharing his enthusiasm and
                                        insights while revealing the wonder in
                                        each artwork.
                                      </span>
                                    </p>
                                  </div>
                                  ...
                                  <div className="paragraph paragraph--type--embedded-media paragraph--view-mode--default">
                                    <figure className="media media-embed media-image js-media">
                                      <img
                                        loading="eager"
                                        className="lazyload not-full-width"
                                        srcSet="/images/DeafLed/Jason_Tennant_250_1.jpg 250w"
                                        sizes="100vw"
                                        width={250}
                                        height={250}
                                        src="/images/DeafLed/Jason_Tennant_250.jpg"
                                        alt="Headshot of Jason Tennant"
                                      />
                                      <figcaption>Jason Tennant.</figcaption>
                                    </figure>
                                  </div>
                                </aside>
                              </div>
