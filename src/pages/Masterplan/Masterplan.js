  ...
  return (
    <div>
      <div>
        ...
        <meta
          name="description"
          content="As one of the most significant cultural redevelopment projects ever, the Masterplan will transform the British Museum for the 21st century."
        />
        <link
          rel="canonical"
        ...
        />
        <title>The Masterplan | British Museum</title>
          ...
          >
            <div className="layout-container">
              ...
              <main id="main-content" className="js-main">
                <div>
                  <div
                    className="hero--has-overlay paragraph paragraph--type--slice-generic-hero paragraph--view-mode--default hero hero--has-video align_left hero--background-pinned js-hero"
                    role="article"
                    data-js-video-background-context
                    aria-labelledby="paragraph-39000-title"
                  >
                    <div className="hero__background">
                      <div className="media media-hero media-image js-media">
                        <picture>
                          ...
                          <source
                            srcSet="/sites/default/files/styles/uncropped_huge/public/2024-11/Masterplan_aerial_view_1920x1080.jpg?itok=-huE0Xsj 1x"
                          ...
                          />
                          <source
                            srcSet="/sites/default/files/styles/uncropped_large/public/2024-11/Masterplan_aerial_view_1920x1080.jpg?itok=aIg773Sw 1x"
                          ...
                          />
                          <source
                            srcSet="/sites/default/files/styles/1_1_media_medium/public/2024-11/Masterplan_aerial_view_1920x1080.jpg?h=d1cb525d&itok=Ae3WtwJe 1x"
                          ...
                          <img
                            ...
                            src="/sites/default/files/styles/1_1_media_small/public/2024-11/Masterplan_aerial_view_1920x1080.jpg?h=d1cb525d&itok=tezeNoLs"
                    ...
                    >
                      <source
                        src="https://bmwebsitestreaming.blob.core.windows.net/bmvideo/Masterplan-header.mp4"
                        type="video/mp4"
                      />
                    </video>
                    <div className="container">
                      <div className="hero__inner">
                        ...
                        <div className="hero__controls">
                          <button
                            className="hero__video-control | js-hero-video-control -video-is-playing"
                            aria-live="polite"
                            data-js-video-background-control
                          >
                            <span className="hero__video-control-icon">
                              <span className="visually-hidden">
                                <span className="js-hero-video-status">
                                  Pause
                                </span>{" "}
                                video
                              </span>
                        ...
                        <div className="section--intro__container">
                          <div className="section--intro__info">
                            ...
                            <div className="section--intro__info-slices">
                              ...
                              <div className="paragraph paragraph--type--info-content paragraph--view-mode--default section--intro__info-content wysiwyg">
                                ...
                                <p>Construction started in autumn 2024</p>
                              </div>
                              <div className="paragraph paragraph--type--info-content paragraph--view-mode--default section--intro__info-content wysiwyg">
                                <h3 className="section--intro__info-content-title">
                                ...
                                <p>
                                  Architect team will be selected in early 2025
                                </p>
                              </div>
                              <div className="paragraph paragraph--type--info-content paragraph--view-mode--default section--intro__info-content wysiwyg">
                                <h3 className="section--intro__info-content-title">
                                ...
                                <p>
                                  ...
                                  >
                                    <span>
                                      Studio Weave appointed in December 2024
                                    </span>
                                    <span className="visually-hidden">
                                      {" "}
                                      (Opens in new window)
                          ...
                          <div className="section--intro__content">
                            <p className="h3">
                              ...
                              redevelopment projects undertaken anywhere in the
                              world, the Masterplan will transform the British
                              Museum for the 21st century.&nbsp;
                            </p>
                            <div className="wysiwyg">
                              <p>
                                Through the Masterplan, we will build a Museum
                                for the future that connects us to our past and
                                to each other. It includes a number of elements,
                              ...
                              <ul>
                                <li>
                                  The{" "}
                                  <a
                                    href="/about-us/masterplan/bmarc"
                                    data-entity-type="node"
                                    data-entity-uuid="9e5cd097-fb8d-4ea7-ace8-1b4211bb2474"
                                    data-entity-substitution="canonical"
                                  >
                                    British Museum Archaeological Collection
                                    (BM_ARC)
                                  </a>
                                  , a state-of-the-art collection storage and
                                  research facility.
                                </li>
                                <li>
                                  A new{" "}
                                  <a
                                    href="/about-us/masterplan/energy-centre-programme"
                                    data-entity-type="node"
                                    data-entity-uuid="66ac6027-346d-4cdd-a5bc-6066bf16693e"
                                    data-entity-substitution="canonical"
                                  >
                                    Energy Centre Programme
                                  </a>
                                ...
                                <li>
                                  The complete reimagining of the{" "}
                                  <a
                                    href="/about-us/masterplan/redevelopment-western-range"
                                    data-entity-type="node"
                                    data-entity-uuid="5b0c4b2e-9b49-46bd-8da4-58c6a0827073"
                                    data-entity-substitution="canonical"
                                  >
                                    Western Range
                                  </a>
                                  , which includes a third of our gallery space
                                  at the iconic Grade I listed Museum site.
                                  &nbsp;
                                </li>
                                <li>
                                  The construction of new visitor welcome
                                  facilities, to replace the outmoded security
                                  tents. &nbsp;
                                </li>
                              </ul>
                              <p>
                                The Museum will stay open throughout the works,
                                maintaining the founding commitment to keep the
                                collection safe and accessible to the public for
                                generations to come. &nbsp;
                              </p>
                            </div>
                          </div>
                      ...
                      <div>
                        <div>
                          <section
                            ...
                            aria-labelledby="paragraph-39002-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-39002-title"
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      Summer 2024 marked the end of the first
                                      phase of the Masterplan with the completed
                                      construction of the British Museum
                                      Archaeological Research Collection
                                      (BM_ARC), near Reading. This new facility
                                      stores collection items in a way that
                                      makes them easy to access for research,
                                      and to allow study and comparison across
                                      ancient world collections. &nbsp;
                                    </p>
                                    <p>
                                      The second phase of the Masterplan is to
                                      overhaul the Museum's outdated energy
                                      infrastructure. The Energy Centre
                                      Programme will see the phasing out of
                                      fossil fuels and a shift to low-carbon
                                      energy, resulting in an estimated annual
                                      net saving of 1,700 tonnes of carbon
                                      dioxide compared to existing usage.
                                    </p>
                                    <p>
                                      The third phase is the complete
                                      reimagining of the Western Range, which
                                      includes all the galleries to the west of
                                      the Great Court. Since it opened in 1857,
                                      the British Museum buildings have evolved
                                      to accommodate more visitors and a growing
                                      collection. Now, we need to rebuild,
                                      redesign and restore some of those
                                      buildings and, at the same time, we want
                                      to reimagine how the collection is
                                      displayed to inspire future generations.
                                      We will begin with the redevelopment of
                                      the Western Range.
                                    </p>
                                    <p>
                                      Another vital aspect of the physical
                                      redesign will be a spectacular new
                                      entrance and arrival experience. The
                                      Visitor Welcome Pavilions will replace the
                                      current structures at both entrances to
                                      the Museum – signalling our desire to be
                                      as accessible and welcoming to our
                                ...
                                <aside className="section--slice-content__embed">
                                  <div className="paragraph paragraph--type--embedded-media paragraph--view-mode--default">
                                    <figure className="media media-embed media-video js-media">
                                      <div
                                        data-video-embed-field-lazy='<div class="video-embed-field-provider-youtube video-embed-field-responsive-video"><iframe title="YouTube Video (The Masterplan)" width="854" height="480" frameborder="0" allowfullscreen="allowfullscreen" src="https://www.youtube.com/embed/6469BglkHCc?autoplay=1&amp;start=0&amp;rel=0" data-cookieconsent="marketing"></iframe>
...
'
                                      ...
                                      >
                                        <img
                                          src="/sites/default/files/styles/16_9_media_large/public/video_thumbnails/6469BglkHCc.jpg?h=c673cd1c&itok=q7PQ6uq0"
                                          width={1300}
                                          height={731}
                                          alt
                                          loading="lazy"
                                        ...
                                        <button
                                          ...
                                          aria-label="Masterplan ambient video - show video"
                                        />
                                      </div>
                                      <div>
                                        <div
                                      ...
                                      <figcaption className="hidden">
                                        British Museum Director Nicholas
                                        Cullinan introduces the Masterplan and
                                        takes you on an architectural journey
                                        from 1753 to the present day and
                                        beyond.&nbsp;
                                      </figcaption>
                                    </figure>
                                  </div>
                                ...
                                <div className="section--slice-quote__container">
                                  <div className="section--slice-quote__image">
                                    <div className="media media-teaser_square media-image js-media">
                                      <img
                                        ...
                                        data-sizes="auto"
                                        data-focal-position="center center"
                                        src="/images/Masterplan/image-01.webp"
                                      />
                                    </div>
                                  </div>
                                  <blockquote className="section--slice-quote__quote">
                                    <p>
                                      ...
                                      transformation of any museum in the world
                                      – not just physically, but intellectually
                                      too. And while we look towards this
                                      exciting future, we will remain guided by
                                      the words of our founder – who dreamed of
                                      a museum connecting all arts and sciences,
                                      which would be accessible to <em>all </em>
                                      persons. Indeed, we want to make the
                                      universal museum more relevant than ever
                                      by making it <em>universally </em>
                                      accessible. That means making our site
                                      here in London as welcoming as possible,
                                      it means sharing our objects as widely as
                                      possible – on a collaborative and equal
                                      basis – and it means embracing digital
                                      technologies to make our collection
                                      searchable, researchable, and available to
                                      everyone, everywhere.
                                    </p>
                                    <cite>
                                      Dr Nicholas Cullinan OBE, Director of the
                                      British Museum
                                    </cite>
                                  </blockquote>
                                </div>
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-39004-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-39004-title"
                                              ...
                                              <div className="teaser__image-container">
                                                <div className="media media-teaser_landscape media-image js-media">
                                                  <img
                                                    ...
                                                    data-sizes="auto"
                                                    data-focal-position="center center"
                                                    src="/images/Masterplan/image-02.jpg"
                                                  />
                                                </div>
                                              </div>
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  ...
                                                  <div className="teaser__summary">
                                                    A purpose-built research
                                                    space and collection storage
                                                    facility that protects
                                                    objects while making them
                                              ...
                                              <div className="teaser__image-container">
                                                <div className="media media-teaser_landscape media-image js-media">
                                                  <img
                                                    ...
                                                    data-sizes="auto"
                                                    data-focal-position="center center"
                                                    src="/images/Masterplan/image-03.jpg"
                                                  />
                                                </div>
                                              </div>
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  ...
                                                  <div className="teaser__summary">
                                                    Redeveloping one third of
                                                    the Museum and reimagining
                                                    how the collection is
                                                    displayed will transform the
                                                    Museum for future
                                                    generations.
                                                  </div>
                                                </div>
                                              ...
                                              <div className="teaser__image-container">
                                                <div className="media media-teaser_landscape media-image js-media">
                                                  <img
                                                    ...
                                                    data-sizes="auto"
                                                    data-focal-position="center center"
                                                    src="/images/Masterplan/image-04.jpg"
                                                  />
                                                </div>
                                              </div>
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  ...
                                                  <div className="teaser__summary">
                                                    ...
                                                    Centre will phase out the
                                                    use of fossil fuels at the
                                                    Museum and pave the way to
                                                    net zero.
                                                  </div>
                                                </div>
                                              </div>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-teaser paragraph--view-mode--default section section--slice-teaser section--z-index-scope section--has-carousel section--bg-white"
                            aria-labelledby="paragraph-39016-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-39016-title"
                                    className="section__title teaser-listing__title"
                                  >
                                    Architecture at the British Museum
                                  </h2>
                                  <div className="carousel-container | js-carousel-container">
                                    <div
                                      className="teaser-listing carousel carousel--2-col swiper-container | js-carousel-2-col"
                                              ...
                                              <div className="teaser__image-container">
                                                <div className="media media-teaser_landscape media-image js-media">
                                                  <img
                                                    ...
                                                    data-sizes="auto"
                                                    data-focal-position="center center"
                                                    src="/images/Masterplan/image-05.jpg"
                                                  />
                                                </div>
                                              </div>
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  <h3 className="teaser__title">
                                                    <a
                                                      href="/visit/object-trails/greek-revival-architecture-simplicity-and-splendour"
                                                      className="teaser__anchor"
                                                    >
                                                      <span>
                                                        <span>
                                              ...
                                              <div className="teaser__image-container">
                                                <div className="media media-teaser_landscape media-image js-media">
                                                  <img
                                                    ...
                                                    data-sizes="auto"
                                                    data-focal-position="center center"
                                                    src="/images/Masterplan/image-06.jpg"
                                                  />
                                                </div>
                                              </div>
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  <h3 className="teaser__title">
                                                    <a
                                                      href="/about-us/british-museum-story/architecture/great-court"
                                                      className="teaser__anchor"
                                                    >
                                                      <span>
                                                  ...
                                                  <div className="teaser__summary">
                                                    ...
                                                    Museum sits the largest
                                                    covered public square in
                                                    Europe, the Queen Elizabeth
                                                    II Great Court.
                                                  </div>
                                                </div>
                                              </div>
                                              ...
                                              <div className="teaser__image-container">
                                                <div className="media media-teaser_landscape media-image js-media">
                                                  <img
                                                    ...
                                                    data-sizes="auto"
                                                    data-focal-position="center center"
                                                    src="/images/Masterplan/image-07.jpg"
                                                  />
                                                </div>
                                              </div>
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  ...
                                                  <div className="teaser__summary">
                                                    Archivist Francesca Hillier
                                                    takes a look at the iconic
                                              ...
                                              <div className="teaser__image-container">
                                                <div className="media media-teaser_landscape media-image js-media">
                                                  <img
                                                    ...
                                                    data-sizes="auto"
                                                    data-focal-position="center center"
                                                    src="/images/Masterplan/image-08.jpg"
                                                  />
                                                </div>
                                              </div>
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  ...
                                                  <div className="teaser__summary">
                                                    View the bold visions of
                                                    five acclaimed architectural
                                                    teams for transforming the
                                                    British Museum's 'Western
                                                    Range', and have your say.
                                                  </div>
                                                </div>
                                    ...
                                    <div className="teaser__image-container">
                                      <div className="media media-teaser_landscape media-image js-media">
                                        <img
                                          ...
                                          data-sizes="auto"
                                          data-focal-position="center center"
                                          src="/images/Masterplan/image-10.webp"
                                        />
                                      </div>
                                    </div>
                                    <div className="teaser__content">
                                      <div className="teaser__content-push">
                                        ...
                                        <div className="teaser__summary">
                                          Find out how our Museum departments
                                          work with, research and care for the
                                          collection and about the research
                                    ...
                                    <div className="teaser__image-container">
                                      <div className="media media-teaser_landscape media-image js-media">
                                        <img
                                          ...
                                          data-sizes="auto"
                                          data-focal-position="center center"
                                          src="/images/Masterplan/image-11.webp"
                                        />
                                      </div>
                                    </div>
                                    <div className="teaser__content">
                                      <div className="teaser__content-push">
                                        ...
                                        <div className="teaser__summary">
                                          Discover the breadth of our research,
                                          the wide range of related
                                          publications, and learn about our
                                    ...
                                    <div className="teaser__image-container">
                                      <div className="media media-teaser_landscape media-image js-media">
                                        <img
                                          ...
                                          data-sizes="auto"
                                          data-focal-position="center center"
                                          src="/images/Masterplan/image-12.jpg"
                                        />
                                      </div>
                                    </div>
                                    <div className="teaser__content">
                                      <div className="teaser__content-push">
                                        ...
                                        <div className="teaser__summary">
                                          Learn how the Museum works in
                                          partnership with more than 200
                                          cultural organisations across the UK
                                          to share the collection and our
                                          knowledge.
                                        </div>
                                      </div>
                                    </div>
                                    ...
                                    <div className="teaser__image-container">
                                      <div className="media media-teaser_landscape media-image js-media">
                                        <img
                                          ...
                                          data-sizes="auto"
                                          data-focal-position="center center"
                                          src="/images/Masterplan/image-13.webp"
                                        />
                                      </div>
                                    </div>
                                    <div className="teaser__content">
                                      <div className="teaser__content-push">
                                        ...
                                        <div className="teaser__summary">
                                          ...
                                          exhibitions are some of the many ways
                                          we build ties internationally. See our
