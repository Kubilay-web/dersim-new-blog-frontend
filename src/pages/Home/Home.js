          ...
          >
            <div className="layout-container">
              ...
              <main id="main-content" className="js-main">
                <div>
                  <div
                    className="hero--front hero--promo-banner paragraph paragraph--type--slice-generic-hero paragraph--view-mode--default hero hero--has-video align_left hero--background-pinned js-hero"
                    role="article"
                    data-js-video-background-context
                    aria-labelledby="paragraph-39949-title"
                  >
                        ...
                        <div className="hero__controls">
                          ...
                          <div className="hero__caption | js-hero-caption">
                            <button
                              ...
                              id="hero-image-caption-button-39949"
                              aria-expanded="false"
                              aria-controls="hero-image-caption-content-39949"
                            >
                              <span className="visually-hidden">
                                Show image caption
                              </span>
                            ...
                            <div
                              ...
                              id="hero-image-caption-content-39949"
                              aria-hidden="true"
                              aria-labelledby="hero-image-caption-button-39949"
                            >
                              <button
                                type="button"
                                className="hero__caption-content-close | js-hero-caption-btn"
                                id="hero-image-caption-close-button-39949"
                                aria-expanded="false"
                                aria-controls="hero-image-caption-content-39949"
                              >
                                <span className="visually-hidden">
                ...
                <div>
                  <div className="intro--frontpage paragraph paragraph--type--slice-generic-intro paragraph--view-mode--default section section--intro section--bg-black">
                    <div className="container">
                      ...
                      <div>
                        <div>
                          <section
                            ...
                            aria-labelledby="paragraph-39951-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-39952-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-39953-title"
                          >
                            <div className="container">
                          ...
                          <section
                            className="paragraph paragraph--type--slice-teaser paragraph--view-mode--default section section--slice-teaser section--z-index-scope section--has-carousel section--bg-black"
                            aria-labelledby="paragraph-39954-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                          ...
                          <section
                            className="paragraph paragraph--type--slice-banner paragraph--view-mode--default section section--slice-banner section--maintain-spacer-top section--bg-white banner"
                            aria-labelledby="paragraph-39955-title"
                          >
                            <div className="container">
                              <div className="banner__outer">
                                <div className="banner__inner">
                          ...
                          <section
                            className="paragraph paragraph--type--slice-teaser paragraph--view-mode--default section section--slice-teaser section--z-index-scope section--has-carousel section--bg-black"
                            aria-labelledby="paragraph-39956-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                          ...
                          <section
                            className="paragraph paragraph--type--slice-banner paragraph--view-mode--default section section--slice-banner section--maintain-spacer-top section--bg-white banner"
                            aria-labelledby="paragraph-39957-title"
                          >
                            <div className="container">
                              <div className="banner__outer">
                                <div className="banner__inner">
                          ...
                          <section
                            className="paragraph paragraph--type--slice-discover paragraph--view-mode--default section section--slice-discover section--z-index-scope section--has-carousel section--bg-black"
                            aria-labelledby="paragraph-39964-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                              ...
                                              <div className="teaser--animate__container">
                                                ...
                                                <div className="teaser--animate__image">
                                                  <div className="media media-discover media-image js-media">
                                                    <img
                                                      loading="lazy"
                                                      src="/images/maize%20god%20cut%20out.png"
                                                      width={307}
                                                      height={480}
                                                      alt="Mayan Maize god"
                                                    />
                                              ...
                                              <div className="teaser--animate__container">
                                                ...
                                                <div className="teaser--animate__image">
                                                  <div className="media media-discover media-image js-media">
                                                    <img
                                                      loading="lazy"
                                                      src="/images/01461427_001_TIF.png"
                                                      width={329}
                                                      height={480}
                                                      alt="Grave stele showing a naked archer"
                                                    />
                                                  </div>
                                                </div>
                                              </div>
                                              ...
                                              <div className="teaser--animate__container">
                                                ...
                                                <div className="teaser--animate__image">
                                                  <div className="media media-discover media-image js-media">
                                                    <img
                                                      loading="lazy"
                                                      src="/images/African%20containers.png"
                                                      width={395}
                                                      height={480}
                                                      alt="Egg-shaped skin container and lid, decorated with geometric patterns"
                                                    />
                                                  </div>
                                                </div>
                                              </div>
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-39973-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                              ...
                                              <div className="teaser__image">
                                                <div className="media media-embed_no_caption media-image js-media">
                                                  <img
                                                    loading="eager"
                                                    className="lazyload not-full-width"
                                                    srcSet="/images/Japanese%20Cat%20Tea%20Cups_British%20Museum_edit_1.jpg 400w, /images/Japanese%20Cat%20Tea%20Cups_British%20Museum_edit_2.jpg 500w"
                                                    sizes="100vw"
                                                    width={500}
                                                    height={500}
                                                    src="/images/Japanese%20Cat%20Tea%20Cups_British%20Museum_edit.jpg"
                                                    alt="Two tea cups with blue cats "
                                                  />
                                                </div>
                                              </div>
                                            </div>
                                              ...
                                              <div className="teaser__image">
                                                <div className="media media-embed_no_caption media-image js-media">
                                                  <img
                                                    loading="eager"
                                                    className="lazyload not-full-width"
                                                    srcSet="/images/Inspired%20by%20Hokusai_2.jpg 400w, /images/Inspired%20by%20Hokusai_1.jpg 464w"
                                                    sizes="100vw"
                                                    width={464}
                                                    height={464}
                                                    src="/images/Inspired%20by%20Hokusai.jpg"
                                                    alt="Cushion with image of the great wave"
                                                  />
                                                </div>
                                              </div>
                                            </div>
                                              ...
                                              <div className="teaser__image">
                                                <div className="media media-embed_no_caption media-image js-media">
                                                  <img
                                                    loading="eager"
                                                    className="lazyload not-full-width"
                                                    srcSet="/images/Inspired%20by%20Ancient%20Egypt_1.jpg 400w, /images/Inspired%20by%20Ancient%20Egypt_2.jpg 750w, /images/Inspired%20by%20Ancient%20Egypt_3.jpg 1000w, /images/Inspired%20by%20Ancient%20Egypt_4.jpg 1200w"
                                                    sizes="100vw"
                                                    width={1200}
                                                    height={1200}
                                                    src="/images/Inspired%20by%20Ancient%20Egypt.jpg"
                                                    alt="Rubber duck that looks like Cleopatra"
                                                  />
                                                </div>
                                              </div>
                                            </div>
