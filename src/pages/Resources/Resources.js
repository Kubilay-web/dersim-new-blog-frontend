...
const Resources = () => {
  ...
  useEffect(() => {
    ...
    const category1 = `${categoryPrefix}-49`;
  ...
  useEffect(() => {
    ...
    // Kategoriler dil bazında dinamik olarak ayarlanıyor
    const category1 = `${contentPrefix}-content-42`;
              ...
              <main id="main-content" className="js-main">
                <div>
                  <div
                    ...
                    role="article"
                    aria-labelledby="paragraph-8088-title"
                  >
                        ...
                        <div className="hero__controls">
                          <div className="hero__caption | js-hero-caption">
                            <button
                              ...
                              id="hero-image-caption-button-8088"
                              aria-expanded="false"
                              aria-controls="hero-image-caption-content-8088"
                            >
                            ...
                            <div
                              ...
                              id="hero-image-caption-content-8088"
                              aria-hidden="true"
                              aria-labelledby="hero-image-caption-button-8088"
                            >
                              <button
                                type="button"
                                className="hero__caption-content-close | js-hero-caption-btn"
                                id="hero-image-caption-close-button-8088"
                                aria-expanded="false"
                                aria-controls="hero-image-caption-content-8088"
                              >
                                <span className="visually-hidden">
                              ...
                              <p> Woman browsing prints and drawings.</p>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div>
                        <div>
                          <section
                            ...
                            aria-labelledby="paragraph-8166-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-8166-title"
                                    className="visually-hidden teaser-listing__title"
                                  >
                                    Library and Archives and Study Rooms
                                  </h2>
                          ...
                          {/* <section
                            className="paragraph paragraph--type--slice-teaser paragraph--view-mode--default section section--slice-teaser section--z-index-scope section--has-carousel section--bg-white"
                            aria-labelledby="paragraph-8679-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-8679-title"
                                    className="visually-hidden teaser-listing__title"
                                  >
                                    More resources
                                  </h2>
