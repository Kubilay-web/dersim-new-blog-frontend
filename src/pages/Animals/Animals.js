          ...
          >
            <div className="layout-container">
              ...
              <main id="main-content" className="js-main">
                <div>
                  <div
                    className="hero--has-overlay paragraph paragraph--type--slice-generic-hero paragraph--view-mode--default hero align_left hero--background-pinned js-hero hero--not-in-viewport"
                    role="article"
                    aria-labelledby="paragraph-3286-title"
                  >
                    ...
                    <div className="container">
                      <div className="hero__inner">
                        <div className="hero__content-container">
                          <h1 id="paragraph-3286-title" className="hero__title">
                            {" "}
                            Animals
                          </h1>
                        </div>
                        <div className="hero__controls">
                          <div className="hero__caption | js-hero-caption">
                            <button
                              ...
                              id="hero-image-caption-button-3286"
                              aria-expanded="false"
                              aria-controls="hero-image-caption-content-3286"
                            >
                            ...
                            <div
                              ...
                              id="hero-image-caption-content-3286"
                              aria-hidden="true"
                              aria-labelledby="hero-image-caption-button-3286"
                            >
                              <button
                                type="button"
                                className="hero__caption-content-close | js-hero-caption-btn"
                                id="hero-image-caption-close-button-3286"
                                aria-expanded="false"
                                aria-controls="hero-image-caption-content-3286"
                              >
                                <span className="visually-hidden">
                              ...
                              <p>
                                {" "}
                                Two out of four small bronze figures of mounted
                                Amazons,&nbsp;which decorated the rim of a
                                Campanian bronze cinerary urn.
                                Capua,&nbsp;490–510 BC.
                              </p>
                              <a href="/collection/object/G_1856-1226-800">
                                <span>Bronze Amazons on Collection online</span>
                              </a>
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="section__inner">
                        <div className="section--intro__container">
                          ...
                          <div className="section--intro__content">
                            <p className="h3">
                              Discover the many wild and wonderful depictions of
                              animals found in the Museum's collection.
                            </p>
                            <div className="wysiwyg">
                              <p>
                                From shape-shifting dolphins to the famous
                                crowd-pulling Gayer-Anderson cat, read on to
                                discover some of the stories behind the objects.
                              </p>
                              <p>
                                You can also search{" "}
                                <a
                                ...
                                to explore how your favourite animals, real and
                                mythical, have featured through history.
                              </p>
                            </div>
                          </div>
                        </div>
                      ...
                      <div>
                        <div>
                          <section
                            ...
                            aria-labelledby="paragraph-7734-title"
                          >
                            <div className="container">
                              <a
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  <h3 className="teaser__title">
                                                    <a
                                                      href="/collection/animals/maria-sibylla-merian-pioneering-artist-flora-and-fauna"
                                                      className="teaser__anchor"
                                                    >
                                                      <span>
                                                        <span>
                                                          Maria Sibylla Merian:
                                                          pioneering artist of
                                                          flora and fauna
                                                        </span>
                                                      </span>
                                                  ...
                                                  <div className="teaser__summary">
                                                    Discover the life, work and
                                                    remarkable contribution to
                                                    the history of natural
                                                    science of this 17th-century
                                                    botanical artist.
                                                  </div>
                                                </div>
                                              </div>
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  <h3 className="teaser__title">
                                                    <a
                                                      href="/collection/animals/gayer-anderson-cat"
                                                      className="teaser__anchor"
                                                    >
                                                      <span>
                                                        <span>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-teaser paragraph--view-mode--default section section--slice-teaser section--z-index-scope section--has-carousel section--bg-black"
                            aria-labelledby="paragraph-18272-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-18272-title"
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  <h3 className="teaser__title">
                                                    <a
                                                      href="/collection/animals/beatrix-potter-flopsy-bunnies-and-british-museum"
                                                      className="teaser__anchor"
                                                    >
                                                      <span>
                                                        <span>
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  <h3 className="teaser__title">
                                                    <a
                                                      href="/collection/americas/shape-shifting-amazonian-dolphins"
                                                      className="teaser__anchor"
                                                    >
                                                      <span>
                                                        <span>
                                                  ...
                                                  <div className="teaser__summary">
                                                    In this video Curator Laura
                                                    Osorio examines an Amazonian
                                                    dolphin tooth necklace and
                                                    the stories that have built
                                                    up around this creature.
                                                  </div>
                                                </div>
                                              </div>
                                            </div>
                                            ...
                                            <div className="teaser__wrapper">
                                              <div className="teaser__image-container">
                                                <div className="media media-teaser_landscape media-image js-media">
                                                  <img
                                                    ...
                                                    width={750}
                                                    height={422}
                                                    data-src="/sites/default/files/styles/16_9_media_small/public/2022-11/Bone_pin_with_carved_unicorn_head_The_British_Museum_teaser_0.jpg?h=83928974&itok=Y4JBrNw4"
                                                    data-sizes="auto"
                                                    data-srcset="/sites/default/files/styles/16_9_media_tiny/public/2022-11/Bone_pin_with_carved_unicorn_head_The_British_Museum_teaser_0.jpg?h=83928974&itok=1ipKXYOz 400w, /sites/default/files/styles/16_9_media_small/public/2022-11/Bone_pin_with_carved_unicorn_head_The_British_Museum_teaser_0.jpg?h=83928974&itok=Y4JBrNw4 750w, /sites/default/files/styles/16_9_media_medium/public/2022-11/Bone_pin_with_carved_unicorn_head_The_British_Museum_teaser_0.jpg?h=83928974&itok=qepYSn9l 1000w, /sites/default/files/styles/16_9_media_large/public/2022-11/Bone_pin_with_carved_unicorn_head_The_British_Museum_teaser_0.jpg?h=83928974&itok=dWLdHgPb 1300w, /sites/default/files/styles/16_9_media_huge/public/2022-11/Bone_pin_with_carved_unicorn_head_The_British_Museum_teaser_0.jpg?h=83928974&itok=HQ-AKM7B 1600w"
                                                    data-focal-position="center center"
                                                    alt="Top of bone pin in shape of a unicorn's head, shown in profile."
                                                    sizes="638px"
                                                    srcSet="/sites/default/files/styles/16_9_media_tiny/public/2022-11/Bone_pin_with_carved_unicorn_head_The_British_Museum_teaser_0.jpg?h=83928974&itok=1ipKXYOz 400w, /sites/default/files/styles/16_9_media_small/public/2022-11/Bone_pin_with_carved_unicorn_head_The_British_Museum_teaser_0.jpg?h=83928974&itok=Y4JBrNw4 750w, /sites/default/files/styles/16_9_media_medium/public/2022-11/Bone_pin_with_carved_unicorn_head_The_British_Museum_teaser_0.jpg?h=83928974&itok=qepYSn9l 1000w, /sites/default/files/styles/16_9_media_large/public/2022-11/Bone_pin_with_carved_unicorn_head_The_British_Museum_teaser_0.jpg?h=83928974&itok=dWLdHgPb 1300w, /sites/default/files/styles/16_9_media_huge/public/2022-11/Bone_pin_with_carved_unicorn_head_The_British_Museum_teaser_0.jpg?h=83928974&itok=HQ-AKM7B 1600w"
                                                    src="/sites/default/files/styles/16_9_media_small/public/2022-11/Bone_pin_with_carved_unicorn_head_The_British_Museum_teaser_0.jpg?h=83928974&itok=Y4JBrNw4"
                                                  />
                                                  <noscript>
                                                    &lt;img loading="eager"
                                                    srcset="/sites/default/files/styles/16_9_media_tiny/public/2022-11/Bone_pin_with_carved_unicorn_head_The_British_Museum_teaser_0.jpg?h=83928974&amp;amp;itok=1ipKXYOz
                                                    400w,
                                                    /sites/default/files/styles/16_9_media_small/public/2022-11/Bone_pin_with_carved_unicorn_head_The_British_Museum_teaser_0.jpg?h=83928974&amp;amp;itok=Y4JBrNw4
                                                    750w,
                                                    /sites/default/files/styles/16_9_media_medium/public/2022-11/Bone_pin_with_carved_unicorn_head_The_British_Museum_teaser_0.jpg?h=83928974&amp;amp;itok=qepYSn9l
                                                    1000w,
                                                    /sites/default/files/styles/16_9_media_large/public/2022-11/Bone_pin_with_carved_unicorn_head_The_British_Museum_teaser_0.jpg?h=83928974&amp;amp;itok=dWLdHgPb
                                                    1300w,
                                                    /sites/default/files/styles/16_9_media_huge/public/2022-11/Bone_pin_with_carved_unicorn_head_The_British_Museum_teaser_0.jpg?h=83928974&amp;amp;itok=HQ-AKM7B
                                                    1600w" width="750"
                                                    height="422"
                                                    data-src="/sites/default/files/styles/16_9_media_small/public/2022-11/Bone_pin_with_carved_unicorn_head_The_British_Museum_teaser_0.jpg?h=83928974&amp;amp;itok=Y4JBrNw4"
                                                    data-sizes="auto" alt="Top
                                                    of bone pin in shape of a
                                                    unicorn&amp;#039;s head,
                                                    shown in profile." /&gt;
                                                  </noscript>
                                                </div>
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  <h3 className="teaser__title">
                                                    <a
                                                      href="/collection/animals/how-catch-unicorn"
                                                      className="teaser__anchor"
                                                    >
                                                      <span>
                                                        <span>
                                                  ...
                                                  <div className="teaser__summary">
                                                    Curator Naomi Speakman shows
                                                    us objects within the
                                                    medieval collection that
                                                    depict mythical beasts and
                                                    discusses their symbolism.
                                                  </div>
                                                </div>
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-11448-title"
                          >
                            <div className="container">
                              <a
                                className="js-jump-link-anchor"
                                    ...
                                    >
                                      ...
                                      >
                                        <button
                                          ...
                                          data-large-image-url="/sites/default/files/styles/uncropped_huge/public/2020-02/Horse-Halikarnassos.jpg"
...
A four-horse chariot group (quadriga) was positioned on the top of the stepped pyramid that crowned the Mausoleum.&nbsp;Attributed to Pytheos of Priene. <a href="http://localhost:3000/collection/object/G_1857-1220-239"><span>Collection online</span></a>'
                                        ...
                                        >
                                          <span className="visually-hidden">
                                            ...
                                            horse - opens in a modal which shows
                                            a larger image and a caption
                                          </span>
                                        </button>
                                      ...
                                      >
                                        <button
                                          type="button"
                                          className="carousel--gallery__button | js-photoswipe-item"
                                          data-large-image-url="/sites/default/files/styles/uncropped_huge/public/2020-02/durer-rhino-2000.jpg"
...
A woodcut of a rhinoceros standing in profile to the right, and five and a half lines of letterpress above. Print made by Albrecht Dürer. <a href=&quot;http://localhost:3000/collection/object/P_1895-0122-714&quot;><span>Collection online</span></a>"
                                      ...
                                      >
                                        <button
                                          type="button"
                                          className="carousel--gallery__button | js-photoswipe-item"
                                          data-large-image-url="/sites/default/files/styles/uncropped_huge/public/2020-02/elephant_2000.jpg"
                                          data-large-image-width={1600}
...
One of a pair of model elephants. Made of porcelain in a mould and decorated in overglaze enamels in red, yellow, green and blue with nigoshide (milky white) body. <a href="http://localhost:3000/collection/object/A_1980-0325-1-2"><span>Collection online</span></a>'
                                        ...
                                        >
                                          <span className="visually-hidden">
                                            ...
                                            Japan - opens in a modal which shows
                                            a larger image and a caption
                                          </span>
                                        </button>
                                        <div className="carousel--gallery__content">
                                      ...
                                      >
                                        <button
                                          type="button"
                                          className="carousel--gallery__button | js-photoswipe-item"
                                          data-large-image-url="/sites/default/files/styles/uncropped_huge/public/2020-02/Merian-2000.jpg"
                                          data-large-image-width={1600}
...
From an album entitled 'Merian's Drawings of Surinam Insects and&nbsp;Amphibians'. It shows one black beetle resembling a stag-beetle, the other green. Watercolour, strengthened with gum, and bodycolour, heightened with white, on vellum.&nbsp; <a href=&quot;http://localhost:3000/collection/object/P_SL-5275-75&quot;><span>Collection online</span></a>"
                                        ...
                                        >
                                          <span className="visually-hidden">
                                            Drawing by Maria Sibylla Merian -
                                            opens in a modal which shows a
                                            larger image and a caption
                                          </span>
                                        </button>
                                        <div className="carousel--gallery__content">
                                          <div className="media media-gallery media-image js-media">
                                            <img
                                              ...
                                              width={900}
                                              height={700}
                                              data-src="/sites/default/files/styles/bm_gallery_medium_700h/public/2020-02/Merian-2000.jpg?itok=AUcampj0"
                                              data-sizes="auto"
                                              data-srcset="/sites/default/files/styles/bm_gallery_medium_700h/public/2020-02/Merian-2000.jpg?itok=AUcampj0 900w"
                                              data-focal-position="center center"
                                              alt="Drawing of two beetles and a plant on vellum"
                                              sizes="643px"
                                              srcSet="/sites/default/files/styles/bm_gallery_medium_700h/public/2020-02/Merian-2000.jpg?itok=AUcampj0 900w"
                                              src="/sites/default/files/styles/bm_gallery_medium_700h/public/2020-02/Merian-2000.jpg?itok=AUcampj0"
                                            />
                                            <noscript>
                                              &lt;img loading="eager"
                                              srcset="/sites/default/files/styles/bm_gallery_medium_700h/public/2020-02/Merian-2000.jpg?itok=AUcampj0
                                              900w" width="900" height="700"
                                              data-src="/sites/default/files/styles/bm_gallery_medium_700h/public/2020-02/Merian-2000.jpg?itok=AUcampj0"
                                              data-sizes="auto" alt="Drawing of
                                              two beetles and a plant on vellum"
                                              /&gt;
                                            </noscript>
                                          </div>
                                          <p className="carousel--gallery__item-title">
                                      ...
                                      >
                                        <button
                                          type="button"
                                          className="carousel--gallery__button | js-photoswipe-item"
                                          data-large-image-url="/sites/default/files/styles/uncropped_huge/public/2020-02/assyrian-wall-panel-2000.jpg"
                                          data-large-image-width={1600}
...
Detail of gypsum wall panel relief from the North Palace, showing king Ashurbanipal hunting on horseback and on foot with attendants. <a href="http://localhost:3000/collection/object/W_1856-0909-48_6"><span>Collection online</span></a>'
                                        ...
                                        >
                                          <span className="visually-hidden">
                                            Neo-Assyrian wall panel - opens in a
                                        ...
                                        <div className="carousel--gallery__content">
                                          <div className="media media-gallery media-image js-media">
                                            <img
                                              ...
                                              width={933}
                                              height={700}
                                              data-src="/sites/default/files/styles/bm_gallery_medium_700h/public/2020-02/assyrian-wall-panel-2000.jpg?itok=QD8QAEUb"
                                              data-sizes="auto"
                                              data-srcset="/sites/default/files/styles/bm_gallery_medium_700h/public/2020-02/assyrian-wall-panel-2000.jpg?itok=QD8QAEUb 933w"
                                              data-focal-position="center center"
                                              alt="Detail of wall panel, showing the heads of two horses"
                                            />
                                            <noscript>
                                              &lt;img loading="eager"
                                              srcset="/sites/default/files/styles/bm_gallery_medium_700h/public/2020-02/assyrian-wall-panel-2000.jpg?itok=QD8QAEUb
                                              933w" width="933" height="700"
                                              data-src="/sites/default/files/styles/bm_gallery_medium_700h/public/2020-02/assyrian-wall-panel-2000.jpg?itok=QD8QAEUb"
                                              data-sizes="auto" alt="Detail of
                                              wall panel, showing the heads of
                                              two horses" /&gt;
                                            </noscript>
                                          </div>
                                          <p className="carousel--gallery__item-title">
                                            Neo-Assyrian wall panel
                                          </p>
                                        </div>
                                      </li>
                                    </ul>
                                  ...
                                  <div className="teaser__wrapper">
                                    ...
                                    <div className="teaser__content">
                                      <div className="teaser__content-push">
                                        ...
                                        <div className="teaser__summary">
                                          Love and desire is a theme found
                                          across the Museum's collection.
                                        </div>
                                      </div>
                                    </div>
                                  </div>
