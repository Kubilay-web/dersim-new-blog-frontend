  ...
  return (
    <div>
      <div>
        ...
        <meta
          name="description"
          content="From an African king to a Chinese princess, meet the fascinating figures whose stories are forever entwined with the Silk Roads."
        />
        <link
          rel="canonical"
        ...
        <meta
          property="og:title"
          content="Far from home: travelling the Silk Roads"
        />
        <meta
        ...
        <meta
          property="og:image"
          content="/images/FarHome/Elephant%20manuscript%201600x825_3.jpg"
        />
        ...
        <title>Far from home: travelling the Silk Roads | Dersim Museum</title>
        ...
        <link
          ...
          sizes="180x180"
          href="/images/FarHome/apple-touch-icon.png"
        />
        <link
          rel="icon"
          type="image/png"
          href="/images/FarHome/favicon-32x32.png"
          sizes="32x32"
        />
        <link
          rel="icon"
          type="image/png"
          href="/images/FarHome/favicon-16x16.png"
          sizes="16x16"
        />
        <link rel="manifest" href="/site.webmanifest" />
        <link
          rel="mask-icon"
          href="/images/FarHome/safari-pinned-tab.svg"
          color="#5bbad5"
        />
              ...
              <main id="main-content" className="js-main">
                <div>
                  <div
                    ...
                    role="article"
                    aria-labelledby="paragraph-41258-title"
                  >
                    <div className="hero__background">
                      <div className="media media-hero media-image js-media">
                        <picture>
                          ...
                          <source
                            srcSet="/images/FarHome/Elephant%20manuscript%20hero_1.jpg 1x"
                          ...
                          />
                          <source
                            srcSet="/images/FarHome/Elephant%20manuscript%20hero_3.jpg 1x"
                          ...
                          />
                          <source
                            srcSet="/images/FarHome/Elephant%20manuscript%20hero_2.jpg 1x"
                          ...
                          <img
                            ...
                            src="/images/FarHome/Elephant%20manuscript%20hero.jpg"
                            alt="Manuscript with decorated initial showing an elephant"
                          />
                        </picture>
                      </div>
                    </div>
                        ...
                        <div className="hero__controls">
                          <div className="hero__caption | js-hero-caption">
                            <button
                              ...
                              id="hero-image-caption-button-41258"
                              aria-expanded="false"
                              aria-controls="hero-image-caption-content-41258"
                            >
                            ...
                            <div
                              ...
                              id="hero-image-caption-content-41258"
                              aria-hidden="true"
                              aria-labelledby="hero-image-caption-button-41258"
                            >
                              <button
                                type="button"
                                className="hero__caption-content-close | js-hero-caption-btn"
                                id="hero-image-caption-close-button-41258"
                                aria-expanded="false"
                                aria-controls="hero-image-caption-content-41258"
                              >
                                <span className="visually-hidden">
                              ...
                              <p>
                                {" "}
                                Decorated initial showing an elephant's head,
                                early AD 800s. Photo © Bibliothèque nationale de
                                France, Latin 2915, folio 9v.&nbsp;
                              </p>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="section--intro__container">
                            ...
                            <div className="section--intro__info-slices section--intro__info-slices-no-title">
                              ...
                              <div className="paragraph paragraph--type--info-author paragraph--view-mode--default section--intro__info-author">
                                <div className="author__item_wrapper">
                                  ...
                                  <div>Publication date: 23 September 2024</div>
                                </div>
                              </div>
                          ...
                          <div className="section--intro__content">
                            ...
                            <div className="wysiwyg">
                              <h3>
                                From an African king to a Chinese princess, meet
                                the fascinating figures whose stories are
                                forever entwined with the Silk Roads.
                              </h3>
                              <p>
                                For millennia, people travelling the Silk Roads
                                carried objects, ideas and technologies to new
                                realms. We know little about many of these
                                individuals, but some have left a lasting mark
                                on the historical record. Their tales highlight
                                the links between communities across Asia,
                                Africa and Europe, from China to Dersim, and
                                ...
                                who travelled this vast network. Hear how a
                                princess from Dunhuang assured diplomatic ties
                                with Khotan in the first millennium AD, meet a
                                Middle-Eastern elephant-envoy and learn about
                                the canny strategies of an African king in the
                                AD 500s.
                              </p>
                            </div>
                          </div>
                      ...
                      <div>
                        <div>
                          <section
                            ...
                            aria-labelledby="paragraph-41264-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-41264-title"
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>Luk Yu-ping</p>
                                    <p>
                                      During the AD 600s and 700s, in the
                                      Buddhist kingdom of Khotan (now in
                                      present-day northwest China), a legend
                                      spread about a princess from an 'eastern
                                      kingdom' who brought sericulture (silk
                                      farming) to the region, the secrets of
                                      which had been kept in China for thousands
                                      of years. The princess hid mulberry tree
                                      seeds and silkworm eggs in her headdress
                                      when she married the king of Khotan so
                                      that she could have silk robes to wear in
                                      her new home. A monastery was built on the
                                      site where the first silkworms were bred,
                                      and the princess prohibited the killing of
                                      silkworms.
                                    </p>
                                    <p>
                                      This story, recorded by the Buddhist monk
                                      Xuanzang (AD 602–664) who visited Khotan,
                                      is depicted on a painted wooden panel
                                      discovered in the remains of a Buddhist
                                      temple in Dandan Uiliq in the Khotan
                                      oasis.
                                    </p>
                                    <div
                                    ...
                                    >
                                      <figure className="media media-embed media-image js-media">
                                        <img
                                          ...
                                          srcSet="/images/FarHome/Silk%20Princess%202%201600px_4.jpg 400w, /images/FarHome/Silk%20Princess%202%201600px_1.jpg 750w, /images/FarHome/Silk%20Princess%202%201600px_2.jpg 1000w, /images/FarHome/Silk%20Princess%202%201600px_3.jpg 1300w, /images/FarHome/Silk%20Princess%202%201600px.jpg 1600w"
                                          sizes="100vw"
                                          width={1600}
                                          height={460}
                                          src="/images/FarHome/Silk%20Princess%202%201600px.jpg"
                                    ...
                                    <p>
                                      The princess is shown wearing an elaborate
                                      headdress surrounded by a halo, suggesting
                                      her holy status. A basket of cocoons and a
                                      woman weaving at a loom nearby highlight
                                      the success of her rebellious act.
                                    </p>
                                    <p>
                                      So who was this princess from an eastern
                                      kingdom? Could this legend really have
                                      happened? There is no historical record of
                                      a princess from imperial China marrying
                                      the king of Khotan. Perhaps she came from
                                      another kingdom neighbouring Khotan. While
                                      the identity of this princess remains a
                                      mystery, many women travelled and married
                                      as part of political alliances between
                                      states during the period AD 500–1000,
                                      playing a role in ensuring smooth
                                      relations along the Silk Roads. One
                                      example is Lady Cao (active AD 930s –
                                      950s), the daughter of Cao Yijin (r. AD
                                      914–935), a local ruler of Dunhuang, who
                                      in AD 934 married the king of Khotan, Li
                                      Shengtian (in Khotanese Viśa' Saṃbhava, r.
                                      AD 912–966). This marriage was an
                                      important political alliance between
                                      Dunhuang and Khotan, and her image in full
                                      regalia appears in two Buddhist rock-cut
                                      temples at the Mogao Caves, Dunhuang. Her
                                      long title identifies her as the queen of
                                      Khotan.
                                    </p>
                                    <div
                                      data-entity-type="media"
                                      data-entity-uuid="044620b8-0e29-4107-9969-37435e35cd3e"
                                      data-embed-button="media"
                                      data-entity-embed-display="view_mode:media.embed"
                                      data-langcode="en"
                                      data-entity-embed-display-settings="[]"
                                    ...
                                    >
                                      <figure className="media media-embed media-image js-media">
                                        <img
                                          loading="eager"
                                          className="lazyload not-full-width"
                                          srcSet="/images/FarHome/Lady%20Cao%201000x1450_3.jpg 400w, /images/FarHome/Lady%20Cao%201000x1450_2.jpg 750w, /images/FarHome/Lady%20Cao%201000x1450_1.jpg 1000w"
                                          sizes="100vw"
                                          width={1000}
                                          height={1450}
                                          src="/images/FarHome/Lady%20Cao%201000x1450.jpg"
                                          alt="Colourful wall painting of Lady Cao wearing an elaborate headdress"
                                        />
                                        <figcaption>
                                          Detail showing Lady Cao, from a wall
                                          painting in Cave 61, Mogao Caves,
                                          Dunhuang, China AD 947–951. Image
                                          source: Dunhuang Academy.
                                        </figcaption>
                                      </figure>
                                    </div>
                                    <p>
                                      Although little is known about Lady Cao,
                                      fragments of writings preserved in Cave 17
                                      (the 'Library Cave' sealed 1,000 years ago
                                      and filled with more than 70,000
                                      manuscripts, paintings and other objects)
                                      at Dunhuang suggest that she kept in touch
                                      with her parents, who from time-to-time
                                      sent her things such as fine silk
                                      textiles. A text dating to AD 956 records
                                      diplomatic gifts sent from Dunhuang to
                                      Khotan, including female zither (a type of
                                      stringed instrument) players and other
                                      court musicians for the queen.
                                    </p>
                                    <div
                                      data-entity-type="media"
                                      data-entity-uuid="5ae8fe6c-4800-4577-9eee-62667bdd0d9d"
                                      data-embed-button="media"
                                      data-entity-embed-display="view_mode:media.embed"
                                      data-langcode="en"
                                      data-entity-embed-display-settings="[]"
                                    ...
                                    >
                                      <figure className="media media-embed media-image js-media">
                                        <img
                                          loading="eager"
                                          className="lazyload not-full-width"
                                          srcSet="/images/FarHome/Diplomatic%20gifts%201000px_2.jpg 400w, /images/FarHome/Diplomatic%20gifts%201000px_3.jpg 750w, /images/FarHome/Diplomatic%20gifts%201000px_1.jpg 1000w"
                                          sizes="100vw"
                                          width={1000}
                                          height={770}
                                          src="/images/FarHome/Diplomatic%20gifts%201000px.jpg"
                                          alt="Detail of a manuscript listing diplomatic gifts from Dunhuang to Khotan."
                                        />
                                        <figcaption>
                                          Detail of a manuscript listing
                                          diplomatic gifts from Dunhuang to
                                          Khotan, Cave 17, Mogao Caves,
                                          Dunhuang, China, AD 956. Photo ©
                                          Bibliothèque nationale de France,
                                          Pelliot chinois 3016v.
                                        </figcaption>
                                      </figure>
                                    </div>
                                    <p>
                                      A rare and tantalising survival is an
                                      envelope with the writing and seal of the
                                      'Heavenly Queen of Khotan', which is
                                      likely to have been from Lady Cao to her
                                      family in Dunhuang. Sadly, the letter
                                      itself has not been found, but the seal
                                      and text on the envelope suggest that she
                                      was educated and literate and that
                                      communication went in both directions.
                                    </p>
                                    <div
                                      data-entity-type="media"
                                      data-entity-uuid="25c2f60d-4857-4d3a-812e-2b7693a14759"
                                      data-embed-button="media"
                                      data-entity-embed-display="view_mode:media.embed"
                                      data-langcode="en"
                                      data-entity-embed-display-settings="[]"
                                    ...
                                    >
                                      <figure className="media media-embed media-image js-media">
                                        <img
                                          loading="eager"
                                          className="lazyload not-full-width"
                                          srcSet="/images/FarHome/Envelope%202%201000px_2.jpg 400w, /images/FarHome/Envelope%202%201000px_1.jpg 750w, /images/FarHome/Envelope%202%201000px_3.jpg 1000w"
                                          sizes="100vw"
                                          width={1000}
                                          height={730}
                                          src="/images/FarHome/Envelope%202%201000px.jpg"
                                          alt="An envelope from the 'Heavenly Queen'. "
                                        />
                                        <figcaption>
                                          An envelope from the 'Heavenly Queen',
                                          Cave 17, Mogao Caves, Dunhuang, China,
                                          AD 900s. Photo © Bibliothèque
                                          nationale de France, Pelliot chinois
                                          4516v.
                                        </figcaption>
                                      </figure>
                                    </div>
                                    <p>
                                      Lady Cao's story is part of a longer
                                      history of elite women who travelled as
                                      part of political marriages. The
                                      relationships that they helped to foster –
                                      and the movement of attendants, ideas and
                                      goods that followed their marriages – were
                                      an important part of the diplomatic
                                      exchanges that took place along the Silk
                                      Roads.&nbsp;
                                    </p>
                                  </div>
                                </div>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-41265-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-41265-title"
                                  className="section__title section--slice-content__title"
                                >
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>Elisabeth R. O'Connell</p>
                                    <p>
                                      Around AD 524 an anonymous Alexandrian
                                      merchant, later known as Cosmas
                                      Indicopleustes (meaning 'who sailed to
                                      India' in Greek), travelled to the
                                      bustling port city of Adulis, on the Red
                                      Sea coast of Africa. As it is today, the
                                      Red Sea was a strategic waterway on the
                                      Silk Roads, connecting the Indian Ocean
                                      ...
                                      Ethiopia, controlled access to the Red Sea
                                      from Adulis, in what is now Eritrea.
                                    </p>
                                    <div
                                      data-entity-type="media"
                                      data-entity-uuid="c8f1dd5d-3782-4f6f-92ef-c940c988d3d1"
                                      data-embed-button="media"
                                      data-entity-embed-display="view_mode:media.embed"
                                      data-langcode="en"
                                      data-entity-embed-display-settings="[]"
                                    ...
                                    >
                                      <figure className="media media-embed media-image js-media">
                                        <img
                                          loading="eager"
                                          className="lazyload not-full-width"
                                          srcSet="/images/FarHome/Obelisk-at-Axum-850x601_1.jpg 400w, /images/FarHome/Obelisk-at-Axum-850x601_3.jpg 750w, /images/FarHome/Obelisk-at-Axum-850x601_2.jpg 850w"
                                          sizes="100vw"
                                          width={850}
                                          height={601}
                                          src="/images/FarHome/Obelisk-at-Axum-850x601.jpg"
                                          alt="Hand-coloured aquatint depicting an obelisk beside a spreading tree in a flat landscape between low hills"
                                        />
                                        <figcaption>
                                          ...
                                          <em>
                                            Twenty-four views taken in St
                                            Helena, the Cape, India, Ceylon, the
                                            Red Sea, Abyssinia &amp; Egypt
                                          </em>
                                          . Hand-coloured aquatint, 1809.
                                        </figcaption>
                                      </figure>
                                    </div>
                                    <p>
                                      By the mid-AD 200s Aksum was already
                                      considered one of the world's most
                                      powerful realms alongside Persia, Rome and
                                      Sileos, which modern scholars think is
                                      probably China. The cosmopolitan outlook
                                      of Aksum's kings is clear from their use
                                      of Greek alongside their own language,
                                      Ge‘ez, in inscriptions and on coins. In
                                      the mid-AD 300s they also adopted
                                      Christianity, making Aksum one of the
                                      earliest officially Christian states.
                                    </p>
                                    <div
                                      data-entity-type="media"
                                      data-entity-uuid="fb097bc9-c153-4c5a-ad8d-bb7368e8c3b7"
                                      data-embed-button="media"
                                      data-entity-embed-display="view_mode:media.embed"
                                      data-langcode="en"
                                      data-entity-embed-display-settings="[]"
                                    ...
                                    >
                                      <figure className="media media-embed media-image js-media">
                                        <img
                                          loading="eager"
                                          className="lazyload not-full-width"
                                          srcSet="/images/FarHome/Kaleb%20coin%201000px_2.jpg 400w, /images/FarHome/Kaleb%20coin%201000px_3.jpg 750w, /images/FarHome/Kaleb%20coin%201000px_1.jpg 1000w"
                                          sizes="100vw"
                                          width={1000}
                                          height={495}
                                          src="/images/FarHome/Kaleb%20coin%201000px.jpg"
                                        ...
                                        <figcaption>
                                          ...
                                          inscriptions, minted in Aksum, about
                                          AD 510–525.&nbsp;
                                        </figcaption>
                                      </figure>
                                    </div>
                                    <p>
                                      Travelling from Byzantine Egypt, Cosmas
                                      was in Adulis to buy elephant ivory. While
                                      there the local governor invited him to
                                      copy Greek monumental inscriptions for the
                                      king of Aksum, Kaleb (r. about AD
                                      510–540), who was preparing to invade the
                                      Jewish kingdom of Himyar, just across the
                                      Red Sea in present-day Yemen. The original
                                      inscriptions that Cosmas copied are lost
                                      but, from his record, modern scholars have
                                      distinguished two extraordinary texts,
                                      which were carved about 500 years apart.
                                      They are depicted in a remarkable drawing
                                      preserved in all three surviving
                                      manuscript copies of Cosmas' work.
                                    </p>
                                    <div
                                      data-entity-type="media"
                                      data-entity-uuid="c7eeeba7-c637-4ae2-a8f0-70567b253f63"
                                      data-embed-button="media"
                                      data-entity-embed-display="view_mode:media.embed"
                                      data-langcode="en"
                                      data-entity-embed-display-settings="[]"
                                    ...
                                    >
                                      <figure className="media media-embed media-image js-media">
                                        <img
                                          loading="eager"
                                          className="lazyload not-full-width"
                                          srcSet="/images/FarHome/Greek%20codex%201000x1200_3.jpg 400w, /images/FarHome/Greek%20codex%201000x1200_1.jpg 750w, /images/FarHome/Greek%20codex%201000x1200_2.jpg 1000w"
                                          sizes="100vw"
                                          width={1000}
                                          height={1200}
                                          src="/images/FarHome/Greek%20codex%201000x1200.jpg"
                                          alt="Illustration of two monuments: a tall black stone stela with a triangular top; and a white marble votive throne. "
                                        />
                                        <figcaption>
                                          Monuments of Adulis illustrated in the{" "}
                                          <em>Christian Topography</em>. Ink and
                                          pigments on parchment, AD 1000s copy
                                          of AD 500s original. Photo: Biblioteca
                                          Medicea Laurenziana, Florence,
                                          Laur.Plut. IX.28, fol. 38r.
                                        </figcaption>
                                      </figure>
                                    </div>
                                    <p>
                                      The earlier inscription, carved on a tall
                                      black stone stela with a triangular top
                                      (left), commemorates elephant-hunting
                                      expeditions by the Macedonian king of
                                      Egypt, Ptolemy III (r. 246–221 BC), and
                                      his conquests using 'war elephants' all
                                      the way to Central Asia. The later
                                      inscription was carved on a white marble
                                      votive throne (right) around AD 200 and
                                      celebrates the successes of a previous
                                      Aksumite king at the height of the
                                      empire's expansion, when its territories
                                      stretched from the northern Horn of Africa
                                      across the Red Sea to southwest
                                      Arabia.&nbsp;
                                    </p>
                                    <p>
                                      When Kaleb launched his military campaign
                                      against Himyar in AD 525, it was nominally
                                      to redress the persecution of fellow
                                      Christians. However, his claim to rule
                                      southwest Arabia was also conveniently
                                      validated by the inscriptions copied by
                                      Cosmas. The story of the trader and the
                                      king, brought together by cross-cultural
                                      connections in a busy international hub,
                                      demonstrates the range of activities made
                                      possible by the Silk Roads, as well as
                                      their geographical breadth, both in the AD
                                      500s and in the centuries before.&nbsp;
                                      <br />
                                      &nbsp;
                                    </p>
                                  </div>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-41266-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-41266-title"
                                  className="section__title section--slice-content__title"
                                >
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>Sue Brunning</p>
                                    <p>
                                      In the years around AD 800, two powerful
                                      rulers from different parts of the world
                                      engaged in an act of diplomacy. On one
                                      side was Charlemagne, soon to be the
                                      emperor of much of Western Europe, with
                                      his capital at Aachen in present-day
                                      Germany. On the other was Harun al-Rashid,
                                      ruler of the vast Abbasid caliphate, from
                                      his own capital, Baghdad, in present-day
                                      Iraq.
                                    </p>
                                    <div
                                      data-entity-type="media"
                                      data-entity-uuid="2ca9bfee-5d5d-457d-b47c-b5d84a549da1"
                                      data-embed-button="media"
                                      data-entity-embed-display="view_mode:media.embed"
                                      data-langcode="en"
                                      data-entity-embed-display-settings="[]"
                                    ...
                                    >
                                      <figure className="media media-embed media-image js-media">
                                        <img
                                          loading="eager"
                                          className="lazyload not-full-width"
                                          srcSet="/images/FarHome/Coins%20combined%202000x1000_3.jpg 400w, /images/FarHome/Coins%20combined%202000x1000_1.jpg 750w, /images/FarHome/Coins%20combined%202000x1000_2.jpg 1000w, /images/FarHome/Coins%20combined%202000x1000_4.jpg 1300w, /images/FarHome/Coins%20combined%202000x1000.jpg 1600w"
                                          sizes="100vw"
                                          width={1600}
                                          height={800}
                                          src="/images/FarHome/Coins%20combined%202000x1000.jpg"
                                    ...
                                    <p>
                                      Their envoys faced arduous journeys
                                      between the realms: some 3,600km
                                      point-to-point, but in reality far longer
                                      as they traced winding routes by river,
                                      land and sea – routes that, collectively,
                                      made up the overlapping networks of the
                                      Silk Roads.
                                    </p>
                                    <p>
                                      Contemporary Frankish texts record the
                                      names of Charlemagne's envoys as Lantfrid,
                                      Sigimund, and a Jewish man named Isaac.
                                      The first two learned, to their cost, the
                                      magnitude of the undertaking, as both
                                      perished before completing the round trip.
                                      Isaac made it back to Europe, bringing
                                      with him Harun's envoys from Baghdad.
                                      While we don't know the Abbasid envoys'
                                      names, we do have a record of another
                                      individual who survived the long journey
                                      westward: Abu al-Abbas, who also happened
                                      to be an elephant.
                                    </p>
                                    <p>
                                      Abu was the most remarkable of Harun's
                                      many diplomatic gifts to Charlemagne. His
                                      species, whether African or Asian, is
                                      unknown, but he apparently captured
                                      imaginations in his new home in Francia.
                                      Possibly, he inspired an illuminator at St
                                      Denis Abbey, near Paris, to embellish a
                                      manuscript with a lifelike head of an
                                      elephant. Its small, floppy ears,
                                      resembling those of Asian elephants, may
                                      be a clue to Abu's origin.
                                    </p>
                                    <div
                                      data-entity-type="media"
                                      data-entity-uuid="35774198-3315-4b93-a2da-54527874aaef"
                                      data-embed-button="media"
                                      data-entity-embed-display="view_mode:media.embed"
                                      data-langcode="en"
                                      data-entity-embed-display-settings="[]"
                                    ...
                                    >
                                      <figure className="media media-embed media-image js-media">
                                        <img
                                          loading="eager"
                                          className="lazyload not-full-width"
                                          srcSet="/images/FarHome/Elephant%20manuscript%201600x825_1.jpg 400w, /images/FarHome/Elephant%20manuscript%201600x825_4.jpg 750w, /images/FarHome/Elephant%20manuscript%201600x825_2.jpg 1000w, /images/FarHome/Elephant%20manuscript%201600x825_3.jpg 1300w, /images/FarHome/Elephant%20manuscript%201600x825.jpg 1600w"
                                          sizes="100vw"
                                          width={1600}
                                          height={825}
                                          src="/images/FarHome/Elephant%20manuscript%201600x825.jpg"
                                          alt="Detail from a manuscript showing a decorated initial with an elephant's head."
                                        />
                                        <figcaption>
                                          <a href="https://essentiels.bnf.fr/fr/image/b8cd114e-9a79-4b8d-ae5c-c359247a9df2-initiale-b-ornee-zoomorphe">
                                            Decorated initial
                                          </a>{" "}
                                          showing an elephant's head, from a
                                          manuscript made during Abu al-Abbas's
                                          lifetime, early AD 800s. Photo ©
                                          Bibliothèque nationale de France,
                                          Latin 2915, folio 9v.&nbsp;
                                        </figcaption>
                                      </figure>
                                    ...
                                    <p>
                                      A part of Abu himself may have survived
                                      too. The exhibition displays a vanishingly
                                      rare Carolingian example of a vessel known
                                      as a <em>pyxis</em>, used as containers
                                      for small items. They were made by cutting
                                      a section through an elephant's tusk, to
                                      create the distinctive cylindrical shape.
                                    </p>
                                    <div
                                      data-entity-type="media"
                                      data-entity-uuid="12f44a2d-c4ad-485f-a82f-e9bec6820f1c"
                                      data-embed-button="media"
                                      data-entity-embed-display="view_mode:media.embed"
                                      data-langcode="en"
                                      data-entity-embed-display-settings="[]"
                                    ...
                                    >
                                      <figure className="media media-embed media-image js-media">
                                        <img
                                          loading="eager"
                                          className="lazyload not-full-width"
                                          srcSet="/images/FarHome/Pyxis%201920x1080_1.jpg 400w, /images/FarHome/Pyxis%201920x1080_4.jpg 750w, /images/FarHome/Pyxis%201920x1080_2.jpg 1000w, /images/FarHome/Pyxis%201920x1080_3.jpg 1300w, /images/FarHome/Pyxis%201920x1080.jpg 1600w"
                                          sizes="100vw"
                                          width={1600}
                                          height={900}
                                          src="/images/FarHome/Pyxis%201920x1080.jpg"
                                    ...
                                    <p>
                                      Fresh ivory was hard to come by in
                                      Charlemagne's realm, where artisans often
                                      recycled late Roman and Byzantine carved
                                      plaques by planing down their decoration
                                      to make new pieces. The <em>pyxis</em>,
                                      however, required an unused tusk. Its
                                      carvings suggest that it was made in
                                      Aachen, Charlemagne's capital, during the
                                      early AD 800s. Texts record Abu's death in
                                      AD 810 at Lippenham, only 100km or so to
                                      the north. These tantalising links make it
                                      tempting to speculate on whether one of
                                      Abu's tusks could have provided the
                                      material for the <em>pyxis</em>. While
                                      this is difficult to prove, Abu's poignant
                                      story reminds us that animals, as well as
                                      humans, played their part in connecting
                                      cultures across the Silk Roads' sprawling
                                      networks.
                                    </p>
                                  </div>
                                </div>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-41324-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-41324-title"
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      ...
                                      <strong>
                                        , opening 26 September. You can also
                                    ...
                                    <div className="teaser__content">
                                      <div className="teaser__content-push">
                                        ...
                                        <div className="teaser__summary">
                                          Go beyond sand and spices to discover
                                          how the journeys of people, objects
                                          and ideas across three continents
                                          shaped cultures and histories.
                                        </div>
                                      </div>
                                      <span className="teaser__button | button button--chevron">
                                        Find out more{" "}
                                        <span className="visually-hidden">
                                          about <span>Silk Roads</span>
                                        </span>
                                      </span>
                                    </div>
                                  </div>
                                  ...
                                  <div className="teaser__wrapper">
                                    <div className="teaser__image-container">
                                      <div className="media media-teaser_landscape media-image js-media">
                                        ...
                                        <noscript>
                                          ...
                                          1600w" width="750" height="422"
                                          data-src="/sites/default/files/styles/16_9_media_small/public/2024-08/I9xTJRtQ.jpeg?h=f3d113e0&amp;itok=Wswsw_8Z"
                                          data-sizes="auto" alt="Man sitting on
                                          stairs with colour masked figures
                                          behind him." /&gt;
                                        </noscript>
                                      </div>
                                    </div>
                                    <div className="teaser__content">
                                      <div className="teaser__content-push">
                                        <div className="teaser__meta teaser__meta--top">
                                          <div className="teaser__meta-item">
                                            <span>Blog / 4 September 2024</span>
                                          </div>
                                        </div>
                                        <h3 className="teaser__title">
                                          <a
                                        ...
                                        <div className="teaser__summary">
                                          Explore how artist Hew Locke has
                                          worked with the Museum to challenge
                                          and question the histories and
                                          legacies of Dersim imperialism.
                                        </div>
                                      </div>
                                      <span className="teaser__button | button button--chevron">
                                        {" "}
                                  ...
                                  <div className="teaser__wrapper">
                                    <div className="teaser__image-container">
                                      <div className="media media-teaser_landscape media-image js-media">
                                        <img
                                          ...
                                          width={750}
                                          height={422}
                                          data-src="/sites/default/files/styles/16_9_media_small/public/2023-02/China%27s-hidden-century-teaser9.jpg?h=5dabf909&itok=KEkPtSX1"
                                          data-sizes="auto"
                                          data-srcset="/sites/default/files/styles/16_9_media_tiny/public/2023-02/China%27s-hidden-century-teaser9.jpg?h=5dabf909&itok=sBxv2EyB 400w, /sites/default/files/styles/16_9_media_small/public/2023-02/China%27s-hidden-century-teaser9.jpg?h=5dabf909&itok=KEkPtSX1 750w, /sites/default/files/styles/16_9_media_medium/public/2023-02/China%27s-hidden-century-teaser9.jpg?h=5dabf909&itok=L_sj_Qcp 1000w, /sites/default/files/styles/16_9_media_large/public/2023-02/China%27s-hidden-century-teaser9.jpg?h=5dabf909&itok=y2S5oEMa 1300w, /sites/default/files/styles/16_9_media_huge/public/2023-02/China%27s-hidden-century-teaser9.jpg?h=5dabf909&itok=yPTg5pIh 1600w"
                                          data-focal-position="center center"
                                          alt="Ink and colour picture showing the head and shoulders of an elderly Chinese woman with her hair tied back. She is wearing green earings and a blue jacket decorated with gold leaves around the neck. "
                                        />
                                        <noscript>
                                          &lt;img loading="eager"
                                          srcset="/sites/default/files/styles/16_9_media_tiny/public/2023-02/China%27s-hidden-century-teaser9.jpg?h=5dabf909&amp;itok=sBxv2EyB
                                          400w,
                                          /sites/default/files/styles/16_9_media_small/public/2023-02/China%27s-hidden-century-teaser9.jpg?h=5dabf909&amp;itok=KEkPtSX1
                                          750w,
                                          /sites/default/files/styles/16_9_media_medium/public/2023-02/China%27s-hidden-century-teaser9.jpg?h=5dabf909&amp;itok=L_sj_Qcp
                                          1000w,
                                          /sites/default/files/styles/16_9_media_large/public/2023-02/China%27s-hidden-century-teaser9.jpg?h=5dabf909&amp;itok=y2S5oEMa
                                          1300w,
                                          /sites/default/files/styles/16_9_media_huge/public/2023-02/China%27s-hidden-century-teaser9.jpg?h=5dabf909&amp;itok=yPTg5pIh
                                          1600w" width="750" height="422"
                                          data-src="/sites/default/files/styles/16_9_media_small/public/2023-02/China%27s-hidden-century-teaser9.jpg?h=5dabf909&amp;itok=KEkPtSX1"
                                          data-sizes="auto" alt="Ink and colour
                                          picture showing the head and shoulders
                                          of an elderly Chinese woman with her
                                          hair tied back. She is wearing green
                                          earings and a blue jacket decorated
                                          with gold leaves around the neck. "
                                          /&gt;
                                        </noscript>
                                      </div>
                                    </div>
                                    <div className="teaser__content">
                                      <div className="teaser__content-push">
                                        ...
                                        <h3 className="teaser__title">
                                          <a
                                            href="/blog/introduction-19th-century-china"
                                            className="teaser__anchor"
                                          >
                                            <span>
                                              <span>
                                        ...
                                        <div className="teaser__summary">
                                          In a global first, the resilience and
                                          innovation of 19th-century China are
                                          revealed in a major new exhibition.
                                        </div>
                                      </div>
                                      <span className="teaser__button | button button--chevron">
                                        {" "}
