...
const Press = () => {
  ...
  useEffect(() => {
    ...
    const category1 = `${categoryPrefix}-11`;
  ...
  useEffect(() => {
    ...
    // Kategoriler dil bazında dinamik olarak ayarlanıyor
    const category1 = `${contentPrefix}-content-40`;
    ...
    <div>
      <div>
        ...
        <meta
          ...
          content="Find the latest press releases, access to images for news reporting, plus how to arrange press photography and news filming at the Museum."
        />
        <meta
          property="og:image"
              ...
              <main id="main-content" className="js-main">
                <div>
                  <div
                    ...
                    role="article"
                    aria-labelledby="paragraph-10517-title"
                  >
                        ...
                        <div className="hero__controls">
                          <div className="hero__caption | js-hero-caption">
                            <button
                              ...
                              id="hero-image-caption-button-10517"
                              aria-expanded="false"
                              aria-controls="hero-image-caption-content-10517"
                            >
                            ...
                            <div
                              ...
                              id="hero-image-caption-content-10517"
                              aria-hidden="true"
                              aria-labelledby="hero-image-caption-button-10517"
                            >
                              <button
                                type="button"
                                className="hero__caption-content-close | js-hero-caption-btn"
                                id="hero-image-caption-close-button-10517"
                                aria-expanded="false"
                                aria-controls="hero-image-caption-content-10517"
                              >
                                <span className="visually-hidden">
                          ...
                          <div className="jump-links">
                            ...
                            >
                              <ul className="jump-links__list" role="list">
                                ...
                                <li className="jump-links__item">
                                  <a
                                    href="#contested-objects-from-the-collection"
                                    className="jump-links__link"
                                  >
                                    <span>
                                      Contested objects from the collection
                                    </span>
                                  </a>
                                </li>
                                <li className="jump-links__item">
                                  <a
                                    href="#more-news-from-the-museum"
                                    className="jump-links__link"
                                  >
                                    <span>More news from the Museum</span>
                                  </a>
                                </li>
                              </ul>
                            </div>
                      ...
                      <div className="section__inner">
                        <div className="section--intro__container">
                          <div className="section--intro__info">
                            ...
                            <div className="section--intro__info-slices">
                              <div className="paragraph paragraph--type--info-content paragraph--view-mode--default section--intro__info-content wysiwyg">
                                <p>
                                  Email:&nbsp;
                                  <a href="/cdn-cgi/l/email-protection#62010d0f0f170c0b0103160b0d0c112200100b160b110a0f171107170f4c0d1005">
                                    <span
                                      className="__cf_email__"
                                      data-cfemail="a3c0ccceced6cdcac0c2d7cacccdd0e3c1d1cad7cad0cbced6d0c6d6ce8dccd1c4"
                                    >
                                      [email&nbsp;protected]
                                    </span>
                                  </a>
                                  <br />
                                  <em>
                                    Please note this inbox is monitored on
                                    weekdays only.
                                  </em>
                                  <br />
                                  <br />
                          ...
                          <div className="section--intro__content">
                            ...
                            {/* <p className="h3">
                              Find the latest press releases, access to images
                              for news reporting, plus how to arrange press
                              photography and news filming at the Museum.
                            </p>
                            <div className="wysiwyg">
                              <p>
                                Contact us for news interviews with our
                                world-respected experts, for information on our
                                collection, and our extensive programme of
                                events and exhibitions.
                              </p>
                              <p>
                                To review exhibitions, please apply for tickets
                                at least 48 hours in advance to ensure access.
                              </p>
                            </div> */}
                          </div>
                        </div>
                      ...
                      <div>
                        <div>
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-10524-title"
                          >
                            <div className="container">
                              <a className="js-jump-link-anchor" id="images" />{" "}
                              <div className="section__inner">
                                <h2
                                  id="paragraph-10524-title"
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      ...
                                      Please contact:{" "}
                                      <a href="/cdn-cgi/l/email-protection#d6b5b9bbbba3b8bfb5b7a2bfb9b8a596b4a4bfa2bfa5bebba3a5b3a3bbf8b9a4b1">
                                        <span
                                          className="__cf_email__"
                                          data-cfemail="b2d1dddfdfc7dcdbd1d3c6dbdddcc1f2d0c0dbc6dbc1dadfc7c1d7c7df9cddc0d5"
                                        >
                                          [email&nbsp;protected]
                                        </span>
                                      </a>
                                      ...
                                      &nbsp;
                                      <br />
                                      For images for commercial use in books and
                                      documentaries, please contact:&nbsp;
                                      <a href="/cdn-cgi/l/email-protection#91e2f0fdf4e2f8fcf0f6f4e2d1f3e3f8e5f8e2f9fce4e2f4e4fcbffee3f6">
                                        <span
                                          className="__cf_email__"
                                          data-cfemail="8ffceee3eafce6e2eee8eafccfedfde6fbe6fce7e2fafceafae2a1e0fde8"
                                        >
                                          [email&nbsp;protected]
                                        </span>
                                      </a>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-10526-title"
                          >
                            <div className="container">
                              <a
                                className="js-jump-link-anchor"
                                id="filming-and-photography"
                              />{" "}
                              <div className="section__inner">
                                <h2
                                  id="paragraph-10526-title"
                                  className="section__title section--slice-content__title"
                                >
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      The press office requires at least 72
                                      hours' prior notice and can only supervise
                                      filming requests related to current Museum
                                      activity.
                                    </p>
                                    <p>
                                      ...
                                      <a href="/cdn-cgi/l/email-protection#ccaaa5a0a1a5a2ab8caebea5b8a5bfa4a1b9bfa9b9a1e2a3beab">
                                        <span
                                          className="__cf_email__"
                                          data-cfemail="04626d68696d6a634466766d706d776c6971776171692a6b7663"
                                        >
                                          [email&nbsp;protected]
                                        </span>
                                      </a>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-10522-title"
                          >
                            <div className="container">
                              <a
                                className="js-jump-link-anchor"
                              ...
                              <div className="section__inner">
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      Read the latest Museum news and
                                      announcements.
                                    </p>
                                    <div
                                      data-entity-type="media"
                                      data-entity-uuid="b45e23fe-1628-421c-bc05-7a45b9195c95"
                                    ...
                                    <div
                                      data-entity-type="media"
                                      data-entity-uuid="1308c49d-72f0-4370-a67b-dc8332944f9f"
                                      data-embed-button="document"
                                      data-entity-embed-display="view_mode:media.full"
                                      data-langcode="en"
                                      data-entity-embed-display-settings="[]"
                                    ...
                                    <div
                                      data-entity-type="media"
                                      data-entity-uuid="bdfb74a3-7e6e-4397-bd7e-d49873af87d2"
                                      data-embed-button="document"
                                      data-entity-embed-display="view_mode:media.full"
                                      data-langcode="en"
                                      data-entity-embed-display-settings="[]"
                                    ...
                                    <div
                                      data-entity-type="media"
                                      data-entity-uuid="70de2061-e15a-4534-8fd1-32162942a230"
                                      data-embed-button="document"
                                      data-entity-embed-display="view_mode:media.full"
                                      data-langcode="en"
                                      data-entity-embed-display-settings="[]"
                                    ...
                                    <div
                                      data-entity-type="media"
                                      data-entity-uuid="499cfa8d-3988-4ad8-9974-d540e5e759db"
                                      data-embed-button="document"
                                      data-entity-embed-display="view_mode:media.full"
                                      data-langcode="en"
                                      data-entity-embed-display-settings="[]"
                                    ...
                                    <p>
                                      View all{" "}
                                      <a
                                        href="/about-us/press/press-releases"
                                        data-entity-type="node"
                                        data-entity-uuid="9e57c560-fc71-4858-9a2e-7e5f27af4936"
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-17838-title"
                          >
                            <div className="container">
                              <a
                                className="js-jump-link-anchor"
                                id="contested-objects-from-the-collection"
                              />{" "}
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-17838-title"
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  ...
                                                  <div className="teaser__summary">
                                                    Learn about Asante regalia,
                                                    a culturally and
                                                    artistically important group
                                                    of objects from the Kingdom
                                                    of Asante.
                                                  </div>
                                                </div>
                                              </div>
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  ...
                                                  <div className="teaser__summary">
                                                    Find out about the Museum's
                                                    commitment to curating human
                                                    remains from around the
                                                    world with care, respect and
                                                    dignity.
                                                  </div>
                                                </div>
                                              </div>
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  ...
                                                  <div className="teaser__summary">
                                                    Learn about the Maqdala
                                                    collection, which represents
                                                    many of the great artistic
                          ...
                          {/* <section
                            className="paragraph paragraph--type--slice-teaser paragraph--view-mode--default section section--slice-teaser section--z-index-scope section--has-carousel section--bg-white"
                            aria-labelledby="paragraph-13993-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-13993-title"
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  ...
                                                  <div className="teaser__summary">
                                                    Find out about the two large
                                                    stone moai from Rapa Nui
                                                    (Easter Island) that the
                                                    Museum cares for.
                                                  </div>
                                                </div>
                                              </div>
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  ...
                                                  <div className="teaser__summary">
                                                    Made of bark and wood, find
                                                    out about this early
                                                    Australian shield.
                                                  </div>
                                                </div>
                                              </div>
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  ...
                                                  <div className="teaser__summary">
                                                    Learn about research carried
                                                    out into the provenance of
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-10529-title"
                          >
                            <div className="container">
                              <a
                                className="js-jump-link-anchor"
                                id="more-news-from-the-museum"
                              />{" "}
                              <div className="section__inner">
                                <h2
                                  id="paragraph-10529-title"
                                  className="section__title section--slice-content__title"
                                >
                                  More news from the Museum
                                </h2>
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      Get the latest updates by subscribing to
                                      our social media channels, plus dive
                                      deeper into our resources through our blog
                                    ...
                                    <ul>
                                      <li>
                                        Follow us on&nbsp;
                                        <a
                                          href="https://twitter.com/britishmuseum?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthor"
                                          rel="noopener"
                                          target="_blank"
                                        >
                                          Twitter
                                        ...
                                        ,&nbsp;
                                        <a
                                          href="https://www.facebook.com/britishmuseum/"
                                          rel="noopener"
                                          target="_blank"
                                        >
                                          Facebook
                                        ...
                                        &nbsp;and&nbsp;
                                        <a
                                          href="https://www.instagram.com/britishmuseum"
                                          rel="noopener"
                                          target="_blank"
                                        >
                                          Instagram
                                      ...
                                      <li>
                                        ...
                                        <a
                                          href="/blog"
                                          data-entity-type="node"
                                          data-entity-uuid="0371a9e1-b0f0-4ea8-9ed8-a084f5f83981"
                                          data-entity-substitution="canonical"
                                          rel="noopener"
                                          target="_blank"
                                          title="Blog"
                                      ...
                                      <li>
                                        Watch our&nbsp;
                                        <a
                                          href="https://www.youtube.com/user/britishmuseum"
                                          rel="noopener"
                                          target="_blank"
                                        >
                                          YouTube channel
                                        </a>
                                        &nbsp;for weekly videos from our
                                        curators, plus a rich variety of content
                                        relating to the Museum and its
                                        collection.
                                      </li>
                                      <li>
                                        Plus, explore{" "}
                                  ...
                                  <div className="teaser__wrapper">
                                    ...
                                    <div className="teaser__content">
                                      <div className="teaser__content-push">
                                        ...
                                        <div className="teaser__summary">
                                          Discover how the Museum and its
                                          collection began and how it has
                                  ...
                                  <div className="teaser__wrapper">
                                    ...
                                    <div className="teaser__content">
                                      <div className="teaser__content-push">
                                        ...
                                        <div className="teaser__summary">
                                          Find about the Museum's history,
                                          architecture, research and governance,
                                          plus info on jobs, press, commercial
                                  ...
                                  <div className="teaser__wrapper">
                                    ...
                                    <div className="teaser__content">
                                      <div className="teaser__content-push">
                                        ...
                                        <div className="teaser__summary">
                                          Read our press releases, featuring
                                          Museum news, acquisitions and
