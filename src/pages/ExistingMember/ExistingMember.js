...
const ExistingMember = () => {
  ...
  useEffect(() => {
    const someContentId = "67b308f07ffef8be106d28e1";
    ...
    <div>
      <div>
        ...
        <meta
          ...
          content="Explore your Membership benefits and find out how your support is integral to the work of the Museum."
        />
        <meta
          property="og:image"
              ...
              <main id="main-content" className="js-main">
                <div>
                  <div
                    ...
                    role="article"
                    aria-labelledby="paragraph-483-title"
                  >
                    ...
                    <div className="container">
                      <div className="hero__inner">
                        <div className="hero__content-container">
                          ...
                          {/* <h1 id="paragraph-483-title" className="hero__title">
                            {" "}
                            Existing Members
                          </h1> */}
                          <a
                        ...
                        <div className="hero__controls">
                          <div className="hero__caption | js-hero-caption">
                            <button
                              ...
                              id="hero-image-caption-button-483"
                              aria-expanded="false"
                              aria-controls="hero-image-caption-content-483"
                            >
                            ...
                            <div
                              ...
                              id="hero-image-caption-content-483"
                              aria-hidden="true"
                              aria-labelledby="hero-image-caption-button-483"
                            >
                              <button
                                type="button"
                                className="hero__caption-content-close | js-hero-caption-btn"
                                id="hero-image-caption-close-button-483"
                                aria-expanded="false"
                                aria-controls="hero-image-caption-content-483"
                              >
                                <span className="visually-hidden">
                        ...
                        <div className="section--intro__container">
                            ...
                            <div className="section--intro__info-slices">
                              ...
                              <div className="intro-link--button paragraph paragraph--type--info-link paragraph--view-mode--default">
                                <a
                                  data-tracking="cta"
                                  className="button button--chevron"
                                  href="/membership/members-gift-aid-declaration"
                                >
                                  <span>Add Gift Aid to your Membership</span>
                                </a>
                              </div>
                              <div className="intro-link--button paragraph paragraph--type--info-link paragraph--view-mode--default">
                                <a
                          ...
                          <div className="section--intro__content">
                            ...
                            <div className="wysiwyg">
                              <p>
                                Share your passion for two million years with
                                someone special this Christmas.
                              </p>
                              <p>
                                Your Membership subscription is a donation that
                                allows us to support the important work of the
                                Museum.
                              </p>
                              <p>
                                Explore{" "}
                              ...
                              <p>
                                <span lang="EN-GB" dir="ltr">
                                  We're also sending regular emails with updates
                                  and content just for Members. If you are not
                                  receiving our emails, please contact the
                                  Membership Office at{" "}
                                </span>
                                <a href="/cdn-cgi/l/email-protection#1771657e727973645775657e637e647f7a626472627a39786570">
                                  <span lang="EN-GB" dir="ltr">
                                    <span
                      ...
                      <div>
                        <div>
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-963-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-963-title"
                          ...
                          {/* <section
                            className="paragraph paragraph--type--slice-teaser paragraph--view-mode--default section section--slice-teaser section--z-index-scope section--has-carousel section--bg-white"
                            aria-labelledby="paragraph-966-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-966-title"
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  <h3 className="teaser__title">
                                                    <a
                                                      href="/membership/how-your-money-helps"
                                                      className="teaser__anchor"
                                                    >
                                                      <span>
                                                        <span>
                                                  ...
                                                  <div className="teaser__summary">
                                                    ...
                                                    archaeological research, new
                                                    scientific technology to
                                                    acquisitions, find out how
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  <h3 className="teaser__title">
                                                    <a
                                                      href="/membership/advisory-council"
                                                      className="teaser__anchor"
                                                    >
                                                      <span>
                                                        <span>
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-37092-title"
                          >
                            <div className="container">
                              <div className="banner__outer">
                                <div className="banner__inner">
                                  ...
                                  <div className="banner__content">
                                    <p>
                                      <span>
                                        Share your experience. Bring a guest and
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-8100-title"
                          >
                            <div className="container">
                              <a
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      Email:{" "}
                                      <a
                                        href="/cdn-cgi/l/email-protection#bed8ccd7dbd0dacdfedcccd7cad7cdd6d3cbcddbcbd390d1ccd9"
