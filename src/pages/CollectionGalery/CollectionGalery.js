...
const CollectionGalery = () => {
  ...
  useEffect(() => {
    const someContentId = "67b2ed407ffef8be106d27e8";

    fetchContentById(someContentId, setContent);
  }, []);

  useEffect(() => {
    const category1 = "Museum highlights";
              ...
              <main id="main-content" className="js-main">
                <div>
                  <div
                    ...
                    role="article"
                    aria-labelledby="paragraph-3328-title"
                  >
                    ...
                    <div className="container">
                      <div className="hero__inner">
                        <div className="hero__content-container">
                          ...
                          {/* <h1 id="paragraph-3328-title" className="hero__title">
                            {" "}
                            Galleries&nbsp;
                          </h1> */}
                        </div>
                        <div className="hero__controls">
                          <div className="hero__caption | js-hero-caption">
                            <button
                              ...
                              id="hero-image-caption-button-3328"
                              aria-expanded="false"
                              aria-controls="hero-image-caption-content-3328"
                            >
                            ...
                            <div
                              ...
                              id="hero-image-caption-content-3328"
                              aria-hidden="true"
                              aria-labelledby="hero-image-caption-button-3328"
                            >
                              <button
                                type="button"
                                className="hero__caption-content-close | js-hero-caption-btn"
                                id="hero-image-caption-close-button-3328"
                                aria-expanded="false"
                                aria-controls="hero-image-caption-content-3328"
                              >
                                <span className="visually-hidden">
                              ...
                              <p>
                                {" "}
                                Visitors standing in the Parthenon gallery (Room
                                18)
                              </p>
                            </div>
                          </div>
                              ...
                              <ul className="jump-links__list" role="list">
                                ...
                                <li className="jump-links__item">
                                  <a
                                    ...
                                    className="jump-links__link"
                                  >
                                    <span>Upper floors </span>
                                  </a>
                                </li>
                                <li className="jump-links__item">
                                  <a
                                    href="#virtual-galleries"
                                    className="jump-links__link"
                                  >
                        ...
                        <div className="section--intro__container">
                          ...
                          <div className="section--intro__content">
                            ...
                            <div className="wysiwyg">
                              <p>
                                Our gallery pages feature a range of exciting
                                resources, including virtual tours with Google
                                Street View, object highlights, timelines,
                                family activities and facts.
                              </p>
                              <p>
                                Below you'll find a list of&nbsp;galleries on
                              ...
                              <p>
                                Please note that galleries in the Museum may be
                                ...
                                galleries at short notice for safety reasons. We
                                regret that in these cases we're not always able
                                to alert the public in advance.&nbsp;
                              </p>
                            </div> */}
                          </div>
                        </div>
                      ...
                      <div>
                        <div>
                          <section
                            ...
                            aria-labelledby="paragraph-14266-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-14266-title"
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  ...
                                                  <div className="teaser__summary">
                                                    Travel back through 3,000
                                                    years of history via our
                                                    timeline and gallery.
                                                    Discover the Rosetta Stone,
                                                    Statue of Ramesses II and
                                                    more.
                                                  </div>
                                                </div>
                                              </div>
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  ...
                                                  <div className="teaser__summary">
                                                    The Sainsbury Africa
                                                    Galleries reveal the
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  ...
                                                  <div className="teaser__summary">
                                                    Spanning over 700 years,
                                                    this Room traces the story
                                                    of Europe from 300 AD.
                                                  </div>
                                                </div>
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  ...
                                                  <div className="teaser__summary">
                                                    The objects in Room 70
                                                    illustrate the rise of Rome
                                                    from a small town to an
                                                    imperial capital.
                                                  </div>
                                                </div>
                                                <span className="teaser__button | button button--chevron">
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-4690-title"
                          >
                            <div className="container">
                              <a
                          ...
                          <section
                            className="listing section--no-keyline-next paragraph paragraph--type--slice-list paragraph--view-mode--default section section--slice-list section--bg-white"
                            aria-labelledby="paragraph-4700-title"
                          >
                            <div className="container">
                              <a
                                className="js-jump-link-anchor"
                                ...
                                <div className="paragraph paragraph--type--list-item paragraph--view-mode--default listing__item">
                                  ...
                                  <div className="listing__content-group">
                                    <div className="listing__content wysiwyg">
                                      <h3 className="listing__title">
                                        {" "}
                                        Assyria: Lion hunts, Siege of Lachish
                                        and Khorsabad
                                      </h3>
                                      <p>Room 10</p>
                                    </div>
                                ...
                                <div className="paragraph paragraph--type--list-item paragraph--view-mode--default listing__item">
                                  ...
                                  <div className="listing__content-group">
                                    ...
                                    <div className="listing__buttons">
                                      <a
                                        className="button"
                                        href="/collection/galleries/east-stairs"
                                      >
                                        Visit the East stairs
                                      </a>
                                    </div>
                                  </div>
                                </div>
                          ...
                          <section
                            className="listing section--no-keyline-next paragraph paragraph--type--slice-list paragraph--view-mode--default section section--slice-list section--bg-white"
                            aria-labelledby="paragraph-4732-title"
                          >
                            <div className="container">
                              <a
                                className="js-jump-link-anchor"
                              ...
                              <div className="section__inner">
                                ...
                                <div className="paragraph paragraph--type--list-item paragraph--view-mode--default listing__item">
                                  ...
                                  <div className="listing__content-group">
                                    ...
                                    <div className="listing__buttons">
                                      <a
                                        className="button"
                                        href="https://islamicworld.britishmuseum.org/"
                                      >
                                        Visit Rooms 42–43
                                      </a>
                                    </div>
                                ...
                                <div className="paragraph paragraph--type--list-item paragraph--view-mode--default listing__item">
                                  ...
                                  <div className="listing__content-group">
                                    <div className="listing__content wysiwyg">
                                      <h3 className="listing__title">
                                        {" "}
                                        Egyptian life and death: the tomb-chapel
                                        of Nebamun
                                      </h3>
                                      <p>
                                        Room 61 (
                                ...
                                <div className="paragraph paragraph--type--list-item paragraph--view-mode--default listing__item">
                                  ...
                                  <div className="listing__content-group">
                                    <div className="listing__content wysiwyg">
                                      <h3 className="listing__title"> Korea</h3>
                                      <p>
                                        Room 67&nbsp;
                                ...
                                <div className="paragraph paragraph--type--list-item paragraph--view-mode--default listing__item">
                                  ...
                                  <div className="listing__content-group">
                                    <div className="listing__content wysiwyg">
                                      <h3 className="listing__title"> Money</h3>
                                      <p>Room 68</p>
                                    </div>
                                    <div className="listing__buttons">
                                      <a
                                ...
                                <div className="paragraph paragraph--type--list-item paragraph--view-mode--default listing__item">
                                  ...
                                  <div className="listing__content-group">
                                    <div className="listing__content wysiwyg">
                                      ...
                                      <p>
                                        Room 70 (<em>The Wolfson Gallery</em>)
                                      </p>
                                    </div>
                                    <div className="listing__buttons">
                                      <a
                                ...
                                <div className="paragraph paragraph--type--list-item paragraph--view-mode--default listing__item">
                                  ...
                                  <div className="listing__content-group">
                                    <div className="listing__content wysiwyg">
                                      <h3 className="listing__title"> Japan</h3>
                                      <p>
                                        Rooms 92–94&nbsp;(
                                        <em>
                                ...
                                <div className="paragraph paragraph--type--list-item paragraph--view-mode--default listing__item">
                                  ...
                                  <div className="listing__content-group">
                                    <div className="listing__content wysiwyg">
                                      <h3 className="listing__title">
                                        {" "}
                                        Chinese Ceramics – Sir Percival David
                                        Collection
                                      </h3>
                                      <p>
                                        Room 95&nbsp;(
                          ...
                          <section
                            className="listing section--no-keyline-next paragraph paragraph--type--slice-list paragraph--view-mode--default section section--slice-list section--bg-white"
                            aria-labelledby="paragraph-4817-title"
                          >
                            <div className="container">
                              <a
                                className="js-jump-link-anchor"
                                id="virtual-galleries"
                              />
                              <div className="section__inner">
                                <h2
                                  id="paragraph-4817-title"
                                  className="section__title"
                                >
                                  Virtual galleries
                                </h2>
                                <div className="paragraph paragraph--type--list-item paragraph--view-mode--default listing__item">
                                  ...
                                  <div className="listing__content-group">
                                    ...
                                    <div className="listing__buttons">
                                      <a
                                        className="button"
                                        href="/collection/galleries/oceania"
                                      >
                                        Explore the Oceania collection
                                      </a>
                                    </div>
                                  </div>
                                </div>
                                <div className="paragraph paragraph--type--list-item paragraph--view-mode--default listing__item">
                                  ...
                                  <div className="listing__content-group">
                                    ...
                                    <div className="listing__buttons">
                                      ...
                                      >
                                        Explore the Prints and drawings
                                        collection
                                      </a>
                                    </div>
                                  </div>
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-12856-title"
                          >
                            <div className="container">
                                    ...
                                    <div className="teaser__content">
                                      <div className="teaser__content-push">
                                        <h3 className="teaser__title">
                                          ...
                                          >
                                            <span>
                                              <span>Collecting the world </span>
                                            </span>
                                            {/* Add visually hidden defacer for screen-reader. Use full stops for reader punctuation. */}
                                          </a>
                                        </h3>
                                        <div className="teaser__summary">
                                          This gallery explores the Museum's
                                          story of human cultural achievement
                                          through a collection of collections.
                                        </div>
                                      </div>
                                      <span className="teaser__button | button button--chevron">
                                        {" "}
                                  ...
                                  <div className="teaser__wrapper">
                                    ...
                                    <div className="teaser__content">
                                      <div className="teaser__content-push">
                                        ...
                                        <div className="teaser__summary">
                                          Explore how continuity and change have
                                          shaped Japan's past and present and
                                          the country's relationships with the
                                          rest of the world.
                                        </div>
                                      </div>
                                      <span className="teaser__button | button button--chevron">
                                      ...
                                      <div className="teaser__content-push">
                                        <h3 className="teaser__title">
                                          ...
                                          >
                                            <span>
                                              <span>
                                                Prints and drawings galleries 90
                                                and 90a
                                              </span>
                                            </span>
                                            {/* Add visually hidden defacer for screen-reader. Use full stops for reader punctuation. */}
                                        ...
                                        <div className="teaser__summary">
                                          Exhibitions and displays of Prints and
                                          Drawings from old masters to living
                                          artists
                                        </div>
                                      </div>
                                    </div>
...
export default CollectionGalery;
