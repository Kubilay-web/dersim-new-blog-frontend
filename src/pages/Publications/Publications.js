...
const Publications = () => {
  ...
  useEffect(() => {
    const category1 = "Museum publications";
  ...
  useEffect(() => {
    const someContentId = "67af22e58b2864c833c09926";
              ...
              <main id="main-content" className="js-main">
                <div>
                  <div
                    ...
                    role="article"
                    aria-labelledby="paragraph-13955-title"
                  >
                        ...
                        <div className="hero__controls">
                          <div className="hero__caption | js-hero-caption">
                            <button
                              ...
                              id="hero-image-caption-button-13955"
                              aria-expanded="false"
                              aria-controls="hero-image-caption-content-13955"
                            >
                            ...
                            <div
                              ...
                              id="hero-image-caption-content-13955"
                              aria-hidden="true"
                              aria-labelledby="hero-image-caption-button-13955"
                            >
                              <button
                                type="button"
                                className="hero__caption-content-close | js-hero-caption-btn"
                                id="hero-image-caption-close-button-13955"
                                aria-expanded="false"
                                aria-controls="hero-image-caption-content-13955"
                              >
                                <span className="visually-hidden">
                    ...
                    <div className="breadcrumb__inner">
                      <div id="block-breadcrumbs">
                        <nav aria-labelledby="system-breadcrumb">
                          ...
                          >
                            You are in the Research section
                          </h2>
                          <ul className="breadcrumb__list">
                            ...
                            <li className="breadcrumb__item breadcrumb__item--link">
                              ...
                              <a href="/research" className="breadcrumb__link">
                                <span>Research</span>
                              </a>
                            </li>
                      ...
                      <div className="section__inner">
                        <div className="section--intro__container">
                          <div className="section--intro__info">
                            ...
                            <div className="section--intro__info-slices">
                              <div className="paragraph paragraph--type--info-content paragraph--view-mode--default section--intro__info-content wysiwyg">
                                <p>
                                  Email:{" "}
                                  <a href="/cdn-cgi/l/email-protection#4c3c392e20252f2538350c2e3e2538253f2421393f29392162233e2b">
                                    <span
                                      className="__cf_email__"
                                      data-cfemail="14646176787d777d606d5476667d607d677c7961677161793a7b6673"
                                    >
                                      [email&nbsp;protected]
                                    </span>
                                  </a>
                          ...
                          <div className="section--intro__content">
                            ...
                            {/* <p className="h3">
                              The Museum produces a range of publications that
                              showcase the scope and depth of research it
                              undertakes.
                            </p>
                            <div className="wysiwyg">
                              <p>
                                From award-winning illustrated exhibition
                                catalogues to academic monographs, the Museum
                                publishes a wide variety of titles that cater
                                for both academics and general readers. All
                                titles are inspired by the Museum's collection,
                                presenting new insights into both familiar and
                                unknown objects and periods of history.
                              </p>
                              <p>
                                The Museum also offers a number of free online
                                academic publications, including a range of
                                titles within the Museum's Research Publications
                                ...
                                disseminating the Museum's research as widely as
                                possible and ensuring that the titles are easily
                                accessible to students and academics all over
                                the world.
                              </p>
                              <p>
                      ...
                      <div>
                        <div>
                          <section
                            ...
                            aria-labelledby="paragraph-13966-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-13966-title"
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  <h3 className="teaser__title">
                                                    <a
                                                      href="/research/publications/online-research-catalogues"
                                                      className="teaser__anchor"
                                                    >
                                                      <span>
                                                        <span>
                                                  ...
                                                  <div className="teaser__summary">
                                                    A series of free catalogues
                                                    combining peer-reviewed
                                                    essays with carefully
                                                    selected groups of object
                          ...
                          {/* <section
                            ...
                            aria-labelledby="paragraph-13961-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-13961-title"
                                    className="section__title teaser-listing__title"
                                  >
                          ...
                          <section
                            className="paragraph paragraph--type--slice-teaser paragraph--view-mode--default section section--slice-teaser section--z-index-scope section--has-carousel section--bg-white"
                            aria-labelledby="paragraph-13968-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-13968-title"
                                    className="section__title teaser-listing__title"
                                  >
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  ...
                                                  <div className="teaser__summary">
                                                    Discover the breadth of our
                                                    research, the wide range of
