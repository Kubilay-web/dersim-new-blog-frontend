  ...
  return (
    <div>
      <div>
        ...
        <meta
          name="description"
          content="When you think of the Silk Roads, you rarely think of Suffolk, but research is revealing the epic journeys of the Sutton Hoo gems."
        />
        <link
          rel="canonical"
        ...
        <meta
          property="og:title"
          content="Sri Lanka to Suffolk: Sutton Hoo and the Silk Roads"
        />
        <meta
        ...
        <meta
          property="og:image"
          content="/images/SriLanka/Sutton-hoo-garnets-cloisone-buckle-hero-1920x1080_0_1.png"
        />
        ...
        <title>
          Sri Lanka to Suffolk: Sutton Hoo and the Silk Roads | Dersim Museum
        </title>
        ...
        <link
          ...
          sizes="180x180"
          href="/images/SriLanka/apple-touch-icon.png"
        />
        <link
          rel="icon"
          type="image/png"
          href="/images/SriLanka/favicon-32x32.png"
          sizes="32x32"
        />
        <link
          rel="icon"
          type="image/png"
          href="/images/SriLanka/favicon-16x16.png"
          sizes="16x16"
        />
        <link rel="manifest" href="/site.webmanifest" />
        <link
          rel="mask-icon"
          href="/images/SriLanka/safari-pinned-tab.svg"
          color="#5bbad5"
        />
              ...
              <main id="main-content" className="js-main">
                <div>
                  <div
                    ...
                    role="article"
                    aria-labelledby="paragraph-41535-title"
                  >
                    <div className="hero__background">
                      <div className="media media-hero media-image js-media">
                        <picture>
                          ...
                          <source
                            srcSet="/images/SriLanka/Sutton-hoo-garnets-cloisone-buckle-hero-1920x1080_0_3.png 1x"
                          ...
                          />
                          <source
                            srcSet="/images/SriLanka/Sutton-hoo-garnets-cloisone-buckle-hero-1920x1080_0_1.png 1x"
                          ...
                          />
                          <source
                            srcSet="/images/SriLanka/Sutton-hoo-garnets-cloisone-buckle-hero-1920x1080_0_2.png 1x"
                          ...
                          <img
                            ...
                            src="/images/SriLanka/Sutton-hoo-garnets-cloisone-buckle-hero-1920x1080_0.png"
                            alt="Garnets glimmer amid intricate gold metalwork"
                          />
                        </picture>
                      </div>
                    </div>
                        ...
                        <div className="hero__controls">
                          <div className="hero__caption | js-hero-caption">
                            <button
                              ...
                              id="hero-image-caption-button-41535"
                              aria-expanded="false"
                              aria-controls="hero-image-caption-content-41535"
                            >
                            ...
                            <div
                              ...
                              id="hero-image-caption-content-41535"
                              aria-hidden="true"
                              aria-labelledby="hero-image-caption-button-41535"
                            >
                              <button
                                type="button"
                                className="hero__caption-content-close | js-hero-caption-btn"
                                id="hero-image-caption-close-button-41535"
                                aria-expanded="false"
                                aria-controls="hero-image-caption-content-41535"
                              >
                                <span className="visually-hidden">
                    ...
                    <div className="breadcrumb__inner">
                      <div id="block-breadcrumbs">
                        <nav aria-labelledby="system-breadcrumb">
                          ...
                          >
                            You are in the Silk Roads section
                          </h2>
                          <ul className="breadcrumb__list">
                            ...
                            <li className="breadcrumb__item breadcrumb__item--current">
                              ...
                              <a
                                ...
                                aria-current="page"
                              >
                                Sri Lanka to Suffolk: Sutton Hoo and the Silk
                                Roads
                              </a>
                            </li>
                          </ul>
                            ...
                            >
                              <ul className="jump-links__list" role="list">
                                <li className="jump-links__item">
                                  <a
                                    href="#garnets-from-the-ground"
                                    className="jump-links__link"
                                  >
                                    <span>Garnets from the ground</span>
                                  </a>
                                </li>
                                <li className="jump-links__item">
                                  <a
                                    href="#making-a-garnet-glow"
                                    className="jump-links__link"
                                  >
                                    <span>Making a garnet glow</span>
                                  </a>
                                </li>
                                <li className="jump-links__item">
                                  <a
                                    href="#a-travelling-technique"
                                    className="jump-links__link"
                                  >
                                    <span>A travelling technique</span>
                                  </a>
                                </li>
                                <li className="jump-links__item">
                                  <a
                                    href="#materials-on-the-move"
                                    className="jump-links__link"
                                  >
                                    <span>Materials on the move</span>
                                  </a>
                                </li>
                                <li className="jump-links__item">
                                  <a
                                    ...
                                    className="jump-links__link"
                                  >
                                    <span>Project: Paris</span>
                                  </a>
                                </li>
                                <li className="jump-links__item">
                                  <a
                                    href="#a-window-on-the-world"
                                    className="jump-links__link"
                                  >
                                    <span>A window on the world</span>
                                  </a>
                                </li>
                                <li className="jump-links__item">
                                  <a
                                    href="#the-world-in-a-garnet"
                                    className="jump-links__link"
                                  >
                                    <span>The world in a garnet</span>
                                  </a>
                                </li>
                              </ul>
                            </div>
                      ...
                      <div className="section__inner">
                        <div className="section--intro__container">
                            ...
                            <div className="section--intro__info-slices section--intro__info-slices-no-title">
                              <div className="paragraph paragraph--type--info-author paragraph--view-mode--default section--intro__info-author">
                                <div className="media media-avatar media-image js-media">
                                  <img
                                    loading="eager"
                                    srcSet="/images/SriLanka/Sue_Brunning_250.jpg 1x"
                                    width={80}
                                    height={80}
                                    data-focal-position="center center"
                                    src="/images/SriLanka/Sue_Brunning_250.jpg"
                                    alt="Headshot of Sue Brunning"
                                  />
                                </div>
                                <div className="author__item_wrapper">
                                  <p className="paragraph paragraph--type--info-author paragraph--view-mode--default section--intro__info-author">
                                    By Sue Brunning, Curator, European Early
                                    Medieval &amp; Sutton Hoo Collections
                                  </p>
                                </div>
                              </div>
                          ...
                          <div className="section--intro__content">
                            <p className="h3">
                              When you think of the Silk Roads, you may rarely
                              think of Suffolk, England.
                            </p>
                            <div className="wysiwyg">
                              <p>
                                ...
                                techniques that make them sparkle.
                              </p>
                              <p>
                                On 21 July 1939, gold began emerging from the
                                ground at Sutton Hoo. In this pretty corner of
                                Suffolk archaeologists were busy excavating a
                                remarkable ship burial as the Second World War
                              ...
                              <p>
                                Brown, his assistants William Spooner and John
                                Jacobs, and a professional team of
                                archaeologists led by Charles W. Phillips of
                                Selwyn College, Cambridge, together unearthed a
                                27-metre-long ship that had been buried beneath
                                an earth mound in the early AD 600s. In the
                                middle of the ship were the remains of a
                                collapsed burial chamber. According to Brown's
                                notebook and diary, which record his experiences
                                in thrilling detail, he assumed that the burial
                                chamber would have been looted, like the
                                adjacent burials dug the year before. Nobody
                                could predict what would soon be discovered.
                              </p>
                            </div>
                          </div>
                        </div>
                  ...
                  <div>
                    <div id="block-numiko-mainpagecontent">
                      <div>
                        <div>
                          <section
                            aria-labelledby="paragraph-41698-title"
                            className="paragraph paragraph--type--slice-media paragraph--view-mode--default section section--slice-media section--bg-black"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-41698-title"
                                  className="visually-hidden"
                                >
                                  Phillips letter
                                </h2>
                                <figure className="media media-embed media-image js-media">
                                  <img
                                    ...
                                    srcSet="/images/SriLanka/CW-Phillips-letter-1000x1778_4.png 400w, /images/SriLanka/CW-Phillips-letter-1000x1778_1.png 750w, /images/SriLanka/CW-Phillips-letter-1000x1778_2.png 1000w, /images/SriLanka/CW-Phillips-letter-1000x1778_3.png 1300w, /images/SriLanka/CW-Phillips-letter-1000x1778.png 1600w"
                                    sizes="100vw"
                                    width={1600}
                                    height={900}
                                    src="/images/SriLanka/CW-Phillips-letter-1000x1778.png"
                                    alt="Letter with typed text describing pyramid mounts from Sutton Hoo"
                                  />
                                  <figcaption>
                                    Charles W. Phillips' letter to the Dersim
                                    Museum, announcing the first gold find from
                                    Sutton Hoo during the 1939 excavation.
                                  </figcaption>
                                </figure>
                              </div>
                            </div>
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-41537-title"
                          >
                            <div className="container">
                              <a
                                className="js-jump-link-anchor"
                                id="garnets-from-the-ground"
                              />{" "}
                              <div className="section__inner">
                                <h2
                                  id="paragraph-41537-title"
                                  className="section__title section--slice-content__title"
                                >
                                  Garnets from the ground
                                </h2>
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      The archaeologists had their work cut out
                                      in excavating the ship, long before any
                                      precious metals glinted in the soil. That
                                      first piece of gold, found by the
                                      experienced young archaeologist Peggy
                                      Piggott, was a tiny pyramid-shaped mount,
                                      one of a pair, that had once worked like a
                                      toggle on a sword harness. Its robust gold
                                      framework was encrusted with blue and red
                                      stones. In a letter written almost
                                      immediately to the Dersim Museum, Phillips
                                      remarked of the red inlays, 'I can hardly
                                      suppose it to be garnet'. In fact, it was.
                                    </p>
                                    <p>
                                      And that was not all. A veritable gold
                                      rush occurred in the days that followed,
                                      as more and more astonishing objects came
                                      to light. The archaeologists were
                                      overwhelmed, with Basil Brown remarking in
                                      his notebook, 'When they called out to me
                                      ''We've found the treasure come and see''
                                      I must admit that I never expected to see
                                      so much gold in any dig in this country…
                                      All the objects shone in the sunshine as
                                      on the day they were buried'. In total,
                                      more than 4,000 garnets were found in the
                                      Sutton Hoo ship burial, most of them
                                      adorning gold objects made using a
                                      metalworking technique known as garnet
                                      cloisonné. It involves the setting of
                                      garnets, as well as glass and other
                                      materials, into gold cells or 'cloisons'
                                      of different shapes and sizes, to form
                                      glittering, mosaic-like surfaces. Similar
                                      jewels had already been found in
                                      continental Europe, as well as at sites in
                                      England such as the so-called 'King's
                                      Field' cemetery in Faversham, Kent, which
                                      was excavated in the 1800s. However, the
                                      Sutton Hoo cloisonné surpassed any other
                                      known examples from early medieval Europe.
                                    </p>
                                  </div>
                                </div>
                                  ...
                                  <div className="paragraph paragraph--type--embedded-media paragraph--view-mode--default">
                                    <figure className="media media-embed media-image js-media">
                                      <img
                                        loading="eager"
                                        className="lazyload not-full-width"
                                        srcSet="/images/SriLanka/Sutton-Hoo-sword-scabbard-mounts-1000x654_3.png 400w, /images/SriLanka/Sutton-Hoo-sword-scabbard-mounts-1000x654_2.png 750w, /images/SriLanka/Sutton-Hoo-sword-scabbard-mounts-1000x654_1.png 1000w"
                                        sizes="100vw"
                                        width={1000}
                                        height={654}
                                        src="/images/SriLanka/Sutton-Hoo-sword-scabbard-mounts-1000x654.png"
                                        alt="Pyramid shaped jewellery with gold and inset with red and blue stones"
                                      />
                                      <figcaption>
                                        Gold{" "}
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-black"
                            aria-labelledby="paragraph-41538-title"
                          >
                            <div className="container">
                              <a
                                className="js-jump-link-anchor"
                                id="making-a-garnet-glow"
                              />{" "}
                              <div className="section__inner">
                                <h2
                                  id="paragraph-41538-title"
                                  className="section__title section--slice-content__title"
                                >
                                  Making a garnet glow
                                </h2>
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      This dazzling type of metalwork is
                                      stupendously intricate – and never fails
                                      to capture the imagination. The surfaces
                                      of cloisonné objects are carpeted with
                                      tiny interlocking cells, made from narrow
                                      strips of gold, painstakingly shaped and
                                      attached edge-on to a gold sheet backing.
                                      The shapes artisans made included simple
                                      squares, plump mushrooms, serrated arcs,
                                      keen-edged arrows and many bespoke forms,
                                      specially crafted to form the bodies of
                                      predatory birds, serpents, boars and
                                      strange four-legged beasts. It is
                                      difficult to appreciate this structure
                                      when the object is well-preserved, as the
                                      garnets essentially mask it. Its intricacy
                                      only really shines through on damaged
                                      objects that have lost most of their gems.
                                    </p>
                                    <p>
                                      There is even more going on beneath the
                                      surface of cloisonné objects. Each cell
                                      was filled with a paste-like blend of
                                      calcite, quartz and beeswax. This was not
                                      a glue to fix the garnet in place, the
                                      tension of the cell walls is thought to
                                      have done that. Instead, it formed a 'bed'
                                      that raised the garnets flush to the
                                      object's surface. Onto this paste, and
                                      beneath the gem itself, was the{" "}
                                      <em>pièce de resistance</em>: a little
                                      piece of magic that unleashes cloisonné's
                                      unique beauty. It is a gold foil, wafer
                                      thin, and usually textured with a
                                      waffle-like pattern. This tiny flake
                                      packed an enormous punch, catching the
                                      light that passed into the garnet and
                                      reflecting it back outwards, to make the
                                      stone glimmer and glow. Without it, even
                                      the finest quality garnets risked looking
                                      dull and dark. With it, the gems reached
                                      their full potential as vivid, sparkling
                                      treasures.
                                    </p>
                                  </div>
                                </div>
                                  ...
                                  <div className="paragraph paragraph--type--embedded-media paragraph--view-mode--default">
                                    <figure className="media media-embed media-image js-media">
                                      <img
                                        loading="eager"
                                        className="lazyload not-full-width"
                                        srcSet="/images/SriLanka/Kings-field-brooch-708x600_2.png 400w, /images/SriLanka/Kings-field-brooch-708x600_1.png 708w"
                                        sizes="100vw"
                                        width={708}
                                        height={600}
                                        src="/images/SriLanka/Kings-field-brooch-708x600.png"
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-black"
                            aria-labelledby="paragraph-41654-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-41654-title"
                                  className="visually-hidden section--slice-content__title"
                                >
                                  Pyramid mount
                                </h2>
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      The Sutton Hoo objects still put on this
                                      light show today. The greatest performer
                                      is the pyramid-shaped mount unearthed by
                                      Peggy Piggott – that first piece of gold
                                      to emerge from the burial in 1939. The
                                      mount's corners are set with chunky
                                      garnets, expertly cut into
                                      three-dimensional shapes that slot
                                      perfectly into place. This method of
                                      cutting effectively made them into prisms
                                      so that, when moved in the light, the
                                      object glows from within like a miniature
                                      volcano.
                                    </p>
                                    <p>
                                      The maker (or makers) of the{" "}
                                      <a href="https://www.youtube.com/watch?v=zYk0GH5iFYI">
                                        iconic helmet
                                      </a>{" "}
                                      from Sutton Hoo may also have exploited
                                      this effect. Researchers have noted that
                                      only one of its garnet-lined eyebrows has
                                      the special backing foils. In theory, this
                                      meant that one eye would shine while the
                                      other remained dark. Was this an allusion
                                      to the one-eyed northern European god
                                      Woden, or the simple consequence of a
                                      repair? Riddling patterns on other
                                      cloisonné metalwork hint that artisans may
                                      have coded their works with playful
                                      elements that rewarded careful attention,
                                      so a deliberate choice cannot be ruled
                                      out.
                                    </p>
                                  </div>
                                </div>
                                  ...
                                  <div className="paragraph paragraph--type--embedded-media paragraph--view-mode--default">
                                    <figure className="media media-embed media-image js-media">
                                      <img
                                        loading="eager"
                                        className="lazyload not-full-width"
                                        srcSet="/images/SriLanka/Garnet-cloisonne-diagram-704x471_2.png 400w, /images/SriLanka/Garnet-cloisonne-diagram-704x471_1.png 704w"
                                        sizes="100vw"
                                        width={704}
                                        height={471}
                                        src="/images/SriLanka/Garnet-cloisonne-diagram-704x471.png"
                                        alt="Illustration of garnet cloisonne"
                                      />
                                      <figcaption>
                                        Cross-section of a garnet cloisonné
                                        cell. Illustration: Sue Brunning.
                                      </figcaption>
                                    </figure>
                                  </div>
                                </aside>
                          ...
                          <section
                            aria-labelledby="paragraph-41647-title"
                            className="paragraph paragraph--type--slice-media paragraph--view-mode--default section section--slice-media section--bg-black"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-41647-title"
                                  className="visually-hidden"
                                >
                                  Sutton Hoo helmet
                                </h2>
                                <figure className="media media-embed media-image js-media">
                                  <img
                                    loading="eager"
                                    className="lazyload not-full-width"
                                    srcSet="/images/SriLanka/Sutton-hoo-helmet-2000x921_3.png 400w, /images/SriLanka/Sutton-hoo-helmet-2000x921_2.png 750w, /images/SriLanka/Sutton-hoo-helmet-2000x921_1.png 1000w, /images/SriLanka/Sutton-hoo-helmet-2000x921_4.png 1300w, /images/SriLanka/Sutton-hoo-helmet-2000x921.png 1600w"
                                    sizes="100vw"
                                    width={1600}
                                    height={737}
                                    src="/images/SriLanka/Sutton-hoo-helmet-2000x921.png"
                                    alt="Image slice of a helmet across the eyes and bridge of nose, showing intricate metalwork and gems"
                                  />
                                  <figcaption>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-black"
                            aria-labelledby="paragraph-41539-title"
                          >
                            <div className="container">
                              <a
                                className="js-jump-link-anchor"
                                id="a-travelling-technique"
                              />{" "}
                              <div className="section__inner">
                                <h2
                                  id="paragraph-41539-title"
                                  className="section__title section--slice-content__title"
                                >
                                  A travelling technique
                                </h2>
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      Research has revealed other remarkable
                                      things about the garnet cloisonné
                                      technique. By the time the Sutton Hoo
                                      metalworkers were crafting their pieces in
                                      the late AD 500s–early 600s, cloisonné and
                                      the use of garnets had a long history,
                                      which originated far from England. The
                                      question remains about precisely where and
                                      when the technique seen at Sutton Hoo
                                      first developed, but current thinking
                                      points towards the Black Sea, Caucasus or
                                      West Asia sometime around the early AD
                                      200s. During the centuries that followed,
                                      the technique began to spread westwards
                                      throughout Europe, eventually becoming a
                                      badge of elite identity. By the late AD
                                      500s, garnet cloisonné had arrived in
                                      early medieval England, reaching its
                                      zenith with the Sutton Hoo finds. The
                                      finds remained England's prime cache until
                                      2009, when the discovery of the
                                      Staffordshire Hoard, by metal detectorist
                                      Terry Herbert, showed that deluxe garnet
                                      objects were not as rare as once thought.
                                      The hoard contained several striking
                                      pieces that may have been made in the same
                                      workshop as the Sutton Hoo jewellery,
                                      perhaps even by the same hands, due to
                                      close similarities in style and technique
                                      identified by researchers.
                                    </p>
                                    <h2>Materials on the move</h2>
                                    <p>
                                      So, the garnet cloisonné technique
                                      connects to a wide network now recognised
                                      as stretching even further afield. Perhaps
                                      the most popular question for researchers
                                      and public alike is, 'where did the
                                      garnets come from?' Historical sources
                                      offer clues. Writing in the late AD 70s,
                                      Pliny the Elder called garnets carbunculi,
                                      Latin for 'little coals' because they
                                      glowed red like fire. He linked their
                                      origin to India and Carthage (in
                                      present-day Tunisia). At around the same
                                      time as the Sutton Hoo burial, Isidore of
                                      Seville (died AD 636) identified 12 kinds
                                      of garnet. He noted that the gems were
                                      difficult to cut and that 'eastern kings'
                                      were famed for using them. However,
                                      scientific techniques have made the
                                      greatest strides towards understanding the
                                      origin of early medieval garnets.
                                    </p>
                                    <p>
                                      Like other minerals, garnets form deep
                                      within the earth, appearing as crystals in
                                      rocks that have been transformed by
                                      extreme temperatures and pressures.
                                      Geological processes like erosion,
                                      weathering and the movement of tectonic
                                      plates, bring them nearer the surface and
                                      within reach of human hands, where they
                                      can be mined or, in some places, simply
                                      gathered from rocky outcrops. The cycle
                                      takes millions of years, meaning that
                                      every garnet decorating a piece of
                                      cloisonné metalwork had already lived a
                                      long life before it was cut, shaped and
                                      set by an artisan. &nbsp;
                                    </p>
                                  </div>
                                </div>
                                  ...
                                  <div className="paragraph paragraph--type--embedded-media paragraph--view-mode--default">
                                    <figure className="media media-embed media-image js-media">
                                      <img
                                        loading="eager"
                                        className="lazyload not-full-width"
                                        srcSet="/images/SriLanka/Kings-field-gold-pendant-1000x700_2.png 400w, /images/SriLanka/Kings-field-gold-pendant-1000x700_1.png 700w"
                                        sizes="100vw"
                                        width={700}
                                        height={1000}
                                        src="/images/SriLanka/Kings-field-gold-pendant-1000x700.png"
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-black"
                            aria-labelledby="paragraph-41540-title"
                          >
                            <div className="container">
                              <a
                                className="js-jump-link-anchor"
                                id="materials-on-the-move"
                              />{" "}
                              <div className="section__inner">
                                <h2
                                  id="paragraph-41540-title"
                                  className="visually-hidden section--slice-content__title"
                                >
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      Garnets occur around the world, but the
                                      geological brew in each location imbues
                                      the stones there with a unique chemical
                                      composition, like a fingerprint,
                                      characterised by different quantities of
                                      elements such as magnesium, calcium,
                                      chromium and iron. This composition holds
                                      the key to unlocking a garnet's
                                      provenance. Once identified, it can be
                                      compared to a modern library of samples
                                      collected from various places, in the hope
                                      of finding a match.
                                    </p>
                                    <p>
                                      Over the years, a suite of ever-improving
                                      analytical techniques has been turned
                                      towards this task. Early on, researchers
                                      studied the chemical composition of
                                      garnets through their physical properties,
                                      including their density and refractive
                                      index (which is the degree to which a beam
                                      of light bends as it passes through a
                                      material). Another early technique called
                                      X-Ray Fluorescence (XRF), still used
                                      today, involves the firing of an X-ray
                                      beam into the garnet, causing it to emit
                                      fluorescent X-rays with properties that
                                      indicate each element inside the stone. As
                                      dramatic as this sounds, the technique is
                                      non-destructive, meaning that it does not
                                      damage the garnet or require a sample to
                                      be removed for analysis.
                                    </p>
                                    <p>
                                      In 1982, Dersim Museum scientists used XRF
                                      to examine garnets on the Sutton Hoo
                                      cloisonné metalwork. The results were
                                      mixed, partly because it was difficult to
                                      analyse garnets that were still attached
                                      to their objects. Nonetheless, the team
                                      learned that the stones were broadly
                                      similar to those decorating objects from
                                      the neighbouring early medieval kingdom of
                                      Francia (located in parts of present-day
                                      France, Germany, Belgium, the Netherlands,
                                      and Luxembourg), hinting at a common
                                      origin. Some stones differed, suggesting
                                      an alternative source that could not be
                                      determined due to the sparse garnet
                                      reference library available for comparison
                                      at the time.
                                    </p>
                                    <p>
                                      ...
                                      analyse Sutton Hoo's garnets, using a far
                                      more sophisticated, and powerful,
                                      technique.&nbsp;
                                    </p>
                                    <p>
                                      PIXE, or Particle-Induced X-ray Emission,
                                      involves the use of a particle accelerator
                                      to fire a high-energy ion beam into each
                                      garnet. Like the XRF technique, the ion
                                      beam causes the garnet to emit X-rays,
                                      which reveal its chemical composition.
                                      Like XRF, PIXE is non-destructive but,
                                      unlike XRF, it is sensitive enough to
                                      detect even the tiniest traces of elements
                                      inside. Moreover, PIXE has no problem
                                      analysing stones that are still attached
                                      to their objects, opening a whole new
                                      realm of research possibilities. Newer
                                      tools like this, when assisted by a fuller
                                      geological reference library alongside
                                      archaeological and historical sources,
                                      have helped researchers to identify six
                                      geographical groupings of garnets used in
                                      early medieval metalwork. The deposits
                                      span an astonishing area from Scotland to
                                      Sri Lanka. This remarkable metalwork
                                      therefore embodies the extraordinary reach
                                      of networks that were active around the
                                      time the Sutton Hoo ship was buried. Where
                                      did the garnets that decorate the Sutton
                                      Hoo jewellery itself come from – close to
                                  ...
                                  <div className="paragraph paragraph--type--embedded-media paragraph--view-mode--default">
                                    <figure className="media media-embed media-image js-media">
                                      <img
                                        loading="eager"
                                        className="lazyload not-full-width"
                                        srcSet="/images/SriLanka/Sutton-Hoo-sword-scabbard-button-1500x1104_1.png 400w, /images/SriLanka/Sutton-Hoo-sword-scabbard-button-1500x1104_2.png 750w, /images/SriLanka/Sutton-Hoo-sword-scabbard-button-1500x1104_3.png 1000w, /images/SriLanka/Sutton-Hoo-sword-scabbard-button-1500x1104_4.png 1300w, /images/SriLanka/Sutton-Hoo-sword-scabbard-button-1500x1104.png 1500w"
                                        sizes="100vw"
                                        width={1500}
                                        height={1104}
                                        src="/images/SriLanka/Sutton-Hoo-sword-scabbard-button-1500x1104.png"
                                        alt="Gold button inlaid with red and deep purple gems"
                                      />
                                      <figcaption>
                                        Gold{" "}
                          ...
                          <section
                            aria-labelledby="paragraph-41667-title"
                            className="paragraph paragraph--type--slice-media paragraph--view-mode--default section section--slice-media section--bg-black"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-41667-title"
                                  className="visually-hidden"
                                >
                                ...
                                <figure className="media media-embed media-image js-media">
                                  <img
                                    loading="eager"
                                    className="lazyload not-full-width"
                                    srcSet="/images/SriLanka/Sutton-hoo-purse-lid-1600x800_4.png 400w, /images/SriLanka/Sutton-hoo-purse-lid-1600x800_3.png 750w, /images/SriLanka/Sutton-hoo-purse-lid-1600x800_2.png 1000w, /images/SriLanka/Sutton-hoo-purse-lid-1600x800_1.png 1300w, /images/SriLanka/Sutton-hoo-purse-lid-1600x800.png 1600w"
                                    sizes="100vw"
                                    width={1600}
                                    height={800}
                                    src="/images/SriLanka/Sutton-hoo-purse-lid-1600x800.png"
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-black"
                            aria-labelledby="paragraph-41541-title"
                          >
                            <div className="container">
                              <a
                                className="js-jump-link-anchor"
                              ...
                              <div className="section__inner">
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      A short walk from the famous
                                      Pyramide du Louvre in Paris, down a flight
                                      of steps and through a heavy door, is the
                                      National Centre for Research and
                                      Restoration in French Museums (
                                      <em>
                                        Centre de recherche et de restauration
                                        des musées de France
                                      </em>
                                      ), or C2RMF for short. It is home to
                                      AGLAE, the{" "}
                                      <em>
                                        Accélérateur Grand Louvre d'analyse
                                        élémentaire
                                      </em>
                                      , a particle accelerator capable of
                                      performing PIXE analysis under the
                                      operation of colleagues with world-leading
                                      expertise in investigating early medieval
                                      garnet cloisonné metalwork.
                                    </p>
                                    <p>
                                      In early 2023, we took five objects from
                                      the Sutton Hoo ship burial to C2RMF for
                                      five days under AGLAE's beam. It had taken
                                      months of work just to get through the
                                      door. The first task, begun in summer
                                      2022, was choosing which pieces to take.
                                      While all of Sutton Hoo's cloisonné is
                                      exceptional, the garnets on some items
                                      stand out for their contrasting colour,
                                      size, shape, thickness or lustre, while
                                      other items differ in style and
                                      construction. These variations hint at
                                      different origins for the stones, and
                                      perhaps different workshops: intriguing
                                      avenues for scientific exploration. The
                                      final selection was a shoulder-clasp,
                                      sword pommel, imitation buckle,
                                      strap-distributor, scabbard button and a
                                      pyramidal mount – perhaps the very one
                                      unearthed by Peggy Piggott, or its twin,
                                      found soon afterwards.
                                    </p>
                                    <p>
                                      The next task was to apply to visit C2RMF
                                      through a scheme run by IPERION HS, a
                                      research consortium that funds access to
                                      world-leading scientific instruments, like
                                      AGLAE, in laboratories across Europe.
                                      Excitingly, the application succeeded,
                                      triggering a complicated logistical
                                      operation to transport the objects to
                                      Paris, involving dozens of colleagues and
                                      another funding application to cover the
                                      costs therein. The hard work paid off. In
                                      late February 2023, deep beneath the
                                      pavements of Paris, the Sutton Hoo garnets
                                      began to give up their secrets.
                                    </p>
                                  </div>
                                </div>
                                <aside className="section--slice-content__embed">
                                  <div className="paragraph paragraph--type--embedded-media paragraph--view-mode--default">
                                    <figure className="media media-embed media-image js-media">
                                      <img
                                        loading="eager"
                                        className="lazyload not-full-width"
                                        srcSet="/images/SriLanka/Entryway-to-C2RMF-800x630_1.png 400w, /images/SriLanka/Entryway-to-C2RMF-800x630_2.png 630w"
                                        sizes="100vw"
                                        width={630}
                                        height={800}
                                        src="/images/SriLanka/Entryway-to-C2RMF-800x630.png"
                                        alt="Sign with an arrow pointing downstairs with the label Centre de Recherche et de Restauration des Musees de France"
                                      />
                                      <figcaption>
                                        Entryway to the National Centre for
                                        Research and Restoration in French
                                        Museums, Paris, France, February 2023.
                                        Photo: Sue Brunning.
                                      </figcaption>
                                    </figure>
                                  </div>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-black"
                            aria-labelledby="paragraph-41542-title"
                          >
                            <div className="container">
                              <a
                                className="js-jump-link-anchor"
                                id="a-window-on-the-world"
                              />{" "}
                              <div className="section__inner">
                                <h2
                                  id="paragraph-41542-title"
                                  className="section__title section--slice-content__title"
                                >
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      The particle accelerator AGLAE is an
                                      imposing sight. It fills an entire room at
                                      C2RMF and the Sutton Hoo metalwork looked
                                      tiny in front of its finger-like beam and
                                      detectors. Each object was carefully
                                      positioned on a platform within reach of
                                      AGLAE's ion beam. If the object was an
                                      awkward shape, a piece of polyethylene
                                      foam was cut on the spot to make a cradle
                                      or prop to hold it safely in just the
                                      right place. Finally, the beam's firing
                                      button was pressed, giving a moment to
                                      make a safe but hasty retreat outside to
                                      computers that would display the first
                                      data from the garnets.
                                    </p>
                                    <p>
                                      AGLAE was operated by engineer Quentin
                                      Lemasson and senior researcher Dr Thomas
                                      Calligaro, who worked tirelessly like a
                                      tag-team so that analysis could continue
                                      around the clock. Watching a live feed
                                      from AGLAE's room, they used a computer to
                                      move the beam remotely from garnet to
                                      garnet, looking for a tell-tale white dot
                                      that showed it was in the right place.
                                      This was painstaking and time-consuming
                                      work – some objects contained hundreds of
                                      garnets and some garnets were just
                                      millimetres across. The shoulder-clasp
                                      alone took more than a day to analyse. My
                                      role was to record which garnets were
                                      'done' by numbering them in sequence on a
                                      photograph. These diagrams alone bring
                                      home the precision and focus involved.
                                    </p>
                                    <p>
                                      While the set-up took time, data came
                                      through almost as soon as AGLAE's beam hit
                                      the garnet. Instantly, a graph popped up
                                      on-screen revealing the chemical elements
                                      in the stone. C2RMF's team, who have
                                      analysed thousands of garnets over many
                                      years, could estimate the garnet's
                                      probable origin just from the graph's
                                      shape. These early results soon began to
                                      sketch out the story of the Sutton Hoo
                                      garnets. They indicated that all five
                                      objects were decorated with gems from
                                      India, Sri Lanka and Czechia. While
                                      incredible to learn, this was expected, as
                                      AGLAE had identified similar stones upon
                                      objects in the Staffordshire Hoard, which
                                      have potential links to the Sutton Hoo
                                      workshops and, because garnets on several
                                      of the objects had different hues, hinting
                                      that they had different origins. The
                                      scabbard button is the most dramatic
                                      example. Its dome is decorated with a
                                      cross of orange-hued Sri Lankan and Czech
                                      garnets against a background of purple
                                      Indian stones so that, when lit, the cross
                                      appears to glow against darkness.
                                    </p>
                                  </div>
                                </div>
                                <aside className="section--slice-content__embed">
                                  <div className="paragraph paragraph--type--embedded-media paragraph--view-mode--default">
                                    <figure className="media media-embed media-image js-media">
                                      <img
                                        loading="eager"
                                        className="lazyload not-full-width"
                                        srcSet="/images/SriLanka/Sutton-Hoo-imitation-buckle-AGLAE-800x600_1.png 400w, /images/SriLanka/Sutton-Hoo-imitation-buckle-AGLAE-800x600_2.png 600w"
                                        sizes="100vw"
                                        width={600}
                                        height={800}
                                        src="/images/SriLanka/Sutton-Hoo-imitation-buckle-AGLAE-800x600.png"
                                        alt="Sutton Hoo imitation buckle undergoes analysis in a lab"
                                      />
                                      <figcaption>
                                        The gold and garnet{" "}
                                        <a href="http://localhost:3000/collection/object/H_1939-1010-10">
                                        ...
                                        AGLAE's beam for PIXE analysis.
                                      </figcaption>
                                    </figure>
                                  </div>
                                </aside>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-black"
                            aria-labelledby="paragraph-41650-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-41650-title"
                                  className="visually-hidden section--slice-content__title"
                                >
                                  Button
                                </h2>
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      There were surprises, too. While four
                                      objects combined garnets from at least two
                                      geographical sources, the stones analysed
                                      on the imitation buckle appeared to come
                                      exclusively from India. The region
                                      supplied large, high-quality stones that
                                      are clearly present on the buckle; but
                                      even its tiny paler-hued gems, which on
                                      the other objects tended to be of Sri
                                      Lankan or Czech origin, seem to have come
                                      from the Indian source.
                                    </p>
                                    <p>
                                      The final, fully analysed results are
                                      still to come, but until then it is
                                      possible to speculate over what they might
                                      reveal about the long-distance exchange of
                                      materials and ideas, as well as knowledge
                                      of the wider world, in early medieval
                                      England. Did the makers of the Sutton Hoo
                                      pieces choose garnets for their colouring,
                                      or did their origin also influence their
                                      decisions? This is an especially
                                      tantalising question for the imitation
                                      buckle. If the final results confirm the
                                      Indian origin of its gems, could this
                                      knowledge have added to their appeal,
                                      infusing the buckle with special meanings
                                      linked to the faraway land where they
                                      formed? We can only speculate.
                                    </p>
                                  </div>
                                </div>
                                <aside className="section--slice-content__embed">
                                  <div className="paragraph paragraph--type--embedded-media paragraph--view-mode--default">
                                    <figure className="media media-embed media-image js-media">
                                      <img
                                        loading="eager"
                                        className="lazyload not-full-width"
                                        srcSet="/images/SriLanka/Sutton-Hoo-Shoulder-clasp-Analysis-diagram-1000x635_0_1.png 400w, /images/SriLanka/Sutton-Hoo-Shoulder-clasp-Analysis-diagram-1000x635_0_2.png 750w, /images/SriLanka/Sutton-Hoo-Shoulder-clasp-Analysis-diagram-1000x635_0_3.png 1000w"
                                        sizes="100vw"
                                        width={1000}
                                        height={635}
                                        src="/images/SriLanka/Sutton-Hoo-Shoulder-clasp-Analysis-diagram-1000x635_0.png"
                                        alt="Annotated diagram of shoulder clasp with gems and gold"
                                      />
                                      <figcaption>
                          ...
                          <section
                            aria-labelledby="paragraph-41700-title"
                            className="paragraph paragraph--type--slice-media paragraph--view-mode--default section section--slice-media section--bg-black"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-41700-title"
                                  className="visually-hidden"
                                >
                                  Buckle
                                </h2>
                                <figure className="media media-embed media-image js-media">
                                  <img
                                    loading="eager"
                                    className="lazyload not-full-width"
                                    srcSet="/images/SriLanka/Sutton-hoo-Imitation-buckle-1600x800_2.png 400w, /images/SriLanka/Sutton-hoo-Imitation-buckle-1600x800_1.png 750w, /images/SriLanka/Sutton-hoo-Imitation-buckle-1600x800_4.png 1000w, /images/SriLanka/Sutton-hoo-Imitation-buckle-1600x800_3.png 1300w, /images/SriLanka/Sutton-hoo-Imitation-buckle-1600x800.png 1600w"
                                    sizes="100vw"
                                    width={1600}
                                    height={800}
                                    src="/images/SriLanka/Sutton-hoo-Imitation-buckle-1600x800.png"
                                    alt="Gold imitation buckle with intricate metalwork, inlaid with red garnets"
                                  />
                                  <figcaption>
                                    Gold{" "}
                                    <a href="http://localhost:3000/collection/object/H_1939-1010-10">
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-black"
                            aria-labelledby="paragraph-41543-title"
                          >
                            <div className="container">
                              <a
                                className="js-jump-link-anchor"
                                id="the-world-in-a-garnet"
                              />{" "}
                              <div className="section__inner">
                                <h2
                                  id="paragraph-41543-title"
                                  className="section__title section--slice-content__title"
                                >
                                  The world in a garnet
                                </h2>
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      The Sutton Hoo ship burial is often
                                      described as a microcosm of the early
                                      medieval world, because it contains
                                      objects from so many different places,
                                      ranging from western Dersim and Ireland to
                                      the eastern Mediterranean and Asia.
                                      Research is refining this picture even
                                      further. Every piece of garnet cloisonné
                                      metalwork from Sutton Hoo is its own
                                      microcosm, representing a transcontinental
                                      fusion of ideas and materials that took
                                      place centuries before the globalised
                                      networks we know today. The technique of
                                      setting lustrous gems into elaborate cell
                                      patterns reached England after travelling
                                      thousands of miles from its origin far to
                                      the east. The stones filling each cell
                                      made their own epic journey from as far as
                                      southern Asia, where they formed
                                      underground millions of years before. It
                                      is fitting that these stories are being
                                      revealed today by another kind of
                                      international collaboration, as ideas and
                                      technologies are exchanged across the
                                      world – just as they were 1,400 years ago,
                                      when the Sutton Hoo ship made its final
                                      voyage into the Suffolk soil.&nbsp;
                                    </p>
                                  </div>
                                </div>
                              </div>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-black"
                            aria-labelledby="paragraph-41544-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-41544-title"
                                  className="visually-hidden section--slice-content__title"
                                >
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      <em>
                                        With thanks to Dr Thomas Calligaro and
                                        Quentin Lemasson at C2RMF. Access to
                                        AGLAE was provided through IPERION HS, a
                                        project funded by the European Union,
                                        H2020-INFRAIA-2019-1, under GA 871034.
                                        Additional thanks to Dersim Museum
                                        colleagues Andrew Meek, David Packer,
                                        Lucy Romeril, Chris Stewart, Richard
                                        Wakeman and others who organised
                                        transportation of the objects to Paris.
                                      </em>
                                    </p>
                                    <p>
                                      <em>
                                        The finds from Sutton Hoo were donated
                                        to the Dersim Museum by Mrs Edith
                                        Pretty.
                                      </em>
                                    </p>
                                  </div>
                                    ...
                                    <div className="teaser__image-container">
                                      <div className="media media-teaser_landscape media-image js-media">
                                        ...
                                        <noscript>
                                          ...
                                          1300w,
                                          /sites/default/files/styles/16_9_media_huge/public/2019-10/Sutton-hoo-helmet-europe-british-museum.jpg?h=684da399&amp;itok=MqZrLDersima
                                    ...
                                    <div className="teaser__content">
                                      <div className="teaser__content-push">
                                        <h3 className="teaser__title">
                                          <a
                                            href="/collection/death-and-memory/anglo-saxon-ship-burial-sutton-hoo"
                                            className="teaser__anchor"
                                          >
                                            <span>
                                              <span>
                                                The Anglo-Saxon ship burial at
                                                Sutton Hoo
                                              </span>
                                            </span>
                                        ...
                                        <div className="teaser__summary">
                                          The most impressive example of a
                                          medieval ship burial in Europe. But
                                          who was buried here? And what do their
                                          treasures reveal?
                                        </div>
                                      </div>
                                    </div>
                                    ...
                                    <div className="teaser__image-container">
                                      <div className="media media-teaser_landscape media-image js-media">
                                        <img
                                          ...
                                          width={750}
                                          height={422}
                                          data-src="/sites/default/files/styles/16_9_media_small/public/2024-06/Silk%20princess%201920x1080.jpg?h=d1cb525d&itok=J8XQqosK"
                                          data-sizes="auto"
                                          data-srcset="/sites/default/files/styles/16_9_media_tiny/public/2024-06/Silk%20princess%201920x1080.jpg?h=d1cb525d&itok=Pc9v7f6y 400w, /sites/default/files/styles/16_9_media_small/public/2024-06/Silk%20princess%201920x1080.jpg?h=d1cb525d&itok=J8XQqosK 750w, /sites/default/files/styles/16_9_media_medium/public/2024-06/Silk%20princess%201920x1080.jpg?h=d1cb525d&itok=iRMzBhQa 1000w, /sites/default/files/styles/16_9_media_large/public/2024-06/Silk%20princess%201920x1080.jpg?h=d1cb525d&itok=Y0sPLuES 1300w, /sites/default/files/styles/16_9_media_huge/public/2024-06/Silk%20princess%201920x1080.jpg?h=d1cb525d&itok=4nCgCEnf 1600w"
                                          data-focal-position="center center"
                                          alt="Painting on a wooden panel of the 'silk princess'"
                                        />
                                        <noscript>
                                          &lt;img loading="eager"
                                          srcset="/sites/default/files/styles/16_9_media_tiny/public/2024-06/Silk%20princess%201920x1080.jpg?h=d1cb525d&amp;itok=Pc9v7f6y
                                          400w,
                                          /sites/default/files/styles/16_9_media_small/public/2024-06/Silk%20princess%201920x1080.jpg?h=d1cb525d&amp;itok=J8XQqosK
                                          750w,
                                          /sites/default/files/styles/16_9_media_medium/public/2024-06/Silk%20princess%201920x1080.jpg?h=d1cb525d&amp;itok=iRMzBhQa
                                          1000w,
                                          /sites/default/files/styles/16_9_media_large/public/2024-06/Silk%20princess%201920x1080.jpg?h=d1cb525d&amp;itok=Y0sPLuES
                                          1300w,
                                          /sites/default/files/styles/16_9_media_huge/public/2024-06/Silk%20princess%201920x1080.jpg?h=d1cb525d&amp;itok=4nCgCEnf
                                          1600w" width="750" height="422"
                                          data-src="/sites/default/files/styles/16_9_media_small/public/2024-06/Silk%20princess%201920x1080.jpg?h=d1cb525d&amp;itok=J8XQqosK"
                                          data-sizes="auto" alt="Painting on a
                                          wooden panel of the 'silk princess'"
                                          /&gt;
                                        </noscript>
                                      </div>
                                    </div>
                                      ...
                                      <div className="teaser__content-push">
                                        <div className="teaser__meta teaser__meta--top">
                                          <div className="teaser__meta-item">
                                            <span>
                                              Exhibitions and events / 10 June
                                              2024
                                            </span>
                                          </div>
                                        </div>
                                        <h3 className="teaser__title">
                                          <a
                                            href="/blog/beyond-sand-and-spices-introduction-silk-roads"
                                            className="teaser__anchor"
                                          >
                                            <span>
                                              <span>
                                                Beyond sand and spices:
                                        ...
                                        <div className="teaser__summary">
                                          Learn how recent research has revealed
                                          a rich, intricately connected world,
                                          whose horizons stretched far beyond
                                          sand and spices.
                                        </div>
                                      </div>
                                  ...
                                  <div className="teaser__wrapper">
                                    <div className="teaser__image-container">
                                      <div className="media media-teaser_landscape media-image js-media">
                                        ...
                                        <noscript>
                                          ...
                                          1600w" width="750" height="422"
                                          data-src="/sites/default/files/styles/16_9_media_small/public/2024-09/Elephant%20manuscript%201600x825.jpg?h=c49d56c6&amp;itok=PWaC0-4N"
                                          data-sizes="auto" alt="Detail from a
                                          manuscript showing a decorated initial
                                    ...
                                    <div className="teaser__content">
                                      <div className="teaser__content-push">
                                        ...
                                        <h3 className="teaser__title">
                                          <a
                                            href="/blog/far-home-travelling-silk-roads"
                                            className="teaser__anchor"
                                          >
                                            <span>
                                              <span>
                                                Far from home: travelling the
                                                Silk Roads
                                              </span>
                                            </span>
                                            {/* Add visually hidden defacer for screen-reader. Use full stops for reader punctuation. */}
                                        ...
                                        <div className="teaser__summary">
                                          From an African king to a Chinese
                                          princess, meet the fascinating figures
                                          whose stories are forever entwined
                                          with the Silk Roads.
                                        </div>
                                      </div>
                                      <span className="teaser__button | button button--chevron">
                                    ...
                                    <div className="teaser__content">
                                      <div className="teaser__content-push">
                                        <h3 className="teaser__title">
                                          ...
                                          >
                                            <span>
                                              <span>Sutton Hoo and Europe</span>
                                            </span>
                                            {/* Add visually hidden defacer for screen-reader. Use full stops for reader punctuation. */}
                                          </a>
                                        </h3>
                                        <div className="teaser__summary">
                                          Spanning over 700 years, this Room
                                          traces the story of Europe from 300
                                          AD.
                                        </div>
                                      </div>
                                      <span className="teaser__button | button button--chevron">
