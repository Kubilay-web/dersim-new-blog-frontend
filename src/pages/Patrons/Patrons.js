...
const Patrons = () => {
  ...
  useEffect(() => {
    const someContentId = "67b311c77ffef8be106d2917";

    fetchContentById(someContentId, setContent);
  }, []);

  useEffect(() => {
    const category1 = "Become a Patron";
    ...
    <div>
      <div>
        ...
        <meta
          ...
          content="Discover the difference that you can make as a Patron, and become more involved in the life and evolution of the Museum."
        />
        <meta
          property="og:image"
              ...
              <main id="main-content" className="js-main">
                <div>
                  <div
                    ...
                    role="article"
                    aria-labelledby="paragraph-3197-title"
                  >
                    ...
                    <div className="container">
                      <div className="hero__inner">
                        <div className="hero__content-container">
                          ...
                          {/* <h1 id="paragraph-3197-title" className="hero__title">
                            {" "}
                            Become a Patron
                          </h1> */}
                        </div>
                        <div className="hero__controls">
                          <div className="hero__caption | js-hero-caption">
                            <button
                              ...
                              id="hero-image-caption-button-3197"
                              aria-expanded="false"
                              aria-controls="hero-image-caption-content-3197"
                            >
                            ...
                            <div
                              ...
                              id="hero-image-caption-content-3197"
                              aria-hidden="true"
                              aria-labelledby="hero-image-caption-button-3197"
                            >
                              <button
                                type="button"
                                className="hero__caption-content-close | js-hero-caption-btn"
                                id="hero-image-caption-close-button-3197"
                                aria-expanded="false"
                                aria-controls="hero-image-caption-content-3197"
                              >
                                <span className="visually-hidden">
                        ...
                        <div className="section--intro__container">
                          <div className="section--intro__info">
                            ...
                            <div className="section--intro__info-slices">
                              <div className="paragraph paragraph--type--info-content paragraph--view-mode--default section--intro__info-content wysiwyg">
                                ...
                                <p>
                                  Email:&nbsp;
                                  <a href="/cdn-cgi/l/email-protection#57273623253839241735253e233e243f3a222432223a79382530">
                                    <span
                                      className="__cf_email__"
                                      data-cfemail="b7c7d6c3c5d8d9c4f7d5c5dec3dec4dfdac2c4d2c2da99d8c5d0"
                                    >
                                      [email&nbsp;protected]
                                    </span>
                                  </a>
                          ...
                          <div className="section--intro__content">
                            ...
                            <div className="wysiwyg">
                              <p>
                                <span>
                                  As members of a community of curious minds,
                                  Patrons can enjoy the collection and learn
                                  from Museum experts in uniquely engaging and
                                  intimate environments. With opportunities to
                                  go behind the scenes and gain exclusive access
                                  to our major exhibitions and galleries,
                                  Patrons receive an unparalleled experience –
                                  all while supporting the vital work of the
                                  Museum.
                                </span>
                                <br />
                                <br />
                      ...
                      <div>
                        <div>
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-28318-title"
                          >
                            <div className="container">
                              <a
                              ...
                              <div className="section__inner">
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      We have four Patron Circles to choose
                                      from. Each provides the opportunity to
                                      support the Museum’s important work and
                                      gives access to a unique selection of
                                      benefits, allowing you to pick the option
                                      most suited to you.
                                    </p>
                                  </div>
                                </div>
                                <aside className="section--slice-content__embed">
                                  <div className="paragraph paragraph--type--embedded-media paragraph--view-mode--default">
                                    <figure className="media media-embed media-image js-media">
                                      ...
                                      />
                                      <figcaption>
                                        A curator talk at Patrons' Open House
                                        2022.&nbsp;Photo ©&nbsp;Lucy Williams
                                        Photography.
                                      </figcaption>
                                    </figure>
                                  </div>
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-28444-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-28444-title"
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  <h3 className="teaser__title">
                                                    <a
                                                      href="/support-us/patrons/sloane-circle"
                                                      className="teaser__anchor"
                                                    >
                                                      <span>
                                                        <span>
                                                  ...
                                                  <div className="teaser__summary">
                                                    £12,000 annually – Sloane
                                                    Patrons enjoy a bespoke
                                                    relationship with the Museum
                                                    and collection, so you can
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  <h3 className="teaser__title">
                                                    <a
                                                      href="/support-us/patrons/cracherode-circle"
                                                      className="teaser__anchor"
                                                    >
                                                      <span>
                                                        <span>
                                                  ...
                                                  <div className="teaser__summary">
                                                    £6,000 annually – Cracherode
                                                    Patrons enjoy remarkable
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  <h3 className="teaser__title">
                                                    <a
                                                      href="/support-us/patrons/brooke-sewell-circle"
                                                      className="teaser__anchor"
                                                    >
                                                      <span>
                                                        <span>
                                                  ...
                                                  <div className="teaser__summary">
                                                    £3,500 annually – Brooke
                                                    Sewell Patrons are invited
                                                    to unique events, such as
                                                    the Director's Dinner and
                                                    trips abroad with Museum
                                                    experts.
                                                  </div>
                                                </div>
                                              </div>
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  <h3 className="teaser__title">
                                                    <a
                                                      href="/support-us/patrons/godman-circle"
                                                      className="teaser__anchor"
                                                    >
                                                      <span>
                                                        <span>
                                                  ...
                                                  <div className="teaser__summary">
                                                    £1,500 annually – Godman
                                                    Patrons have the opportunity
                                                    to engage with the Museum's
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-3207-title"
                          >
                            <div className="container">
                              <a
                                className="js-jump-link-anchor"
                              ...
                              <div className="section__inner">
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    ...
                                    <p>
                                      In addition to Patron Circles, there are a
                                      number of Special Interest Groups that
                                      support specific areas of the collection.
                                    </p>
                                    <p>
                                      Special Interest Group members are invited
                                      to tailored events throughout the year.
                                      You'll have close contact with curators
                                      working in your area of interest, giving
                                      you lots of opportunities to expand your
                                      knowledge in the area of the collection
                                ...
                                <aside className="section--slice-content__embed">
                                  <div className="paragraph paragraph--type--embedded-media paragraph--view-mode--default">
                                    <figure className="media media-embed media-image js-media">
                                      ...
                                      />
                                      <figcaption>
                                        A Special Interest Group event in
                                        the&nbsp;
                                        <a
                          ...
                          {/* <section
                            className="paragraph paragraph--type--slice-teaser paragraph--view-mode--default section section--slice-teaser section--z-index-scope section--has-carousel section--bg-white"
                            aria-labelledby="paragraph-7780-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-7780-title"
                                    className="visually-hidden teaser-listing__title"
                                  >
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  <h3 className="teaser__title">
                                                    <a
                                                      href="/support-us/patrons/cammea-group"
                                                      className="teaser__anchor"
                                                    >
                                                      <span>
                                                        <span>
                                                  ...
                                                  <div className="teaser__summary">
                                                    £4,000 annually – CaMMEA
                                                    supports the Museum's
                                                    growing collection of more
                                                    than 200 established and
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  <h3 className="teaser__title">
                                                    <a
                                                      href="/support-us/patrons/ottley-group"
                                                      className="teaser__anchor"
                                                    >
                                                      <span>
                                                        <span>
                                                          Ottley Group (pre-1900
                                                          European drawings)
                                                        </span>
                                                      </span>
                                                  ...
                                                  <div className="teaser__summary">
                                                    £3,450 annually – the Ottley
                                                    Group supports the
                                                    acquisition of Old Master
                                                    and English works for the
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  <h3 className="teaser__title">
                                                    <a
                                                      href="/support-us/patrons/vollard-group"
                                                      className="teaser__anchor"
                                                    >
                                                      <span>
                                                        <span>
                                                          Vollard Group
                                                          (post-1945 prints and
                                                          drawings)
                                                        </span>
                                                      </span>
                                                  ...
                                                  <div className="teaser__summary">
                                                    £3,450 annually – the
                                                    Vollard Group supports the
                                                    Department of Prints and
                                                    Drawings' acquisition of
