...
const CommercialPress = () => {
  ...
  useEffect(() => {
    ...
    const category1 = `${contentPrefix}-content-16`;
  ...
  useEffect(() => {
    ...
    // Kategoriler dil bazında dinamik olarak ayarlanıyor
    const accordion1 = `${accordionPrefix}-accordion-14`;
              ...
              <main id="main-content" className="js-main">
                <div>
                  <div
                    ...
                    role="article"
                    aria-labelledby="paragraph-5945-title"
                  >
                        ...
                        <div className="hero__controls">
                          <div className="hero__caption | js-hero-caption">
                            <button
                              ...
                              id="hero-image-caption-button-5945"
                              aria-expanded="false"
                              aria-controls="hero-image-caption-content-5945"
                            >
                            ...
                            <div
                              ...
                              id="hero-image-caption-content-5945"
                              aria-hidden="true"
                              aria-labelledby="hero-image-caption-button-5945"
                            >
                              <button
                                type="button"
                                className="hero__caption-content-close | js-hero-caption-btn"
                                id="hero-image-caption-close-button-5945"
                                aria-expanded="false"
                                aria-controls="hero-image-caption-content-5945"
                              >
                                <span className="visually-hidden">
                              ...
                              <p>
                                {" "}
                                Discover more with our range of titles spanning
                                the fine and decorative arts, history,
                          ...
                          <div className="section--intro__info">
                            ...
                            <div className="section--intro__info-slices">
                              <div className="paragraph paragraph--type--info-content paragraph--view-mode--default section--intro__info-content wysiwyg">
                                <p>
                                  Email:&nbsp;
                                  <a href="/cdn-cgi/l/email-protection#daaaafb8b6b3b9b3aea39ab8a8b3aeb3a9b2b7afa9bfafb7f4b5a8bd">
                                    <span
                                      className="__cf_email__"
                                      data-cfemail="d4a4a1b6b8bdb7bda0ad94b6a6bda0bda7bcb9a1a7b1a1b9fabba6b3"
                                    >
                                      [email&nbsp;protected]
                                    </span>
                                  </a>
                          ...
                          <div className="section--intro__content">
                            ...
                            <div className="wysiwyg">
                              ...
                              <p>
                                ...
                                books shed light on new discoveries of global
                                interest and provide fresh insights into
                                well-known objects and periods of history.
                      ...
                      <div>
                        <div>
                          <section
                            ...
                            aria-labelledby="paragraph-8366-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-12712"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-12712"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                      ...
                                      <span> Rights enquiries</span>
                                    </button>
                                  </h3>
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-12712"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-12712"
                                  >
                                    <ul>
                                      <li>
                                        To enquire about co-edition and rights
                                        information contact Claudia Bloch:&nbsp;
                                        <a
                                          href="/cdn-cgi/l/email-protection#3655545a59555e7654445f425f455e5b434553435b18594451"
                                          data-gc-link="mailto:cbloch@britishmuseum.org"
                                        >
                                          <span
                                            className="__cf_email__"
                                            data-cfemail="6605040a09050e2604140f120f150e0b131503130b48091401"
                                          >
                                            [email&nbsp;protected]
                                          </span>
                                        </a>
                                      ...
                                      <li>
                                        ...
                                        <a href="/cdn-cgi/l/email-protection#2e5d4f424b5d6e4c4347434f494b5d004d4143">
                                          <span
                                            className="__cf_email__"
                                            data-cfemail="f88b99949d8bb89a959195999f9d8bd69b9795"
                                          >
                                            [email&nbsp;protected]
                                          </span>
                                        </a>
                                      ...
                                      <li>
                                        To enquire about licensing text from one
                                        of our publications, please contact:{" "}
                                        <a href="/cdn-cgi/l/email-protection#dfafbaadb2b6acacb6b0b1ac9fbdadb6abb6acb7b2aaacbaaab2f1b0adb8">
                                          <span
                                            className="__cf_email__"
                                            data-cfemail="daaabfa8b7b3a9a9b3b5b4a99ab8a8b3aeb3a9b2b7afa9bfafb7f4b5a8bd"
                                          >
                                            [email&nbsp;protected]
                                          </span>
                                        </a>
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-8364"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-8364"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                  ...
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-8364"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-8364"
                                  >
                                    <ul>
                                      <li>
                                        For Dersim contact:&nbsp;
                                        ...
                                        >
                                          <span
                                            className="__cf_email__"
                                            data-cfemail="c8bba9a4adbb88bca0a9a5adbba0bdacbba7a6e6aba7e6bda3"
                                          >
                                            [email&nbsp;protected]
                                          </span>
                                        </a>
                                      ...
                                      <li>
                                        For&nbsp;Export (excluding USA)
                                        contact:&nbsp;
                                        <a
                                          href="/cdn-cgi/l/email-protection#f89d8088978a8c8b99949d8bb88c9099959d8b908d9c8b9796d69b97d68d93"
                                          data-auth="NotApplicable"
                                          rel="noopener noreferrer"
                                          target="_blank"
                                        >
                                          <span
                                            className="__cf_email__"
                                            data-cfemail="781d0008170a0c0b19141d0b380c1019151d0b100d1c0b1716561b17560d13"
                                          >
                                            [email&nbsp;protected]
                                          </span>
                                        </a>
                                      ...
                                      <li>
                                        For USA contact:&nbsp;
                                        <a
                                          href="/cdn-cgi/l/email-protection#c9aaa8baaca4a8bdac89aaa8baaca4a8bdacb9bcaba5a0baa1acbbbae7aaa6a4"
                                          data-auth="NotApplicable"
                                          rel="noopener noreferrer"
                                          target="_blank"
                                        >
                                          <span
                                            className="__cf_email__"
                                            data-cfemail="492a283a2c24283d2c092a283a2c24283d2c393c2b25203a212c3b3a672a2624"
                                          >
                                            [email&nbsp;protected]
                                          </span>
                                        </a>
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-8365"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-8365"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                      ...
                                      <span> Scholarly book orders</span>
                                    </button>
                                  </h3>
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-8365"
                                    aria-hidden="true"
                                  ...
                                  >
                                    ...
                                    <p>
                                      For all private/individual book order
                                      enquiries and to place an order:
                                      <br />
                                      <br />
                                      Oxbow Books, 47 Church Street, Barnsley,
                                      S70 2AS
                                      <br />
                                      Email:&nbsp;
                                      <a href="/cdn-cgi/l/email-protection#6e01160c01192e1e0b00430f000a431d19011c0a400d01401b05">
                                        <span
                                          className="__cf_email__"
                                          data-cfemail="aac5d2c8c5ddeadacfc487cbc4ce87d9ddc5d8ce84c9c584dfc1"
                                        >
                                          [email&nbsp;protected]
                                        </span>
                                      </a>
                                      <br />
                                      Phone: +44 (0)1226 734350
                                      <br />
                                      Fax: +44 (0)1226 734438
                                    </p>
                                    <p>
                                      Trade enquiries should be sent to&nbsp;
                                      <a href="/cdn-cgi/l/email-protection#f3878192979680929f9680b383969dde929d97de80849c8197dd909cdd8698">
                                        <span
                                          className="__cf_email__"
                                          data-cfemail="dca8aebdb8b9afbdb0b9af9cacb9b2f1bdb2b8f1afabb3aeb8f2bfb3f2a9b7"
                                        >
                                          [email&nbsp;protected]
                                        </span>
                                      </a>
                                    ...
                                    <h4>
                                      <br />
                                      For US Sales: Casemate Academic
                                    </h4>
                                    <p>
                                      For all private/individual book order
                                      enquiries and to place an order:
                                      <br />
                                      <br />
                                      Casemate Academic, 1950 Lawrence Road,
                                      Havertown PA 19083
                                      <br />
                                      Email:&nbsp;
                                      <a
                                        href="/cdn-cgi/l/email-protection#7e1d1f0d1b131f0a1b3e1d1f0d1b131f0a1b0e0b1c12170d161b0c0d501d1113"
                                        data-gc-link="mailto:casemate@casematepublishers.com"
                                      >
                                        <span
                                          className="__cf_email__"
                                          data-cfemail="6e0d0f1d0b030f1a0b2e0d0f1d0b030f1a0b1e1b0c02071d060b1c1d400d0103"
                                        >
                                          [email&nbsp;protected]
                                        </span>
                                      </a>
                                      <br />
                                      Phone: 001 610 853 9131
                                      <br />
                                      Fax: 001 610 853 9146
                                      <br />
                                      &nbsp;
                                      <br />
                                      Trade enquiries can also be sent to&nbsp;
                                      <a
                                        href="/cdn-cgi/l/email-protection#72111301171f13061732111301171f1306170207101e1b011a1700015c111d1f"
                                        data-gc-link="mailto:casemate@casematepublishers.com"
                                      >
                                        <span
                                          className="__cf_email__"
                                          data-cfemail="5b383a283e363a2f3e1b383a283e363a2f3e2b2e39373228333e292875383436"
                                        >
                                          [email&nbsp;protected]
                                        </span>
                                      </a>
                                      ...
                                      For more information on trade sales
                                      orders, visit the{" "}
                                      <a href="https://www.oxbowbooks.com/dbbc/trade-sales/">
                                        Oxbow Books website
                                      </a>
                                      .
                                    </p>
...
export default CommercialPress;
