...
const Jobs = () => {
  ...
  useEffect(() => {
    ...
    const category1 = `${categoryPrefix}-59`;
  ...
  useEffect(() => {
    ...
    // Kategoriler dil bazında dinamik olarak ayarlanıyor
    const category1 = `${contentPrefix}-content-53`;
    ...
    <div>
      <div>
        ...
        <meta
          ...
          content="We are always looking for talented people to join us."
        />
        <meta
          property="og:image"
              ...
              <main id="main-content" className="js-main">
                <div>
                  <div
                    ...
                    role="article"
                    aria-labelledby="paragraph-11364-title"
                  >
                        ...
                        <div className="hero__controls">
                          <div className="hero__caption | js-hero-caption">
                            <button
                              ...
                              id="hero-image-caption-button-11364"
                              aria-expanded="false"
                              aria-controls="hero-image-caption-content-11364"
                            >
                            ...
                            <div
                              ...
                              id="hero-image-caption-content-11364"
                              aria-hidden="true"
                              aria-labelledby="hero-image-caption-button-11364"
                            >
                              <button
                                type="button"
                                className="hero__caption-content-close | js-hero-caption-btn"
                                id="hero-image-caption-close-button-11364"
                                aria-expanded="false"
                                aria-controls="hero-image-caption-content-11364"
                              >
                                <span className="visually-hidden">
                          ...
                          <div className="section--intro__info">
                            ...
                            <div className="section--intro__info-slices">
                              <div className="paragraph paragraph--type--info-content paragraph--view-mode--default section--intro__info-content wysiwyg">
                                <p>
                                  Email:&nbsp;
                                  <a href="/cdn-cgi/l/email-protection#25474857404657504c516547574c514c564d4850564050480b4a5742">
                                    <span
                                      className="__cf_email__"
                                      data-cfemail="a7c5cad5c2c4d5d2ced3e7c5d5ced3ced4cfcad2d4c2d2ca89c8d5c0"
                                    >
                                      [email&nbsp;protected]
                                    </span>
                                  </a>
                          ...
                          <div className="section--intro__content">
                            ...
                            <div className="wysiwyg">
                              <p>
                                ...
                                us. From visitor assistants to curators,
                                scientists to administrators and sales
                                assistants to fundraisers, our jobs can involve
                                looking after the collection, visitors or
                                resources.
                                <br />
                                <br />
                                We're committed to equal opportunities and to
                                providing our employees with a work environment
                                free from discrimination in which all can
                                thrive. We recognise and value the benefits of a
                                diverse workforce and we welcome applications
                      ...
                      <div>
                        <div>
                          <section
                            ...
                            aria-labelledby="paragraph-11382-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-11382-title"
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  <h3 className="teaser__title">
                                                    <a
                                                      href="/about-us/jobs/vacancies-visitor-and-security-services-department"
                                                      className="teaser__anchor"
                                                    >
                                                      <span>
                                                        <span>
                                                  ...
                                                  <div className="teaser__summary">
                                                    Find out about job
                                                    opportunities within Visitor
                                                    and Security Services,
                                                    including who we are, roles
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  <h3 className="teaser__title">
                                                    <a
                                                      href="/about-us/working-british-museum/staff-benefits"
                                                      className="teaser__anchor"
                                                    >
                                                      <span>
                                                        <span>
                                  ...
                                  <div className="teaser__wrapper">
                                    ...
                                    <div className="teaser__content">
                                      <div className="teaser__content-push">
                                        ...
                                        <div className="teaser__summary">
                                          Discover how the Museum promotes and
                                          provides access to the collection
                                          through its research departments,
                                          tours and initiatives.
                                        </div>
                                      </div>
                                    </div>
                                  </div>
                                  ...
                                  <div className="teaser__wrapper">
                                    ...
                                    <div className="teaser__content">
                                      <div className="teaser__content-push">
                                        ...
                                        <div className="teaser__summary">
                                          Find opening times, entry, travel and
                                          facilities information and also
