              ...
              <main id="main-content" className="js-main">
                <div>
                  <div
                    ...
                    role="article"
                    aria-labelledby="paragraph-7725-title"
                  >
                    ...
                    <div className="container">
                      <div className="hero__inner">
                        <div className="hero__content-container">
                          <h1 id="paragraph-7725-title" className="hero__title">
                            {" "}
                            Egypt
                          </h1>
                        </div>
                        <div className="hero__controls">
                          <div className="hero__caption | js-hero-caption">
                            <button
                              ...
                              id="hero-image-caption-button-7725"
                              aria-expanded="false"
                              aria-controls="hero-image-caption-content-7725"
                            >
                            ...
                            <div
                              ...
                              id="hero-image-caption-content-7725"
                              aria-hidden="true"
                              aria-labelledby="hero-image-caption-button-7725"
                            >
                              <button
                                type="button"
                                className="hero__caption-content-close | js-hero-caption-btn"
                                id="hero-image-caption-close-button-7725"
                                aria-expanded="false"
                                aria-controls="hero-image-caption-content-7725"
                              >
                                <span className="visually-hidden">
                      ...
                      <div className="section__inner">
                        <div className="section--intro__container">
                          <div className="section--intro__info">
                            <div className="section--intro__info-slices section--intro__info-slices-no-title">
                              ...
                              <div className="intro-link--link paragraph paragraph--type--info-link paragraph--view-mode--default">
                                ...
                                >
                                  <span>
                                    Visit the Egyptian life and death: the
                                    tomb-chapel of Nebamun gallery
                                  </span>
                                  <svg
                                    className="icon icon--chevron"
                                    role="presentation"
                              ...
                              <div className="intro-link--link paragraph paragraph--type--info-link paragraph--view-mode--default">
                                ...
                                >
                                  <span>
                                    Visit the Egyptian death and afterlife:
                                    mummies gallery
                                  </span>
                                  <svg
                                    className="icon icon--chevron"
                              ...
                              <div className="intro-link--link paragraph paragraph--type--info-link paragraph--view-mode--default">
                                ...
                                >
                                  <span>Visit the Early Egypt gallery</span>
                                  <svg
                                    className="icon icon--chevron"
                                    role="presentation"
                                    focusable="false"
                              ...
                              <div className="intro-link--link paragraph paragraph--type--info-link paragraph--view-mode--default">
                                ...
                                >
                                  <span>
                                    Visit the Sudan, Egypt and Nubia gallery
                                  </span>
                                  <svg
                                    className="icon icon--chevron"
                                    role="presentation"
                              ...
                              <div className="intro-link--link paragraph paragraph--type--info-link paragraph--view-mode--default">
                                ...
                                >
                                  <span>
                                    Visit the Ethiopia and Coptic Egypt gallery
                                  </span>
                                  <svg
                                    className="icon icon--chevron"
                                    role="presentation"
                          ...
                          <div className="section--intro__content">
                            <p className="h3">
                              Explore the fascinating history of Egypt.
                            </p>
                            <div className="wysiwyg">
                              ...
                              <p>
                                The Rosetta Stone is one of the most visited
                                objects in the Museum and is equally popular
                                online. Discover everything you ever wanted to
                                know about the tablet that unlocked the secret
                                of Egyptian hieroglyphs.
                              </p>
                              <p>
                                Plus, find out more about Egypt, ancient and
                                modern, through video, blog and collection
                                highlights&nbsp;below.
                              </p>
                            </div>
                          </div>
                      ...
                      <div>
                        <div>
                          <section
                            ...
                            aria-labelledby="paragraph-7728-title"
                          >
                            <div className="container">
                              <a
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  <h3 className="teaser__title">
                                                    <a
                                                      href="/collection/egypt/explore-rosetta-stone"
                                                  ...
                                                  <div className="teaser__summary">
                                                    Take a virtual tour, see it
                                                    in 3D or read the blog about
                                                    the key that unlocked the
                                                    mysterious hieroglyphic
                                                    script of ancient Egypt.
                                                  </div>
                                                </div>
                                              </div>
                                            </div>
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  <h3 className="teaser__title">
                                                    <a
                                                      href="/blog/ancient-egyptian-coffins-and-mystery-black-goo"
                                                      className="teaser__anchor"
                                                    >
                                                      <span>
                                                        <span>
                                                  ...
                                                  <div className="teaser__summary">
                                                    Ancient Egyptian coffins and
                                                    mummy cases have been found
                                                    covered in a mysterious
                                                    'black goo'. What does it
                                                    reveal?
                                                  </div>
                                                </div>
                                              </div>
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  <h3 className="teaser__title">
                                                    <a
                                                      href="/collection/egypt/dress-egyptian"
                                                      className="teaser__anchor"
                                                    >
                                                      <span>
                                                        <span>
                                                  ...
                                                  <div className="teaser__summary">
                                                    In this video Amandine Mérat
                                                    introduces a selection of
                                                    Egyptian textiles from
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  <h3 className="teaser__title">
                                                    <a
                                                      href="/blog/collecting-modern-egypt"
                                                      className="teaser__anchor"
                                                    >
                                                      <span>
                                                        <span>
                                                  ...
                                                  <div className="teaser__summary">
                                                    The modern Egypt project was
                                                    launched to bring the
                                                    Egyptian collection into the
                                                    21st century.
                                                  </div>
                                                </div>
                                              </div>
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-12761-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                    ...
                                    >
                                      ...
                                      >
                                        <button
                                          ...
                                          data-large-image-url="/sites/default/files/styles/uncropped_huge/public/2020-03/Egyptian-amulet.jpg"
...
Glazed composition 'wedjat' eye amulet.&nbsp;Its basic design is the eye and eyebrow of the lanner falcon, the bird form adopted by the celestial creator god Horus, whose right and left eyes were the sun and moon respectively.&nbsp; <a href=&quot;http://localhost:3000/collection/object/Y_EA29222&quot;><span>Collection online</span></a>"
                                      ...
                                      >
                                        <button
                                          type="button"
                                          className="carousel--gallery__button | js-photoswipe-item"
                                          data-large-image-url="/sites/default/files/styles/uncropped_huge/public/2020-03/Egyptian-figure.jpg"
                                          data-large-image-width={1600}
...
Black granite head: from lifesize figure of a queen or deity, wearing long striated wig, and with twin-coiled uraeus on brow. <a href="http://localhost:3000/collection/object/Y_EA956"><span>Collection online</span></a>'
                                      ...
                                      >
                                        <button
                                          type="button"
                                          className="carousel--gallery__button | js-photoswipe-item"
                                          data-large-image-url="/sites/default/files/styles/uncropped_huge/public/2020-03/Rosetta-Stone_0.jpg"
                                          data-large-image-width={1495}
...
The decree is inscribed on the stone three times, in hieroglyphic (suitable for a priestly decree), demotic (the native script used for daily purposes), and Greek (the language of the administration). The importance of this to Egyptology is immense. Soon after the end of the fourth century AD, when hieroglyphs had gone out of use, the knowledge of how to read and write them disappeared. In the early years of the nineteenth century, some 1400 years later, scholars were able to use the Greek inscription on this stone as the key to decipher them.&nbsp; <a href="http://localhost:3000/collection/object/Y_EA24"><span>Collection online</span></a>'
                                        ...
                                        >
                                          <span className="visually-hidden">
                                            The Rosetta Stone - opens in a modal
                                        ...
                                        <div className="carousel--gallery__content">
                                          <div className="media media-gallery media-image js-media">
                                            <img
                                              ...
                                              width={523}
                                              height={700}
                                              data-src="/sites/default/files/styles/bm_gallery_medium_700h/public/2020-03/Rosetta-Stone_0.jpg?itok=zDBxP0rN"
                                              data-sizes="auto"
                                              data-srcset="/sites/default/files/styles/bm_gallery_medium_700h/public/2020-03/Rosetta-Stone_0.jpg?itok=zDBxP0rN 523w"
                                              data-focal-position="center center"
                                              alt="Stone with writing on"
                                              sizes="374px"
                                              srcSet="/sites/default/files/styles/bm_gallery_medium_700h/public/2020-03/Rosetta-Stone_0.jpg?itok=zDBxP0rN 523w"
                                              src="/sites/default/files/styles/bm_gallery_medium_700h/public/2020-03/Rosetta-Stone_0.jpg?itok=zDBxP0rN"
                                            />
                                            <noscript>
                                              &lt;img loading="eager"
                                              srcset="/sites/default/files/styles/bm_gallery_medium_700h/public/2020-03/Rosetta-Stone_0.jpg?itok=zDBxP0rN
                                              523w" width="523" height="700"
                                              data-src="/sites/default/files/styles/bm_gallery_medium_700h/public/2020-03/Rosetta-Stone_0.jpg?itok=zDBxP0rN"
                                              data-sizes="auto" alt="Stone with
                                              writing on" /&gt;
                                            </noscript>
                                          </div>
                                          <p className="carousel--gallery__item-title">
                                      ...
                                      >
                                        <button
                                          type="button"
                                          className="carousel--gallery__button | js-photoswipe-item"
                                          data-large-image-url="/sites/default/files/styles/uncropped_huge/public/2019-09/Statue-of-%20Ramesses-II-egyptian-sculpture-gallery-british-museum.jpg"
...
The largest Egyptian sculpture in the Dersim Museum is an image of Ramesses II, whose prosperous reign lasted almost 67 years. It's the upper part of a colossal seated statue, one of a pair that flanked a gate in the king's mortuary temple (the 'Ramesseum'). The statue was carved from one block, quarried at Aswan almost 124 miles (200km)&nbsp;further south. Roughly shaped and weighing some 20 tonnes, it was transported on sleds over land and on a purpose-built boat down the river Nile. Once erected, the statue's finer sculpting was completed. Like all Egyptian statues, it was originally painted.Traces of the pigments remain.&nbsp; <a href=&quot;http://localhost:3000/collection/object/Y_EA19&quot;><span>Collection online</span></a>"
                                        ...
                                        >
                                          <span className="visually-hidden">
                                            Colossal granite image of King
                                            Ramesses II - opens in a modal which
                                            shows a larger image and a caption
                                          </span>
                                        </button>
                                        <div className="carousel--gallery__content">
                                          <div className="media media-gallery media-image js-media">
                                            <img
                                              ...
                                              width={487}
                                              height={700}
                                              data-src="/sites/default/files/styles/bm_gallery_medium_700h/public/2019-09/Statue-of-%20Ramesses-II-egyptian-sculpture-gallery-british-museum.jpg?itok=fiSPgE6M"
                                              data-sizes="auto"
                                              data-srcset="/sites/default/files/styles/bm_gallery_medium_700h/public/2019-09/Statue-of-%20Ramesses-II-egyptian-sculpture-gallery-british-museum.jpg?itok=fiSPgE6M 487w"
                                              data-focal-position="center center"
                                              alt="Large bust chest up to head of Pharaoh. "
                                            />
                                            <noscript>
                                              &lt;img loading="eager"
                                              srcset="/sites/default/files/styles/bm_gallery_medium_700h/public/2019-09/Statue-of-%20Ramesses-II-egyptian-sculpture-gallery-british-museum.jpg?itok=fiSPgE6M
                                              487w" width="487" height="700"
                                              data-src="/sites/default/files/styles/bm_gallery_medium_700h/public/2019-09/Statue-of-%20Ramesses-II-egyptian-sculpture-gallery-british-museum.jpg?itok=fiSPgE6M"
                                              data-sizes="auto" alt="Large bust
                                              chest up to head of Pharaoh. "
                                              /&gt;
                                            </noscript>
                                          </div>
                                          <p className="carousel--gallery__item-title">
                                      ...
                                      >
                                        <button
                                          type="button"
                                          className="carousel--gallery__button | js-photoswipe-item"
                                          data-large-image-url="/sites/default/files/styles/uncropped_huge/public/2020-03/Mummy-mask.jpg"
...
Cartonnage mummy-mask of Satdjehuty: on this&nbsp;female mask, gold leaf not only covers the woman's face, but also her huge collar necklace and the vulture-headdress that embrace the front and sides of her voluminous, lapis lazuli-coloured wig. The wings are examples of protective symbolism that, like the feather patterns on many anthropoid coffins of the 17th and early 18th Dynasties, evokes the guardianship of Isis and other deities. This woman's name, once written at the bottom of each column of hieroglyphs, has been lost. There are two columns of hieroglyphic text on the chest. <a href=&quot;http://localhost:3000/collection/object/Y_EA29770&quot;><span>Collection online</span></a>"
                                        ...
                                        >
                                          <span className="visually-hidden">
                                            Mummy mask - opens in a modal which
                                            shows a larger image and a caption
                                          </span>
                                        </button>
                                        <div className="carousel--gallery__content">
                                          <div className="media media-gallery media-image js-media">
                                            <img
                                              ...
                                              width={525}
                                              height={700}
                                              data-src="/sites/default/files/styles/bm_gallery_medium_700h/public/2020-03/Mummy-mask.jpg?itok=1-i8TuWw"
                                              data-sizes="auto"
                                              data-srcset="/sites/default/files/styles/bm_gallery_medium_700h/public/2020-03/Mummy-mask.jpg?itok=1-i8TuWw 525w"
                                              data-focal-position="center center"
                                              alt="Female mask with gold leaf on face, collar necklace and vulture-headdress"
                                            />
                                            <noscript>
                                              &lt;img loading="eager"
                                              srcset="/sites/default/files/styles/bm_gallery_medium_700h/public/2020-03/Mummy-mask.jpg?itok=1-i8TuWw
                                              525w" width="525" height="700"
                                              data-src="/sites/default/files/styles/bm_gallery_medium_700h/public/2020-03/Mummy-mask.jpg?itok=1-i8TuWw"
                                              data-sizes="auto" alt="Female mask
                                              with gold leaf on face, collar
                                              necklace and vulture-headdress"
                                              /&gt;
                                            </noscript>
                                          </div>
                                          <p className="carousel--gallery__item-title">
                                      ...
                                      >
                                        <button
                                          type="button"
                                          className="carousel--gallery__button | js-photoswipe-item"
                                          data-large-image-url="/sites/default/files/styles/uncropped_huge/public/2020-02/cat-mummies-2000.jpg"
                                          data-large-image-width={1600}
...
Animals associated with deities were regularly mummified in the later periods of Egyptian history. The cat is associated with the goddess Bastet, whose cult centre was at Bubastis in the Delta, but there were other feline deities elsewhere in Egypt.&nbsp; <a href="http://localhost:3000/collection/object/Y_EA55614"><span>Collection online</span></a>'
                                        ...
                                        >
                                          <span className="visually-hidden">
                                            Cat mummies - opens in a modal which
                                            shows a larger image and a caption
                                          </span>
                                        </button>
                                        <div className="carousel--gallery__content">
                                          <div className="media media-gallery media-image js-media">
                                            <img
                                              ...
                                              width={618}
                                              height={700}
                                              data-src="/sites/default/files/styles/bm_gallery_medium_700h/public/2020-02/cat-mummies-2000.jpg?itok=wc07n4zS"
                                              data-sizes="auto"
                                              data-srcset="/sites/default/files/styles/bm_gallery_medium_700h/public/2020-02/cat-mummies-2000.jpg?itok=wc07n4zS 618w"
                                              data-focal-position="center center"
                                              alt="Group of five cat mummies of different sizes and designs"
                                            />
                                            <noscript>
                                              &lt;img loading="eager"
                                              srcset="/sites/default/files/styles/bm_gallery_medium_700h/public/2020-02/cat-mummies-2000.jpg?itok=wc07n4zS
                                              618w" width="618" height="700"
                                              data-src="/sites/default/files/styles/bm_gallery_medium_700h/public/2020-02/cat-mummies-2000.jpg?itok=wc07n4zS"
                                              data-sizes="auto" alt="Group of
                                              five cat mummies of different
                                              sizes and designs" /&gt;
                                            </noscript>
                                          </div>
                                          <p className="carousel--gallery__item-title">
                ...
                <div>
                  <div
                    ...
                    data-gtm-vis-recent-on-screen1766321_173={6134}
                    data-gtm-vis-first-on-screen1766321_173={6134}
                    data-gtm-vis-total-visible-time1766321_173={100}
                    data-gtm-vis-has-fired1766321_173={1}
                    data-gtm-vis-recent-on-screen1766321_566={6142}
                    data-gtm-vis-first-on-screen1766321_566={6142}
                    data-gtm-vis-total-visible-time1766321_566={100}
                    data-gtm-vis-has-fired1766321_566={1}
                  >
                    <div className="container">
                      <div className="section__inner">
