...
const Research = () => {
  ...
  useEffect(() => {
    const category1 = "Explore our work";
    const category2 = "Research resources";
  ...
  useEffect(() => {
    const someContentId = "67af228c8b2864c833c09924";
    ...
    <div>
      <div>
        ...
        <meta
          ...
          content="Discover the breadth of our research, the wide range of related publications, and learn about our research studentships."
        />
        <meta
          property="og:image"
              ...
              <main id="main-content" className="js-main">
                <div>
                  <div
                    ...
                    role="article"
                    aria-labelledby="paragraph-8398-title"
                  >
                    ...
                    <div className="container">
                      <div className="hero__inner">
                        <div className="hero__content-container">
                          ...
                          {/* <h1 id="paragraph-8398-title" className="hero__title">
                            {" "}
                            Research
                          </h1> */}
                        </div>
                        <div className="hero__controls">
                          <div className="hero__caption | js-hero-caption">
                            <button
                              ...
                              id="hero-image-caption-button-8398"
                              aria-expanded="false"
                              aria-controls="hero-image-caption-content-8398"
                            >
                            ...
                            <div
                              ...
                              id="hero-image-caption-content-8398"
                              aria-hidden="true"
                              aria-labelledby="hero-image-caption-button-8398"
                            >
                              <button
                                type="button"
                                className="hero__caption-content-close | js-hero-caption-btn"
                                id="hero-image-caption-close-button-8398"
                                aria-expanded="false"
                                aria-controls="hero-image-caption-content-8398"
                              >
                                <span className="visually-hidden">
                              ...
                              <p>
                                {" "}
                                Multi-spectral imaging of anthropoid wooden
                                outer coffin of Nestawedjat, Lady of the House,
                                daughter of Djedmutiufankh,&nbsp;700–680 BC.
                                Nicky Newman (Senior Conservator Organics)
                                on-camera with Joanne Dyer (Scientist)
                                observing.&nbsp;
                              </p>
                            </div>
                          </div>
                      ...
                      <div className="section__inner">
                        <div className="section--intro__container">
                          <div className="section--intro__info">
                            ...
                            <div className="section--intro__info-slices">
                              <div className="paragraph paragraph--type--info-content paragraph--view-mode--default section--intro__info-content wysiwyg">
                                <p>
                                  Email:{" "}
                                  <a href="/cdn-cgi/l/email-protection#fbb9b6a99e889e9a899893bb9989928f928893968e889e8e96d594899c">
                                    <span
                                      className="__cf_email__"
                                      data-cfemail="8ae8e7f8eff9efebf8e9e2cae8f8e3fee3f9e2e7fff9efffe7a4e5f8ed"
                                    >
                                      [email&nbsp;protected]
                                    </span>
                                  </a>
                              ...
                              <div className="intro-link--button paragraph paragraph--type--info-link paragraph--view-mode--default">
                                <a
                                  data-tracking="cta"
                                  className="button button--chevron"
                                  href="https://britishmuseum.iro.bl.uk/"
                                >
                                  <span>
                                    Explore our digital publications repository
                                  </span>
                                </a>
                              </div>
                            </div>
                          ...
                          <div className="section--intro__content">
                            ...
                            {/* <p className="h3">
                              Research at the Museum drives the care, display
                              and understanding of the collection.
                            </p>
                            <div className="wysiwyg">
                              <p>
                                Museum staff carry out research all over the
                                world, challenging existing concepts of the
                                past, through new and collaborative forms of
                                knowledge creation and using cutting edge
                                technology. Research projects cover a wide
                                variety of academic disciplines and can involve
                                archaeological excavation, studies of museum
                                collections, working with craftspeople,
                                understanding our visitors, conservation and
                                scientific investigations.
                              </p>
                              <p>
                                Our research depends on partnerships and
                                collaborations across the world and throughout
                                the United Kingdom. Spanning two million years
                                of global history, all of our research starts
                                with objects – things that people have made and
                                used – from ancient flint tools found at the
                                oldest ancient human site in Northern Europe to
                                contemporary Middle Eastern art, helping people
                                to learn, understand and be inspired by human
                                history.&nbsp;
                              </p>
                            </div> */}
                          </div>
                      ...
                      <div>
                        <div>
                          <section
                            ...
                            aria-labelledby="paragraph-8617-title"
                          >
                            <div className="container">
                              <a
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  ...
                                                  <div className="teaser__summary">
                                                    From uncovering ancient
                                                    civilisations to developing
                                                    cutting edge conservation
                                                    methods, discover the
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  <h3 className="teaser__title">
                                                    <a
                                                      href="/research/research-strategy-and-governance"
                                                      className="teaser__anchor"
                                                    >
                                                      <span>
                                                        <span>
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  <h3 className="teaser__title">
                                                    <a
                                                      href="/research/research-students"
                                                      className="teaser__anchor"
                                                    >
                                                      <span>
                                                        <span>
                          ...
                          {/* <section
                            className="paragraph paragraph--type--slice-teaser paragraph--view-mode--default section section--slice-teaser section--z-index-scope section--has-carousel section--bg-white"
                            aria-labelledby="paragraph-14060-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-14060-title"
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  <h3 className="teaser__title">
                                                    <a
                                                      href="/our-work/departments/collection-care/conservation"
                                                      className="teaser__anchor"
                                                    >
                                                      <span>
                                                        <span>
                                                  ...
                                                  <div className="teaser__summary">
                                                    ...
                                                    and innovative new
                                                    conservation techniques, our
                                                    conservators preserve the
                          ...
                          <section
                            className="paragraph paragraph--type--slice-teaser paragraph--view-mode--default section section--slice-teaser section--z-index-scope section--has-carousel section--bg-white"
                            aria-labelledby="paragraph-14216-title"
                          >
                            <div className="container">
                              <a
                                className="js-jump-link-anchor"
