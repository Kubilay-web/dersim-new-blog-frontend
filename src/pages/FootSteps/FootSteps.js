  ...
  return (
    <div>
      <div>
        ...
        <meta
          name="description"
          content="Discover key Silk Roads cities across Central Asia – and win a once-in-a-lifetime holiday."
        />
        <link
          rel="canonical"
        ...
        <meta
          property="og:title"
          content="In the footsteps of history: travelling the Silk Roads today"
        />
        <meta
        ...
        <meta
          property="og:image"
          content="/images/FootSteps/Registan%20sunrise%201920x1080_2.jpg"
        />
        ...
        <title>
          In the footsteps of history: travelling the Silk Roads today | British
          Museum
        </title>
        ...
        <link
          ...
          sizes="180x180"
          href="/images/FootSteps/apple-touch-icon.png"
        />
        <link
          rel="icon"
          type="image/png"
          href="/images/FootSteps/favicon-32x32.png"
          sizes="32x32"
        />
        <link
          rel="icon"
          type="image/png"
          href="/images/FootSteps/favicon-16x16.png"
          sizes="16x16"
        />
        <link rel="manifest" href="/site.webmanifest" />
        <link
          rel="mask-icon"
          href="/images/FootSteps/safari-pinned-tab.svg"
          color="#5bbad5"
        />
              ...
              <main id="main-content" className="js-main">
                <div>
                  <div
                    ...
                    role="article"
                    aria-labelledby="paragraph-42058-title"
                  >
                    <div className="hero__background">
                      <div className="media media-hero media-image js-media">
                        <picture>
                          ...
                          <source
                            srcSet="/images/FootSteps/Registan%20sunrise%201920x1080_1.jpg 1x"
                          ...
                          />
                          <source
                            srcSet="/images/FootSteps/Registan%20sunrise%201920x1080_2.jpg 1x"
                          ...
                          />
                          <source
                            srcSet="/images/FootSteps/Registan%20sunrise%201920x1080_6.jpg 1x"
                          ...
                          <img
                            ...
                            src="/images/FootSteps/Registan%20sunrise%201920x1080.jpg"
                    ...
                    <div className="container">
                      <div className="hero__inner">
                        <div className="hero__content-container">
                          <h1
                            id="paragraph-42058-title"
                            className="hero__title hero__title--small"
                          >
                            {" "}
                            In the footsteps of history: travelling the Silk
                            Roads today
                          </h1>
                        </div>
                        <div className="hero__controls">
                          <div className="hero__caption | js-hero-caption">
                            <button
                              ...
                              id="hero-image-caption-button-42058"
                              aria-expanded="false"
                              aria-controls="hero-image-caption-content-42058"
                            >
                            ...
                            <div
                              ...
                              id="hero-image-caption-content-42058"
                              aria-hidden="true"
                              aria-labelledby="hero-image-caption-button-42058"
                            >
                              <button
                                type="button"
                                className="hero__caption-content-close | js-hero-caption-btn"
                                id="hero-image-caption-close-button-42058"
                                aria-expanded="false"
                                aria-controls="hero-image-caption-content-42058"
                              >
                                <span className="visually-hidden">
                              ...
                              <p>
                                {" "}
                                The Registan square by day – the heart of
                                Samarkand. Photo: Wild Frontiers.
                              </p>
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="section__inner">
                        <div className="section--intro__container">
                            ...
                            <div className="section--intro__info-slices section--intro__info-slices-no-title">
                              <div className="paragraph paragraph--type--info-author paragraph--view-mode--default section--intro__info-author">
                                <div className="author__item_wrapper">
                                  ...
                                  <div>Publication date: 1 November 2024</div>
                                </div>
                              </div>
                            </div>
                          </div>
                          <div className="section--intro__content">
                            <p className="h3">
                              From buzzing capitals to snow-capped peaks, join
                              us as we journey between Silk Roads hot spots
                              across Central Asia – plus, win the chance to
                              visit these incredible locations on a
                            ...
                            <div className="wysiwyg">
                              <p>
                                ...
                                from about AD 500 to 1000, a time that witnessed
                                significant leaps in connectivity and the rise
                                of major religions. But what are these hubs of
                                cultural exchange like today? We asked adventure
                                travel experts,{" "}
                                <a href="https://www.wildfrontierstravel.com/en_GB">
                                  Wild Frontiers
                                </a>
                                , to take us on a tour of some key Silk Roads
                                cities in Central Asia, stopping along the way
                                to share top travel tips. Read on for a
                                historical travel guide – and for your chance to
                                win a holiday to Uzbekistan and see these places
                                for yourself.
                              </p>
                            </div>
                          </div>
                      ...
                      <div>
                        <div>
                          <section
                            ...
                            aria-labelledby="paragraph-42060-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-42060-title"
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      Samarkand (Samarqand in Uzbek) has a
                                      history dating back 2,700 years, making it
                                      one of the oldest cities in Central Asia.
                                      It was the capital of the late Timurid
                                      empire created by Tamerlane (or Amir Temur
                                      in Uzbek) (1336–1405), and later his
                                      grandson Ulugbek (1394–1449) established a
                                      centre for science and astronomy there in
                                      the 15th century.
                                    </p>
                                    <div
                                      data-entity-type="media"
                                      data-entity-uuid="fc9dca35-daa2-47a9-bae7-fa575c6210cc"
                                    ...
                                    >
                                      <figure className="media media-embed media-image js-media">
                                        <img
                                          ...
                                          srcSet="/images/FootSteps/Registan%20sunrise%201920x1080_5.jpg 400w, /images/FootSteps/Registan%20sunrise%201920x1080_3.jpg 750w, /images/FootSteps/Registan%20sunrise%201920x1080_4.jpg 1000w, /images/FootSteps/Registan%20sunrise%201920x1080_2.jpg 1300w, /images/FootSteps/Registan%20sunrise%201920x1080_1.jpg 1600w"
                                          sizes="100vw"
                                          width={1600}
                                          height={900}
                                          src="/images/FootSteps/Registan%20sunrise%201920x1080_1.jpg"
                                          alt="View of buildings in Samarkand with a sunset behind "
                                        />
                                        <figcaption>
                                          The Registan square by day – the heart
                                          of Samarkand. Photo: Wild Frontiers.
                                        </figcaption>
                                      </figure>
                                    </div>
                                    <p>
                                      ...
                                      <br />
                                      Samarkand sits on the banks of the
                                      Zeravshan River, in southeastern
                                      Uzbekistan, and is one of the most popular
                                      Silk Road cities with modern visitors. A
                                      vast and ancient city, it hosts some of
                                      the most magnificent architecture in the
                                      Islamic world with mosques, mausoleums,
                                      madrassahs, minarets and mosaics lining
                                      the streets. Visit the iconic Registan
                                      square which, by day, is filled with
                                      traders, ice cream sellers, and craft
                                      shops playing music. Stick around until
                                      the evening for a light and sound show
                                      that illuminates the sparkling mosaics for
                                      a captivating spectacle.
                                    </p>
                                    <p>
                                      To the northeast of the modern town,
                                      you'll find Afrasiab, the site of the
                                      oldest parts of the city, from where the
                                      masters of Silk Roads trade, the Sogdians,
                                      ruled from around 700 BC to AD 750. Today
                                      it can be found next to the Afrasiab
                                      Museum of Samarkand, which is surrounded
                                      by a grassy landscape near the Bibi Khanum
                                      Mosque. The original mosque was completed
                                      in 1404 – though it was later destroyed in
                                      an earthquake in 1897 and then rebuilt in
                                      the 1970s.
                                    </p>
                                    <div
                                      data-entity-type="media"
                                      data-entity-uuid="1e995970-b933-462d-9167-c424b53d27e1"
                                      data-embed-button="media"
                                      data-entity-embed-display="view_mode:media.embed"
                                      data-langcode="en"
                                      data-entity-embed-display-settings="[]"
                                    ...
                                    >
                                      <figure className="media media-embed media-image js-media">
                                        <img
                                          loading="eager"
                                          className="lazyload not-full-width"
                                          srcSet="/images/FootSteps/Bibi%20Khanum%20Mosque%201920x1080_4.jpg 400w, /images/FootSteps/Bibi%20Khanum%20Mosque%201920x1080_3.jpg 750w, /images/FootSteps/Bibi%20Khanum%20Mosque%201920x1080_1.jpg 1000w, /images/FootSteps/Bibi%20Khanum%20Mosque%201920x1080_2.jpg 1300w, /images/FootSteps/Bibi%20Khanum%20Mosque%201920x1080.jpg 1600w"
                                          sizes="100vw"
                                          width={1600}
                                          height={900}
                                          src="/images/FootSteps/Bibi%20Khanum%20Mosque%201920x1080.jpg"
                                          alt="Looking towards the Bibi Khanum Mosque"
                                        />
                                        <figcaption>
                                          Bibi Khanum Mosque was the largest of
                                          its kind in Central Asia and could
                                          hold up to 10,000 worshippers. Photo:
                                          Wild Frontiers.
                                        </figcaption>
                                      </figure>
                                    </div>
                                    <p>
                                      <strong>Travel tip:</strong> Unravel the
                                      wonders of handmade silk clothing at
                                      Valentina Romanenko's studio. The products
                                      on offer are a blend of ancient costumes,
                                      traditional Uzbek <em>suzane </em>
                                      (hand-embroidered textiles), and silk
                                      evening dresses.
                                    </p>
                                  </div>
                                </div>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-42061-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-42061-title"
                                  className="section__title section--slice-content__title"
                                >
                                  Tashkent
                                </h2>
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      Tashkent (Toshkent in Uzbek) is the
                                      capital of and largest city in Uzbekistan.
                                      It is one of the most populous cities in
                                      Central Asia and the major economic,
                                      political, and cultural centre of the
                                      republic. Tashkent's history spans two
                                      millennia, although few monuments from
                                      ancient times have survived. Among the
                                      survivors are the 16th-century Ko'kaldosh
                                      Madrassah, the 14th- to 15th-century
                                      Sheikhantaur Ensemble and the Hazrati-Imam
                                      Complex (dating back to the 16th century).
                                    </p>
                                    <div
                                      data-entity-type="media"
                                      data-entity-uuid="575fa445-c5f7-48a9-adbd-93cd92842e21"
                                      data-embed-button="media"
                                      data-entity-embed-display="view_mode:media.embed"
                                      data-langcode="en"
                                      data-entity-embed-display-settings="[]"
                                    ...
                                    >
                                      <figure className="media media-embed media-image js-media">
                                        <img
                                          loading="eager"
                                          className="lazyload not-full-width"
                                          srcSet="/images/FootSteps/Ko%E2%80%99kaldosh%20Madrassah%201920x1080_4.jpg 400w, /images/FootSteps/Ko%E2%80%99kaldosh%20Madrassah%201920x1080_3.jpg 750w, /images/FootSteps/Ko%E2%80%99kaldosh%20Madrassah%201920x1080_2.jpg 1000w, /images/FootSteps/Ko%E2%80%99kaldosh%20Madrassah%201920x1080_1.jpg 1300w, /images/FootSteps/Ko%E2%80%99kaldosh%20Madrassah%201920x1080.jpg 1600w"
                                          sizes="100vw"
                                          width={1600}
                                          height={900}
                                          src="/images/FootSteps/Ko%E2%80%99kaldosh%20Madrassah%201920x1080.jpg"
                                          alt="Courtyard at the Ko'kaldosh Madrassah"
                                        />
                                        <figcaption>
                                          Ko'kaldosh Madrassah, built around
                                          1570 still stands near the Chorsu
                                          Bazaar in the Old City. Photo: Wild
                                          Frontiers.
                                        </figcaption>
                                      </figure>
                                    </div>
                                    <p>
                                      ...
                                      <br />
                                      After a disastrous earthquake in 1966,
                                      Tashkent was almost completely rebuilt.
                                      Modern apartment houses, new architectural
                                      complexes, administrative buildings and
                                      theatres decorated with traditional
                                      tilework make Tashkent a beautiful,
                                      fascinating city, with a modern (and
                                      striking) metro system that makes it easy
                                      to explore.
                                    </p>
                                    <div
                                      data-entity-type="media"
                                      data-entity-uuid="828541d0-0b81-4fbf-b825-6bfe4a6655ee"
                                      data-embed-button="media"
                                      data-entity-embed-display="view_mode:media.embed"
                                      data-langcode="en"
                                      data-entity-embed-display-settings="[]"
                                    ...
                                    >
                                      <figure className="media media-embed media-image js-media">
                                        <img
                                          loading="eager"
                                          className="lazyload not-full-width"
                                          srcSet="/images/FootSteps/tashkentmetro%201000x675_3.jpg 400w, /images/FootSteps/tashkentmetro%201000x675_2.jpg 750w, /images/FootSteps/tashkentmetro%201000x675_1.jpg 1000w"
                                          sizes="100vw"
                                          width={1000}
                                          height={675}
                                          src="/images/FootSteps/tashkentmetro%201000x675.jpg"
                                          alt="Platform on the Tashkent metro with a highly decorated ceiling."
                                        />
                                        <figcaption>
                                          Established in 1977, Tashkent's metro
                                          system has 50 stations, each with
                                          their own theme, reflected in the
                                          decoration. Photo: Wild Frontiers.
                                        </figcaption>
                                      </figure>
                                    </div>
                                    <p>
                                      <strong>Travel tip:</strong> Visit
                                      Rakhimov's Ceramic Studio in the ancient
                                      district, established by Mukhitdin
                                      Rakhimov, a famous craftsman, scientist
                                      and researcher in the field of ancient
                                      ceramics. His work is continued by his
                                      son, Akbar Rakhimov, and his grandson,
                                      Alisher.
                                    </p>
                                  </div>
                                </div>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-42062-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-42062-title"
                                  className="section__title section--slice-content__title"
                                >
                                  Bukhara
                                </h2>
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      Bukhara also has ancient origins and was a
                                      major staging point on the Silk Roads,
                                      acting as a perfect rest stop. By about AD
                                      500, it was already an important centre,
                                      defended by a citadel that still stands to
                                      this day. Located about 40km to the west
                                      of Bukhara, the ruins of Varakhsha are a
                                      UNESCO site and popular tourist spot.
                                      Bukhara is also the site of the Ark
                                      Fortress or 'Ark of Bukhara', the
                                      impressive residence of the former Emirs
                                      of Bukhara, which was built around the
                                      fifth century AD.
                                    </p>
                                    <div
                                      data-entity-type="media"
                                      data-entity-uuid="f3d8d225-bd18-4f7c-84c2-3965a97c4abe"
                                      data-embed-button="media"
                                      data-entity-embed-display="view_mode:media.embed"
                                      data-langcode="en"
                                      data-entity-embed-display-settings="[]"
                                    ...
                                    >
                                      <figure className="media media-embed media-image js-media">
                                        <img
                                          loading="eager"
                                          className="lazyload not-full-width"
                                          srcSet="/images/FootSteps/ark%20of%20Bukhara%201000x650_3.jpg 400w, /images/FootSteps/ark%20of%20Bukhara%201000x650_2.jpg 750w, /images/FootSteps/ark%20of%20Bukhara%201000x650_1.jpg 1000w"
                                          sizes="100vw"
                                          width={1000}
                                          height={650}
                                          src="/images/FootSteps/ark%20of%20Bukhara%201000x650.jpg"
                                          alt="Fortified walls of the Ark of Bukhara"
                                        />
                                        <figcaption>
                                          The Ark of Bukhara still stands today
                                          and houses a museum exploring the
                                          history of the building. Photo: Wild
                                          Frontiers.
                                        </figcaption>
                                      </figure>
                                    </div>
                                    <p>
                                      ...
                                      <br />
                                      Modern Bukhara is filled with bazaars and
                                      labyrinthine alleyways – and provides
                                      ample opportunities to meet the locals and
                                      discover a thriving and diverse craft
                                      scene. The central square of this relaxed
                                      town is a great place to grab a drink and
                                      people-watch.
                                    </p>
                                    <div
                                      data-entity-type="media"
                                      data-entity-uuid="81b771e3-30c5-479a-b6ef-0847dce8e03a"
                                      data-embed-button="media"
                                      data-entity-embed-display="view_mode:media.embed"
                                      data-langcode="en"
                                      data-entity-embed-display-settings="[]"
                                    ...
                                    >
                                      <figure className="media media-embed media-image js-media">
                                        <img
                                          loading="eager"
                                          className="lazyload not-full-width"
                                          srcSet="/images/FootSteps/Bukhara%201000x1200_3.jpg 400w, /images/FootSteps/Bukhara%201000x1200_2.jpg 750w, /images/FootSteps/Bukhara%201000x1200_1.jpg 1000w"
                                          sizes="100vw"
                                          width={1000}
                                          height={1200}
                                          src="/images/FootSteps/Bukhara%201000x1200.jpg"
                                          alt="A display of rugs in Bukhara"
                                        />
                                        <figcaption>
                                          Explore pieces of incredible
                                          craftmanship in Bukhara and return
                                          with some unique treasures. Photo:
                                          Wild Frontiers.
                                        </figcaption>
                                      </figure>
                                    </div>
                                    <p>
                                      <strong>Did you know?</strong> Puppetry
                                      has been a tradition in Central Asia since
                                      the first century AD. Discover Bukhara's
                                      traditional puppet-making scene and visit
                                      the 16th-century Ko'kaldosh Madrassah
                                      puppet theatre for a performance.&nbsp;
                                    </p>
                                  </div>
                                </div>
                              </div>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-42063-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-42063-title"
                                  className="section__title section--slice-content__title"
                                >
                                  Tajikistan
                                </h2>
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      Rugged and mountainous, Tajikistan is the
                                      smallest of the Central Asian countries.
                                      Dominated by the towering peak of Ismoil
                                      Somoni (7,495m), this magnificent
                                      landscape has been inhabited since
                                      prehistoric times. The lush valleys that
                                      make up its northern and southern fringes
                                      have seen few visitors during the last
                                      century, but the area is growing in
                                      popularity due to its unspoilt natural
                                      wonders, hiking opportunities and rich
                                      cultural history.
                                    </p>
                                    <div
                                      data-entity-type="media"
                                      data-entity-uuid="f4356310-4ca5-44e1-9c55-f91013c3d1dd"
                                      data-embed-button="media"
                                      data-entity-embed-display="view_mode:media.embed"
                                      data-langcode="en"
                                      data-entity-embed-display-settings="[]"
                                    ...
                                    >
                                      <figure className="media media-embed media-image js-media">
                                        <img
                                          loading="eager"
                                          className="lazyload not-full-width"
                                          srcSet="/images/FootSteps/FannMountains%201000x675_3.jpg 400w, /images/FootSteps/FannMountains%201000x675_1.jpg 750w, /images/FootSteps/FannMountains%201000x675_2.jpg 1000w"
                                          sizes="100vw"
                                          width={1000}
                                          height={675}
                                          src="/images/FootSteps/FannMountains%201000x675.jpg"
                                          alt="A blue lake in front of snow-capped mountains"
                                        />
                                        <figcaption>
                                          The beautiful Fann Mountains in
                                          Tajikistan are a hiker's dream. Photo:
                                          Wild Frontiers.
                                        </figcaption>
                                      </figure>
                                    </div>
                                    <p>
                                      ...
                                      <br />
                                      Today, the routes that made up the old
                                      Silk Roads wind their way through some of
                                      the country's most spectacular scenery,
                                      providing an opportunity to retrace Marco
                                      Polo's footsteps across the Pamir Plateau.
                                      Don't miss the epic road journey along the
                                      Pamir Highway, which goes from the Kyrgyz
                                      border near Karakul Lake to the city of
                                      Khorog, and on to the capital of Dushanbe.
                                      Or check out the turquoise waters of
                                      Margazor Lakes, the Zarafshan River and
                                      legendary Iskandar Kul lake, and the
                                      natural beauty of the Fann Mountains.
                                    </p>
                                    <div
                                      data-entity-type="media"
                                      data-entity-uuid="4a3e1258-4fa3-47c1-84fa-b583254b2d05"
                                      data-embed-button="media"
                                      data-entity-embed-display="view_mode:media.embed"
                                      data-langcode="en"
                                      data-entity-embed-display-settings="[]"
                                    ...
                                    >
                                      <figure className="media media-embed media-image js-media">
                                        <img
                                          loading="eager"
                                          className="lazyload not-full-width"
                                          srcSet="/images/FootSteps/Pamir%20Highway%201000x550_1.jpg 400w, /images/FootSteps/Pamir%20Highway%201000x550_3.jpg 750w, /images/FootSteps/Pamir%20Highway%201000x550_2.jpg 1000w"
                                          sizes="100vw"
                                          width={1000}
                                          height={550}
                                          src="/images/FootSteps/Pamir%20Highway%201000x550.jpg"
                                          alt="Long straight road heading towards snow-capped mountains"
                                        />
                                        <figcaption>
                                          The majestic Pamir Highway is the one
                                          of the highest international highways
                                          in the world and will take your breath
                                          away – quite literally! Photo: Wild
                                          Frontiers.
                                        </figcaption>
                                      </figure>
                                    </div>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-42066-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-42066-title"
                                  className="section__title section--slice-content__title"
                                >
                                  Panjikent
                                </h2>
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      Head to the city of Panjikent to
                                      understand why Tajikistan is a destination
                                      that promises to ignite a real sense of
                                      discovery. From remarkable archaeological
                                      ruins and fascinating museums to buzzing
                                      bazaars, step back in time at this
                                      beautifully preserved historical site.
                                    </p>
                                    <div
                                      data-entity-type="media"
                                      data-entity-uuid="b3b12384-6efa-4706-aa36-0f03153d1899"
                                      data-embed-button="media"
                                      data-entity-embed-display="view_mode:media.embed"
                                      data-langcode="en"
                                      data-entity-embed-display-settings="[]"
                                    ...
                                    >
                                      <figure className="media media-embed media-image js-media">
                                        <img
                                          loading="eager"
                                          className="lazyload not-full-width"
                                          srcSet="/images/FootSteps/Panjikent%201000x700_3.jpg 400w, /images/FootSteps/Panjikent%201000x700_1.jpg 750w, /images/FootSteps/Panjikent%201000x700_2.jpg 1000w"
                                          sizes="100vw"
                                          width={1000}
                                          height={700}
                                          src="/images/FootSteps/Panjikent%201000x700.jpg"
                                          alt="View over a city with mountains behind"
                                        />
                                        <figcaption>
                                          Modern life meets ancient ruins in the
                                          historical city of Panjikent. Photo:
                                          Wild Frontiers.
                                        </figcaption>
                                      </figure>
                                    </div>
                                    <p>
                                      <strong>Travel tip:</strong> If travelling
                                      through both Uzbekistan and Tajikistan,
                                      you'll undoubtedly be exposed to what is
                                      known as the '<em>Plov </em>contest'. Each
                                      country puts its own local spin on this
                                      rice and meat dish and claims theirs the
                                      best. Choose your favourite wisely!
                                    </p>
                                    <div
                                      data-entity-type="media"
                                      data-entity-uuid="0e3940e2-0b0e-402b-8775-4c8006410a03"
                                      data-embed-button="media"
                                      data-entity-embed-display="view_mode:media.embed"
                                      data-langcode="en"
                                      data-entity-embed-display-settings="[]"
                                    ...
                                    >
                                      <figure className="media media-embed media-image js-media">
                                        <img
                                          loading="eager"
                                          className="lazyload not-full-width"
                                          srcSet="/images/FootSteps/Plov%201000x650_3.jpg 400w, /images/FootSteps/Plov%201000x650_1.jpg 750w, /images/FootSteps/Plov%201000x650_2.jpg 1000w"
                                          sizes="100vw"
                                          width={1000}
                                          height={650}
                                          src="/images/FootSteps/Plov%201000x650.jpg"
                                          alt="Large dish of plov surrounded by ingredients"
                                        />
                                        <figcaption>
                                          Spoons at the ready! Try the local
                                          dish <em>plov</em>. Photo: Wild
                                          Frontiers.
                                        </figcaption>
                                      </figure>
                                    </div>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-42064-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-42064-title"
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      To celebrate <em>Silk Roads</em>, Wild
                                      Frontiers is offering a fantastic prize of
                                      a 10-day{" "}
                                      <a href="https://www.wildfrontierstravel.com/en_GB/destination/uzbekistan/tailor-made/classic-uzbekistan/0000000043">
                                        Classic Silk Road Uzbekistan private
                                        tour
                                      </a>{" "}
                                      for two people, including flights,
                                      accommodation, transfers, guided
                                      sightseeing and some meals.{" "}
                                      <a href="https://www.wildfrontierstravel.com/en_GB/britishmuseumsilkroadscompetition">
                                        <strong>Enter the competition</strong>
                                      </a>{" "}
                                    ...
                                    <p>
                                      ...
                                      have been experts in off-the-beaten-track
                                      adventure travel since 1998. Watch their{" "}
                                      <a href="https://www.youtube.com/watch?v=7bWVqPIb_S8&list=PL-bqrmpDC9L5ricb1bCGnP3NW4W_l4I0d&index=8">
                                        Silk Roads travel guide video
                                      </a>
                                      .
                                    </p>
                                    <p>
                                    ...
                                    <div className="teaser__image-container">
                                      <div className="media media-teaser_landscape media-image js-media">
                                        <img
                                          ...
                                          width={750}
                                          height={422}
                                          data-src="/sites/default/files/styles/16_9_media_small/public/2024-09/Sutton-hoo-garnets-cloisone-buckle-hero-1920x1080_0.png?h=d1cb525d&itok=VPWn1Bgj"
                                          data-sizes="auto"
                                          data-srcset="/sites/default/files/styles/16_9_media_tiny/public/2024-09/Sutton-hoo-garnets-cloisone-buckle-hero-1920x1080_0.png?h=d1cb525d&itok=qfmoYNtD 400w, /sites/default/files/styles/16_9_media_small/public/2024-09/Sutton-hoo-garnets-cloisone-buckle-hero-1920x1080_0.png?h=d1cb525d&itok=VPWn1Bgj 750w, /sites/default/files/styles/16_9_media_medium/public/2024-09/Sutton-hoo-garnets-cloisone-buckle-hero-1920x1080_0.png?h=d1cb525d&itok=3tS02HcS 1000w, /sites/default/files/styles/16_9_media_large/public/2024-09/Sutton-hoo-garnets-cloisone-buckle-hero-1920x1080_0.png?h=d1cb525d&itok=JzK_UjYP 1300w, /sites/default/files/styles/16_9_media_huge/public/2024-09/Sutton-hoo-garnets-cloisone-buckle-hero-1920x1080_0.png?h=d1cb525d&itok=Djn8CO7t 1600w"
                                          data-focal-position="center center"
                                          alt="Garnets glimmer amid intricate gold metalwork"
                                        />
                                        <noscript>
                                          &lt;img loading="eager"
                                          srcset="/sites/default/files/styles/16_9_media_tiny/public/2024-09/Sutton-hoo-garnets-cloisone-buckle-hero-1920x1080_0.png?h=d1cb525d&amp;itok=qfmoYNtD
                                          400w,
                                          /sites/default/files/styles/16_9_media_small/public/2024-09/Sutton-hoo-garnets-cloisone-buckle-hero-1920x1080_0.png?h=d1cb525d&amp;itok=VPWn1Bgj
                                          750w,
                                          /sites/default/files/styles/16_9_media_medium/public/2024-09/Sutton-hoo-garnets-cloisone-buckle-hero-1920x1080_0.png?h=d1cb525d&amp;itok=3tS02HcS
                                          1000w,
                                          /sites/default/files/styles/16_9_media_large/public/2024-09/Sutton-hoo-garnets-cloisone-buckle-hero-1920x1080_0.png?h=d1cb525d&amp;itok=JzK_UjYP
                                          1300w,
                                          /sites/default/files/styles/16_9_media_huge/public/2024-09/Sutton-hoo-garnets-cloisone-buckle-hero-1920x1080_0.png?h=d1cb525d&amp;itok=Djn8CO7t
                                          1600w" width="750" height="422"
                                          data-src="/sites/default/files/styles/16_9_media_small/public/2024-09/Sutton-hoo-garnets-cloisone-buckle-hero-1920x1080_0.png?h=d1cb525d&amp;itok=VPWn1Bgj"
                                          data-sizes="auto" alt="Garnets glimmer
                                          amid intricate gold metalwork" /&gt;
                                        </noscript>
                                      </div>
                                    </div>
                                    <div className="teaser__content">
                                      <div className="teaser__content-push">
                                        <h3 className="teaser__title">
                                          ...
                                          >
                                            <span>
                                              <span>
                                                Sri Lanka to Suffolk: Sutton Hoo
                                                and the Silk Roads
                                              </span>
                                            </span>
                                            {/* Add visually hidden defacer for screen-reader. Use full stops for reader punctuation. */}
                                        ...
                                        <div className="teaser__summary">
                                          When you think of the Silk Roads, you
                                          rarely think of Suffolk, but research
                                          is revealing the epic journeys of the
                                          Sutton Hoo gems.
                                        </div>
                                      </div>
                                    </div>
