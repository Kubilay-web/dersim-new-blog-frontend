...
const AdultLearning = () => {
  ...
  useEffect(() => {
    const someContentId = "67b2f8977ffef8be106d2821";

    fetchContentById(someContentId, setContent);
  }, []);

  useEffect(() => {
    const category1 = "Adult learning";
    ...
    <div>
      <div>
        ...
        <meta
          ...
          content="Explore the cultural heritage of the world and make unexpected connections through talks, debates, performances and study days."
        />
        <meta
          property="og:image"
              ...
              <main id="main-content" className="js-main">
                <div>
                  <div
                    ...
                    role="article"
                    aria-labelledby="paragraph-9607-title"
                  >
                    ...
                    <div className="container">
                      <div className="hero__inner">
                        <div className="hero__content-container">
                          ...
                          {/* <h1 id="paragraph-9607-title" className="hero__title">
                            {" "}
                            Adult learning
                          </h1> */}
                        </div>
                        <div className="hero__controls">
                          <div className="hero__caption | js-hero-caption">
                            <button
                              ...
                              id="hero-image-caption-button-9607"
                              aria-expanded="false"
                              aria-controls="hero-image-caption-content-9607"
                            >
                            ...
                            <div
                              ...
                              id="hero-image-caption-content-9607"
                              aria-hidden="true"
                              aria-labelledby="hero-image-caption-button-9607"
                            >
                              <button
                                type="button"
                                className="hero__caption-content-close | js-hero-caption-btn"
                                id="hero-image-caption-close-button-9607"
                                aria-expanded="false"
                                aria-controls="hero-image-caption-content-9607"
                              >
                                <span className="visually-hidden">
                              ...
                              <p>
                                {" "}
                                Adult learning, festivals, lates
                                and&nbsp;special events.
                              </p>
                            </div>
                          </div>
                      ...
                      <div className="section__inner">
                        <div className="section--intro__container">
                          ...
                          <div className="section--intro__content">
                            ...
                            {/* <p className="h3">
                              Explore the cultural heritage of the world and
                              make unexpected connections with a breadth of
                              programming designed for adults of all ages
                              including talks, debates, performances, study days
                              and short courses. &nbsp;
                            </p>
                      ...
                      <div>
                        <div>
                          <section
                            ...
                            aria-labelledby="paragraph-9609-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-9609-title"
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  ...
                                                  <div className="teaser__summary">
                                                    Enjoy talks and debates that
                                                    shine new light on the
                                                    Museum's collection.
                                                  </div>
                                                </div>
                                              </div>
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  ...
                                                  <div className="teaser__summary">
                                                    Enjoy events at home or on
                                                    the go with our programme of
                          ...
                          {/* <section
                            className="paragraph paragraph--type--slice-teaser paragraph--view-mode--default section section--slice-teaser section--z-index-scope section--has-carousel section--bg-white"
                            aria-labelledby="paragraph-10046-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-10046-title"
                                    className="visually-hidden teaser-listing__title"
                                  >
                                    Adult learning
                                  </h2>
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  ...
                                                  <div className="teaser__summary">
                                                    Make connections at a
                                                    special event or cultural
                                                    festival.
                                                  </div>
                                                </div>
                                              </div>
                          ...
                          {/* <section
                            className="paragraph paragraph--type--slice-teaser paragraph--view-mode--default section section--slice-teaser section--z-index-scope section--has-carousel section--bg-white"
                            aria-labelledby="paragraph-9613-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-9613-title"
                                    className="visually-hidden teaser-listing__title"
                                  >
                                    Adult learning
                                  </h2>
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  ...
                                                  <div className="teaser__summary">
                                                    Choose from Deaf-led tours,
                                                    object-handling sessions and
                                                    more.
                                                  </div>
                                                </div>
                                              </div>
                          ...
                          {/* <section
                            className="paragraph paragraph--type--slice-teaser paragraph--view-mode--default section section--slice-teaser section--z-index-scope section--has-carousel section--bg-white"
                            aria-labelledby="paragraph-9615-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-9615-title"
                                    className="visually-hidden teaser-listing__title"
                                  >
                                    Adult learning
                                  </h2>
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  ...
                                                  <div className="teaser__summary">
                                                    Encounter cutting edge
                                                    research from around the
                                                    world through specialist
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  <h3 className="teaser__title">
                                                    <a
                                                      href="/learn/adult-learning/esol"
                                                      className="teaser__anchor"
                                                    >
                                                      <span>
                                                        <span>ESOL</span>
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-26142-title"
                          >
                            <div className="container">
                                ...
                                <div className="banner__inner">
                                  ...
                                  <div className="banner__content">
                                    <p>
                                      ...
                                      the Museum's special events, sign up for
                                      our public events newsletter.&nbsp;
                                    </p>
