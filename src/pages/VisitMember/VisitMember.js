...
const VisitMember = () => {
  ...
  useEffect(() => {
    ...
    const category1 = `${categoryPrefix}-46`;
  ...
  useEffect(() => {
    ...
    // Kategoriler dil bazında dinamik olarak ayarlanıyor
    const category1 = `${contentPrefix}-content-51`;
  ...
  return (
    <div>
      <div>
        ...
        <meta
          name="description"
          content="Find practical information, highlight trails and a wealth of ideas on what to see and do."
        />
        <link
          rel="canonical"
        ...
        />
        <title>Visiting as a Member | British Museum</title>
              ...
              <main id="main-content" className="js-main">
                <div>
                  <div
                    ...
                    role="article"
                    aria-labelledby="paragraph-762-title"
                  >
                    <div className="hero__background">
                      <div className="media media-hero media-image js-media">
                        <picture>
                          ...
                          <source
                            src="/images/VisitMember/image-01.webp"
                          ...
                          <img
                            ...
                            src="/images/VisitMember/image-01.webp"
                            alt="Two Members closely inspecting Gayer-Anderson cat, a bronze figure depicting one form of the goddess Bastet. "
                          />
                        </picture>
                      </div>
                    </div>
                      ...
                      <div className="hero__inner">
                        <div className="hero__content-container">
                          ...
                          <a
                            ...
                            data-tracking="cta"
                          >
                            <span>Buy or renew Membership</span>
                          </a>
                        </div>
                        <div className="hero__controls">
                          <div className="hero__caption | js-hero-caption">
                            <button
                              ...
                              id="hero-image-caption-button-762"
                              aria-expanded="false"
                              aria-controls="hero-image-caption-content-762"
                            >
                            ...
                            <div
                              ...
                              id="hero-image-caption-content-762"
                              aria-hidden="true"
                              aria-labelledby="hero-image-caption-button-762"
                            >
                              <button
                                type="button"
                                className="hero__caption-content-close | js-hero-caption-btn"
                                id="hero-image-caption-close-button-762"
                                aria-expanded="false"
                                aria-controls="hero-image-caption-content-762"
                              >
                                <span className="visually-hidden">
                              ...
                              <p>
                                {" "}
                                At an exclusive Members' evening, the
                                Gayer-Anderson cat, a bronze figure depicting
                    ...
                    <div className="breadcrumb__inner">
                      <div id="block-breadcrumbs">
                        <nav aria-labelledby="system-breadcrumb">
                          ...
                          >
                            You are in the Membership section
                          </h2>
                          ...
                          <div className="jump-links">
                            ...
                            >
                              <ul className="jump-links__list" role="list">
                                ...
                                <li className="jump-links__item">
                                  <a
                                    href="#contact-us-and-faqs"
                                    className="jump-links__link"
                                  >
                                    <span>Contact us and FAQs</span>
                                  </a>
                                </li>
                              </ul>
                            </div>
                        ...
                        <div className="section--intro__container">
                            ...
                            <div className="section--intro__info-slices">
                              <div className="paragraph paragraph--type--info-content paragraph--view-mode--default section--intro__info-content wysiwyg">
                                ...
                                <p lang="EN-US">
                                  Daily: 10.00–17.00 (
                                  <a
                                    href="https://euc-word-edit.officeapps.live.com/node/1162"
                                    target="_blank"
                                    rel="noopener"
                              ...
                              <div className="intro-link--button paragraph paragraph--type--info-link paragraph--view-mode--default">
                                <a
                                  ...
                                  href="/membership/upgrade-your-membership"
                                >
                          ...
                          <div className="section--intro__content">
                            ...
                            <div className="wysiwyg">
                              <p>
                                You won't need to book to visit special
                                exhibitions, but&nbsp;you'll need to show your
                                Membership card to gain entry. If
                                you're&nbsp;visiting before your Membership card
                                arrives, please bring your Membership purchase
                                confirmation email and a form of ID to the
                                Membership Desk in the Great Court. We'll then
                                issue a temporary card to access your on-site
                                benefits.
                              </p>
                              <p>
                                Members are no longer required to join any
                                queues that develop outside the Museum gates.
                                Find out more in{" "}
                                <a href="#entering-the-museum">
                                  Entering the Museum
                                </a>
                                .
                              </p>
                              <p>
                                The visitor and Member cloakroom is located near
                              ...
                              <p>
                                ...
                                <a
                                  ...
                                  data-entity-uuid="953e6f22-50bf-4e13-b84c-3de6403723b8"
                                >
                                  Membership FAQs
                                </a>
                                &nbsp;page for any queries about your visit, or
                                contact us at&nbsp;
                                <a href="mailto:friends@britishmuseum.org">
                      ...
                      <div>
                        <div>
                          <section
                            ...
                            aria-labelledby="paragraph-20400-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-20400-title"
                                              ...
                                              <div className="teaser__image-container">
                                                <div className="media media-teaser_landscape media-image js-media">
                                                  <img
                                                    ...
                                                    sizes="516px"
                                                    src="/images/VisitMember/image-02.webp"
                                                  />
                                                </div>
                                              </div>
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  ...
                                                  <div className="teaser__summary">
                                                    ...
                                                    from lectures, tours and
                                                    workshops to film screenings
                                                    and free events.
                                                  </div>
                                                </div>
                                              </div>
                                              ...
                                              <div className="teaser__image-container">
                                                <div className="media media-teaser_landscape media-image js-media">
                                                  <img
                                                    ...
                                                    sizes="516px"
                                                    src="/images/VisitMember/image-03.jpg"
                                                  />
                                                </div>
                                              </div>
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  ...
                                                  <div className="teaser__summary">
                                                    Get inspiration on what not
                                                    to miss during your next
                                                    visit, plus everything on
                                                    offer to Members.
                                                  </div>
                                                </div>
                                              </div>
                                              ...
                                              <div className="teaser__image-container">
                                                <div className="media media-teaser_landscape media-image js-media">
                                                  <img
                                                    ...
                                                    alt="Members Room"
                                                    sizes="516px"
                                                    src="/images/VisitMember/image-04.jpg"
                                                  />
                                                </div>
                                              </div>
                                              <div className="teaser__content">
                          ...
                          <section
                            className="paragraph paragraph--type--slice-teaser paragraph--view-mode--default section section--slice-teaser section--z-index-scope section--has-carousel section--bg-white"
                            aria-labelledby="paragraph-37094-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-37094-title"
                                              ...
                                              <div className="teaser__image-container">
                                                <div className="media media-teaser_landscape media-image js-media">
                                                  <img
                                                    ...
                                                    sizes="516px"
                                                    src="/images/VisitMember/image-05.webp"
                                                  />
                                                </div>
                                              </div>
                                              <div className="teaser__content">
                                              ...
                                              <div className="teaser__image-container">
                                                <div className="media media-teaser_landscape media-image js-media">
                                                  <img
                                                    ...
                                                    data-sizes="auto"
                                                    data-focal-position="center center"
                                                    alt="Female figure made of sandstone, standing with hands folded in front and with a fan-shaped headdress."
                                                    sizes="516px"
                                                    src="/images/VisitMember/image-06.jpg"
                                                  />
                                                </div>
                                              </div>
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  <h3 className="teaser__title">
                                                    <a
                                                      href="/visit/object-trails/members-highlight-object-trail"
                                                      className="teaser__anchor"
                                                    >
                                                      <span>
                                                        <span>
                                                  ...
                                                  <div className="teaser__summary">
                                                    Rediscover the permanent
                                                    collection through objects
                                                    acquired and funded with
                                              ...
                                              <div className="teaser__image-container">
                                                <div className="media media-teaser_landscape media-image js-media">
                                                  <img
                                                    ...
                                                    sizes="516px"
                                                    src="/images/VisitMember/image-07.jpg"
                                                  />
                                                </div>
                                              </div>
                                              <div className="teaser__content">
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-40371-title"
                          >
                            <div className="container">
                              <a
                              ...
                              <div className="section__inner">
                                <h2
                                  id="paragraph-40371-title"
                                  className="section__title section--slice-content__title"
                                  data-gtm-vis-first-on-screen1766321_306={1724}
                                  data-gtm-vis-total-visible-time1766321_306={
                                    100
                                  }
                                  data-gtm-vis-has-fired1766321_306={1}
                                ...
                                <div
                                  className="section--slice-content__main"
                                  data-gtm-vis-first-on-screen1766321_333={1741}
                                  data-gtm-vis-total-visible-time1766321_333={
                                    100
                                  }
                                  data-gtm-vis-has-fired1766321_333={1}
                                >
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      Members no longer need to join queues that
                                      develop outside the Museum gates. Instead,
                                      you can go straight to the front of the
                                      queue, show your valid Membership card{" "}
                                      <span
                                        style={{
                                          color: "black",
                                      ...
                                      or confirmation email if you've joined
                                      recently{" "}
                                      <span
                                        style={{
                                          color: "black",
                                      ...
                                      and security colleagues will guide you to
                                      the Members' lane (leading to the security
                                      tent). This procedure will be in place at
                                      both entrances, but we recommend that you
                                      use the Main entrance on Great Russell
                                      Street for the quickest possible access.
                                    </p>
                                    <p>
                                      Please note that our security team will
                                      ask at the entrance to see your Membership
                                      card or confirmation email. The number of
                                      Members and guests eligible to skip the
                                      queue will correspond with the total on
                                      your Membership card or confirmation email
                                      – Admits 1 or Admits 2. Members can still
                                      get expedited entry for up to four
                                      children under the age of 16. If your
                                      Membership card has expired you won't be
                                      able to skip the queue.&nbsp;
                                    </p>
                                    <p>
                                      If your card has expired, or if you have
                                      any other queries, please contact the
                                      Membership office before your visit and
                                  ...
                                  <div className="paragraph paragraph--type--embedded-media paragraph--view-mode--default">
                                    <figure className="media media-embed media-image js-media">
                                      <img
                                        ...
                                        width={1000}
                                        height={500}
                                        src="/images/VisitMember/image-08.jpg"
                                      />
                                      <figcaption>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-21237-title"
                          >
                            <div className="container">
                              <a
                                className="js-jump-link-anchor"
                              ...
                              <div className="section__inner">
                                <h2
                                  id="paragraph-21237-title"
                                  className="section__title section--slice-content__title"
                                  data-gtm-vis-first-on-screen1766321_306={1775}
                                  data-gtm-vis-total-visible-time1766321_306={
                                    100
                                  }
                                  data-gtm-vis-has-fired1766321_306={1}
                                ...
                                <div
                                  className="section--slice-content__main"
                                  data-gtm-vis-first-on-screen1766321_333={2176}
                                  data-gtm-vis-total-visible-time1766321_333={
                                    100
                                  }
                                  data-gtm-vis-has-fired1766321_333={1}
                                >
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      ...
                                      need to show your Membership card to gain
                                      entry. If you're visiting before your
                                      Membership card arrives, please bring your
                                      Membership purchase confirmation email and
                                      a form of ID to the Membership Desk in the
                                      Great Court on the day of your visit.
                                      We'll then issue a temporary card to
                                      access your on-site benefits.
                                    </p>
                                    <p>
                                      Members can also look forward to an
                                      exploration of the work of 19th century
                                      Japanese artist Utagawa Hiroshige (1 May –
                                      7 September 2025) and a major exhibition
                                      focusing on the sacred art of ancient
                                      India (22 May – 12 October 2025), which
                                      inspired modern depictions of Hindu,
                                  ...
                                  <div className="paragraph paragraph--type--embedded-media paragraph--view-mode--default">
                                    <figure className="media media-embed media-image js-media">
                                      <img
                                        ...
                                        width={1600}
                                        height={927}
                                        src="/images/VisitMember/image-09.webp"
                                      />
                                      <figcaption>
                                        <a
                                        ...
                                        offers a unique chance to see objects
                                        from the length and breadth of the Silk
                                        Roads, telling a story of connection
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-16030-title"
                          >
                            <div className="container">
                              <div className="banner__outer">
                                <div className="banner__inner">
                                  ...
                                  <div className="banner__content">
                                    <p>
                                      <span>
                                        Sign up and receive emails packed full
                                        of fun activities, information on family
                                        events, priority booking for sleepovers
                                        and more.
                                      </span>
                                    </p>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-7810-title"
                          >
                            <div className="container">
                              <a
                                className="js-jump-link-anchor"
                                id="contact-us-and-faqs"
                              />{" "}
                              <div className="section__inner">
                                <h2
                                  id="paragraph-7810-title"
                                  className="section__title section--slice-content__title"
                                  data-gtm-vis-first-on-screen1766321_306={2243}
                                  data-gtm-vis-total-visible-time1766321_306={
                                    100
                                  }
                                  data-gtm-vis-has-fired1766321_306={1}
                                ...
                                <div
                                  className="section--slice-content__main"
                                  data-gtm-vis-first-on-screen1766321_333={2260}
                                  data-gtm-vis-total-visible-time1766321_333={
                                    100
                                  }
                                  data-gtm-vis-has-fired1766321_333={1}
                                >
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      Email:{" "}
                                      <a
                                        href="mailto:friends@britishmuseum.org"
