...
const LeaveLegacy = () => {
  ...
  useEffect(() => {
    const someContentId = "67b31dca7ffef8be106d293c";
              ...
              <main id="main-content" className="js-main">
                <div>
                  <div
                    ...
                    role="article"
                    aria-labelledby="paragraph-3138-title"
                  >
                    ...
                    <div className="container">
                      <div className="hero__inner">
                        <div className="hero__content-container">
                          ...
                          {/* <h1 id="paragraph-3138-title" className="hero__title">
                            {" "}
                            Leave a legacy
                          </h1> */}
                        </div>
                        <div className="hero__controls">
                          <div className="hero__caption | js-hero-caption">
                            <button
                              ...
                              id="hero-image-caption-button-3138"
                              aria-expanded="false"
                              aria-controls="hero-image-caption-content-3138"
                            >
                            ...
                            <div
                              ...
                              id="hero-image-caption-content-3138"
                              aria-hidden="true"
                              aria-labelledby="hero-image-caption-button-3138"
                            >
                              <button
                                type="button"
                                className="hero__caption-content-close | js-hero-caption-btn"
                                id="hero-image-caption-close-button-3138"
                                aria-expanded="false"
                                aria-controls="hero-image-caption-content-3138"
                              >
                                <span className="visually-hidden">
                              ...
                              <p>
                                {" "}
                                Tania Desloge, Organics Conservator, performing
                                a surface clean on a newly acquired set of
                                Japanese Samurai armour. Many of the Museum's
                                vital conservation projects are made possible
                            ...
                            >
                              <ul className="jump-links__list" role="list">
                                <li className="jump-links__item">
                                  <a
                                    href="#a-gift-in-your-will"
                                    className="jump-links__link"
                                  >
                                    <span>A gift in your will</span>
                                  </a>
                                </li>
                                <li className="jump-links__item">
                                  <a
                                    href="#donate-an-object"
                                    className="jump-links__link"
                                  >
                        ...
                        <div className="section--intro__container">
                          <div className="section--intro__info">
                            ...
                            <div className="section--intro__info-slices">
                              <div className="paragraph paragraph--type--info-content paragraph--view-mode--default section--intro__info-content wysiwyg">
                                <p>
                                  Email:&nbsp;
                                  <a href="/cdn-cgi/l/email-protection#f19d94969092889c909f90969483b1938398859882999c848294849cdf9e8396">
                                    <span
                                      className="__cf_email__"
                                      data-cfemail="38545d5f595b41555956595f5d4a785a4a514c514b50554d4b5d4d5516574a5f"
                                    >
                                      [email&nbsp;protected]
                                    </span>
                                  </a>
                          ...
                          <div className="section--intro__content">
                            ...
                            {/* <div className="wysiwyg">
                              <p>
                                We're sincerely grateful for every gift we
                                receive, whether that's a gift in your will –
                                either a financial contribution or the gift of
                                an object – or a donation in memory. Your legacy
                              ...
                              <p>
                                ...
                                benefit the future work of the Museum.
                              </p>
                            </div> */}
                          </div>
                        </div>
                      ...
                      <div>
                        <div>
                          <section
                            ...
                            aria-labelledby="paragraph-3158-title"
                          >
                            <div className="container">
                              <a
                                className="js-jump-link-anchor"
                                id="a-gift-in-your-will"
                              />{" "}
                              <div className="section__inner">
                                <h2
                                  id="paragraph-3158-title"
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    ...
                                    <p>
                                      ...
                                      future work of the Museum.
                                    </p>
                                    <p>
                                      For more information, please email:&nbsp;
                                      <a href="/cdn-cgi/l/email-protection#38545d5f595b41555956595f5d4a785a4a514c514b50554d4b5d4d5516574a5f">
                                        <span
                                          className="__cf_email__"
                                          data-cfemail="dbb7bebcbab8a2b6bab5babcbea99bb9a9b2afb2a8b3b6aea8beaeb6f5b4a9bc"
                                        >
                                          [email&nbsp;protected]
                                        </span>
                                      </a>
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-3146-title"
                          >
                            <div className="container">
                              <a
                                className="js-jump-link-anchor"
                              ...
                              <div className="section__inner">
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    ...
                                    <p>
                                      Objects determined to be pre-eminent may
                                    ...
                                    <p>
                                      The Museum is committed to caring for the
                                      collection. Due to limited space and
                                      resources we're unfortunately unable to
                                      accept all objects offered to the Museum.
                                      Please send more details about your
                                      proposed donation, including images and
                                      provenance information, to:{" "}
                                      <a href="/cdn-cgi/l/email-protection#eb8f8e9d8e87849b868e859fab8999829f829883869e988e9e86c584998c">
                                        <span
                                          className="__cf_email__"
                                          data-cfemail="80e4e5f6e5eceff0ede5eef4c0e2f2e9f4e9f3e8edf5f3e5f5edaeeff2e7"
                                        >
                                          [email&nbsp;protected]
                                        </span>
                                      </a>
                                  ...
                                  <div className="paragraph paragraph--type--embedded-media paragraph--view-mode--default">
                                    <figure className="media media-embed media-image js-media">
                                      ...
                                      <figcaption>
                                        ...
                                        Acquired through the Acceptance in Lieu
                                        Scheme.&nbsp;
                                      </figcaption>
                                    </figure>
                                  </div>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-right section--bg-white"
                            aria-labelledby="paragraph-3147-title"
                          >
                            <div className="container">
                              <a
                                className="js-jump-link-anchor"
                              ...
                              <div className="section__inner">
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    ...
                                    <p>
                                      When we lose a loved one, remembering them
                                      in a meaningful way can bring consolation.
                                      Your gift can help the memory of a friend
                                      or relative live on while supporting the
                                      Museum's work.
                                    </p>
                                    <p>
                                      Our legacy manager&nbsp;would be happy to
                                      talk to you about giving a gift in memory
                                      or setting up a tribute fund.
                                    </p>
                                    <p>
                                      For more information, please email:&nbsp;
                                      <a href="/cdn-cgi/l/email-protection#deb2bbb9bfbda7b3bfb0bfb9bbac9ebcacb7aab7adb6b3abadbbabb3f0b1acb9">
                                        <span
                                          className="__cf_email__"
                                          data-cfemail="9df1f8fafcfee4f0fcf3fcfaf8efddffeff4e9f4eef5f0e8eef8e8f0b3f2effa"
                                        >
                                          [email&nbsp;protected]
                                        </span>
                                      </a>
                                ...
                                <aside className="section--slice-content__embed">
                                  <div className="paragraph paragraph--type--embedded-media paragraph--view-mode--default">
                                    <figure className="media media-embed media-image js-media">
                                      ...
                                      />
                                      <figcaption>
                                        Conservator performing cleaning tests on
                                        a Parthenon metope. Many of the Museum's
                                        vital conservation projects are made
                                        possible by in memoriam donations.
                                      </figcaption>
                                    </figure>
                                  </div>
                                </aside>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-6074-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-6074-title"
                                  className="section__title section--slice-content__title"
                                >
                                  Registered address
                                </h2>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-7755-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-7755-title"
                                  className="section__title section--slice-content__title"
                                >
                                  The Museum's charitable status
                                </h2>
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                    ...
                                    <p>
                                      However, it isn't subject to regulation by
                                      the Charity Commission and therefore has
