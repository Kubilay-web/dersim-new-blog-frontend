...
const AudioApp = () => {
  ...
  useEffect(() => {
    ...
    const category1 = `${contentPrefix}-content-7`;
    ...
    <div>
      <div>
        ...
        <meta
          ...
          content="Our Audio app will help you make the most of your visit – available in multiple languages."
        />
        <meta
          property="og:image"
              ...
              <main id="main-content" className="js-main">
                <div>
                  <div
                    ...
                    role="article"
                    aria-labelledby="paragraph-2217-title"
                  >
                        ...
                        <div className="hero__controls">
                          <div className="hero__caption | js-hero-caption">
                            <button
                              ...
                              id="hero-image-caption-button-2217"
                              aria-expanded="false"
                              aria-controls="hero-image-caption-content-2217"
                            >
                            ...
                            <div
                              ...
                              id="hero-image-caption-content-2217"
                              aria-hidden="true"
                              aria-labelledby="hero-image-caption-button-2217"
                            >
                              <button
                                type="button"
                                className="hero__caption-content-close | js-hero-caption-btn"
                                id="hero-image-caption-close-button-2217"
                                aria-expanded="false"
                                aria-controls="hero-image-caption-content-2217"
                              >
                                <span className="visually-hidden">
                              ...
                              <p> Visitor using the Audio app.</p>
                            </div>
                          </div>
                        </div>
                      </div>
                          ...
                          <div className="section--intro__info">
                            ...
                            <div className="section--intro__info-slices">
                              <div className="paragraph paragraph--type--info-content paragraph--view-mode--default section--intro__info-content wysiwyg">
                                ...
                                <p>
                                  Full bundle per language £4.99
                                  <br />
                                  Themed tour per language £1.99–£2.99
                                </p>
                              </div>
                              <div className="paragraph paragraph--type--info-content paragraph--view-mode--default section--intro__info-content wysiwyg">
                                <p>
                                  The Audio app is available in the following
                                  languages:
                                </p>
                                <ul>
                                  <li>English</li>
                                  <li>
                                    <a
                                      href="/visit/audio-app/audio-app-mandarin"
                                      data-entity-type="node"
                                      data-entity-uuid="2027b7f9-6845-4f93-8faf-ea43b36ea1bd"
                                      data-entity-substitution="canonical"
                                    >
                                      <span lang="zh-hans" dir="ltr">
                                        中文
                                      </span>
                                    </a>
                                  </li>
                                  <li>
                                    <a
                                      href="/visit/audio-app/audio-app-spanish"
                                      data-entity-type="node"
                                      data-entity-uuid="631515cd-7c34-4067-9824-5cde3159e7f3"
                                      data-entity-substitution="canonical"
                                    >
                                  ...
                                  <li>
                                    <a
                                      href="/visit/audio-app/audio-app-italian"
                                      data-entity-type="node"
                                      data-entity-uuid="918de44e-bcc9-4c94-adff-366c3d49f0c1"
                                      data-entity-substitution="canonical"
                                    >
                                      <span lang="it" dir="ltr">
                                        Italiano
                                      </span>
                                    </a>
                                  </li>
                                  <li>
                                    <a
                                      href="/visit/audio-app/audio-app-french"
                                      data-entity-type="node"
                                      data-entity-uuid="18b378d8-6ae7-4a74-82ad-40ac0734c617"
                                      data-entity-substitution="canonical"
                                    >
                                  ...
                                  <li>
                                    <a
                                      href="/visit/audio-app/audio-app-korean"
                                      data-entity-type="node"
                                      data-entity-uuid="47c250a8-f4f8-40ab-a062-56bd3f412879"
                                      data-entity-substitution="canonical"
                                    >
                                  ...
                                  <li>
                                    <a
                                      href="/visit/audio-app/audio-app-japanese"
                                      data-entity-type="node"
                                      data-entity-uuid="438a1980-127f-4210-8fbc-69244d03256d"
                                      data-entity-substitution="canonical"
                                    >
                                      <span lang="ja" dir="ltr">
                                        日本語
                                      </span>
                                    </a>
                                  </li>
                                  <li>
                                    <a
                                      href="/visit/audio-app/audio-app-deutsch"
                                      data-entity-type="node"
                                      data-entity-uuid="2cb5fec0-7abe-430f-966c-03161bba319c"
                                      data-entity-substitution="canonical"
                                    >
                          ...
                          <div className="section--intro__content">
                            ...
                            {/* <div className="wysiwyg">
                              <p>
                                ...
                                collection from the comfort of your own home.
                              </p>
                              <p>The Audio app features:</p>
                              <ul>
                                <li>
                                  Expert commentaries on 250 highlight objects
                                  from the collection.
                                </li>
                                <li>
                                  65 gallery introductions available for free.
                                </li>
                                <li>
                                  Audio, video, text and images providing
                                  in-depth information.
                                </li>
                                <li>
                                  Self-guided tours to explore the Museum, from
                                  ancient Egypt to Medieval Europe.
                                </li>
                                <li>
                                  A space where you can add objects to
                                  favourites.
                                </li>
                                <li>
                                  Practical visiting information, including a
                                  new interactive map, to help you prepare for
                                  your visit and find your way around the
                                  Museum.
                                </li>
                              </ul>
                              <p>
                      ...
                      <div>
                        <div>
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-25181-title"
                          >
                            <div className="container">
                              <a
                              ...
                              <div className="section__inner">
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p
                                      paraeid="{fa88fc74-65ba-4b25-983d-9a0584ccdf7f}{241}"
                                      paraid={1706894531}
                                    >
                                      <strong>Take a self-guided tour</strong>
                                    </p>
                                    <p
                                      paraeid="{fa88fc74-65ba-4b25-983d-9a0584ccdf7f}{249}"
                                      paraid={49816431}
                                    >
                                      Choose from one of the self-guided tours
                                      which each explore a theme – from Top Ten
                                      to ancient Egypt. Each tour has an audio
                                      introduction, providing background
                                      information and context, before guiding
                                      you around the Museum. Plus for a limited
                                      time only, discover Japan's late Edo
                                      period with our audio tour{" "}
                                      <em>
                                        City life and salon culture in Kyoto and
                                        Osaka: 1770–1900
                                      </em>
                                      . Listen to audio commentary of 17
                                      fascinating objects from these two major
                                      Japanese cities, and learn more about the
                                      people who made and enjoyed them.
                                    </p>
                                    <p
                                      paraeid="{fa88fc74-65ba-4b25-983d-9a0584ccdf7f}{249}"
                                      paraid={49816431}
                                    >
                                      Don't miss out! Experience the
                                      'mesmerising' (<em>The Guardian</em>){" "}
                                      <a
                                      ...
                                      exhibition with an exclusive audio tour –
                                      available now in the Audio app.
                                    </p>
                                    <p
                                      paraeid="{b1759b14-e6d7-450f-bf37-b21ca0353776}{24}"
                                      paraid={924724862}
                                    >
                                      <strong>Explore the galleries</strong>
                                    </p>
                                    <p
                                      paraeid="{b1759b14-e6d7-450f-bf37-b21ca0353776}{30}"
                                      paraid={188649021}
                                    >
                                      Browse pictures of all the objects in the
                                      Audio app by culture and theme – and see
                                      how the collection is displayed within the
                                      galleries – then decide what you want to
                                      explore.&nbsp;
                                    </p>
                                    <p
                                      paraeid="{b1759b14-e6d7-450f-bf37-b21ca0353776}{72}"
                                      paraid={893128629}
                                    >
                                      <strong>Dive deeper</strong>
                                    </p>
                                    <p
                                      paraeid="{b1759b14-e6d7-450f-bf37-b21ca0353776}{78}"
                                      paraid={25846898}
                                    >
                                    ...
                                    <p
                                      paraeid="{b1759b14-e6d7-450f-bf37-b21ca0353776}{128}"
                                      paraid={1929772144}
                                    >
                                      <strong>Languages</strong>
                                    </p>
                                    <p
                                      paraeid="{b1759b14-e6d7-450f-bf37-b21ca0353776}{136}"
                                      paraid={862402334}
                                    >
                                  ...
                                  <div className="paragraph paragraph--type--embedded-media paragraph--view-mode--default">
                                    <figure className="media media-embed media-image js-media">
                                      ...
                                      <figcaption>
                                        ...
                                        Parthenon gallery, including an
                                        introduction and 20 object guides that
                                        you can listen to.&nbsp;
                                      </figcaption>
                                    </figure>
                                  </div>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-25191-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-25191-title"
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    ...
                                    >
                                      <strong>
                                        Look for the audio guide symbol
                                      </strong>
                                    </p>
                                    <div
                                      data-langcode="en"
                                      data-entity-type="media"
                                      data-entity-uuid="1ece7cdc-8448-443c-b510-e08fab086e38"
                                      data-embed-button="media"
                                      data-entity-embed-display="view_mode:media.embed"
                                      className="align-left embedded-entity"
                                    ...
                                    <p
                                      paraeid="{b1759b14-e6d7-450f-bf37-b21ca0353776}{190}"
                                      paraid={581851813}
                                    >
                                      The Audio app covers 250 objects in the
                                      permanent galleries – when you see the
                                      audio guide symbol on cases or next to
                                      objects, enter the number using the keypad
                                      on the app for audio commentaries and
                                      other information.&nbsp;
                                    </p>
                                    <p
                                      paraeid="{b1759b14-e6d7-450f-bf37-b21ca0353776}{242}"
                                      paraid={1063443444}
                                    >
                                    ...
                                    <p
                                      paraeid="{db6f5831-bcad-40f6-aaaf-14b36b45dace}{23}"
                                      paraid={753901005}
                                    >
                                      <strong>Price</strong>
                                    </p>
                                    <ul>
                                      <li
                                        paraeid="{db6f5831-bcad-40f6-aaaf-14b36b45dace}{29}"
                                        paraid={2139460522}
                                      >
                                        Full bundle per language £4.99
                                      </li>
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-2282-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-2282-title"
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  ...
                                                  <div className="teaser__summary">
                                                    Choose a trail and go on a
                                                    fascinating tour around the
                                                    Museum that showcases the
                                                    best objects on display.
                                                  </div>
                                                </div>
                                              </div>
                                            </div>
