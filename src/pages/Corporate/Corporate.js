...
const Corporate = () => {
  ...
  useEffect(() => {
    ...
    const category1 = `${categoryPrefix}-58`;
  ...
  useEffect(() => {
    ...
    // Kategoriler dil bazında dinamik olarak ayarlanıyor
    const category1 = `${contentPrefix}-content-14`;
  ...
  return (
    <div>
      <div>
        ...
        <meta
          name="description"
          content="The Museum welcomes corporate partnerships, sponsorships and memberships with businesses around the world. Read about the different types and choose the right one for your company."
        />
        <link
          rel="canonical"
              ...
              <main id="main-content" className="js-main">
                <div>
                  <div
                    ...
                    role="article"
                    aria-labelledby="paragraph-1854-title"
                  >
                        ...
                        <div className="hero__controls">
                          <div className="hero__caption | js-hero-caption">
                            <button
                              ...
                              id="hero-image-caption-button-1854"
                              aria-expanded="false"
                              aria-controls="hero-image-caption-content-1854"
                            >
                            ...
                            <div
                              ...
                              id="hero-image-caption-content-1854"
                              aria-hidden="true"
                              aria-labelledby="hero-image-caption-button-1854"
                            >
                              <button
                                type="button"
                                className="hero__caption-content-close | js-hero-caption-btn"
                                id="hero-image-caption-close-button-1854"
                                aria-expanded="false"
                                aria-controls="hero-image-caption-content-1854"
                              >
                                <span className="visually-hidden">
                        ...
                        <div className="section--intro__container">
                          <div className="section--intro__info">
                            ...
                            <div className="section--intro__info-slices">
                              <div className="paragraph paragraph--type--info-content paragraph--view-mode--default section--intro__info-content wysiwyg">
                                ...
                                <p>
                                  Email:{" "}
                                  <a href="/cdn-cgi/l/email-protection#6e0d011c1e011c0f1a0b1d1b1e1e011c1a2e0c1c071a071d06031b1d0b1b0340011c09">
                                    <span
                                      className="__cf_email__"
                                      data-cfemail="15767a67657a67746170666065657a67615577677c617c667d7860667060783b7a6772"
                                    >
                                      [email&nbsp;protected]
                                    </span>
                                  </a>
                          ...
                          <div className="section--intro__content">
                            ...
                            <div className="wysiwyg">
                              <p>
                                Become actively involved in the life of the
                                Museum through enhanced access to the collection
                                and special exhibitions programme for your
                                company, clients and employees.
                              </p>
                              <p>
                                <span>
                                  We'd be delighted to talk to you about the
                                  different ways in which your company can
                                  engage with the Museum. For more information,
                      ...
                      <div>
                        <div>
                          <section
                            ...
                            aria-labelledby="paragraph-1861-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-1861-title"
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  <h3 className="teaser__title">
                                                    <a
                                                      href="/support-us/corporate-support/corporate-sponsorship"
                                                      className="teaser__anchor"
                                                    >
                                                      <span>
                                                        <span>
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  <h3 className="teaser__title">
                                                    <a
                                                      href="/support-us/corporate-support/corporate-partnership"
                                                      className="teaser__anchor"
                                                    >
                                                      <span>
                                                        <span>
                                                  ...
                                                  <div className="teaser__summary">
                                                    Entertain in the Museum's
                                                    galleries and Great Court –
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  <h3 className="teaser__title">
                                                    <a
                                                      href="/support-us/corporate-support/corporate-membership"
                                                      className="teaser__anchor"
                                                    >
                                                      <span>
                                                        <span>
                                                  ...
                                                  <div className="teaser__summary">
                                                    ...
                                                    staff and clients through
                                                    privileged access to the
                                                    Museum, its curators and the
                                                    collection.
                                                  </div>
                                                </div>
                                              </div>
                          ...
                          {/* <section
                            className="paragraph paragraph--type--slice-teaser paragraph--view-mode--default section section--slice-teaser section--z-index-scope section--has-carousel section--bg-white"
                            aria-labelledby="paragraph-2300-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <div className="teaser-listing__container">
                                  <h2
                                    id="paragraph-2300-title"
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  <h3 className="teaser__title">
                                                    <a
                                                      href="/support-us/corporate-support/current-corporate-supporters"
                                                      className="teaser__anchor"
                                                    >
                                                      <span>
                                                        <span>
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  <h3 className="teaser__title">
                                                    <a
                                                      href="/support-us/corporate-support/event-spaces"
                                                      className="teaser__anchor"
                                                    >
                                                      <span>
                                                        <span>
