  ...
  return (
    <div>
      <div>
        ...
        <meta
          name="description"
          content="Learn how recent research has revealed a rich, intricately connected world, whose horizons stretched far beyond sand and spices."
        />
        <link
          rel="canonical"
        ...
        <meta
          property="og:title"
          content="Beyond sand and spices: introduction to 'Silk Roads'"
        />
        <meta
        ...
        <meta
          property="og:image"
          content="images/Silk%20princess%201920x1080.jpg"
        />
              ...
              <main id="main-content" className="js-main">
                <div>
                  <div
                    ...
                    role="article"
                    aria-labelledby="paragraph-39659-title"
                  >
                    <div className="hero__background">
                      <div className="media media-hero media-image js-media">
                        <picture>
                          ...
                          <source
                            srcSet="images/Silk-princess-panel-1920x1080_3.jpg 1x"
                          ...
                          />
                          <source
                            srcSet="images/Silk-princess-panel-1920x1080_1.jpg 1x"
                          ...
                          />
                          <source
                            srcSet="images/Silk-princess-panel-1920x1080_2.jpg 1x"
                          ...
                          <img
                            ...
                            src="images/Silk-princess-panel-1920x1080.jpg"
                        ...
                        <div className="hero__controls">
                          <div className="hero__caption | js-hero-caption">
                            <button
                              ...
                              id="hero-image-caption-button-39659"
                              aria-expanded="false"
                              aria-controls="hero-image-caption-content-39659"
                            >
                            ...
                            <div
                              ...
                              id="hero-image-caption-content-39659"
                              aria-hidden="true"
                              aria-labelledby="hero-image-caption-button-39659"
                            >
                              <button
                                type="button"
                                className="hero__caption-content-close | js-hero-caption-btn"
                                id="hero-image-caption-close-button-39659"
                                aria-expanded="false"
                                aria-controls="hero-image-caption-content-39659"
                              >
                                <span className="visually-hidden">
                              ...
                              <p>
                                {" "}
                                Painting on a wooden panel of the 'silk
                          ...
                          <ul className="breadcrumb__list">
                            ...
                            <li className="breadcrumb__item breadcrumb__item--current">
                              ...
                              <a
                                ...
                                aria-current="page"
                              >
                                Beyond sand and spices: introduction to 'Silk
                                Roads'
                              </a>
                            </li>
                          </ul>
                        ...
                        <div className="section--intro__container">
                          <div className="section--intro__info">
                            <div className="section--intro__info-slices section--intro__info-slices-no-title">
                              ...
                              <div className="paragraph paragraph--type--info-author paragraph--view-mode--default section--intro__info-author">
                                <div className="author__item_wrapper">
                                  <p className="paragraph paragraph--type--info-author paragraph--view-mode--default section--intro__info-author">
                                    By Luk Yu-ping, Basil Gray Curator: Chinese
                                    Paintings, Prints and Central Asian
                                    Collections
                                  </p>
                                </div>
                              </div>
                              <div className="paragraph paragraph--type--info-author paragraph--view-mode--default section--intro__info-author">
                                <div className="author__item_wrapper">
                                  <p className="paragraph paragraph--type--info-author paragraph--view-mode--default section--intro__info-author">
                                    By Elisabeth R. O'Connell, Byzantine World
                                    Curator
                                  </p>
                                  <div>Publication date: 10 June 2024</div>
                                </div>
                              </div>
                          ...
                          <div className="section--intro__content">
                            ...
                            <div className="wysiwyg">
                              <h3>
                                What comes to mind when you hear the term 'Silk
                                Road'?
                              </h3>
                              <p>
                                Camels? Very likely. Silk? Of course. Deserts,
                                spices and Marco Polo? Quite possibly. All are
                                indelibly linked to this famous route, popularly
                                perceived as a conduit of trade between Asia and
                                Europe in past centuries. For many, the Silk
                                Road weaves visions of far-flung commerce across
                                cultural boundaries and of warm-hued adventures
                                in 'exotic' lands.&nbsp;
                              </p>
                              <p>
                                However, this is only part of the story. Read on
                                to see what the curators of our new exhibition{" "}
                                <a
                                  href="/exhibitions/silk-roads"
                                  data-entity-type="node"
                                  data-entity-uuid="f5d41527-77ab-4583-8f5c-5c7c27452157"
                                  data-entity-substitution="canonical"
                                >
                                  <em>Silk Roads</em>
                                </a>{" "}
                                (26 September 2024 – 23 February 2025) reveal
                                about the extent and impact of these fascinating
                                networks.
                              </p>
                            </div>
                          </div>
                      ...
                      <div>
                        <div>
                          <section
                            ...
                            aria-labelledby="paragraph-39664-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-39664-title"
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      ...
                                      plying its supposed path in the ancient
                                      and medieval past. In fact, it was not
                                      coined until the 19th century, and only
                                      gained wider currency in the 20th century,
                                      when the romanticised notion of the Silk
                                      Road grew popular. This vision is a modern
                                      concept – however, it bears elements of
                                      truth. Certainly, exchanges took place
                                      between Asia and Europe in the past; they
                                      did involve silk and spices; and camels
                                      were one of the 'vehicles' used. But in
                                      the century and more since the term was
                                      coined, research has revealed a richer,
                                      more intricately connected world whose
                                      horizons stretched even farther than first
                                      imagined.
                                    </p>
                                  </div>
                                </div>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-39665-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-39665-title"
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <div
                                      ...
                                      data-entity-uuid="d5b5de0c-8121-4206-9743-3cad504e8f88"
                                    ...
                                    >
                                      <figure className="media media-embed media-image js-media">
                                        <img
                                          ...
                                          srcSet="images/Sancai_camel_1000x918_3.jpg 400w, images/Sancai_camel_1000x918_1.jpg 750w, images/Sancai_camel_1000x918_2.jpg 1000w"
                                          sizes="100vw"
                                          width={1000}
                                          height={918}
                                          src="images/Sancai_camel_1000x918.jpg"
                                    ...
                                    <p>
                                      This expanded world forms the basis of the
                                      new exhibition{" "}
                                      <a
                                        href="/exhibitions/silk-roads"
                                        data-entity-type="node"
                                      ...
                                      (26 September 2024 – 23 February 2025).
                                      The plural title highlights that, rather
                                      than a single route of exchange, there was
                                      a web of interlocking networks that
                                      spanned Asia, Africa and Europe, from
                                      Japan to Ireland, from the Arctic to
                                      Madagascar. Their arteries ran in multiple
                                      directions, crossed diverse terrains, and
                                      conveyed not just silk and spices, but a
                                      multitude of objects and materials, people
                                      and ideas, which were exchanged in many
                                      contexts besides trade. Such interactions
                                      helped to shape cultures and histories
                                      across continents.
                                    </p>
                                    <p>
                                      The exhibition's very first object sets up
                                      this richer version of the Silk Roads: a
                                      figurine of the Buddha, made in what is
                                      now northwest Pakistan in the decades
                                      around AD 600, but found thousands of
                                      kilometres away on the tiny island of
                                      Helgö in eastern Sweden, where it had
                                      arrived by about AD 800. Its message is
                                      that this story goes far beyond desert
                                      dunes into less familiar lands.
                                    </p>
                                    <div
                                      data-entity-type="media"
                                      data-entity-uuid="42836172-5452-4da8-b15f-c97adb15cc83"
                                      data-embed-button="media"
                                      data-entity-embed-display="view_mode:media.embed"
                                      data-langcode="en"
                                      data-entity-embed-display-settings="[]"
                                    ...
                                    >
                                      <figure className="media media-embed media-image js-media">
                                        <img
                                          loading="eager"
                                          className="lazyload not-full-width"
                                          srcSet="images/Buddha%201600x1400_4.jpg 400w, images/Buddha%201600x1400_3.jpg 750w, images/Buddha%201600x1400_2.jpg 1000w, images/Buddha%201600x1400_1.jpg 1300w, images/Buddha%201600x1400.jpg 1600w"
                                          sizes="100vw"
                                          width={1600}
                                          height={1400}
                                          src="images/Buddha%201600x1400.jpg"
                                          alt="Copper alloy Buddha figurine"
                                        />
                                        <figcaption>
                                          Copper alloy Buddha figurine, probably
                                          made in the Swat Valley, Pakistan,
                                          late AD 500s–mid-600s, excavated near
                                          buildings dating to about AD 800,
                                          Helgö, Sweden. Historiska Museet,
                                          Stockholm. 108115_HST. Photo: Myrin,
                                          Ola, Historiska museet/SHM (CC BY
                                          4.0).
                                        </figcaption>
                                      </figure>
                                    </div>
                                    <p>
                                      The exhibition's timeframe of about AD 500
                                      to 1000 may also surprise, since it ends
                                      long before Marco Polo's (1254–1324)
                                      travels in Asia – a common Silk Roads
                                      touchpoint. These five centuries mark
                                      perhaps a less familiar but defining slice
                                      through the Silk Roads' long history. They
                                      witnessed the rise and transcontinental
                                      activities of several major powers,
                                      including the Tang dynasty (AD 618–907) in
                                      China, Islamic states beginning with the
                                      Rashidun Caliphate (AD 632–61), the
                                      Byzantine empire from emperor Justinian
                                      (d. AD 565) to Basil II (d. AD 1025), and
                                      the Carolingian empire in Francia (AD
                                      800–87). It also saw the spread of
                                      Buddhism, Christianity and Islam;
                                      large-scale migrations of peoples; and
                                      movement of objects through trade and
                                      other methods on an unprecedented
                                      scale.&nbsp;
                                    </p>
                                    <p>
                                      <a
                                      ...
                                      further departs from convention in its
                                      experimental approach to telling big
                                      stories in a museum setting. With three
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-39666-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-39666-title"
                                  className="section__title section--slice-content__title"
                                >
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      Visitors to the show experience this
                                      connected world by making their own epic
                                      journey from East Asia to northwest
                                      Europe, winding through several large
                                      geographic zones and pausing at six
                                      intimate moments focusing on a particular
                                      people or place of notable cultural
                                      interactions in the Silk Roads' history.
                                      For within this sprawling story are
                                      opportunities for quieter, more personal
                                      connections through objects evoking
                                      individuals who lived, travelled, worked
                                      and died on these networks. You'll
                                      encounter Willibald, a monk from England
                                      who smuggled balsam out of the city of
                                      Tyre (in present-day Lebanon) and the monk
                                      Xuanzang, who embarked on an intrepid
                                      16-year-long journey from Tang China's
                                      capital of Chang'an to India.&nbsp;
                                    </p>
                                  </div>
                                </div>
                              </div>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-39667-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-39667-title"
                                  className="section__title section--slice-content__title"
                                >
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <div
                                      data-entity-type="media"
                                      data-entity-uuid="811e40ce-6e31-43fd-abbe-a70c2a21a0d6"
                                      data-embed-button="media"
                                      data-entity-embed-display="view_mode:media.embed"
                                      data-langcode="en"
                                      data-entity-embed-display-settings="[]"
                                    ...
                                    >
                                      <figure className="media media-embed media-image js-media">
                                        <img
                                          loading="eager"
                                          className="lazyload not-full-width"
                                          srcSet="images/Camel%20and%20horse%201600x590px_4.jpg 400w, images/Camel%20and%20horse%201600x590px_3.jpg 750w, images/Camel%20and%20horse%201600x590px_1.jpg 1000w, images/Camel%20and%20horse%201600x590px_2.jpg 1300w, images/Camel%20and%20horse%201600x590px.jpg 1600w"
                                          sizes="100vw"
                                          width={1600}
                                          height={590}
                                          src="images/Camel%20and%20horse%201600x590px.jpg"
                                    ...
                                    <p>
                                      Few may associate diplomacy and warfare
                                      with the Silk Roads, but both helped
                                      propel people, objects and ideas across
                                      cultural boundaries. A lively sketch from
                                      the 'Library Cave' in Dunhuang, a Buddhist
                                      centre in northwest China, evokes
                                      diplomatic relations between the local
                                      ruler of Dunhuang, neighbouring kingdoms
                                      in the Tarim Basin and Chinese dynasties
                                      during the AD 900s. It shows two envoys,
                                      wearing the headdress of government
                                      officials, travelling with a horse and
                                      camel that were probably intended as
                                      tribute given that they're not carrying
                                      goods to trade.
                                    </p>
                                  </div>
                                </div>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-39668-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-39668-title"
                                  className="section__title section--slice-content__title"
                                >
                                  People on the move
                                </h2>
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      The Silk Roads' many arteries were busy
                                      with people of all kinds, from merchants
                                      to missionaries and mercenaries. Some
                                      travelled by choice, while others were
                                      forced to move by factors beyond their
                                      control. The Sogdians of Central Asia were
                                      great traders who have left traces on
                                      lands from the Eurasian Steppe to India,
                                      and from China to the Mediterranean. A
                                      spectacular glimpse of the Sogdians in
                                    ...
                                    <div
                                      data-entity-type="media"
                                      data-entity-uuid="9c0faf92-d784-47cb-adb6-a06016077e7f"
                                      data-embed-button="media"
                                      data-entity-embed-display="view_mode:media.embed"
                                      data-langcode="en"
                                      data-entity-embed-display-settings="[]"
                                    ...
                                    >
                                      <figure className="media media-embed media-image js-media">
                                        <img
                                          loading="eager"
                                          className="lazyload not-full-width"
                                          srcSet="images/Wall%20painting%201600px_4.jpg 400w, images/Wall%20painting%201600px_3.jpg 750w, images/Wall%20painting%201600px_1.jpg 1000w, images/Wall%20painting%201600px_2.jpg 1300w, images/Wall%20painting%201600px.jpg 1600w"
                                          sizes="100vw"
                                          width={1600}
                                          height={900}
                                          src="images/Wall%20painting%201600px.jpg"
                                          alt="Fragment of a wall painting showing a local ruler’s entourage paying their respects at the tomb of his ancestors."
                                        />
                                        <figcaption>
                                          Section of the wall painting from the
                                          south wall of the ‘Hall of the
                                          Ambassadors’, AD 660s, Afrasiab
                                          (Samarkand), Uzbekistan. © ACDF of
                                          Uzbekistan, Samarkand State Museum
                                          Reserve.
                                        </figcaption>
                                      </figure>
                                    </div>
                                    <p>
                                      A very different story is told by a silver
                                      neck-ring found near Tallinn, Estonia.
                                      During the AD 800s and 900s, Scandinavian
                                      Vikings traded human beings, many seized
                                      from eastern Europe, into the Islamic
                                      east, in return for silver dirham coins,
                                      which were conveyed back to Scandinavia
                                      via rivers that flowed through Russia and
                                      Ukraine into the Baltic sea. The neck-ring
                                      was probably cast from melted-down coins
                                      that had been used to purchase captives
                                      caught up in this exploitation.
                                    </p>
                                    <div
                                      data-entity-type="media"
                                      data-entity-uuid="03e9920d-357d-447c-8a62-f8e6f8a3d314"
                                      data-embed-button="media"
                                      data-entity-embed-display="view_mode:media.embed"
                                      data-langcode="en"
                                      data-entity-embed-display-settings="[]"
                                    ...
                                    >
                                      <figure className="media media-embed media-image js-media">
                                        <img
                                          loading="eager"
                                          className="lazyload not-full-width"
                                          srcSet="images/Neck%20ring%201000px_3.jpg 400w, images/Neck%20ring%201000px_1.jpg 750w, images/Neck%20ring%201000px_2.jpg 1000w"
                                          sizes="100vw"
                                          width={1000}
                                          height={600}
                                          src="images/Neck%20ring%201000px.jpg"
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-39669-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-39669-title"
                                  className="section__title section--slice-content__title"
                                >
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      Objects of every form and function also
                                      traversed the Silk Roads, from books and
                                      cookware to weapons and jewellery, along
                                      with countless raw materials including
                                      gemstones, elephant ivory, furs and
                                      marble. Marble fragments from a church
                                      built in the AD 500s using local
                                      techniques at Adulis, a Red Sea port of
                                      the Christian kingdom of Aksum
                                      (present-day Eritrea and northeast
                                      Ethiopia), have been scientifically
                                      identified as Proconnesian marble from
                                      across the Mediterranean sea, quarried
                                      near Constantinople, capital of the
                                      Byzantine empire.&nbsp;
                                    </p>
                                    <div
                                      data-entity-type="media"
                                      data-entity-uuid="36fd5ef5-bdb4-495b-beef-4b23fd09e93e"
                                      data-embed-button="media"
                                      data-entity-embed-display="view_mode:media.embed"
                                      data-langcode="en"
                                      data-entity-embed-display-settings="[]"
                                    ...
                                    >
                                      <figure className="media media-embed media-image js-media">
                                        <img
                                          loading="eager"
                                          className="lazyload not-full-width"
                                          srcSet="images/Chancel%20screen%20rotated%201000px%281%29_1.jpg 400w, images/Chancel%20screen%20rotated%201000px%281%29_2.jpg 750w, images/Chancel%20screen%20rotated%201000px%281%29_3.jpg 1000w"
                                          sizes="100vw"
                                          width={1000}
                                          height={1200}
                                          src="images/Chancel%20screen%20rotated%201000px%281%29.jpg"
                                    ...
                                    <p>
                                      Similarly, scientific analysis has traced
                                      garnets used in cloisonné jewellery,
                                      favoured by the social elite across Europe
                                      into the AD 600s, to distant lands. A
                                      superlative example is a shoulder-clasp
                                      from the famous Sutton Hoo ship burial in
                                      Suffolk, England, which depicts two boars
                                      set with purple-red Indian garnets, their
                                      backs bristling with orange-red Czech and
                                      Sri Lankan gems.
                                    </p>
                                    <div
                                      data-entity-type="media"
                                      data-entity-uuid="7ef054cc-3e67-436c-b64c-e402b3d7c18e"
                                      data-embed-button="media"
                                      data-entity-embed-display="view_mode:media.embed"
                                      data-langcode="en"
                                      data-entity-embed-display-settings="[]"
                                    ...
                                    >
                                      <figure className="media media-embed media-image js-media">
                                        <img
                                          loading="eager"
                                          className="lazyload not-full-width"
                                          srcSet="images/Sutton%20Hoo%20clasp%201000x1100px_2.jpg 400w, images/Sutton%20Hoo%20clasp%201000x1100px_1.jpg 750w, images/Sutton%20Hoo%20clasp%201000x1100px_3.jpg 1000w"
                                          sizes="100vw"
                                          width={1000}
                                          height={1100}
                                          src="images/Sutton%20Hoo%20clasp%201000x1100px.jpg"
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-39670-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-39670-title"
                                  className="section__title section--slice-content__title"
                                >
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      Throughout the exhibition, objects evoke
                                      the adoption and adaptation of elements
                                      from one culture by another: a process
                                      motivated by diverse factors and leading
                                      to rich, often innovative, developments.
                                      In Italy the Lombards, a Germanic-speaking
                                      people who had migrated from Pannonia
                                      (central Europe) in AD 568, assumed and
                                      modified many Byzantine aspects of life,
                                      from political infrastructure to
                                      tableware. A witness to this is a fine
                                      drinking-horn, characteristically northern
                                      European in form, but made from
                                      cobalt-blue Mediterranean glass.
                                    </p>
                                    <div
                                      data-entity-type="media"
                                      data-entity-uuid="854b55b7-f5d9-4c14-b638-a39a9ebbc65a"
                                      data-embed-button="media"
                                      data-entity-embed-display="view_mode:media.embed"
                                      data-langcode="en"
                                      data-entity-embed-display-settings="[]"
                                    ...
                                    >
                                      <figure className="media media-embed media-image js-media">
                                        <img
                                          loading="eager"
                                          className="lazyload not-full-width"
                                          srcSet="images/Drinking%20horn%201600x1100px_4.jpg 400w, images/Drinking%20horn%201600x1100px_3.jpg 750w, images/Drinking%20horn%201600x1100px_2.jpg 1000w, images/Drinking%20horn%201600x1100px_1.jpg 1300w, images/Drinking%20horn%201600x1100px.jpg 1600w"
                                          sizes="100vw"
                                          width={1600}
                                          height={1100}
                                          src="images/Drinking%20horn%201600x1100px.jpg"
                                    ...
                                    <p>
                                      A fitting counterpart from the other end
                                      of the Silk Roads is an animal-headed
                                      white stoneware cup, made in Tang China
                                      but modelled after a type of vessel known
                                      as a <em>rhyton</em>, which originated in
                                      the Iranian world. The emergence of this
                                      and other vessel types in Tang China
                                      coincided with the popularity of grape
                                      wine, supplied by Sogdian merchants in the
                                      capital Chang'an.
                                    </p>
                                    <div
                                      data-entity-type="media"
                                      data-entity-uuid="d5d2d596-887a-4510-923f-369daeb00113"
                                      data-embed-button="media"
                                      data-entity-embed-display="view_mode:media.embed"
                                      data-langcode="en"
                                      data-entity-embed-display-settings="[]"
                                    ...
                                    >
                                      <figure className="media media-embed media-image js-media">
                                        <img
                                          loading="eager"
                                          className="lazyload not-full-width"
                                          srcSet="images/Chinese%20rhyton%201000px_3.jpg 400w, images/Chinese%20rhyton%201000px_1.jpg 750w, images/Chinese%20rhyton%201000px_2.jpg 1000w"
                                          sizes="100vw"
                                          width={1000}
                                          height={800}
                                          src="images/Chinese%20rhyton%201000px.jpg"
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-39671-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-39671-title"
                                  className="section__title section--slice-content__title"
                                >
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      The Silk Roads' networks brought about
                                      encounters between peoples of different
                                      faiths, from small local religions to
                                      vast, universalising ones that spread
                                      ...
                                      legacy of Gandharan art based in
                                      present-day northwest Pakistan, which
                                      developed from interactions with the
                                      cultures of ancient Greece and the Roman
                                      Empire. The muscular torso and draped
                                      clothing of a bodhisattva image
                                      characterise its blended visual
                                      vocabulary.
                                    </p>
                                    <div
                                      data-entity-type="media"
                                      data-entity-uuid="9d7657bf-835e-4c8b-979b-5843e5265000"
                                      data-embed-button="media"
                                      data-entity-embed-display="view_mode:media.embed"
                                      data-langcode="en"
                                      data-entity-embed-display-settings="[]"
                                    ...
                                    >
                                      <figure className="media media-embed media-image js-media">
                                        <img
                                          loading="eager"
                                          className="lazyload not-full-width"
                                          srcSet="images/Bodhisattva%201000px_2.jpg 400w, images/Bodhisattva%201000px_1.jpg 750w, images/Bodhisattva%201000px_3.jpg 1000w"
                                          sizes="100vw"
                                          width={1000}
                                          height={1500}
                                          src="images/Bodhisattva%201000px.jpg"
                                          alt="Clay torso of a bodhisattva"
                                        />
                                        <figcaption>
                                          Clay torso of a bodhisattva,
                                          Tajikistan, AD 600–800. Photo: State
                                          Institution 'National Museum' of the
                                    ...
                                    <p>
                                      Meanwhile, from northwest Europe, a
                                      cross-shaped brooch could relate to
                                      diplomatic exchanges between the Christian
                                      ruler Charlemagne in Francia (covering
                                      much of present-day France, Germany and
                                      the Low Countries), and the Muslim Abbasid
                                      caliph Harun al-Rashid in Baghdad, during
                                      the years around AD 800. Made in
                                      Charlemagne's realm, the brooch's
                                      centrepiece is an Islamic glass seal that
                                      may have been acquired during these
                                      exchanges.
                                    </p>
                                    <div
                                      data-entity-type="media"
                                      data-entity-uuid="abf01a71-010d-44fc-82c1-5be231c1e601"
                                      data-embed-button="media"
                                      data-entity-embed-display="view_mode:media.embed"
                                      data-langcode="en"
                                      data-entity-embed-display-settings="[]"
                                    ...
                                    >
                                      <figure className="media media-embed media-image js-media">
                                        <img
                                          loading="eager"
                                          className="lazyload not-full-width"
                                          srcSet="images/Cross-shaped%20brooch%201000px_3.jpg 400w, images/Cross-shaped%20brooch%201000px_1.jpg 750w, images/Cross-shaped%20brooch%201000px_2.jpg 1000w"
                                          sizes="100vw"
                                          width={1000}
                                          height={1000}
                                          src="images/Cross-shaped%20brooch%201000px.jpg"
                                        ...
                                        <figcaption>
                                          ...
                                          copper-alloy, Republic of Ireland,
                                          late AD 700s.&nbsp;
                                        </figcaption>
                                      </figure>
                                    </div>
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-39672-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-39672-title"
                                  className="section__title section--slice-content__title"
                                >
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      Ideas, knowledge and technology flowed
                                      along the Silk Roads as readily as people
                                      and objects. A famous evocation of this is
                                      a painted wooden votive panel that relates
                                      how silk farming reached the Buddhist
                                      kingdom of Khotan in the Tarim Basin (in
                                      present-day Xinjiang Uyghur Autonomous
                                      Region, China). It is believed to depict a
                                      Chinese princess who smuggled silkworm
                                      eggs and mulberry seeds in her headdress
                                      as she travelled to marry the Khotanese
                                      king. Around her are a basket of what may
                                      be silkworm cocoons, a woman with a loom
                                      and a comb beater, and perhaps the patron
                                      deity of weaving. By the AD 600s, Khotan
                                      was farming silk and had a flourishing
                                      textile industry.
                                    </p>
                                    <div
                                      data-entity-type="media"
                                      data-entity-uuid="ee25187e-e0fa-4762-bc65-80def7efb6e4"
                                      data-embed-button="media"
                                      data-entity-embed-display="view_mode:media.embed"
                                      data-langcode="en"
                                      data-entity-embed-display-settings="[]"
                                    ...
                                    >
                                      <figure className="media media-embed media-image js-media">
                                        <img
                                          loading="eager"
                                          className="lazyload not-full-width"
                                          srcSet="images/Silk%20Princess%202%201600px_3.jpg 400w, images/Silk%20Princess%202%201600px_1.jpg 750w, images/Silk%20Princess%202%201600px_2.jpg 1000w, images/Silk%20Princess%202%201600px_4.jpg 1300w, images/Silk%20Princess%202%201600px.jpg 1600w"
                                          sizes="100vw"
                                          width={1600}
                                          height={460}
                                          src="images/Silk%20Princess%202%201600px.jpg"
                                          alt="Wooden painted panel of a princess with a basket of silk worm cocoons."
                                        />
                                        <figcaption>
                                          <a href="http://localhost:3000/collection/object/A_1907-1111-73">
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-39673-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-39673-title"
                                  className="visually-hidden section--slice-content__title"
                                >
                                  Conclusion
                                </h2>
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      ...
                                      parting image of a deeply interlinked
                                      world traversed by people, objects and
                                      ideas. It also reminds us that while modes
                                      of transport and ways of connecting
                                      change, exchanges between cultures near
                                      and far have always been a part of
                                      humanity's past and will continue to shape
                                      its future.
                                    </p>
                                    <div
                                      data-entity-type="media"
                                      data-entity-uuid="05083ec8-552d-4335-bf0d-d853309bd05a"
                                      data-embed-button="media"
                                      data-entity-embed-display="view_mode:media.embed"
                                      data-langcode="en"
                                      data-entity-embed-display-settings="[]"
                                    ...
                                    >
                                      <figure className="media media-embed media-image js-media">
                                        <img
                                          loading="eager"
                                          className="lazyload not-full-width"
                                          srcSet="images/Franks%20casket%201600x1100px_4.jpg 400w, images/Franks%20casket%201600x1100px_1.jpg 750w, images/Franks%20casket%201600x1100px_2.jpg 1000w, images/Franks%20casket%201600x1100px_3.jpg 1300w, images/Franks%20casket%201600x1100px.jpg 1600w"
                                          sizes="100vw"
                                          width={1600}
                                          height={1100}
                                          src="images/Franks%20casket%201600x1100px.jpg"
                                        ...
                                        <figcaption>
                                          ...
                                          northern England, found in France,
                                          early AD 700s.
                                        </figcaption>
                                      </figure>
                                    </div>
                                    <p>
                                      ...
                                      and breadth of the Silk Roads at this
                                      major new exhibition, opening 26
                                      September. A{" "}
                                      <a href="https://www.britishmuseumshoponline.org/silk-roads-paperback.html">
                                        special book
                                      </a>{" "}
                                    ...
                                    <p>
                                      ...
                                      <br />
                                      Uzbekistan Art and Culture Development
                                      Foundation
                                    </p>
                                  </div>
                                </div>
                                    ...
                                    <div className="teaser__image-container">
                                      <div className="media media-teaser_landscape media-image js-media">
                                        <img
                                          ...
                                          width={750}
                                          height={422}
                                          data-src="/sites/default/files/styles/16_9_media_small/public/2024-02/Man%20rising%201600px.jpg?h=885abe81&itok=L_s8EypX"
                                          data-sizes="auto"
                                          data-srcset="/sites/default/files/styles/16_9_media_tiny/public/2024-02/Man%20rising%201600px.jpg?h=885abe81&itok=PC3GHNh4 400w, /sites/default/files/styles/16_9_media_small/public/2024-02/Man%20rising%201600px.jpg?h=885abe81&itok=L_s8EypX 750w, /sites/default/files/styles/16_9_media_medium/public/2024-02/Man%20rising%201600px.jpg?h=885abe81&itok=3a6Xhl92 1000w, /sites/default/files/styles/16_9_media_large/public/2024-02/Man%20rising%201600px.jpg?h=885abe81&itok=gJcoVkJF 1300w, /sites/default/files/styles/16_9_media_huge/public/2024-02/Man%20rising%201600px.jpg?h=885abe81&itok=N7qC8AxV 1600w"
                                          data-focal-position="center center"
                                          alt="Drawing of a man pushing himself up with his arms, viewed from behind."
                                        />
                                        <noscript>
                                          &lt;img loading="eager"
                                          srcset="/sites/default/files/styles/16_9_media_tiny/public/2024-02/Man%20rising%201600px.jpg?h=885abe81&amp;itok=PC3GHNh4
                                          400w,
                                          /sites/default/files/styles/16_9_media_small/public/2024-02/Man%20rising%201600px.jpg?h=885abe81&amp;itok=L_s8EypX
                                          750w,
                                          /sites/default/files/styles/16_9_media_medium/public/2024-02/Man%20rising%201600px.jpg?h=885abe81&amp;itok=3a6Xhl92
                                          1000w,
                                          /sites/default/files/styles/16_9_media_large/public/2024-02/Man%20rising%201600px.jpg?h=885abe81&amp;itok=gJcoVkJF
                                          1300w,
                                          /sites/default/files/styles/16_9_media_huge/public/2024-02/Man%20rising%201600px.jpg?h=885abe81&amp;itok=N7qC8AxV
                                          1600w" width="750" height="422"
                                          data-src="/sites/default/files/styles/16_9_media_small/public/2024-02/Man%20rising%201600px.jpg?h=885abe81&amp;itok=L_s8EypX"
                                          data-sizes="auto" alt="Drawing of a
                                          man pushing himself up with his arms,
                                          viewed from behind." /&gt;
                                        </noscript>
                                      </div>
                                    </div>
                                    <div className="teaser__content">
                                      <div className="teaser__content-push">
                                        ...
                                        <h3 className="teaser__title">
                                          <a
                                            href="/blog/introduction-michelangelo-last-decades"
                                        ...
                                        <div className="teaser__summary">
                                          Discover the extraordinary dynamism of
                                          Michelangelo's work in the final 30
                                          years of his life with exhibition
                                          curator, Sarah Vowles.
                                        </div>
                                      </div>
                                  ...
                                  <div className="teaser__wrapper">
                                    <div className="teaser__image-container">
                                      <div className="media media-teaser_landscape media-image js-media">
                                        <img
                                          ...
                                          width={750}
                                          height={422}
                                          data-src="/sites/default/files/styles/16_9_media_small/public/2024-04/Toning%201600px.jpg?h=2aa300aa&itok=49kXgiV-"
                                          data-sizes="auto"
                                          data-srcset="/sites/default/files/styles/16_9_media_tiny/public/2024-04/Toning%201600px.jpg?h=2aa300aa&itok=aProYlwa 400w, /sites/default/files/styles/16_9_media_small/public/2024-04/Toning%201600px.jpg?h=2aa300aa&itok=49kXgiV- 750w, /sites/default/files/styles/16_9_media_medium/public/2024-04/Toning%201600px.jpg?h=2aa300aa&itok=11xjb1pS 1000w, /sites/default/files/styles/16_9_media_large/public/2024-04/Toning%201600px.jpg?h=2aa300aa&itok=Di5pPncV 1300w, /sites/default/files/styles/16_9_media_huge/public/2024-04/Toning%201600px.jpg?h=2aa300aa&itok=045wAI0u 1600w"
                                          data-focal-position="center center"
                                          alt="Japanese paper infills are toned with watercolour to the surrounding area of cartoon paper"
                                        />
                                        <noscript>
                                          &lt;img loading="eager"
                                          srcset="/sites/default/files/styles/16_9_media_tiny/public/2024-04/Toning%201600px.jpg?h=2aa300aa&amp;itok=aProYlwa
                                          400w,
                                          /sites/default/files/styles/16_9_media_small/public/2024-04/Toning%201600px.jpg?h=2aa300aa&amp;itok=49kXgiV-
                                          750w,
                                          /sites/default/files/styles/16_9_media_medium/public/2024-04/Toning%201600px.jpg?h=2aa300aa&amp;itok=11xjb1pS
                                          1000w,
                                          /sites/default/files/styles/16_9_media_large/public/2024-04/Toning%201600px.jpg?h=2aa300aa&amp;itok=Di5pPncV
                                          1300w,
                                          /sites/default/files/styles/16_9_media_huge/public/2024-04/Toning%201600px.jpg?h=2aa300aa&amp;itok=045wAI0u
                                          1600w" width="750" height="422"
                                          data-src="/sites/default/files/styles/16_9_media_small/public/2024-04/Toning%201600px.jpg?h=2aa300aa&amp;itok=49kXgiV-"
                                          data-sizes="auto" alt="Japanese paper
                                          infills are toned with watercolour to
                                          the surrounding area of cartoon paper"
                                          /&gt;
                                        </noscript>
                                      </div>
                                    </div>
                                    <div className="teaser__content">
                                      <div className="teaser__content-push">
                                        ...
                                        <h3 className="teaser__title">
                                          <a
                                            href="/blog/biggest-challenge-conserving-michelangelos-epifania"
                                            className="teaser__anchor"
                                          >
                                            <span>
                                              <span>
                                                The biggest challenge:
                                                conserving Michelangelo's
                                                'Epifania'
                                              </span>
                                            </span>
                                            {/* Add visually hidden defacer for screen-reader. Use full stops for reader punctuation. */}
                                        ...
                                        <div className="teaser__summary">
                                          Go behind the scenes to discover how
                                          conservators prepared an extremely
                                          rare (and enormous) Michelangelo
                                          drawing for our latest exhibition.
                                        </div>
                                      </div>
                                      <span className="teaser__button | button button--chevron">
                                        {" "}
                                  ...
                                  <div className="teaser__wrapper">
                                    <div className="teaser__image-container">
                                      <div className="media media-teaser_landscape media-image js-media">
                                        <img
                                          ...
                                          width={750}
                                          height={422}
                                          data-src="/sites/default/files/styles/16_9_media_small/public/2023-10/Legion%20MODAL%20image%201458x1148.jpg?h=cbd96907&itok=eOLmFS8_"
                                          data-sizes="auto"
                                          data-srcset="/sites/default/files/styles/16_9_media_tiny/public/2023-10/Legion%20MODAL%20image%201458x1148.jpg?h=cbd96907&itok=MecE9Etp 400w, /sites/default/files/styles/16_9_media_small/public/2023-10/Legion%20MODAL%20image%201458x1148.jpg?h=cbd96907&itok=eOLmFS8_ 750w, /sites/default/files/styles/16_9_media_medium/public/2023-10/Legion%20MODAL%20image%201458x1148.jpg?h=cbd96907&itok=x-eH-8lx 1000w, /sites/default/files/styles/16_9_media_large/public/2023-10/Legion%20MODAL%20image%201458x1148.jpg?h=cbd96907&itok=jhoa0f1Q 1300w, /sites/default/files/styles/16_9_media_huge/public/2023-10/Legion%20MODAL%20image%201458x1148.jpg?h=cbd96907&itok=UfcOBcdb 1600w"
                                          data-focal-position="center center"
                                          alt="Bronze helmet lying on the earth, mostly intact but with the crest box, one cheek-piece and several of the bosses missing."
                                        />
                                        <noscript>
                                          &lt;img loading="eager"
                                          srcset="/sites/default/files/styles/16_9_media_tiny/public/2023-10/Legion%20MODAL%20image%201458x1148.jpg?h=cbd96907&amp;itok=MecE9Etp
                                          400w,
                                          /sites/default/files/styles/16_9_media_small/public/2023-10/Legion%20MODAL%20image%201458x1148.jpg?h=cbd96907&amp;itok=eOLmFS8_
                                          750w,
                                          /sites/default/files/styles/16_9_media_medium/public/2023-10/Legion%20MODAL%20image%201458x1148.jpg?h=cbd96907&amp;itok=x-eH-8lx
                                          1000w,
                                          /sites/default/files/styles/16_9_media_large/public/2023-10/Legion%20MODAL%20image%201458x1148.jpg?h=cbd96907&amp;itok=jhoa0f1Q
                                          1300w,
                                          /sites/default/files/styles/16_9_media_huge/public/2023-10/Legion%20MODAL%20image%201458x1148.jpg?h=cbd96907&amp;itok=UfcOBcdb
                                          1600w" width="750" height="422"
                                          data-src="/sites/default/files/styles/16_9_media_small/public/2023-10/Legion%20MODAL%20image%201458x1148.jpg?h=cbd96907&amp;itok=eOLmFS8_"
                                          data-sizes="auto" alt="Bronze helmet
                                          lying on the earth, mostly intact but
                                          with the crest box, one cheek-piece
                                          and several of the bosses missing."
                                          /&gt;
                                        </noscript>
                                      </div>
                                    </div>
                                    <div className="teaser__content">
                                      <div className="teaser__content-push">
                                        ...
                                        <h3 className="teaser__title">
                                          <a
                                            href="/blog/introduction-legion-life-roman-army"
                                            className="teaser__anchor"
                                          >
                                            <span>
                                              <span>
                                                Introduction to Legion: life in
                                                the Roman army
                                              </span>
                                            </span>
                                            {/* Add visually hidden defacer for screen-reader. Use full stops for reader punctuation. */}
                                        ...
                                        <div className="teaser__summary">
                                          Most stories of the Roman empire
                                          describe the history of powerful men.
                                          Legion focuses on the lives of
                                          ordinary soldiers.
                                        </div>
                                      </div>
                                      <span className="teaser__button | button button--chevron">
                                    ...
                                    <div className="teaser__image-container">
                                      <div className="media media-teaser_landscape media-image js-media">
                                        <img
                                          ...
                                          width={750}
                                          height={422}
                                          data-src="/sites/default/files/styles/16_9_media_small/public/2024-02/Julia_Domna_marble_bust_Yale_1920x1080.jpg?h=d540d934&itok=8MUsALqV"
                                          data-sizes="auto"
                                          data-srcset="/sites/default/files/styles/16_9_media_tiny/public/2024-02/Julia_Domna_marble_bust_Yale_1920x1080.jpg?h=d540d934&itok=6PSo7Hgv 400w, /sites/default/files/styles/16_9_media_small/public/2024-02/Julia_Domna_marble_bust_Yale_1920x1080.jpg?h=d540d934&itok=8MUsALqV 750w, /sites/default/files/styles/16_9_media_medium/public/2024-02/Julia_Domna_marble_bust_Yale_1920x1080.jpg?h=d540d934&itok=moLxCgCL 1000w, /sites/default/files/styles/16_9_media_large/public/2024-02/Julia_Domna_marble_bust_Yale_1920x1080.jpg?h=d540d934&itok=aDos7LjZ 1300w, /sites/default/files/styles/16_9_media_huge/public/2024-02/Julia_Domna_marble_bust_Yale_1920x1080.jpg?h=d540d934&itok=DRNhQZxE 1600w"
                                          data-focal-position="center center"
                                          alt="A white marble portrait of a woman with centre parting and braided wig."
                                        />
                                        <noscript>
                                          &lt;img loading="eager"
                                          srcset="/sites/default/files/styles/16_9_media_tiny/public/2024-02/Julia_Domna_marble_bust_Yale_1920x1080.jpg?h=d540d934&amp;itok=6PSo7Hgv
                                          400w,
                                          /sites/default/files/styles/16_9_media_small/public/2024-02/Julia_Domna_marble_bust_Yale_1920x1080.jpg?h=d540d934&amp;itok=8MUsALqV
                                          750w,
                                          /sites/default/files/styles/16_9_media_medium/public/2024-02/Julia_Domna_marble_bust_Yale_1920x1080.jpg?h=d540d934&amp;itok=moLxCgCL
                                          1000w,
                                          /sites/default/files/styles/16_9_media_large/public/2024-02/Julia_Domna_marble_bust_Yale_1920x1080.jpg?h=d540d934&amp;itok=aDos7LjZ
                                          1300w,
                                          /sites/default/files/styles/16_9_media_huge/public/2024-02/Julia_Domna_marble_bust_Yale_1920x1080.jpg?h=d540d934&amp;itok=DRNhQZxE
                                          1600w" width="750" height="422"
                                          data-src="/sites/default/files/styles/16_9_media_small/public/2024-02/Julia_Domna_marble_bust_Yale_1920x1080.jpg?h=d540d934&amp;itok=8MUsALqV"
                                          data-sizes="auto" alt="A white marble
                                          portrait of a woman with centre
                                          parting and braided wig." /&gt;
                                        </noscript>
                                      </div>
                                    </div>
                                    <div className="teaser__content">
                                      <div className="teaser__content-push">
                                        <div className="teaser__meta teaser__meta--top">
                                          <div className="teaser__meta-item">
                                            <span>
                                              Exhibitions and events / 6 March
                                              2024
                                            </span>
                                          </div>
                                        </div>
                                        <h3 className="teaser__title">
                                          <a
                                            href="/blog/women-to-the-front"
                                            className="teaser__anchor"
                                          >
                                            <span>
                                              <span>Women to the front</span>
                                            </span>
                                            {/* Add visually hidden defacer for screen-reader. Use full stops for reader punctuation. */}
                                          </a>
                                        </h3>
                                        <div className="teaser__summary">
                                          Men may have done the fighting, but
                                          Legion shows that a picture of Roman
                                          military life without women is just
                                          wrong, says Mary Beard.
                                        </div>
                                      </div>
                                      <span className="teaser__button | button button--chevron">
                                        {" "}
