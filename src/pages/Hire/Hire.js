...
const Hire = () => {
  ...
  useEffect(() => {
    ...
    const category1 = `${categoryPrefix}-10`;
  ...
  useEffect(() => {
    ...
    // Kategoriler dil bazında dinamik olarak ayarlanıyor
    const category1 = `${contentPrefix}-content-11`;
  ...
  useEffect(() => {
    ...
    // Kategoriler dil bazında dinamik olarak ayarlanıyor
    const accordion1 = `${accordionPrefix}-accordion-4`;
              ...
              <main id="main-content" className="js-main">
                <div>
                  <div
                    ...
                    role="article"
                    aria-labelledby="paragraph-5024-title"
                  >
                        ...
                        <div className="hero__controls">
                          <div className="hero__caption | js-hero-caption">
                            <button
                              ...
                              id="hero-image-caption-button-5024"
                              aria-expanded="false"
                              aria-controls="hero-image-caption-content-5024"
                            >
                            ...
                            <div
                              ...
                              id="hero-image-caption-content-5024"
                              aria-hidden="true"
                              aria-labelledby="hero-image-caption-button-5024"
                            >
                              <button
                                type="button"
                                className="hero__caption-content-close | js-hero-caption-btn"
                                id="hero-image-caption-close-button-5024"
                                aria-expanded="false"
                                aria-controls="hero-image-caption-content-5024"
                              >
                                <span className="visually-hidden">
                              ...
                              <p>
                                {" "}
                                You can hire the BP Theatre, a flexible space
                                for all occasions.
                              </p>
                            </div>
                          </div>
                    ...
                    <div className="breadcrumb__inner">
                      <div id="block-breadcrumbs">
                        <nav aria-labelledby="system-breadcrumb">
                          ...
                          >
                            You are in the Commercial section
                          </h2>
                          ...
                          <div className="jump-links">
                            ...
                            >
                              <ul className="jump-links__list" role="list">
                                ...
                                <li className="jump-links__item">
                                  <a
                                    href="#accredited-suppliers"
                                    className="jump-links__link"
                                  >
                                    <span>Accredited suppliers</span>
                                  </a>
                                </li>
                              </ul>
                            </div>
                          ...
                          <div className="section--intro__info">
                            ...
                            <div className="section--intro__info-slices">
                              <div className="paragraph paragraph--type--info-content paragraph--view-mode--default section--intro__info-content wysiwyg">
                                <p>
                                  Email:{" "}
                                  <a href="/cdn-cgi/l/email-protection#f88e9d968d9d90918a9db89a8a918c918b90958d8b9d8d95d6978a9f">
                                    <span
                                      className="__cf_email__"
                                      data-cfemail="d1a7b4bfa4b4b9b8a3b491b3a3b8a5b8a2b9bca4a2b4a4bcffbea3b6"
                                    >
                                      [email&nbsp;protected]
                                    </span>
                                  </a>
                              ...
                              <div className="intro-link--button paragraph paragraph--type--info-link paragraph--view-mode--default">
                                <a
                                  ...
                                  href="#accredited-suppliers"
                                >
                                  <span>See our accredited suppliers</span>
                                </a>
                              </div>
                            </div>
                          </div>
                      ...
                      <div>
                        <div>
                          <section
                            ...
                            aria-labelledby="paragraph-5026-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-5026-title"
                                ...
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                      During opening hours delegates also have
                                      access to the Museum's collection and
                                      special exhibitions for inspiration,
                                      relaxation and motivation.
                                      <br />
                                      <br />
                                      An experienced, dedicated team is
                                      available to assist organisers with every
                                      element of their event, from site visits,
                                      administration, technology options and
                                      pre-planning through to on-site management
                                      on the day. We also work with a host
                                      of&nbsp;
                                      <a href="#accredited-suppliers">
                                        accredited suppliers
                                      </a>{" "}
                                      to make your event a success.&nbsp;
                                    </p>
                                    <p>
                                      With all our unique spaces, we have set
                                      everything up in accordance with current
                                      government social distancing advice and
                                      are providing new services to ensure not
                                      only that your guests have a positive
                                      experience here, but that you feel
                                      confident in choosing us for your next
                                      event .<br />
                                      <br />A range of additional bespoke
                                      services are available to make events
                                      special:
                                    </p>
                                    <ul>
                                      <li>
                                        Hybrid, live streaming and webcasting
                                        events including 'virtual delegates'
                                      </li>
                                      <li>
                                        Branded gifts and swag bags from our
                                        world famous shop
                                      </li>
                                      <li>
                                        Catering, from light refreshments to
                                        three-course meals, including our
                                        individual 'Bento Boxes' by Benugo
                                      </li>
                                      <li>Manned cloakrooms</li>
                                      <li>
                                        Exhibition tickets&nbsp;catalogues and
                                        tickets
                                      </li>
                                      <li>
                                        HD recordings for on-demand viewing
                                      </li>
                                      <li>Room dressing and lighting design</li>
                                      <li>
                                        Tailor-made tours during the day or
                                        private after hours tours of the Museum
                                      </li>
                                    </ul>
                                  </div>
                                </div>
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  <h3 className="teaser__title">
                                                    <a
                                                      href="/commercial/commercial-hire/east-and-west-foyers"
                                                      className="teaser__anchor"
                                                    >
                                                      <span>
                                                        <span>
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  <h3 className="teaser__title">
                                                    <a
                                                      href="/commercial/commercial-hire/claus-moser-room"
                                                      className="teaser__anchor"
                                                    >
                                                      <span>
                                                        <span>
                                            ...
                                            <div className="teaser__wrapper">
                                              ...
                                              <div className="teaser__content">
                                                <div className="teaser__content-push">
                                                  <h3 className="teaser__title">
                                                    <a
                                                      href="/commercial/commercial-hire/rooms-a-and-b"
                                                      className="teaser__anchor"
                                                    >
                                                      <span>
                                                        <span>
                          ...
                          <section
                            ...
                            aria-labelledby="paragraph-40944-title"
                          >
                            <div className="container">
                              <a
                                className="js-jump-link-anchor"
                                id="accredited-suppliers"
                              />
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-40940"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-40940"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                  ...
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-40940"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-40940"
                                  >
                                    <h3>Alexander &amp; Björck</h3>
                                    <p>
                                      Email:{" "}
                                      <a href="/cdn-cgi/l/email-protection#fe8e9f8c8a979b8dbe9f929b869f909a9b8c9f909a9c94918c9d95d09d9193">
                                        <span
                                          className="__cf_email__"
                                          data-cfemail="fd8d9c8f8994988ebd9c9198859c9399988f9c93999f97928f9e96d39e9290"
                                        >
                                          [email&nbsp;protected]
                                        </span>
                                      </a>
                                      <br />
                                      Phone: +44 (0)20 3457 1700
                                      <br />
                                      Website:{" "}
                                      <a href="http://www.alexanderandbjorck.com">
                                        www.alexanderandbjorck.com
                                      </a>
                                    </p>
                                    <h3>Alison Price &amp; Co</h3>
                                    <p>
                                      Email:{" "}
                                      <a href="/cdn-cgi/l/email-protection#51343f2024382338342211303d38223e3f21233832347f323e7f243a">
                                        <span
                                          className="__cf_email__"
                                          data-cfemail="67020916120e150e021427060b0e14080917150e040249040849120c"
                                        >
                                          [email&nbsp;protected]
                                        </span>
                                      </a>
                                      <br />
                                      Phone: +44 (0)20 7840 7640
                                      <br />
                                      Website:{" "}
                                      <a href="http://www.alisonprice.co.uk">
                                        www.alisonprice.co.uk
                                      </a>
                                    </p>
                                    <h3>The Admirable Crichton*</h3>
                                    <p>
                                      Email:{" "}
                                      <a href="/cdn-cgi/l/email-protection#9bebfae9eff2fee8dbeff3fefaf8b5feedfef5efe8">
                                        <span
                                          className="__cf_email__"
                                          data-cfemail="2b5b4a595f424e586b5f434e4a48054e5d4e455f58"
                                        >
                                          [email&nbsp;protected]
                                        </span>
                                      </a>
                                      <br />
                                      Phone: +44 (0)20 7326 3800
                                      <br />
                                      Website:{" "}
                                      <a href="http://www.admirable-crichton.co.uk">
                                    ...
                                    <p>
                                      Email:{" "}
                                      <a href="/cdn-cgi/l/email-protection#593b343c2f3c372d2a193b3c372c3e36773a3634">
                                        <span
                                          className="__cf_email__"
                                          data-cfemail="c0a2ada5b6a5aeb4b380a2a5aeb5a7afeea3afad"
                                        >
                                          [email&nbsp;protected]
                                        </span>
                                      </a>
                                      <br />
                                      Phone: +44 (0)20 7323 8989
                                      <br />
                                      Website:{" "}
                                      <a href="https://www.benugo.com/events">
                                        www.benugo.com/events
                                      </a>
                                    </p>
                                    <h3>BeSeasoned Events</h3>
                                    <p>
                                      Email:{" "}
                                      <a href="/cdn-cgi/l/email-protection#fa929f969695ba989f899f9b8995949f9ed49995d48f91">
                                        <span
                                          className="__cf_email__"
                                          data-cfemail="c2aaa7aeaead82a0a7b1a7a3b1adaca7a6eca1adecb7a9"
                                        >
                                          [email&nbsp;protected]
                                        </span>
                                      </a>
                                      <br />
                                      Phone: +44 (0)20 7334 3900
                                      <br />
                                      Website:{" "}
                                      <a href="https://www.beseasoned.co.uk">
                                        www.beseasoned.co.uk
                                      </a>
                                    </p>
                                    <h3>Blue Strawberry*</h3>
                                    <p>
                                      Email:{" "}
                                      <a href="/cdn-cgi/l/email-protection#3058555c5c5f70525c4555434442514752554242491e535f1e455b">
                                        <span
                                          className="__cf_email__"
                                          data-cfemail="58303d343437183a342d3d2b2c2a392f3a3d2a2a21763b37762d33"
                                        >
                                          [email&nbsp;protected]
                                        </span>
                                      </a>
                                      <br />
                                      Phone: +44 (0)20 7733 3151
                                      <br />
                                      Website:{" "}
                                      <a href="http://www.bluestrawberry.co.uk">
                                        www.bluestrawberry.co.uk
                                      </a>
                                    </p>
                                    <h3>By Word of Mouth</h3>
                                    <p>
                                      Email:{" "}
                                      <a href="/cdn-cgi/l/email-protection#4a2f3c2f243e390a28333d25382e252c27253f3e22642925643f21">
                                        <span
                                          className="__cf_email__"
                                          data-cfemail="b7d2c1d2d9c3c4f7d5cec0d8c5d3d8d1dad8c2c3df99d4d899c2dc"
                                        >
                                          [email&nbsp;protected]
                                        </span>
                                      </a>
                                      <br />
                                      Phone: +44 (0)20 8871 9566
                                      <br />
                                      Website:{" "}
                                      <a href="http://www.bywordofmouth.co.uk">
                                    ...
                                    <p>
                                      Email:{" "}
                                      <a href="/cdn-cgi/l/email-protection#284d5e4d465c5b684b49584d5a49464c4a4d5a5a51064b47065d43">
                                        <span
                                          className="__cf_email__"
                                          data-cfemail="630615060d1710230002130611020d07010611111a4d000c4d1608"
                                        >
                                          [email&nbsp;protected]
                                        </span>
                                      </a>
                                      <br />
                                      Phone: +44 (0)1483 427521
                                      <br />
                                      Website:{" "}
                                      <a href="http://www.caperandberry.co.uk">
                                        www.caperandberry.co.uk
                                      </a>
                                    </p>
                                    <h3>Food Show*</h3>
                                    <p>
                                      Email:{" "}
                                      <a href="/cdn-cgi/l/email-protection#96f3f8e7e3ffe4fff3e5d6f0f9f9f2e5fef9e1fae2f2b8f5f9fb">
                                        <span
                                          className="__cf_email__"
                                          data-cfemail="36535847435f445f53457650595952455e59415a42521855595b"
                                        >
                                          [email&nbsp;protected]
                                        </span>
                                      </a>
                                      <br />
                                      Phone: +44 (0)20 7793 1877
                                      <br />
                                      Website:{" "}
                                      <a href="http://www.foodshowltd.com">
                                        www.foodshowltd.com
                                      </a>
                                    </p>
                                    <h3>Lettice Events</h3>
                                    <p>
                                      Email:{" "}
                                      <a href="/cdn-cgi/l/email-protection#f19487949f8582b19d9485859892949487949f8582df929e9c">
                                        <span
                                          className="__cf_email__"
                                          data-cfemail="80e5f6e5eef4f3c0ece5f4f4e9e3e5e5f6e5eef4f3aee3efed"
                                        >
                                          [email&nbsp;protected]
                                        </span>
                                      </a>
                                      <br />
                                      Phone: +44 (0)20 3820 2083
                                      <br />
                                      Website:{" "}
                                      <a href="http://www.letticeevents.com">
                                        www.letticeevents.com
                                      </a>
                                    </p>
                                    <h3>Morning Venue</h3>
                                    <p>
                                      Email:{" "}
                                      <a href="/cdn-cgi/l/email-protection#0b6c796e6a7f6d64646f4b66647d62656c7d6e657e6e25686466">
                                        <span
                                          className="__cf_email__"
                                          data-cfemail="f6918493978290999992b69b99809f98918093988393d895999b"
                                        >
                                          [email&nbsp;protected]
                                        </span>
                                      </a>
                                      <br />
                                      Phone: +44 (0)20 8691 6661
                                      <br />
                                      Website:{" "}
                                      <a href="http://www.movingvenue.com">
                                        www.movingvenue.com
                                      </a>
                                    </p>
                                    <h3>The Ripe Avocado</h3>
                                    <p>
                                      Email:{" "}
                                      <a href="/cdn-cgi/l/email-protection#82e7f4e7ecf6f1c2f6eae7f0ebf2e7e3f4ede1e3e6edace1edacf7e9">
                                        <span
                                          className="__cf_email__"
                                          data-cfemail="ddb8abb8b3a9ae9da9b5b8afb4adb8bcabb2bebcb9b2f3beb2f3a8b6"
                                        >
                                          [email&nbsp;protected]
                                        </span>
                                      </a>
                                      <br />
                                      Phone: +44 (0)20 8143 2455
                                      <br />
                                      Website:{" "}
                                      <a href="http://www.theripeavocado.co.uk">
                                    ...
                                    <p>
                                      ...
                                      <a href="/cdn-cgi/l/email-protection#4c24292020230c3f3c232327202322282322622f2321">
                                        <span
                                          className="__cf_email__"
                                          data-cfemail="741c1118181b3407041b1b1f181b1a101b1a5a171b19"
                                        >
                                          [email&nbsp;protected]
                                        </span>
                                      </a>
                                      <br />
                                      Phone: +44 (0)203 3979 537
                                      <br />
                                      Website:{" "}
                                      <a href="http://www.spooklondon.com">
                                        www.spooklondon.com
                                      </a>
                                    </p>
                                    <h3>Zafferano Catering</h3>
                                    <p>
                                      Email:{" "}
                                      <a href="/cdn-cgi/l/email-protection#452c2b232a053f2423232037242b2a6b262a6b302e">
                                        <span
                                          className="__cf_email__"
                                          data-cfemail="127b7c747d52687374747760737c7d3c717d3c6779"
                                        >
                                          [email&nbsp;protected]
                                        </span>
                                      </a>
                                      <br />
                                      Phone: +44 (0)20 8905 9120
                                      <br />
                                      Website:{" "}
                                      <a href="http://www.zafferano.co.uk">
                                        www.zafferano.co.uk
                                      </a>
                                    </p>
                                    <p>
                                      * Commercial Hire events and Filming only
                                    </p>
                                  </div>
                                </div>
                                <div
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-40941"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-40941"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                  ...
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-40941"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-40941"
                                  >
                                    <h3>Prelude Entertainment</h3>
                                    <p>
                                      Email:{" "}
                                      <a href="/cdn-cgi/l/email-protection#5526343930261525273039203130303b21302721343c3b38303b217b363a7b203e">
                                        <span
                                          className="__cf_email__"
                                          data-cfemail="a1d2c0cdc4d2e1d1d3c4cdd4c5c4c4cfd5c4d3d5c0c8cfccc4cfd58fc2ce8fd4ca"
                                        >
                                          [email&nbsp;protected]
                                        </span>
                                      </a>
                                      <br />
                                      Phone: +44 (0)208 660 6647
                                      <br />
                                      Website{" "}
                                      <a href="http://www.preludeentertainment.co.uk">
                                        www.preludeentertainment.co.uk
                                      </a>
                                    </p>
                                    <h3>Sternberg Clarke</h3>
                                    <p>
                                      Email:{" "}
                                      <a href="/cdn-cgi/l/email-protection#94e7f5f8f1e7d4e7e0f1e6faf6f1e6f3f7f8f5e6fff1baf7fbbae1ff">
                                        <span
                                          className="__cf_email__"
                                          data-cfemail="9ae9fbf6ffe9dae9eeffe8f4f8ffe8fdf9f6fbe8f1ffb4f9f5b4eff1"
                                        >
                                          [email&nbsp;protected]
                                        </span>
                                      </a>
                                      <br />
                                      Phone: +44 (0)20 8877 1102
                                      <br />
                                      Website{" "}
                                      <a href="http://www.sternbergclarke.co.uk/">
                                        www.sternbergclarke.co.uk
                                      </a>
                                    </p>
                                    <h3>Jillie Bushell Associates*</h3>
                                    <p>
                                      Email:{" "}
                                      <a href="/cdn-cgi/l/email-protection#036a6d656c43696a6f6f6a666176706b666f6f2d606c6e">
                                        <span
                                          className="__cf_email__"
                                          data-cfemail="dfb6b1b9b09fb5b6b3b3b6babdaaacb7bab3b3f1bcb0b2"
                                        >
                                          [email&nbsp;protected]
                                        </span>
                                      </a>
                                      <br />
                                      Phone: +44 (0)207 582 3048
                                      <br />
                                      Website{" "}
                                      <a href="http://www.jilliebushell.com">
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-40942"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-40942"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                  ...
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-40942"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-40942"
                                  >
                                    <h3>Bloomsbury Flowers*</h3>
                                    <p>
                                      Email:{" "}
                                      <a href="/cdn-cgi/l/email-protection#ef86818980af8d838080829c8d9a9d96898380988a9d9cc18c80c19a84">
                                        <span
                                          className="__cf_email__"
                                          data-cfemail="761f18101936141a19191b051403040f101a190113040558151958031d"
                                        >
                                          [email&nbsp;protected]
                                        </span>
                                      </a>
                                      <br />
                                      Phone: +44 (0)20 7242 2840
                                      <br />
                                      Website:{" "}
                                      <a href="http://www.bloomsburyflowers.co.uk">
                                        www.bloomsburyflowers.co.uk
                                      </a>
                                    </p>
                                    <h3>Lavender Green</h3>
                                    <p>
                                      Email:{" "}
                                      <a href="/cdn-cgi/l/email-protection#1c75727a735c707d6a797278796e7b6e797972327f73326977">
                                        <span
                                          className="__cf_email__"
                                          data-cfemail="90f9fef6ffd0fcf1e6f5fef4f5e2f7e2f5f5febef3ffbee5fb"
                                        >
                                          [email&nbsp;protected]
                                        </span>
                                      </a>
                                      <br />
                                      Phone: +44 (0)20 8171 1001
                                      <br />
                                      Website:{" "}
                                      <a href="http://www.lavendergreen.co.uk">
                                    ...
                                    <p>
                                      ...
                                      <a href="/cdn-cgi/l/email-protection#fb92959d94bb97948d9e9d97948c9e89888e90d5989496">
                                        <span
                                          className="__cf_email__"
                                          data-cfemail="a7cec9c1c8e7cbc8d1c2c1cbc8d0c2d5d4d2cc89c4c8ca"
                                        >
                                          [email&nbsp;protected]
                                        </span>
                                      </a>
                                      <br />
                                      Phone: +44 (0)1923 711655
                                      <br />
                                      Website:{" "}
                                      <a href="http://loveflowersuk.com">
                                        loveflowersuk.com
                                      </a>
                                    </p>
                                    <h3>Pinstripes &amp; Peonies</h3>
                                    <p>
                                      Email:{" "}
                                      <a href="/cdn-cgi/l/email-protection#ccaaa0a3bba9bebf8cbca5a2bfb8bea5bca9bfada2a8bca9a3a2a5a9bfe2afa3a1">
                                        <span
                                          className="__cf_email__"
                                          data-cfemail="4d2b21223a283f3e0d3d24233e393f243d283e2c23293d28222324283e632e2220"
                                        >
                                          [email&nbsp;protected]
                                        </span>
                                      </a>
                                      <br />
                                      Phone: +44 (0)20 7720 1245
                                      <br />
                                      Website:{" "}
                                      <a href="http://www.pinstripesandpeonies.com">
                                        http://www.pinstripesandpeonies.com
                                      </a>
                                    </p>
                                    <h3>Simon J. Lycett*</h3>
                                    <p>
                                      Email:{" "}
                                      <a href="/cdn-cgi/l/email-protection#5d38332c28342f34382e1d2e3430323331243e382929733e32732836">
                                        <span
                                          className="__cf_email__"
                                          data-cfemail="3d58534c48544f54584e7d4e5450525351445e584949135e52134856"
                                        >
                                          [email&nbsp;protected]
                                        </span>
                                      </a>
                                      <br />
                                      Phone: +44 (0)20 7277 3322
                                      <br />
                                      Website:{" "}
                                      <a href="http://www.simonlycett.co.uk">
                                        www.simonlycett.co.uk
                                      </a>
                                    </p>
                                    <h3>Veevers Carter</h3>
                                    <p>
                                      Email:{" "}
                                      <a href="/cdn-cgi/l/email-protection#96fff8f0f9d6e0f3f3e0f3e4e5f5f7e4e2f3e4b8f5f9fb">
                                        <span
                                          className="__cf_email__"
                                          data-cfemail="60090e060f20160505160512130301121405124e030f0d"
                                        >
                                          [email&nbsp;protected]
                                        </span>
                                      </a>
                                      <br />
                                      Phone: +44 (0)20 7237 8800
                                      <br />
                                      Website:{" "}
                                      <a href="http://www.veeverscarter.com">
                                        www.veeverscarter.com
                                      </a>
                                    </p>
                                    <p>
                                      * Commercial Hire events and Filming only
                                ...
                                >
                                  <h3 className="accordion__heading">
                                    <button
                                      ...
                                      id="accordion-40943"
                                      aria-expanded="false"
                                      aria-controls="accordion-content-40943"
                                    >
                                      <svg
                                        className="icon icon--plus"
                                        role="presentation"
                                      ...
                                      <span>
                                        {" "}
                                        Production/Management/Design/Activations
                                      </span>
                                    </button>
                                  </h3>
                                  <div
                                    className="accordion__content | js-accordion-content"
                                    id="accordion-content-40943"
                                    aria-hidden="true"
                                    aria-labelledby="accordion-40943"
                                  >
                                    <h3>Bespoke Productions*</h3>
                                    <p>
                                      Email:{" "}
                                      <a href="/cdn-cgi/l/email-protection#7d0e09081914123d1f180e0d12161850111213191213531e12530816">
                                        <span
                                          className="__cf_email__"
                                          data-cfemail="46353233222f290624233536292d236b2a292822292868252968332d"
                                        >
                                          [email&nbsp;protected]
                                        </span>
                                      </a>
                                      <br />
                                      Phone: +44 (0)20 8961 1510
                                      <br />
                                      Website:{" "}
                                      <a href="http://www.bespoke-london.co.uk">
                                        www.bespoke-london.co.uk
                                      </a>
                                    </p>
                                    <h3>DDA Group*</h3>
                                    <p>
                                      Email:{" "}
                                      <a href="/cdn-cgi/l/email-protection#e0979797ce848481878c8f82818cce838f8dcf838f8e94818394">
                                        www.ddaglobal.com/contact
                                      </a>
                                      <br />
                                      Phone: +44 (0)20 7932 9800
                                      <br />
                                      Website:{" "}
                                      <a href="http://www.ddaglobal.com">
                                        www.ddaglobal.com
                                      </a>
                                    </p>
                                    <h3>Dobson Sound*</h3>
                                    <p>
                                      Email:{" "}
                                      <a href="/cdn-cgi/l/email-protection#583d36292d312a313d2b183c373a2b37362b372d363c763b37762d33">
                                        <span
                                          className="__cf_email__"
                                          data-cfemail="7b1e150a0e1209121e083b1f141908141508140e151f551814550e10"
                                        >
                                          [email&nbsp;protected]
                                        </span>
                                      </a>
                                      <br />
                                      Phone: +44 (0)20 8545 0202
                                      <br />
                                      Website:{" "}
                                      <a href="http://www.dobsonsound.co.uk">
                                        www.dobsonsound.co.uk
                                      </a>
                                    </p>
                                    <h3>Event Concept</h3>
                                    <p>
                                      Email:{" "}
                                      <a href="/cdn-cgi/l/email-protection#eb82858d84ab8e9d8e859f888485888e9b9fc58884c59e80">
                                        <span
                                          className="__cf_email__"
                                          data-cfemail="6f060109002f0a190a011b0c00010c0a1f1b410c00411a04"
                                        >
                                          [email&nbsp;protected]
                                        </span>
                                      </a>
                                      <br />
                                      Phone: +44 (0)20 7740 3988
                                      <br />
                                      Website:{" "}
                                      <a href="http://www.eventconcept.com">
                                    ...
                                    <p>
                                      ...
                                      <a href="/cdn-cgi/l/email-protection#6f070a0303002f0a190a011b1f1d000b1a0c1b0600011c410300010b0001">
                                        <span
                                          className="__cf_email__"
                                          data-cfemail="6008050c0c0f200516050e1410120f04150314090f0e134e0c0f0e040f0e"
                                        >
                                          [email&nbsp;protected]
                                        </span>
                                      </a>
                                      <br />
                                      Phone: +44 (0)20 8224 7176
                                      <br />
                                      Website:{" "}
                                      <a href="http://www.eventproductions.london">
                                        www.eventproductions.london
                                      </a>
                                    </p>
                                    <h3>Light Motif*</h3>
                                    <p>
                                      Email:{" "}
                                      <a href="/cdn-cgi/l/email-protection#10797e767f507c797778647d7f6479763e737f3e657b">
                                        <span
                                          className="__cf_email__"
                                          data-cfemail="9df4f3fbf2ddf1f4faf5e9f0f2e9f4fbb3fef2b3e8f6"
                                        >
                                          [email&nbsp;protected]
                                        </span>
                                      </a>
                                      <br />
                                      Phone: +44 (0)20 7183 5381
                                      <br />
                                      Website:{" "}
                                      <a href="http://www.lightmotif.co.uk">
                                        www.lightmotif.co.uk
                                      </a>
                                    </p>
                                    <h3>Wise Productions</h3>
                                    <p>
                                      Email:{" "}
                                      <a href="/cdn-cgi/l/email-protection#badfccdfd4cec9facdd3c9dfcac8d5decfd9ced3d5d4c994d9d594cfd1">
                                        <span
                                          className="__cf_email__"
                                          data-cfemail="0e6b786b607a7d4e79677d6b7e7c616a7b6d7a6761607d206d61207b65"
                                        >
                                          [email&nbsp;protected]
                                        </span>
                                      </a>
                                      <br />
                                      Phone: +44 (0)20 8991 6922
                                      <br />
                                      Website:{" "}
                                      <a href="http://www.wiseproductions.co.uk">
                          ...
                          <section
                            className="paragraph paragraph--type--slice-content paragraph--view-mode--default section section--slice-content section--slice-content--align-left section--bg-white"
                            aria-labelledby="paragraph-5027-title"
                          >
                            <div className="container">
                              <div className="section__inner">
                                <h2
                                  id="paragraph-5027-title"
                                  className="section__title section--slice-content__title"
                                >
                                  Corporate and branded gifts
                                </h2>
                                <div className="section--slice-content__main">
                                  <div className="section--slice-content__wysiwyg wysiwyg">
                                    <p>
                                    ...
                                    <p>
                                      High quality replica sculptures and Museum
                                      objects are available as well as
                                      personalised branded gifts.
                                    </p>
                                    <p>
                                      Gifts can be designed to feature your
                                      business logo, colours or a personal
                                      message. Ideal for corporate days,
                                      business functions and events, the
                                      Museum's selection of gifts are perfect
                                      souvenirs for yourself and your
                                      colleagues.
                                    </p>
                                  </div>
                                </div>
                                  ...
                                  <div className="teaser__wrapper">
                                    ...
                                    <div className="teaser__content">
                                      <div className="teaser__content-push">
                                        ...
                                        <div className="teaser__summary">
                                          Enjoy a unique experience dining under
                                          the magnificent roof of the Great
                                          Court.
                                        </div>
                                      </div>
                                    </div>
                                  ...
                                  <div className="teaser__wrapper">
                                    ...
                                    <div className="teaser__content">
                                      <div className="teaser__content-push">
                                        <h3 className="teaser__title">
                                          <a
                                            href="/commercial/filming/filming-requests"
                                            className="teaser__anchor"
                                          >
                                            <span>
                                              <span>Filming requests</span>
                                            </span>
                                            {/* Add visually hidden defacer for screen-reader. Use full stops for reader punctuation. */}
                                          </a>
                                        </h3>
                                        <div className="teaser__summary">
                                          The Museum strives to be a
                                          film-friendly environment; whether
                                          it's for press or commercial purposes.
                                        </div>
                                      </div>
                                    </div>
                                  </div>
                                  ...
                                  <div className="teaser__wrapper">
                                    ...
                                    <div className="teaser__content">
                                      <div className="teaser__content-push">
                                        ...
                                        <div className="teaser__summary">
                                          We offer a broad range of commercial
                                          opportunities reaching consumers
                                          around the world.&nbsp;
                                        </div>
                                      </div>
                                    </div>
